...
(declare-fun var220_interpretation_of_theory_safe_over_async__t0 () Bool)
(assert
  (= var220_interpretation_of_theory_safe_over_async__t0 (theory1_safe var219_async__t0) )
)

(assert (! var220_interpretation_of_theory_safe_over_async__t0 :named A0))(check-sat)
...
(declare-fun var223_safe_async___t0 () Bool)
(assert
  (= var223_safe_async___t0 (theory1_safe var219_async__t0) )
)

(push 1)

(assert
  (and true (or (not var223_safe_async___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/modules/io/src/unix.zz:217
(declare-fun var225_cast_of_deref_var219_async__upper__t0 () (_ BitVec 64))
(declare-fun var224_deref_var219_async__upper__t0 () (_ BitVec 64))
(assert (! (= var225_cast_of_deref_var219_async__upper__t0 var224_deref_var219_async__upper__t0) :named A1)); : /home/runner/work/carrier/carrier/core/modules/io/src/unix.zz:217
(declare-fun var226_safe_cast_of_deref_var219_async__upper_____safe_self___t0 () Bool)
(assert
  (= var226_safe_cast_of_deref_var219_async__upper_____safe_self___t0 (theory1_safe var225_cast_of_deref_var219_async__upper__t0) )
)

(declare-fun var221_self__t1 () (_ BitVec 64))
(assert
  (= var226_safe_cast_of_deref_var219_async__upper_____safe_self___t0 (theory1_safe var221_self__t1) )
)

(declare-fun var227_nullterm_cast_of_deref_var219_async__upper_____nullterm_self___t0 () Bool)
(assert
  (= var227_nullterm_cast_of_deref_var219_async__upper_____nullterm_self___t0 (theory2_nullterm var225_cast_of_deref_var219_async__upper__t0) )
)

(assert
  (= var227_nullterm_cast_of_deref_var219_async__upper_____nullterm_self___t0 (theory2_nullterm var221_self__t1) )
)

(declare-fun var221_self__t0 () (_ BitVec 64))
(assert
  (= var221_self__t1  (ite true var225_cast_of_deref_var219_async__upper__t0 var221_self__t0)  )
)
...
(assert
  (= var228_interpretation_of_theory_safe_over_self__t0 (theory1_safe var221_self__t1) )
)

(assert (! var228_interpretation_of_theory_safe_over_self__t0 :named A2))(check-sat)
...
(assert
  (= var231_safe_self___t0 (theory1_safe var221_self__t1) )
)
...
(assert (! (= var234_implicit_coercion_of_literal_0__t0 var233_literal_0__t0) :named A3))(declare-fun var232_deref_var221_self__timeout__t1 () (_ BitVec 64))
(declare-fun var232_deref_var221_self__timeout__t0 () (_ BitVec 64))
(assert
  (= var232_deref_var221_self__timeout__t1  (ite true var234_implicit_coercion_of_literal_0__t0 var232_deref_var221_self__timeout__t0)  )
)
