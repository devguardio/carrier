...
;
const size_t sizeof_carrier_peering_Path = sizeof(carrier_peering_Path);
...
;
const size_t sizeof_carrier_peering_Peering = sizeof(carrier_peering_Peering);
...
#line 35 "/home/aep/proj/devguard/carrier/src/peering.zz"
void __attribute__ ((visibility ("default"))) carrier_peering_received (carrier_peering_Peering*  const  self, carrier_peering_Transport const  transport, net_address_Address const  addr, carrier_peering_Class const  klass)
{
  for (

#line 36 "/home/aep/proj/devguard/carrier/src/peering.zz"
  uintptr_t i  =     0;(    i <    16  );
(    i ++)){
if (
#line 37 "/home/aep/proj/devguard/carrier/src/peering.zz"
    net_address_eq(( &    self ->paths [     i] .addr),( &    addr)    )){

#line 38 "/home/aep/proj/devguard/carrier/src/peering.zz"
  return ;

}

if ((
#line 40 "/home/aep/proj/devguard/carrier/src/peering.zz"
 !    self ->paths [     i] .used)){

#line 41 "/home/aep/proj/devguard/carrier/src/peering.zz"
    self ->paths [     i] .transport =     transport;

#line 42 "/home/aep/proj/devguard/carrier/src/peering.zz"
    self ->paths [     i] .addr =     addr;

#line 43 "/home/aep/proj/devguard/carrier/src/peering.zz"
    self ->paths [     i] .klass =     klass;

#line 44 "/home/aep/proj/devguard/carrier/src/peering.zz"
    self ->paths [     i] .used =     true;

#line 45 "/home/aep/proj/devguard/carrier/src/peering.zz"
    self ->paths [     i] .active =     true;

#line 46 "/home/aep/proj/devguard/carrier/src/peering.zz"
  return ;
...
#line 51 "/home/aep/proj/devguard/carrier/src/peering.zz"
void __attribute__ ((visibility ("default"))) carrier_peering_from_proto (carrier_peering_Peering*  const  self, err_Err*  const  e, uintptr_t const  et, protonerf_Field const  field)
{
if ((
#line 54 "/home/aep/proj/devguard/carrier/src/peering.zz"
    field .a ==    0  )){

#line 55 "/home/aep/proj/devguard/carrier/src/peering.zz"
  return ;

}


#line 57 "/home/aep/proj/devguard/carrier/src/peering.zz"
;

#line 58 "/home/aep/proj/devguard/carrier/src/peering.zz"
;

#line 59 "/home/aep/proj/devguard/carrier/src/peering.zz"
  protonerf_Decoder dec2  =     protonerf_decode(    field .a,    field .value .v_len    );

#line 62 "/home/aep/proj/devguard/carrier/src/peering.zz"
  net_address_Address ip  = {    0,};

#line 63 "/home/aep/proj/devguard/carrier/src/peering.zz"
  carrier_peering_Class cat  =     carrier_peering_Class_Invalid;
  for (;;){

#line 65 "/home/aep/proj/devguard/carrier/src/peering.zz"
  protonerf_Field const  field  =     protonerf_next(( &    dec2),    (err_Err* )(    e),
#line 51 "/home/aep/proj/devguard/carrier/src/peering.zz"
    et    );
if (
#line 66 "/home/aep/proj/devguard/carrier/src/peering.zz"
    err_check(    (err_Err* )(    e),
#line 51 "/home/aep/proj/devguard/carrier/src/peering.zz"
    et,
#line 34 "/home/aep/proj/zz/modules/err/src/lib.zz"
    "/home/aep/proj/devguard/carrier/src/peering.zz",
#line 35 "/home/aep/proj/zz/modules/err/src/lib.zz"
    "::carrier::peering::from_proto",
#line 36 "/home/aep/proj/zz/modules/err/src/lib.zz"
    66    )){

#line 67 "/home/aep/proj/devguard/carrier/src/peering.zz"
  return ;

}

if ((
#line 69 "/home/aep/proj/devguard/carrier/src/peering.zz"
 !    field .valid)){

#line 70 "/home/aep/proj/devguard/carrier/src/peering.zz"
break;

}


#line 72 "/home/aep/proj/devguard/carrier/src/peering.zz"
switch (
    field .index) {
case 
#line 73 "/home/aep/proj/devguard/carrier/src/peering.zz"
    carrier_proto_Path_Category:
{
{

#line 74 "/home/aep/proj/devguard/carrier/src/peering.zz"
switch (
    field .value .v_u64) {
case 
#line 75 "/home/aep/proj/devguard/carrier/src/peering.zz"
    1:
{
{

#line 76 "/home/aep/proj/devguard/carrier/src/peering.zz"
    cat =     carrier_peering_Class_Local;

}
break;}
case 
#line 78 "/home/aep/proj/devguard/carrier/src/peering.zz"
    2:
{
{

#line 79 "/home/aep/proj/devguard/carrier/src/peering.zz"
    cat =     carrier_peering_Class_Internet;

}
break;}
case 
#line 81 "/home/aep/proj/devguard/carrier/src/peering.zz"
    3:
{
{

#line 82 "/home/aep/proj/devguard/carrier/src/peering.zz"
    cat =     carrier_peering_Class_BrokerOrigin;
...
break;}
case 
#line 88 "/home/aep/proj/devguard/carrier/src/peering.zz"
    carrier_proto_Path_Ipaddr:
{
{
if ((
#line 89 "/home/aep/proj/devguard/carrier/src/peering.zz"
    field .a !=    0  )){

#line 90 "/home/aep/proj/devguard/carrier/src/peering.zz"
;

#line 91 "/home/aep/proj/devguard/carrier/src/peering.zz"
;

#line 92 "/home/aep/proj/devguard/carrier/src/peering.zz"
    net_address_from_str(( &    ip),    (char const * )(    field .a),    field .value .v_len    );
if (
#line 93 "/home/aep/proj/devguard/carrier/src/peering.zz"
    net_address_valid(( &    ip)    )){

#line 94 "/home/aep/proj/devguard/carrier/src/peering.zz"
    log_debug(
#line 76 "/home/aep/proj/zz/modules/log/src/lib.zz"
    "carrier::peering",
#line 94 "/home/aep/proj/devguard/carrier/src/peering.zz"
    "path: %.*s",    field .value .v_len,    field .a    );

}
 else {

#line 96 "/home/aep/proj/devguard/carrier/src/peering.zz"
    log_debug(
#line 76 "/home/aep/proj/zz/modules/log/src/lib.zz"
    "carrier::peering",
#line 96 "/home/aep/proj/devguard/carrier/src/peering.zz"
    "cannot parse path: %.*s",    field .value .v_len,    field .a    );
...
if (
#line 102 "/home/aep/proj/devguard/carrier/src/peering.zz"
    net_address_valid(( &    ip)    )){

#line 103 "/home/aep/proj/devguard/carrier/src/peering.zz"
    carrier_peering_received(    self,    carrier_peering_Transport_Udp,    ip,    cat    );
