...
(assert
  (= var210_interpretation_of_theory_safe_over_ii__t0 (theory1_safe var209_ii__t0) )
)

(assert (! var210_interpretation_of_theory_safe_over_ii__t0 :named A1))(check-sat)
...
(assert
  (= var214_safe_self___t0 (theory1_safe var208_self__t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var218_interpretation_of_theory_safe_over_ii__t0 () Bool)
(assert
  (= var218_interpretation_of_theory_safe_over_ii__t0 (theory1_safe var209_ii__t0) )
)
...
(assert
  (=  var221_infix_expression__t0 (= var217_literal_0__t0 var220_literal_0__t0))
)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:223
(declare-fun var222_interpretation_of_theory_nullterm_over_literal_0__t0 () Bool)
(assert
  (= var222_interpretation_of_theory_nullterm_over_literal_0__t0 (theory2_nullterm var217_literal_0__t0) )
)

; : /home/runner/work/carrier/carrier/core/src/vault.zz:223
(declare-fun var223_infix_expression__t0 () Bool)
(assert
  (=  var223_infix_expression__t0 (or var221_infix_expression__t0 var222_interpretation_of_theory_nullterm_over_literal_0__t0))
)

(push 1)

(assert
  (and true (or (not var218_interpretation_of_theory_safe_over_ii__t0 ) (not var219_interpretation_of_theory_safe_over_self__t0 ) (not var223_infix_expression__t0 ) ))
...
(declare-fun var224_return_value_of___carrier__vault__authorize_open_stream__t0 () Bool)
(declare-fun var212_return__t0 () Bool)
(assert
  (= var212_return__t1  (ite true var224_return_value_of___carrier__vault__authorize_open_stream__t0 var212_return__t0)  )
)
