...
(declare-fun var333_secret__t0 () (_ BitVec 64))
(declare-fun var334_interpretation_of_theory_safe_over_secret__t0 () Bool)
(assert
  (= var334_interpretation_of_theory_safe_over_secret__t0 (theory1_safe var333_secret__t0) )
)

(assert (! var334_interpretation_of_theory_safe_over_secret__t0 :named A2))(check-sat)
...
(assert (! (= var340_cast_of_deref_var332_self__user__t0 var339_deref_var332_self__user__t0) :named A4)); : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:470
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:473
(declare-fun var348_addressof_deref_var336_this__network_secret___t0 () (_ BitVec 64))
(declare-fun var349_len_addressof_deref_var336_this__network_secret____t0 () (_ BitVec 64))
(assert
  (= var349_len_addressof_deref_var336_this__network_secret____t0 (theory0_len var348_addressof_deref_var336_this__network_secret___t0) )
)

(assert
  (= var349_len_addressof_deref_var336_this__network_secret____t0 (_ bv1 64))

)

(assert
  (= var348_addressof_deref_var336_this__network_secret___t0 (_ bv347 64))

)

(declare-fun var350_true__t0 () Bool)
(assert
  (= var350_true__t0 (theory1_safe var348_addressof_deref_var336_this__network_secret___t0) )
)
