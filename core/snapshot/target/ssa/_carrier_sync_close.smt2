...
(assert
  (= var825_interpretation_of_theory_safe_over_self__t0 (theory1_safe var823_self__t0) )
)

(assert (! var825_interpretation_of_theory_safe_over_self__t0 :named A6))(check-sat)
...
(declare-fun var827_safe_self___t0 () Bool)
(assert
  (= var827_safe_self___t0 (theory1_safe var823_self__t0) )
)

(push 1)

(assert
  (and true (or (not var827_safe_self___t0 ) ))
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/sync.zz:55
(declare-fun var828_deref_var823_self__ep__t0 () (_ BitVec 64))
(declare-fun var829_interpretation_of_theory_safe_over_deref_var823_self__ep__t0 () Bool)
(assert
  (= var829_interpretation_of_theory_safe_over_deref_var823_self__ep__t0 (theory1_safe var828_deref_var823_self__ep__t0) )
)

(assert (! var829_interpretation_of_theory_safe_over_deref_var823_self__ep__t0 :named A7))(check-sat)

; : /home/runner/work/carrier/carrier/core/src/sync.zz:55
(declare-fun var830_literal_Unsigned_1___t0 () (_ BitVec 64))
(assert
  (= var830_literal_Unsigned_1___t0 (_ bv1 64))
...
; : /home/runner/work/carrier/carrier/core/src/sync.zz:56
; begin safe ptr check
(declare-fun var832_safe_deref_var823_self__ep___t0 () Bool)
(assert
  (= var832_safe_deref_var823_self__ep___t0 (theory1_safe var828_deref_var823_self__ep__t0) )
)

(push 1)

(assert
  (and true (or (not var832_safe_deref_var823_self__ep___t0 ) ))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var834_interpretation_of_theory_safe_over_deref_var823_self__ep__t0 () Bool)
(assert
  (= var834_interpretation_of_theory_safe_over_deref_var823_self__ep__t0 (theory1_safe var828_deref_var823_self__ep__t0) )
)

(push 1)

(assert
  (and true (or (not var834_interpretation_of_theory_safe_over_deref_var823_self__ep__t0 ) ))
...
(declare-fun var831_deref_var828_deref_var823_self__ep___t1 () (_ BitVec 64))
(declare-fun var831_deref_var828_deref_var823_self__ep___t0 () (_ BitVec 64))
(assert
  (= var831_deref_var828_deref_var823_self__ep___t1  (ite true var831_deref_var828_deref_var823_self__ep___t1 var831_deref_var828_deref_var823_self__ep___t0)  )
)
