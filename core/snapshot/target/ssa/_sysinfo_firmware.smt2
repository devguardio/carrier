...
(assert
  (not (= var809_infix_expression__t0 true))
)
...
(assert
  (not (= var1115_infix_expression__t0 true))
)
...
(assert
  (= var1243_interpretation_of_theory___err__checked_over_deref_S1236_e___t0 (theory64___err__checked var1238_deref_S1236_e___t0) )
)
