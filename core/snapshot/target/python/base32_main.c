...
#include <stdint.h>
#include <string.h>
#include "zz/carrier/base32_main.h"
...
static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "base32_main", "base32::main", -1, methods};

PyObject*  py_mod_base32_main_Init()
{
