...
(declare-fun var787_ep__t0 () (_ BitVec 64))
(declare-fun var788_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var788_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var787_ep__t0) )
)

(assert (! var788_interpretation_of_theory_safe_over_ep__t0 :named A5))(check-sat)
...
(declare-fun var790_safe_ep___t0 () Bool)
(assert
  (= var790_safe_ep___t0 (theory1_safe var787_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var790_safe_ep___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
(declare-fun var792_addressof___carrier__shell__ShellConfig___t0 () (_ BitVec 64))
(declare-fun var793_len_addressof___carrier__shell__ShellConfig____t0 () (_ BitVec 64))
(assert
  (= var793_len_addressof___carrier__shell__ShellConfig____t0 (theory0_len var792_addressof___carrier__shell__ShellConfig___t0) )
)

(assert
  (= var793_len_addressof___carrier__shell__ShellConfig____t0 (_ bv1 64))

)

(assert
  (= var792_addressof___carrier__shell__ShellConfig___t0 (_ bv432 64))

)

(declare-fun var794_true__t0 () Bool)
(assert
  (= var794_true__t0 (theory1_safe var792_addressof___carrier__shell__ShellConfig___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
(declare-fun var795_addressof___carrier__shell__ShellConfig___t0 () (_ BitVec 64))
(declare-fun var796_len_addressof___carrier__shell__ShellConfig____t0 () (_ BitVec 64))
(assert
  (= var796_len_addressof___carrier__shell__ShellConfig____t0 (theory0_len var795_addressof___carrier__shell__ShellConfig___t0) )
)

(assert
  (= var796_len_addressof___carrier__shell__ShellConfig____t0 (_ bv1 64))

)

(assert
  (= var795_addressof___carrier__shell__ShellConfig___t0 (_ bv432 64))

)

(declare-fun var797_true__t0 () Bool)
(assert
  (= var797_true__t0 (theory1_safe var795_addressof___carrier__shell__ShellConfig___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var798_interpretation_of_theory_safe_over_addressof___carrier__shell__ShellConfig___t0 () Bool)
(assert
  (= var798_interpretation_of_theory_safe_over_addressof___carrier__shell__ShellConfig___t0 (theory1_safe var795_addressof___carrier__shell__ShellConfig___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var799_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var799_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var787_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var798_interpretation_of_theory_safe_over_addressof___carrier__shell__ShellConfig___t0 ) (not var799_interpretation_of_theory_safe_over_ep__t0 ) ))
...
(declare-fun var789_deref_var787_ep___t1 () (_ BitVec 64))
(declare-fun var789_deref_var787_ep___t0 () (_ BitVec 64))
(assert
  (= var789_deref_var787_ep___t1  (ite true var789_deref_var787_ep___t1 var789_deref_var787_ep___t0)  )
)
