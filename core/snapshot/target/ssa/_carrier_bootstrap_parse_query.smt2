...
(assert
  (not (= var383_at__t3 #x500b0c9100082450))
)
...
(get-value (
  ...
  var119___carrier__vault__MAX_BROKERS__t1
...
(assert
  (not (= var119___carrier__vault__MAX_BROKERS__t1 #x0000000000000010))
)
...
(assert
  (=  var723_infix_expression__t0 (bvugt var415_storepos__t2 var119___carrier__vault__MAX_BROKERS__t1))
)
