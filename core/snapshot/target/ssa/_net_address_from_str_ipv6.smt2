...
(assert
  (not (= var253_at_part__t2 #x0000000000000002))
)
...
(assert
  (not (= var253_at_part__t2 #x0000000000000011))
)
...
(assert
  (not (= var281_i__t5 #x0000000000000004))
)
...
(assert
  (not (= var421_i__t2 #x0000000000000003))
)
...
(assert
  (not (= var478_infix_expression__t0 #x0000000000000001))
)
...
(assert
  (=  var491_infix_expression__t0 (= var15___net__address__Type__Ipv6__t0 var14___net__address__Type__Ipv4__t0))
)
...
(assert
  (=  var496_infix_expression__t0 (= var15___net__address__Type__Ipv6__t0 var15___net__address__Type__Ipv6__t0))
)
...
(assert (! (= var507_implicit_coercion_of___net__address__Type__Ipv6__t0 var15___net__address__Type__Ipv6__t0) :named A48)); : /home/runner/work/carrier/carrier/modules/net/src/address.zz:189
