...
(declare-fun var292_id__t0 () (_ BitVec 64))
(declare-fun var293_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var293_interpretation_of_theory_safe_over_id__t0 (theory1_safe var292_id__t0) )
)

(assert (! var293_interpretation_of_theory_safe_over_id__t0 :named A2))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/vault_esp32.zz:57
(declare-fun var299_safe_literal_array_297_____safe_secret___t0 () Bool)
(assert
  (= var299_safe_literal_array_297_____safe_secret___t0 (theory1_safe var297_literal_array_297__t0) )
)

(declare-fun var295_secret__t1 () (_ BitVec 64))
(assert
  (= var299_safe_literal_array_297_____safe_secret___t0 (theory1_safe var295_secret__t1) )
)

(declare-fun var300_nullterm_literal_array_297_____nullterm_secret___t0 () Bool)
(assert
  (= var300_nullterm_literal_array_297_____nullterm_secret___t0 (theory2_nullterm var297_literal_array_297__t0) )
)

(assert
  (= var300_nullterm_literal_array_297_____nullterm_secret___t0 (theory2_nullterm var295_secret__t1) )
)

(declare-fun var301_len_secret___t0 () (_ BitVec 64))
(assert
  (= var301_len_secret___t0 (theory0_len var295_secret__t1) )
)

(assert
  (= var301_len_secret___t0 (_ bv1 64))
...
; : /home/runner/work/carrier/carrier/core/src/vault_esp32.zz:58
; : /home/runner/work/carrier/carrier/core/src/vault_esp32.zz:58
(declare-fun var302_addressof_secret___t0 () (_ BitVec 64))
(declare-fun var303_len_addressof_secret____t0 () (_ BitVec 64))
(assert
  (= var303_len_addressof_secret____t0 (theory0_len var302_addressof_secret___t0) )
)

(assert
  (= var303_len_addressof_secret____t0 (_ bv1 64))

)

(assert
  (= var302_addressof_secret___t0 (_ bv295 64))

)

(declare-fun var304_true__t0 () Bool)
(assert
  (= var304_true__t0 (theory1_safe var302_addressof_secret___t0) )
)
...
(assert
  (= var305_addressof_secret___t0 (_ bv295 64))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var308_interpretation_of_theory_safe_over_addressof_secret___t0 () Bool)
(assert
  (= var308_interpretation_of_theory_safe_over_addressof_secret___t0 (theory1_safe var305_addressof_secret___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var309_interpretation_of_theory_safe_over_self__t0 () Bool)
(assert
  (= var309_interpretation_of_theory_safe_over_self__t0 (theory1_safe var291_self__t0) )
)

(push 1)

(assert
  (and true (or (not var308_interpretation_of_theory_safe_over_addressof_secret___t0 ) (not var309_interpretation_of_theory_safe_over_self__t0 ) ))
...
(declare-fun var295_secret__t2 () (_ BitVec 64))
(assert
  (= var295_secret__t2  (ite true var295_secret__t2 var295_secret__t1)  )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_esp32.zz:59
; : /home/runner/work/carrier/carrier/core/src/vault_esp32.zz:59
(declare-fun var311_addressof_secret___t0 () (_ BitVec 64))
(declare-fun var312_len_addressof_secret____t0 () (_ BitVec 64))
(assert
  (= var312_len_addressof_secret____t0 (theory0_len var311_addressof_secret___t0) )
)

(assert
  (= var312_len_addressof_secret____t0 (_ bv1 64))

)

(assert
  (= var311_addressof_secret___t0 (_ bv295 64))

)

(declare-fun var313_true__t0 () Bool)
(assert
  (= var313_true__t0 (theory1_safe var311_addressof_secret___t0) )
)
...
(assert
  (= var314_addressof_secret___t0 (_ bv295 64))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var317_interpretation_of_theory_safe_over_addressof_secret___t0 () Bool)
(assert
  (= var317_interpretation_of_theory_safe_over_addressof_secret___t0 (theory1_safe var314_addressof_secret___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var318_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var318_interpretation_of_theory_safe_over_id__t0 (theory1_safe var292_id__t0) )
)

(push 1)

(assert
  (and true (or (not var317_interpretation_of_theory_safe_over_addressof_secret___t0 ) (not var318_interpretation_of_theory_safe_over_id__t0 ) ))
