...
(assert (! (= var671_len_deref_S667_e____t0 var668_et__t0) :named A5)); : /home/runner/work/carrier/carrier/core/src/stream.zz:184
; : /home/runner/work/carrier/carrier/core/src/stream.zz:184
; call of safe
...
(get-value (
  ...
  var679_deref_var666_self__closing__t0
...
(assert
  (not (= var679_deref_var666_self__closing__t0 false))
)
...
; literal expr
(declare-fun var680_literal_4294967295__t0 () Bool)
(assert
  var680_literal_4294967295__t0
)

(declare-fun var676_return__t1 () Bool)
(declare-fun var676_return__t0 () Bool)
(assert
  (= var676_return__t1  (ite var679_deref_var666_self__closing__t0 var680_literal_4294967295__t0 var676_return__t0)  )
)

; end branch
; branch returned. the rest of the function only happens if the condition leading to return never happened
; (not var679_deref_var666_self__closing__t0)
(assert
  (not var679_deref_var666_self__closing__t0)
)
...
(declare-fun var681_deref_var666_self__order_incomming__t0 () (_ BitVec 64))
(assert
  (=  var682_infix_expression__t0 (bvule var672_order__t0 var681_deref_var666_self__order_incomming__t0))
)
...
; literal expr
(declare-fun var683_literal_4294967295__t0 () Bool)
(assert
  var683_literal_4294967295__t0
)

(declare-fun var676_return__t2 () Bool)
(assert
  (= var676_return__t2  (ite var682_infix_expression__t0 var683_literal_4294967295__t0 var676_return__t1)  )
)
...
(assert (! (= var685_implicit_coercion_of_literal_1__t0 var684_literal_1__t0) :named A9)); : /home/runner/work/carrier/carrier/core/src/stream.zz:195
(declare-fun var686_infix_expression__t0 () (_ BitVec 64))
(assert
   (=  var686_infix_expression__t0 (bvadd var681_deref_var666_self__order_incomming__t0 var685_implicit_coercion_of_literal_1__t0))
)

; : /home/runner/work/carrier/carrier/core/src/stream.zz:195
(declare-fun var687_infix_expression__t0 () Bool)
(assert
  (=  var687_infix_expression__t0 (not (= var672_order__t0 var686_infix_expression__t0)))
)
...
(assert
  (not (= var687_infix_expression__t0 true))
)
...
; literal expr
(declare-fun var688_literal_0__t0 () Bool)
(assert
  (not var688_literal_0__t0)
)

(declare-fun var676_return__t3 () Bool)
(assert
  (= var676_return__t3  (ite var687_infix_expression__t0 var688_literal_0__t0 var676_return__t2)  )
)

; end branch
; branch returned. the rest of the function only happens if the condition leading to return never happened
; (not var687_infix_expression__t0)
(assert
  (not var687_infix_expression__t0)
)
...
(assert (! (= var690_implicit_coercion_of_literal_1__t0 var689_literal_1__t0) :named A10)); : /home/runner/work/carrier/carrier/core/src/stream.zz:200
(declare-fun var691_assign_inter__t0 () (_ BitVec 64))
(assert
   (=  var691_assign_inter__t0 (bvadd var681_deref_var666_self__order_incomming__t0 var690_implicit_coercion_of_literal_1__t0))
)

(declare-fun var692_safe_assign_inter_____safe_deref_var666_self__order_incomming___t0 () Bool)
(assert
  (= var692_safe_assign_inter_____safe_deref_var666_self__order_incomming___t0 (theory1_safe var691_assign_inter__t0) )
)

(declare-fun var681_deref_var666_self__order_incomming__t1 () (_ BitVec 64))
(assert
  (= var692_safe_assign_inter_____safe_deref_var666_self__order_incomming___t0 (theory1_safe var681_deref_var666_self__order_incomming__t1) )
)

(declare-fun var693_nullterm_assign_inter_____nullterm_deref_var666_self__order_incomming___t0 () Bool)
(assert
  (= var693_nullterm_assign_inter_____nullterm_deref_var666_self__order_incomming___t0 (theory2_nullterm var691_assign_inter__t0) )
)

(assert
  (= var693_nullterm_assign_inter_____nullterm_deref_var666_self__order_incomming___t0 (theory2_nullterm var681_deref_var666_self__order_incomming__t1) )
)

(assert
  (= var681_deref_var666_self__order_incomming__t1  (ite true var691_assign_inter__t0 var681_deref_var666_self__order_incomming__t0)  )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var695_interpretation_of_theory_safe_over_self__t0 () Bool)
(assert
  (= var695_interpretation_of_theory_safe_over_self__t0 (theory1_safe var666_self__t0) )
)

(push 1)

(assert
  (and true (or (not var695_interpretation_of_theory_safe_over_self__t0 ) ))
...
(assert
  (= var677_deref_var666_self___t1  (ite true var677_deref_var666_self___t1 var677_deref_var666_self___t0)  )
)
...
(declare-fun var676_return__t4 () Bool)
(assert
  (= var676_return__t4  (ite true var697_literal_4294967295__t0 var676_return__t3)  )
)
