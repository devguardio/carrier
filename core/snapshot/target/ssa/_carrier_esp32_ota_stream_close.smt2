...
(assert (! (= var801_len_deref_S797_e____t0 var798_et__t0) :named A5)); : /home/runner/work/carrier/carrier/core/src/esp32.zz:174
; call of safe
...
(assert
  (= var803_interpretation_of_theory_safe_over_self__t0 (theory1_safe var796_self__t0) )
)
...
(declare-fun var804_interpretation_of_theory___err__checked_over_deref_S797_e___t0 () Bool)
(assert
  (= var804_interpretation_of_theory___err__checked_over_deref_S797_e___t0 (theory16___err__checked var799_deref_S797_e___t0) )
)

(assert (! var804_interpretation_of_theory___err__checked_over_deref_S797_e___t0 :named A8))(check-sat)
...
(assert (! (= var806_implicit_coercion_of_literal_0__t0 var805_literal_0__t0) :named A9)); : /home/runner/work/carrier/carrier/core/src/esp32.zz:177
(declare-fun var807_infix_expression__t0 () Bool)
(declare-fun var187___carrier__esp32__ota_handle__t0 () (_ BitVec 64))
(assert
  (=  var807_infix_expression__t0 (not (= var187___carrier__esp32__ota_handle__t0 var806_implicit_coercion_of_literal_0__t0)))
)
...
(assert (! (= var811_implicit_coercion_of_literal_0__t0 var810_literal_0__t0) :named A10)); : /home/runner/work/carrier/carrier/core/src/esp32.zz:179
(declare-fun var812_safe_implicit_coercion_of_literal_0_____safe___carrier__esp32__ota_handle___t0 () Bool)
(assert
  (= var812_safe_implicit_coercion_of_literal_0_____safe___carrier__esp32__ota_handle___t0 (theory1_safe var811_implicit_coercion_of_literal_0__t0) )
)

(declare-fun var187___carrier__esp32__ota_handle__t1 () (_ BitVec 64))
(assert
  (= var812_safe_implicit_coercion_of_literal_0_____safe___carrier__esp32__ota_handle___t0 (theory1_safe var187___carrier__esp32__ota_handle__t1) )
)

(declare-fun var813_nullterm_implicit_coercion_of_literal_0_____nullterm___carrier__esp32__ota_handle___t0 () Bool)
(assert
  (= var813_nullterm_implicit_coercion_of_literal_0_____nullterm___carrier__esp32__ota_handle___t0 (theory2_nullterm var811_implicit_coercion_of_literal_0__t0) )
)

(assert
  (= var813_nullterm_implicit_coercion_of_literal_0_____nullterm___carrier__esp32__ota_handle___t0 (theory2_nullterm var187___carrier__esp32__ota_handle__t1) )
)

(assert
  (= var187___carrier__esp32__ota_handle__t1  (ite var807_infix_expression__t0 var811_implicit_coercion_of_literal_0__t0 var187___carrier__esp32__ota_handle__t0)  )
)
