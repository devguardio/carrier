...
(assert (! (= var328_cast_of_deref_var320_self__user__t0 var327_deref_var320_self__user__t0) :named A4)); : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:438
...
(declare-fun var335_deref_var324_this__has_principal__t0 () Bool)
(assert
  (= var336_unary_expression__t0 (not var335_deref_var324_this__has_principal__t0 ))
)
...
(assert
  (not (= var336_unary_expression__t0 true))
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var337_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var337_interpretation_of_theory_safe_over_id__t0 (theory1_safe var321_id__t0) )
)
...
(assert
  (and var336_unary_expression__t0 (or (not var337_interpretation_of_theory_safe_over_id__t0 ) (not var338_interpretation_of_theory_safe_over_self__t0 ) ))
...
; (not var336_unary_expression__t0)
(assert
  (not var336_unary_expression__t0)
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:445
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:445
(declare-fun var341_addressof_deref_var324_this__principal___t0 () (_ BitVec 64))
(declare-fun var342_len_addressof_deref_var324_this__principal____t0 () (_ BitVec 64))
(assert
  (= var342_len_addressof_deref_var324_this__principal____t0 (theory0_len var341_addressof_deref_var324_this__principal___t0) )
)

(assert
  (= var342_len_addressof_deref_var324_this__principal____t0 (_ bv1 64))

)

(assert
  (= var341_addressof_deref_var324_this__principal___t0 (_ bv340 64))

)

(declare-fun var343_true__t0 () Bool)
(assert
  (= var343_true__t0 (theory1_safe var341_addressof_deref_var324_this__principal___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:445
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:445
(declare-fun var344_addressof_deref_var324_this__principal___t0 () (_ BitVec 64))
(declare-fun var345_len_addressof_deref_var324_this__principal____t0 () (_ BitVec 64))
(assert
  (= var345_len_addressof_deref_var324_this__principal____t0 (theory0_len var344_addressof_deref_var324_this__principal___t0) )
)

(assert
  (= var345_len_addressof_deref_var324_this__principal____t0 (_ bv1 64))

)

(assert
  (= var344_addressof_deref_var324_this__principal___t0 (_ bv340 64))

)

(declare-fun var346_true__t0 () Bool)
(assert
  (= var346_true__t0 (theory1_safe var344_addressof_deref_var324_this__principal___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var347_interpretation_of_theory_safe_over_addressof_deref_var324_this__principal___t0 () Bool)
(assert
  (= var347_interpretation_of_theory_safe_over_addressof_deref_var324_this__principal___t0 (theory1_safe var344_addressof_deref_var324_this__principal___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var348_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var348_interpretation_of_theory_safe_over_id__t0 (theory1_safe var321_id__t0) )
)

(push 1)

(assert
  (and true (or (not var347_interpretation_of_theory_safe_over_addressof_deref_var324_this__principal___t0 ) (not var348_interpretation_of_theory_safe_over_id__t0 ) ))
