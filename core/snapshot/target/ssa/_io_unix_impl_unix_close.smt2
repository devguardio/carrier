...
(declare-fun var223_deref_var219_ctx__isvalid__t0 () Bool)
(assert
  (= var224_unary_expression__t0 (not var223_deref_var219_ctx__isvalid__t0 ))
)
...
(assert
  (not (= var224_unary_expression__t0 true))
)
...
(declare-fun var223_deref_var219_ctx__isvalid__t1 () Bool)
(assert
  (= var223_deref_var219_ctx__isvalid__t1  (ite true var228_literal_0__t0 var223_deref_var219_ctx__isvalid__t0)  )
)
