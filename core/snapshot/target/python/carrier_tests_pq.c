...
#include <stdint.h>
#include <string.h>
#include "zz/carrier/carrier_tests_pq.h"
...
static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_tests_pq", "carrier::tests::pq", -1, methods};

PyObject*  py_mod_carrier_tests_pq_Init()
{
