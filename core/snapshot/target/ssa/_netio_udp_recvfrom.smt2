...
(assert
  (= var244_interpretation_of_theory___err__checked_over_deref_S228_e___t0 (theory41___err__checked var230_deref_S228_e___t0) )
)
...
(assert
  (= var265_interpretation_of_theory___err__checked_over_deref_S228_e___t0 (theory41___err__checked var230_deref_S228_e___t0) )
)
...
(assert
  (= var280_interpretation_of_theory___err__checked_over_deref_S228_e___t0 (theory41___err__checked var230_deref_S228_e___t2) )
)
...
(assert
  (= var282_safe___io__Result__Error_____safe_return___t0 (theory1_safe var34___io__Result__Error__t0) )
)
...
(assert
  (= var283_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var34___io__Result__Error__t0) )
)
...
(assert (! (= var284_implicit_coercion_of___io__Result__Error__t0 var34___io__Result__Error__t0) :named A12))(declare-fun var245_return__t0 () (_ BitVec 64))
(assert
...
(assert (! (= var308_implicit_coercion_of___net__address__Type__Ipv4__t0 var59___net__address__Type__Ipv4__t0) :named A14)); : /home/runner/work/carrier/carrier/core/modules/netio/src/udp.zz:80
...
(assert (! (= var312_implicit_coercion_of___net__address__Type__Ipv6__t0 var60___net__address__Type__Ipv6__t0) :named A15)); : /home/runner/work/carrier/carrier/core/modules/netio/src/udp.zz:82
...
(assert
  (= var319_safe___io__Result__Later_____safe_return___t0 (theory1_safe var33___io__Result__Later__t0) )
)
...
(assert
  (= var320_nullterm___io__Result__Later_____nullterm_return___t0 (theory2_nullterm var33___io__Result__Later__t0) )
)
...
(assert (! (= var321_implicit_coercion_of___io__Result__Later__t0 var33___io__Result__Later__t0) :named A17))(assert
...
(assert
  (= var344_interpretation_of_theory___err__checked_over_deref_S228_e___t0 (theory41___err__checked var230_deref_S228_e___t3) )
)
...
(assert
  (= var347_safe___io__Result__Error_____safe_return___t0 (theory1_safe var34___io__Result__Error__t0) )
)
...
(assert
  (= var348_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var34___io__Result__Error__t0) )
)
...
(assert (! (= var349_implicit_coercion_of___io__Result__Error__t0 var34___io__Result__Error__t0) :named A20))(assert
...
(assert
  (= var355_safe___io__Result__Ready_____safe_return___t0 (theory1_safe var32___io__Result__Ready__t0) )
)
...
(assert
  (= var356_nullterm___io__Result__Ready_____nullterm_return___t0 (theory2_nullterm var32___io__Result__Ready__t0) )
)
...
(assert (! (= var357_implicit_coercion_of___io__Result__Ready__t0 var32___io__Result__Ready__t0) :named A22))(assert
