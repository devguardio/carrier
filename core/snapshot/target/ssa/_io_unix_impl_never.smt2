...
(assert
  (= var244_safe___io__Result__Later_____safe_return___t0 (theory1_safe var20___io__Result__Later__t0) )
)
...
(assert
  (= var245_nullterm___io__Result__Later_____nullterm_return___t0 (theory2_nullterm var20___io__Result__Later__t0) )
)
...
(assert (! (= var246_implicit_coercion_of___io__Result__Later__t0 var20___io__Result__Later__t0) :named A5))(declare-fun var243_return__t0 () (_ BitVec 64))
(assert
