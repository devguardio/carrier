...
(declare-fun var162_return_value_of___byteorder__swap64__t0 () (_ BitVec 64))
(declare-fun var163_safe_return_value_of___byteorder__swap64_____safe_return___t0 () Bool)
(assert
  (= var163_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var162_return_value_of___byteorder__swap64__t0) )
)

(declare-fun var161_return__t1 () (_ BitVec 64))
(assert
  (= var163_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var161_return__t1) )
)

(declare-fun var164_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 () Bool)
(assert
  (= var164_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var162_return_value_of___byteorder__swap64__t0) )
)

(assert
  (= var164_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var161_return__t1) )
)

(declare-fun var161_return__t0 () (_ BitVec 64))
(assert
  (= var161_return__t1  (ite true var162_return_value_of___byteorder__swap64__t0 var161_return__t0)  )
)
...
(declare-fun var165_x__t0 () (_ BitVec 64))
(declare-fun var167_safe_x_____safe_return___t0 () Bool)
(assert
  (= var167_safe_x_____safe_return___t0 (theory1_safe var165_x__t0) )
)

(declare-fun var166_return__t1 () (_ BitVec 64))
(assert
  (= var167_safe_x_____safe_return___t0 (theory1_safe var166_return__t1) )
)

(declare-fun var168_nullterm_x_____nullterm_return___t0 () Bool)
(assert
  (= var168_nullterm_x_____nullterm_return___t0 (theory2_nullterm var165_x__t0) )
)

(assert
  (= var168_nullterm_x_____nullterm_return___t0 (theory2_nullterm var166_return__t1) )
)

(declare-fun var166_return__t0 () (_ BitVec 64))
(assert
  (= var166_return__t1  (ite true var165_x__t0 var166_return__t0)  )
)
