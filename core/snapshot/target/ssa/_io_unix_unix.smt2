...
(declare-fun var236_safe_literal_struct_234_____safe_ctx___t0 () Bool)
(assert
  (= var236_safe_literal_struct_234_____safe_ctx___t0 (theory1_safe var234_literal_struct_234__t0) )
)

(declare-fun var233_ctx__t1 () (_ BitVec 64))
(assert
  (= var236_safe_literal_struct_234_____safe_ctx___t0 (theory1_safe var233_ctx__t1) )
)

(declare-fun var237_nullterm_literal_struct_234_____nullterm_ctx___t0 () Bool)
(assert
  (= var237_nullterm_literal_struct_234_____nullterm_ctx___t0 (theory2_nullterm var234_literal_struct_234__t0) )
)

(assert
  (= var237_nullterm_literal_struct_234_____nullterm_ctx___t0 (theory2_nullterm var233_ctx__t1) )
)

(declare-fun var233_ctx__t0 () (_ BitVec 64))
(assert
  (= var233_ctx__t1  (ite true var234_literal_struct_234__t0 var233_ctx__t0)  )
)
...
(declare-fun var260_safe_literal_struct_238_____safe_return___t0 () Bool)
(assert
  (= var260_safe_literal_struct_238_____safe_return___t0 (theory1_safe var238_literal_struct_238__t0) )
)

(declare-fun var232_return__t1 () (_ BitVec 64))
(assert
  (= var260_safe_literal_struct_238_____safe_return___t0 (theory1_safe var232_return__t1) )
)

(declare-fun var261_nullterm_literal_struct_238_____nullterm_return___t0 () Bool)
(assert
  (= var261_nullterm_literal_struct_238_____nullterm_return___t0 (theory2_nullterm var238_literal_struct_238__t0) )
)

(assert
  (= var261_nullterm_literal_struct_238_____nullterm_return___t0 (theory2_nullterm var232_return__t1) )
)

(declare-fun var232_return__t0 () (_ BitVec 64))
(assert
  (= var232_return__t1  (ite true var238_literal_struct_238__t0 var232_return__t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/modules/io/src/unix.zz:114
(declare-fun var262_interpretation_of_theory_safe_over___io__read_fn__t0 () Bool)
(assert
  (= var262_interpretation_of_theory_safe_over___io__read_fn__t0 (theory1_safe var239_literal_struct_239__t0) )
)

(push 1)

(assert
  (and true (or (not var262_interpretation_of_theory_safe_over___io__read_fn__t0 ) ))
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/modules/io/src/unix.zz:114
(declare-fun var263_interpretation_of_theory_safe_over___io__read_fn__t0 () Bool)
(assert
  (= var263_interpretation_of_theory_safe_over___io__read_fn__t0 (theory1_safe var239_literal_struct_239__t0) )
)

(push 1)

(assert
  (and true (or (not var263_interpretation_of_theory_safe_over___io__read_fn__t0 ) ))
