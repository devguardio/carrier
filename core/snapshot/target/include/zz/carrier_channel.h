...
extern carrier_channel_Transfer carrier_channel_transfer_from_symmetric (carrier_symmetric_SymmetricState const *  const  symm, uint8_t const  version, uint32_t const  revision, uint64_t const  route, bool const  responder);
