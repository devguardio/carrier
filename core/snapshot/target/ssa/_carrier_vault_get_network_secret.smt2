...
(declare-fun var201_addr__t0 () (_ BitVec 64))
(declare-fun var202_interpretation_of_theory_safe_over_addr__t0 () Bool)
(assert
  (= var202_interpretation_of_theory_safe_over_addr__t0 (theory1_safe var201_addr__t0) )
)

(assert (! var202_interpretation_of_theory_safe_over_addr__t0 :named A1))(check-sat)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:127
(declare-fun var206_deref_var200_self__i_get_network_secret__t0 () (_ BitVec 64))
(declare-fun var207_interpretation_of_theory_safe_over_deref_var200_self__i_get_network_secret__t0 () Bool)
(assert
  (= var207_interpretation_of_theory_safe_over_deref_var200_self__i_get_network_secret__t0 (theory1_safe var206_deref_var200_self__i_get_network_secret__t0) )
)

(assert (! var207_interpretation_of_theory_safe_over_deref_var200_self__i_get_network_secret__t0 :named A3))(check-sat)
...
; begin safe ptr check
; : /home/runner/work/carrier/carrier/core/src/vault.zz:128
(declare-fun var211_safe_deref_var200_self__i_get_network_secret___t0 () Bool)
(assert
  (= var211_safe_deref_var200_self__i_get_network_secret___t0 (theory1_safe var206_deref_var200_self__i_get_network_secret__t0) )
)

(push 1)

(assert
  (and true (or (not var211_safe_deref_var200_self__i_get_network_secret___t0 ) ))
