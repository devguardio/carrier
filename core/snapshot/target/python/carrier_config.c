...
static PyObject* py_carrier_config_register(PyObject *pyself, PyObject *args) {
    //ep
    PyObject * arg0 = 0;
    if (!PyArg_ParseTuple(args, "O", &arg0)) { return NULL; };
    carrier_config_register(
...
{"register", py_carrier_config_register, METH_VARARGS,""},
{NULL, NULL, 0, NULL}
};

static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_config", "carrier::config", -1, methods};
