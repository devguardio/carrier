...
(assert
  (= var250_interpretation_of_theory___err__checked_over_deref_S228_e___t0 (theory30___err__checked var230_deref_S228_e___t0) )
)
...
(assert
  (= var256_interpretation_of_theory___err__checked_over_deref_S228_e___t0 (theory30___err__checked var230_deref_S228_e___t0) )
)
...
(assert
  (= var274_interpretation_of_theory___err__checked_over_deref_S228_e___t0 (theory30___err__checked var230_deref_S228_e___t2) )
)
...
(assert
  (= var276_safe___io__Result__Error_____safe_return___t0 (theory1_safe var10___io__Result__Error__t0) )
)
...
(assert
  (= var277_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var10___io__Result__Error__t0) )
)
...
(assert (! (= var278_implicit_coercion_of___io__Result__Error__t0 var10___io__Result__Error__t0) :named A10))(declare-fun var251_return__t0 () (_ BitVec 64))
(assert
...
(assert
  (= var306_interpretation_of_theory___err__checked_over_deref_S228_e___t0 (theory30___err__checked var230_deref_S228_e___t3) )
)
...
(assert
  (= var309_safe___io__Result__Error_____safe_return___t0 (theory1_safe var10___io__Result__Error__t0) )
)
...
(assert
  (= var310_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var10___io__Result__Error__t0) )
)
...
(assert (! (= var311_implicit_coercion_of___io__Result__Error__t0 var10___io__Result__Error__t0) :named A14))(assert
...
(assert
  (= var312_safe___io__Result__Ready_____safe_return___t0 (theory1_safe var8___io__Result__Ready__t0) )
)
...
(assert
  (= var313_nullterm___io__Result__Ready_____nullterm_return___t0 (theory2_nullterm var8___io__Result__Ready__t0) )
)
...
(assert (! (= var314_implicit_coercion_of___io__Result__Ready__t0 var8___io__Result__Ready__t0) :named A15))(assert
