...
(declare-fun var202_interpretation_of_theory_safe_over_ii__t0 () Bool)
(assert
  (= var202_interpretation_of_theory_safe_over_ii__t0 (theory1_safe var201_ii__t0) )
)

(assert (! var202_interpretation_of_theory_safe_over_ii__t0 :named A1))(check-sat)
...
(declare-fun var206_safe_self___t0 () Bool)
(assert
  (= var206_safe_self___t0 (theory1_safe var200_self__t0) )
)

(push 1)

(assert
  (and true (or (not var206_safe_self___t0 ) ))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var210_interpretation_of_theory_safe_over_ii__t0 () Bool)
(assert
  (= var210_interpretation_of_theory_safe_over_ii__t0 (theory1_safe var201_ii__t0) )
)
...
(assert
  (=  var213_infix_expression__t0 (= var209_literal_0__t0 var212_literal_0__t0))
)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:223
(declare-fun var214_interpretation_of_theory_nullterm_over_literal_0__t0 () Bool)
(assert
  (= var214_interpretation_of_theory_nullterm_over_literal_0__t0 (theory2_nullterm var209_literal_0__t0) )
)

; : /home/runner/work/carrier/carrier/core/src/vault.zz:223
(declare-fun var215_infix_expression__t0 () Bool)
(assert
  (=  var215_infix_expression__t0 (or var213_infix_expression__t0 var214_interpretation_of_theory_nullterm_over_literal_0__t0))
)

(push 1)

(assert
  (and true (or (not var210_interpretation_of_theory_safe_over_ii__t0 ) (not var211_interpretation_of_theory_safe_over_self__t0 ) (not var215_infix_expression__t0 ) ))
...
(declare-fun var216_return_value_of___carrier__vault__authorize_open_stream__t0 () Bool)
(declare-fun var204_return__t0 () Bool)
(assert
  (= var204_return__t1  (ite true var216_return_value_of___carrier__vault__authorize_open_stream__t0 var204_return__t0)  )
)
