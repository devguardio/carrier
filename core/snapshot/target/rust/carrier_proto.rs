...
pub enum GenesisCurrent {
    ...
    carrier_proto_GenesisCurrent_Commitmsg = 2,
    carrier_proto_GenesisCurrent_Stable = 3,
    carrier_proto_GenesisCurrent_Contentsize = 4,
...
pub enum GenesisUpdate {
    ...
    carrier_proto_GenesisUpdate_Commitmsg = 2,
    carrier_proto_GenesisUpdate_Parent = 3,
    carrier_proto_GenesisUpdate_Contentsize = 4,
