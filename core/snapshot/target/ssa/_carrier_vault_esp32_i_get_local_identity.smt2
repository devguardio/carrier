...
(declare-fun var282_id__t0 () (_ BitVec 64))
(declare-fun var283_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var283_interpretation_of_theory_safe_over_id__t0 (theory1_safe var282_id__t0) )
)

(assert (! var283_interpretation_of_theory_safe_over_id__t0 :named A2))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/vault_esp32.zz:57
(declare-fun var287_literal_array_287__t0 () (_ BitVec 64))
(declare-fun var288_true__t0 () Bool)
(assert
  (= var288_true__t0 (theory1_safe var287_literal_array_287__t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_esp32.zz:57
(declare-fun var289_safe_literal_array_287_____safe_secret___t0 () Bool)
(assert
  (= var289_safe_literal_array_287_____safe_secret___t0 (theory1_safe var287_literal_array_287__t0) )
)

(declare-fun var285_secret__t1 () (_ BitVec 64))
(assert
  (= var289_safe_literal_array_287_____safe_secret___t0 (theory1_safe var285_secret__t1) )
)

(declare-fun var290_nullterm_literal_array_287_____nullterm_secret___t0 () Bool)
(assert
  (= var290_nullterm_literal_array_287_____nullterm_secret___t0 (theory2_nullterm var287_literal_array_287__t0) )
)

(assert
  (= var290_nullterm_literal_array_287_____nullterm_secret___t0 (theory2_nullterm var285_secret__t1) )
)

(declare-fun var291_len_secret___t0 () (_ BitVec 64))
(assert
  (= var291_len_secret___t0 (theory0_len var285_secret__t1) )
)

(assert
  (= var291_len_secret___t0 (_ bv1 64))
...
; : /home/runner/work/carrier/carrier/core/src/vault_esp32.zz:58
; : /home/runner/work/carrier/carrier/core/src/vault_esp32.zz:58
(declare-fun var292_addressof_secret___t0 () (_ BitVec 64))
(declare-fun var293_len_addressof_secret____t0 () (_ BitVec 64))
(assert
  (= var293_len_addressof_secret____t0 (theory0_len var292_addressof_secret___t0) )
)

(assert
  (= var293_len_addressof_secret____t0 (_ bv1 64))

)

(assert
  (= var292_addressof_secret___t0 (_ bv285 64))

)

(declare-fun var294_true__t0 () Bool)
(assert
  (= var294_true__t0 (theory1_safe var292_addressof_secret___t0) )
)
...
(assert
  (= var295_addressof_secret___t0 (_ bv285 64))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var298_interpretation_of_theory_safe_over_addressof_secret___t0 () Bool)
(assert
  (= var298_interpretation_of_theory_safe_over_addressof_secret___t0 (theory1_safe var295_addressof_secret___t0) )
)
...
(assert
  (= var299_interpretation_of_theory_safe_over_self__t0 (theory1_safe var281_self__t0) )
)

(push 1)

(assert
  (and true (or (not var298_interpretation_of_theory_safe_over_addressof_secret___t0 ) (not var299_interpretation_of_theory_safe_over_self__t0 ) ))
...
(declare-fun var285_secret__t2 () (_ BitVec 64))
(assert
  (= var285_secret__t2  (ite true var285_secret__t2 var285_secret__t1)  )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_esp32.zz:59
; : /home/runner/work/carrier/carrier/core/src/vault_esp32.zz:59
(declare-fun var301_addressof_secret___t0 () (_ BitVec 64))
(declare-fun var302_len_addressof_secret____t0 () (_ BitVec 64))
(assert
  (= var302_len_addressof_secret____t0 (theory0_len var301_addressof_secret___t0) )
)

(assert
  (= var302_len_addressof_secret____t0 (_ bv1 64))

)

(assert
  (= var301_addressof_secret___t0 (_ bv285 64))

)

(declare-fun var303_true__t0 () Bool)
(assert
  (= var303_true__t0 (theory1_safe var301_addressof_secret___t0) )
)
...
(assert
  (= var304_addressof_secret___t0 (_ bv285 64))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var307_interpretation_of_theory_safe_over_addressof_secret___t0 () Bool)
(assert
  (= var307_interpretation_of_theory_safe_over_addressof_secret___t0 (theory1_safe var304_addressof_secret___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var308_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var308_interpretation_of_theory_safe_over_id__t0 (theory1_safe var282_id__t0) )
)

(push 1)

(assert
  (and true (or (not var307_interpretation_of_theory_safe_over_addressof_secret___t0 ) (not var308_interpretation_of_theory_safe_over_id__t0 ) ))
