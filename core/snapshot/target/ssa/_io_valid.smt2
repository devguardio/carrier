...
(assert
  (= var188_safe_self___t0 (theory1_safe var184_self__t0) )
)
...
(declare-fun var186_return__t1 () Bool)
(declare-fun var189_deref_var184_self__isvalid__t0 () Bool)
(declare-fun var186_return__t0 () Bool)
(assert
  (= var186_return__t1  (ite true var189_deref_var184_self__isvalid__t0 var186_return__t0)  )
)
