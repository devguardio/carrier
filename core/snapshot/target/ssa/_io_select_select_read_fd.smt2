...
; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:56
(declare-fun var243_addressof_deref_var236_self__read_fds___t0 () (_ BitVec 64))
(declare-fun var244_len_addressof_deref_var236_self__read_fds____t0 () (_ BitVec 64))
(assert
  (= var244_len_addressof_deref_var236_self__read_fds____t0 (theory0_len var243_addressof_deref_var236_self__read_fds___t0) )
)

(assert
  (= var244_len_addressof_deref_var236_self__read_fds____t0 (_ bv1 64))

)

(assert
  (= var243_addressof_deref_var236_self__read_fds___t0 (_ bv242 64))

)

(declare-fun var245_true__t0 () Bool)
(assert
  (= var245_true__t0 (theory1_safe var243_addressof_deref_var236_self__read_fds___t0) )
)
