...
(assert
  (=  var222_infix_expression__t0 (bvult var216_i__t2 var5___carrier__vault__MAX_BROKERS__t1))
)
...
(get-value (
  ...
  var5___carrier__vault__MAX_BROKERS__t1
...
(assert
  (not (= var5___carrier__vault__MAX_BROKERS__t1 #x0000000000000010))
)
...
(assert
  (not (= var216_i__t2 #x0000000000000001))
)
...
(assert (! (= var233_implicit_coercion_of_literal_0__t0 ( (_ extract 7 0) var232_literal_0__t0 )) :named A5)); : /home/runner/work/carrier/carrier/core/src/vault.zz:178
...
(assert
  (not (= var234_infix_expression__t0 true))
)
