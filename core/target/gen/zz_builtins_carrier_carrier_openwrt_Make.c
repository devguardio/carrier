...
#include <stddef.h>
const __attribute__ ((unused)) size_t carrier_cmd_config_RemoteOpFailed = 1;
const __attribute__ ((unused)) size_t toml_ParseError = 2;
const __attribute__ ((unused)) size_t err_OutOfTail = 3;
const __attribute__ ((unused)) size_t carrier_channel_InvalidFrame = 4;
...
const __attribute__ ((unused)) size_t carrier_cmd_stream_OpenResponse = 9;
const __attribute__ ((unused)) size_t carrier_cmd_config_net_RemoteOpFailed = 10;
const __attribute__ ((unused)) size_t carrier_identity_Invalid = 11;
const __attribute__ ((unused)) size_t err_InvalidArgument = 12;
...
const __attribute__ ((unused)) size_t carrier_router_OutOfOptions = 15;
...
const __attribute__ ((unused)) size_t err_NotImplemented = 18;
const __attribute__ ((unused)) size_t io_NotImplemented = 19;
const __attribute__ ((unused)) size_t protonerf_Invalid = 20;
const __attribute__ ((unused)) size_t hpack_decoder_Invalid = 21;
