...
extern {
    ...
    #[link_name = "carrier_router_make"]
    pub fn r#make( Zbrk: super::carrier_channel::Channel,  Zudp4: super::net_udp::Socket,  Zudp6: super::net_udp::Socket)  -> super::carrier_router::Router;
