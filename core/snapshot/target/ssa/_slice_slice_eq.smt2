...
; literal expr
(declare-fun var50_literal_0__t0 () Bool)
(assert
  (not var50_literal_0__t0)
)

(declare-fun var48_return__t1 () Bool)
(declare-fun var48_return__t0 () Bool)
(assert
  (= var48_return__t1  (ite var49_infix_expression__t0 var50_literal_0__t0 var48_return__t0)  )
)
...
(assert (! (= var54_implicit_coercion_of_literal_0__t0 var53_literal_0__t0) :named A3)); : /home/runner/work/carrier/carrier/modules/slice/src/slice.zz:21
(declare-fun var55_infix_expression__t0 () Bool)
(declare-fun var52_return_value_of___ext___string_h___memcmp__t0 () (_ BitVec 64))
(assert
  (=  var55_infix_expression__t0 (= var52_return_value_of___ext___string_h___memcmp__t0 var54_implicit_coercion_of_literal_0__t0))
)
