...
(assert
  (= var856_interpretation_of_theory_symbol_over___err__InvalidArgument__t0 (theory3_symbol var121___err__InvalidArgument__t0) )
)
...
(assert
  (= var861_interpretation_of_theory___err__checked_over_deref_S808_e___t0 (theory27___err__checked var810_deref_S808_e___t1) )
)
...
(assert (! (= var865_implicit_coercion_of___json__ValueType__Object__t0 var114___json__ValueType__Object__t0) :named A19)); : /home/runner/work/carrier/carrier/core/tests/noise.zz:152
...
(assert
  (= var884_interpretation_of_theory_symbol_over___err__InvalidArgument__t0 (theory3_symbol var121___err__InvalidArgument__t0) )
)
...
(assert
  (= var889_interpretation_of_theory___err__checked_over_deref_S808_e___t0 (theory27___err__checked var810_deref_S808_e___t2) )
)
...
(assert
  (not (= var835_v_index__t0 #x0000000000000005))
)
...
(assert
  (= var927_interpretation_of_theory___err__checked_over_deref_S808_e___t0 (theory27___err__checked var810_deref_S808_e___t2) )
)
