...
(declare-fun var736_target__t0 () (_ BitVec 64))
(declare-fun var737_interpretation_of_theory_safe_over_target__t0 () Bool)
(assert
  (= var737_interpretation_of_theory_safe_over_target__t0 (theory1_safe var736_target__t0) )
)

(assert (! var737_interpretation_of_theory_safe_over_target__t0 :named A6))(check-sat)
...
(assert
  (= var740_safe_self___t0 (theory1_safe var735_self__t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/endpoint.zz:160
(declare-fun var742_addressof_deref_var735_self__cluster_target___t0 () (_ BitVec 64))
(declare-fun var743_len_addressof_deref_var735_self__cluster_target____t0 () (_ BitVec 64))
(assert
  (= var743_len_addressof_deref_var735_self__cluster_target____t0 (theory0_len var742_addressof_deref_var735_self__cluster_target___t0) )
)

(assert
  (= var743_len_addressof_deref_var735_self__cluster_target____t0 (_ bv1 64))

)

(assert
  (= var742_addressof_deref_var735_self__cluster_target___t0 (_ bv741 64))

)

(declare-fun var744_true__t0 () Bool)
(assert
  (= var744_true__t0 (theory1_safe var742_addressof_deref_var735_self__cluster_target___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/endpoint.zz:161
; : /home/runner/work/carrier/carrier/core/src/initiator.zz:32
(declare-fun var749_implicit_coercion_of___carrier__initiator__Move__Target__t0 () (_ BitVec 64))
(assert (! (= var749_implicit_coercion_of___carrier__initiator__Move__Target__t0 var63___carrier__initiator__Move__Target__t0) :named A8)); : /home/runner/work/carrier/carrier/core/src/endpoint.zz:161
(declare-fun var750_safe_implicit_coercion_of___carrier__initiator__Move__Target_____safe_deref_var735_self__cluster_move___t0 () Bool)
(assert
  (= var750_safe_implicit_coercion_of___carrier__initiator__Move__Target_____safe_deref_var735_self__cluster_move___t0 (theory1_safe var749_implicit_coercion_of___carrier__initiator__Move__Target__t0) )
)

(declare-fun var748_deref_var735_self__cluster_move__t1 () (_ BitVec 64))
(assert
  (= var750_safe_implicit_coercion_of___carrier__initiator__Move__Target_____safe_deref_var735_self__cluster_move___t0 (theory1_safe var748_deref_var735_self__cluster_move__t1) )
)

(declare-fun var751_nullterm_implicit_coercion_of___carrier__initiator__Move__Target_____nullterm_deref_var735_self__cluster_move___t0 () Bool)
(assert
  (= var751_nullterm_implicit_coercion_of___carrier__initiator__Move__Target_____nullterm_deref_var735_self__cluster_move___t0 (theory2_nullterm var749_implicit_coercion_of___carrier__initiator__Move__Target__t0) )
)

(assert
  (= var751_nullterm_implicit_coercion_of___carrier__initiator__Move__Target_____nullterm_deref_var735_self__cluster_move___t0 (theory2_nullterm var748_deref_var735_self__cluster_move__t1) )
)

(declare-fun var748_deref_var735_self__cluster_move__t0 () (_ BitVec 64))
(assert
  (= var748_deref_var735_self__cluster_move__t1  (ite true var749_implicit_coercion_of___carrier__initiator__Move__Target__t0 var748_deref_var735_self__cluster_move__t0)  )
)
