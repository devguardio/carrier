...
; literal expr
(declare-fun var242_literal_4294967295__t0 () Bool)
(assert
  var242_literal_4294967295__t0
)

; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:142
(declare-fun var241_literal_struct_241__t0 () (_ BitVec 64))
(declare-fun var243_safe_literal_struct_241_____safe_ctx___t0 () Bool)
(assert
  (= var243_safe_literal_struct_241_____safe_ctx___t0 (theory1_safe var241_literal_struct_241__t0) )
)

(declare-fun var240_ctx__t1 () (_ BitVec 64))
(assert
  (= var243_safe_literal_struct_241_____safe_ctx___t0 (theory1_safe var240_ctx__t1) )
)

(declare-fun var244_nullterm_literal_struct_241_____nullterm_ctx___t0 () Bool)
(assert
  (= var244_nullterm_literal_struct_241_____nullterm_ctx___t0 (theory2_nullterm var241_literal_struct_241__t0) )
)

(assert
  (= var244_nullterm_literal_struct_241_____nullterm_ctx___t0 (theory2_nullterm var240_ctx__t1) )
)

(declare-fun var240_ctx__t0 () (_ BitVec 64))
(assert
  (= var240_ctx__t1  (ite true var241_literal_struct_241__t0 var240_ctx__t0)  )
)
...
(declare-fun var267_safe_literal_struct_245_____safe_return___t0 () Bool)
(assert
  (= var267_safe_literal_struct_245_____safe_return___t0 (theory1_safe var245_literal_struct_245__t0) )
)

(declare-fun var239_return__t1 () (_ BitVec 64))
(assert
  (= var267_safe_literal_struct_245_____safe_return___t0 (theory1_safe var239_return__t1) )
)

(declare-fun var268_nullterm_literal_struct_245_____nullterm_return___t0 () Bool)
(assert
  (= var268_nullterm_literal_struct_245_____nullterm_return___t0 (theory2_nullterm var245_literal_struct_245__t0) )
)

(assert
  (= var268_nullterm_literal_struct_245_____nullterm_return___t0 (theory2_nullterm var239_return__t1) )
)

(declare-fun var239_return__t0 () (_ BitVec 64))
(assert
  (= var239_return__t1  (ite true var245_literal_struct_245__t0 var239_return__t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:140
(declare-fun var269_interpretation_of_theory_safe_over___io__read_fn__t0 () Bool)
(assert
  (= var269_interpretation_of_theory_safe_over___io__read_fn__t0 (theory1_safe var246_literal_struct_246__t0) )
)

(push 1)

(assert
  (and true (or (not var269_interpretation_of_theory_safe_over___io__read_fn__t0 ) ))
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:140
(declare-fun var270_interpretation_of_theory_safe_over___io__read_fn__t0 () Bool)
(assert
  (= var270_interpretation_of_theory_safe_over___io__read_fn__t0 (theory1_safe var246_literal_struct_246__t0) )
)

(push 1)

(assert
  (and true (or (not var270_interpretation_of_theory_safe_over___io__read_fn__t0 ) ))
