...
(assert
  (= var278_safe___carrier__preshared__DISCOVERY_____safe_r___t0 (theory1_safe var57___carrier__preshared__DISCOVERY__t1) )
)
...
(assert
  (= var279_nullterm___carrier__preshared__DISCOVERY_____nullterm_r___t0 (theory2_nullterm var57___carrier__preshared__DISCOVERY__t1) )
)
...
(assert
  (= var277_r__t1  (ite true var57___carrier__preshared__DISCOVERY__t1 var277_r__t0)  )
)
...
(assert
  (= var286_interpretation_of_theory_safe_over_cast_of_literal_string____carrier_revision__carrier_build_id__application__paths___t0 (theory1_safe var62_cast_of_literal_string____carrier_revision__carrier_build_id__application__paths___t0) )
)
...
(assert
  (=  var288_infix_expression__t0 (bvuge var287_literal_Unsigned_57___t0 var63_literal_Unsigned_56___t0))
)
...
(assert
  (= var299_interpretation_of_theory_safe_over_cast_of_literal_string____carrier_revision__carrier_build_id__application__paths___t0 (theory1_safe var62_cast_of_literal_string____carrier_revision__carrier_build_id__application__paths___t0) )
)
...
(assert
  (=  var301_infix_expression__t0 (bvuge var300_literal_Unsigned_57___t0 var63_literal_Unsigned_56___t0))
)
...
(assert
  (= var309_interpretation_of_theory_safe_over_cast_of_literal_string____carrier_revision__carrier_build_id__application__paths___t0 (theory1_safe var62_cast_of_literal_string____carrier_revision__carrier_build_id__application__paths___t0) )
)
...
(assert
  (=  var311_infix_expression__t0 (bvuge var310_literal_Unsigned_57___t0 var63_literal_Unsigned_56___t0))
)
