...
#line 17 "/home/aep/proj/devguard/carrier/src/responder.zz"
void __attribute__ ((visibility ("hidden"))) carrier_responder_accept_insecure (carrier_noise_Responder*  const  self, err_Err*  const  e, uintptr_t const  et, carrier_vault_Vault const *  const  store, uint64_t route, uint64_t const  timestamp, slice_mut_slice_MutSlice*  const  frame)
{

#line 28 "/home/aep/proj/devguard/carrier/src/responder.zz"
  uintptr_t const  size_before_any  =     frame ->at;

#line 30 "/home/aep/proj/devguard/carrier/src/responder.zz"
    slice_mut_slice_push(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    0x08    );

#line 31 "/home/aep/proj/devguard/carrier/src/responder.zz"
    slice_mut_slice_push(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    0x00    );

#line 32 "/home/aep/proj/devguard/carrier/src/responder.zz"
    slice_mut_slice_push(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    0x00    );

#line 33 "/home/aep/proj/devguard/carrier/src/responder.zz"
    slice_mut_slice_push(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    0x00    );
{

#line 36 "/home/aep/proj/devguard/carrier/src/responder.zz"
( *(    (uint8_t* )(( &    route)) +    7  )) |=     0b00000001;

}


#line 38 "/home/aep/proj/devguard/carrier/src/responder.zz"
    slice_mut_slice_push64(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    route    );

#line 39 "/home/aep/proj/devguard/carrier/src/responder.zz"
    slice_mut_slice_push64(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    byteorder_to_be64(    0    )    );

#line 42 "/home/aep/proj/devguard/carrier/src/responder.zz"
  carrier_identity_Address ephemeral_address  = {    0,};

#line 43 "/home/aep/proj/devguard/carrier/src/responder.zz"
    carrier_identity_address_from_secret(( &    ephemeral_address),( &    self ->ephemeral)    );

#line 44 "/home/aep/proj/devguard/carrier/src/responder.zz"
    carrier_symmetric_mix_hash(( &    self ->symm),    ephemeral_address .k,    32    );

#line 45 "/home/aep/proj/devguard/carrier/src/responder.zz"
    slice_mut_slice_append_bytes(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    ephemeral_address .k,    32    );

#line 48 "/home/aep/proj/devguard/carrier/src/responder.zz"
  carrier_identity_Address dh  = {    0,};

#line 49 "/home/aep/proj/devguard/carrier/src/responder.zz"
    carrier_identity_dh(( &    dh),( &    self ->ephemeral),( &    self ->remote_ephemeral)    );

#line 50 "/home/aep/proj/devguard/carrier/src/responder.zz"
    carrier_symmetric_mix_key(( &    self ->symm),    dh .k,    32    );

#line 53 "/home/aep/proj/devguard/carrier/src/responder.zz"
;

#line 54 "/home/aep/proj/devguard/carrier/src/responder.zz"
  uintptr_t const  before_encrypt_len  =     frame ->at;

#line 55 "/home/aep/proj/devguard/carrier/src/responder.zz"
  uint8_t*  const  before_encrypt_mem  = (    slice_mut_slice_mem(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    ))    ) +    frame ->at  );

#line 58 "/home/aep/proj/devguard/carrier/src/responder.zz"
  carrier_identity_Identity eid  = {    0,};

#line 59 "/home/aep/proj/devguard/carrier/src/responder.zz"
    carrier_vault_get_identity(    store,( &    eid)    );

#line 60 "/home/aep/proj/devguard/carrier/src/responder.zz"
    slice_mut_slice_append_bytes(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    eid .k,    32    );

#line 63 "/home/aep/proj/devguard/carrier/src/responder.zz"
    slice_mut_slice_push64(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    byteorder_to_be64(    timestamp    )    );

#line 66 "/home/aep/proj/devguard/carrier/src/responder.zz"
    slice_mut_slice_push32(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    byteorder_to_be32(    carrier_revision_REVISION    )    );

#line 69 "/home/aep/proj/devguard/carrier/src/responder.zz"
    frame ->at +=     16;

#line 73 "/home/aep/proj/devguard/carrier/src/responder.zz"
    frame ->at +=     76;

#line 75 "/home/aep/proj/devguard/carrier/src/responder.zz"
;

#line 76 "/home/aep/proj/devguard/carrier/src/responder.zz"
;

#line 77 "/home/aep/proj/devguard/carrier/src/responder.zz"
;

#line 79 "/home/aep/proj/devguard/carrier/src/responder.zz"
    printf(    "<> pre encrypt %zu\n",    frame ->at    );

#line 80 "/home/aep/proj/devguard/carrier/src/responder.zz"
    hex_dump_slice(    (slice_slice_Slice const * )(    slice_slice_borrow(( &    frame ->slice)    ))    );

#line 82 "/home/aep/proj/devguard/carrier/src/responder.zz"
  uintptr_t const  rs  =     carrier_symmetric_encrypt_and_mix_hash(( &    self ->symm),    (err_Err* )(    e),
#line 19 "/home/aep/proj/devguard/carrier/src/responder.zz"
    et,
#line 83 "/home/aep/proj/devguard/carrier/src/responder.zz"
    before_encrypt_mem,((    frame ->at -    before_encrypt_len  ) -    16  ),
#line 84 "/home/aep/proj/devguard/carrier/src/responder.zz"
    0,
#line 85 "/home/aep/proj/devguard/carrier/src/responder.zz"
    before_encrypt_mem,(    frame ->at -    before_encrypt_len  )    );

#line 90 "/home/aep/proj/devguard/carrier/src/responder.zz"
  uint8_t signme  [     56 ]  = {    0,};

#line 91 "/home/aep/proj/devguard/carrier/src/responder.zz"
    mem_copy(    carrier_endpoint_SIGN_PURPOSE,    signme,    string_strlen(    carrier_endpoint_SIGN_PURPOSE    )    );

#line 92 "/home/aep/proj/devguard/carrier/src/responder.zz"
  uint8_t*  const  m  = (    signme +    string_strlen(    carrier_endpoint_SIGN_PURPOSE    )  );

#line 93 "/home/aep/proj/devguard/carrier/src/responder.zz"
    mem_copy(    self ->symm .h,    m,    32    );

#line 95 "/home/aep/proj/devguard/carrier/src/responder.zz"
  carrier_identity_Signature sig  = {    0,};

#line 96 "/home/aep/proj/devguard/carrier/src/responder.zz"
    carrier_vault_sign(    store,( &    sig),    signme,    56    );

#line 97 "/home/aep/proj/devguard/carrier/src/responder.zz"
    printf(    "<> %zu %zu\n",    frame ->at,    size_before_any    );

#line 98 "/home/aep/proj/devguard/carrier/src/responder.zz"
;

#line 100 "/home/aep/proj/devguard/carrier/src/responder.zz"
    hex_dump_slice(    (slice_slice_Slice const * )(    slice_slice_borrow(( &    frame ->slice)    ))    );

#line 101 "/home/aep/proj/devguard/carrier/src/responder.zz"
    assert(    slice_mut_slice_append_bytes(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    sig .k,    64    )    );

#line 102 "/home/aep/proj/devguard/carrier/src/responder.zz"
    hex_dump_slice(    (slice_slice_Slice const * )(    slice_slice_borrow(( &    frame ->slice)    ))    );

#line 104 "/home/aep/proj/devguard/carrier/src/responder.zz"
