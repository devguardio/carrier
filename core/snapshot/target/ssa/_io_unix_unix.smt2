...
(declare-fun var224_safe_literal_struct_222_____safe_ctx___t0 () Bool)
(assert
  (= var224_safe_literal_struct_222_____safe_ctx___t0 (theory1_safe var222_literal_struct_222__t0) )
)

(declare-fun var221_ctx__t1 () (_ BitVec 64))
(assert
  (= var224_safe_literal_struct_222_____safe_ctx___t0 (theory1_safe var221_ctx__t1) )
)

(declare-fun var225_nullterm_literal_struct_222_____nullterm_ctx___t0 () Bool)
(assert
  (= var225_nullterm_literal_struct_222_____nullterm_ctx___t0 (theory2_nullterm var222_literal_struct_222__t0) )
)

(assert
  (= var225_nullterm_literal_struct_222_____nullterm_ctx___t0 (theory2_nullterm var221_ctx__t1) )
)

(declare-fun var221_ctx__t0 () (_ BitVec 64))
(assert
  (= var221_ctx__t1  (ite true var222_literal_struct_222__t0 var221_ctx__t0)  )
)
...
(assert
  (= var240_true__t0 (theory1_safe var234_literal_struct_234__t0) )
)
...
(declare-fun var248_safe_literal_struct_226_____safe_return___t0 () Bool)
(assert
  (= var248_safe_literal_struct_226_____safe_return___t0 (theory1_safe var226_literal_struct_226__t0) )
)

(declare-fun var220_return__t1 () (_ BitVec 64))
(assert
  (= var248_safe_literal_struct_226_____safe_return___t0 (theory1_safe var220_return__t1) )
)

(declare-fun var249_nullterm_literal_struct_226_____nullterm_return___t0 () Bool)
(assert
  (= var249_nullterm_literal_struct_226_____nullterm_return___t0 (theory2_nullterm var226_literal_struct_226__t0) )
)

(assert
  (= var249_nullterm_literal_struct_226_____nullterm_return___t0 (theory2_nullterm var220_return__t1) )
)

(declare-fun var220_return__t0 () (_ BitVec 64))
(assert
  (= var220_return__t1  (ite true var226_literal_struct_226__t0 var220_return__t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/modules/io/src/unix.zz:114
(declare-fun var250_interpretation_of_theory_safe_over___io__read_fn__t0 () Bool)
(assert
  (= var250_interpretation_of_theory_safe_over___io__read_fn__t0 (theory1_safe var227_literal_struct_227__t0) )
)

(push 1)

(assert
  (and true (or (not var250_interpretation_of_theory_safe_over___io__read_fn__t0 ) ))
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/modules/io/src/unix.zz:114
(declare-fun var251_interpretation_of_theory_safe_over___io__read_fn__t0 () Bool)
(assert
  (= var251_interpretation_of_theory_safe_over___io__read_fn__t0 (theory1_safe var227_literal_struct_227__t0) )
)

(push 1)

(assert
  (and true (or (not var251_interpretation_of_theory_safe_over___io__read_fn__t0 ) ))
