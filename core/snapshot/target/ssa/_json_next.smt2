...
(assert
  (=  var182_infix_expression__t0 (bvuge var181_deref_S165_self__depth__t0 var61___json__MAX_DEPTH__t1))
)
...
(assert
  (= var200_interpretation_of_theory_symbol_over___err__OutOfTail__t0 (theory3_symbol var113___err__OutOfTail__t0) )
)
...
(assert
  (= var205_interpretation_of_theory___err__checked_over_deref_S170_e___t0 (theory20___err__checked var172_deref_S170_e___t1) )
)
...
(assert (! (= var225_implicit_coercion_of___json__ParserState__Object__t0 var10___json__ParserState__Object__t0) :named A11)); : /home/runner/work/carrier/carrier/modules/json/src/lib.zz:96
...
(assert (! (= var227_implicit_coercion_of___json__ParserState__PreVal__t0 var13___json__ParserState__PreVal__t0) :named A12)); : /home/runner/work/carrier/carrier/modules/json/src/lib.zz:96
...
(assert
  (= var250_interpretation_of_theory_symbol_over___json__ParseError__t0 (theory3_symbol var111___json__ParseError__t0) )
)
...
(assert
  (= var255_interpretation_of_theory___err__checked_over_deref_S170_e___t0 (theory20___err__checked var172_deref_S170_e___t2) )
)
