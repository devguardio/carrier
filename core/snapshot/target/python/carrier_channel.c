...
static PyObject * py_get_carrier_channel_Channel_revision(PyObject *pyself, void *closure) {

    carrier_channel_Channel * self = pyFATGetPtr(pyself, "carrier_channel_Channel");
    if (self == 0) { return 0; }
            return PyLong_FromUnsignedLongLong(self->revision);
}
static int py_set_carrier_channel_Channel_revision(PyObject *pyself, PyObject *value, void *closure) {

    carrier_channel_Channel * self = pyFATGetPtr(pyself, "carrier_channel_Channel");
    if (self == 0) { return 0; }
            self->revision = PyLong_AsUnsignedLongLong(value);
    return 0;
}
...
{"revision", py_get_carrier_channel_Channel_revision, py_set_carrier_channel_Channel_revision,NULL,NULL},
