...
(assert (! (= var681_len_deref_S677_e____t0 var678_et__t0) :named A5)); : /home/runner/work/carrier/carrier/core/src/stream.zz:184
; : /home/runner/work/carrier/carrier/core/src/stream.zz:184
; call of safe
...
(get-value (
  ...
  var689_deref_var676_self__closing__t0
...
(assert
  (not (= var689_deref_var676_self__closing__t0 false))
)
...
; literal expr
(declare-fun var690_literal_4294967295__t0 () Bool)
(assert
  var690_literal_4294967295__t0
)

(declare-fun var686_return__t1 () Bool)
(declare-fun var686_return__t0 () Bool)
(assert
  (= var686_return__t1  (ite var689_deref_var676_self__closing__t0 var690_literal_4294967295__t0 var686_return__t0)  )
)

; end branch
; branch returned. the rest of the function only happens if the condition leading to return never happened
; (not var689_deref_var676_self__closing__t0)
(assert
  (not var689_deref_var676_self__closing__t0)
)
...
(declare-fun var691_deref_var676_self__order_incomming__t0 () (_ BitVec 64))
(assert
  (=  var692_infix_expression__t0 (bvule var682_order__t0 var691_deref_var676_self__order_incomming__t0))
)
...
(declare-fun var686_return__t2 () Bool)
(assert
  (= var686_return__t2  (ite var692_infix_expression__t0 var693_literal_4294967295__t0 var686_return__t1)  )
)
...
(assert (! (= var695_implicit_coercion_of_literal_1__t0 var694_literal_1__t0) :named A9)); : /home/runner/work/carrier/carrier/core/src/stream.zz:195
(declare-fun var696_infix_expression__t0 () (_ BitVec 64))
(assert
   (=  var696_infix_expression__t0 (bvadd var691_deref_var676_self__order_incomming__t0 var695_implicit_coercion_of_literal_1__t0))
)

; : /home/runner/work/carrier/carrier/core/src/stream.zz:195
(declare-fun var697_infix_expression__t0 () Bool)
(assert
  (=  var697_infix_expression__t0 (not (= var682_order__t0 var696_infix_expression__t0)))
)
...
(assert
  (not (= var697_infix_expression__t0 true))
)
...
; literal expr
(declare-fun var698_literal_0__t0 () Bool)
(assert
  (not var698_literal_0__t0)
)

(declare-fun var686_return__t3 () Bool)
(assert
  (= var686_return__t3  (ite var697_infix_expression__t0 var698_literal_0__t0 var686_return__t2)  )
)

; end branch
; branch returned. the rest of the function only happens if the condition leading to return never happened
; (not var697_infix_expression__t0)
(assert
  (not var697_infix_expression__t0)
)
...
(assert (! (= var700_implicit_coercion_of_literal_1__t0 var699_literal_1__t0) :named A10)); : /home/runner/work/carrier/carrier/core/src/stream.zz:200
(declare-fun var701_assign_inter__t0 () (_ BitVec 64))
(assert
   (=  var701_assign_inter__t0 (bvadd var691_deref_var676_self__order_incomming__t0 var700_implicit_coercion_of_literal_1__t0))
)

(declare-fun var702_safe_assign_inter_____safe_deref_var676_self__order_incomming___t0 () Bool)
(assert
  (= var702_safe_assign_inter_____safe_deref_var676_self__order_incomming___t0 (theory1_safe var701_assign_inter__t0) )
)

(declare-fun var691_deref_var676_self__order_incomming__t1 () (_ BitVec 64))
(assert
  (= var702_safe_assign_inter_____safe_deref_var676_self__order_incomming___t0 (theory1_safe var691_deref_var676_self__order_incomming__t1) )
)

(declare-fun var703_nullterm_assign_inter_____nullterm_deref_var676_self__order_incomming___t0 () Bool)
(assert
  (= var703_nullterm_assign_inter_____nullterm_deref_var676_self__order_incomming___t0 (theory2_nullterm var701_assign_inter__t0) )
)

(assert
  (= var703_nullterm_assign_inter_____nullterm_deref_var676_self__order_incomming___t0 (theory2_nullterm var691_deref_var676_self__order_incomming__t1) )
)

(assert
  (= var691_deref_var676_self__order_incomming__t1  (ite true var701_assign_inter__t0 var691_deref_var676_self__order_incomming__t0)  )
)
...
(assert
  (= var705_interpretation_of_theory_safe_over_self__t0 (theory1_safe var676_self__t0) )
)

(push 1)

(assert
  (and true (or (not var705_interpretation_of_theory_safe_over_self__t0 ) ))
...
(assert
  (= var687_deref_var676_self___t1  (ite true var687_deref_var676_self___t1 var687_deref_var676_self___t0)  )
)
...
(declare-fun var686_return__t4 () Bool)
(assert
  (= var686_return__t4  (ite true var707_literal_4294967295__t0 var686_return__t3)  )
)
