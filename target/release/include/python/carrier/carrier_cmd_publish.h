...
#ifndef ZZ_EXPORT_HEADER__carrier_cmd_publish
#define ZZ_EXPORT_HEADER__carrier_cmd_publish
struct io_Context_t;
...
#ifndef ZZ_EXPORT_pool_Pool_640_640
#define ZZ_EXPORT_pool_Pool_640_640
struct pool_Pool_640_t {
   uintptr_t blocksize ;
   uintptr_t poolsize ;
   uint8_t*  used ;
...
;
const size_t sizeof_pool_Pool_640;
...
#ifndef ZZ_EXPORT_carrier_endpoint_Endpoint_100000_100000
#define ZZ_EXPORT_carrier_endpoint_Endpoint_100000_100000
struct carrier_endpoint_Endpoint_100000_t {
   net_Engine const *  netengine ;
   carrier_vault_Vault vault ;
   carrier_initiator_Move cluster_move ;
...
;
const size_t sizeof_carrier_endpoint_Endpoint_100000;
...
#ifndef ZZ_EXPORT_carrier_shell_Shell
#define ZZ_EXPORT_carrier_shell_Shell
struct carrier_shell_Shell_t {
   io_Io master ;
   pid_t pid ;
...
;
const size_t sizeof_carrier_shell_Shell;
