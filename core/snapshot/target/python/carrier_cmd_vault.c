...
#include <stdint.h>
#include <string.h>
#include "zz/carrier/carrier_cmd_vault.h"
...
static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_cmd_vault", "carrier::cmd_vault", -1, methods};

PyObject*  py_mod_carrier_cmd_vault_Init()
{
