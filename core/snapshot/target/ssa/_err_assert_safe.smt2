...
(declare-fun var150_implicit_coercion_of_literal_0__t0 () (_ BitVec 64))
(assert (! (= var150_implicit_coercion_of_literal_0__t0 var149_literal_0__t0) :named A0)); : /home/runner/work/carrier/carrier/modules/err/src/lib.zz:283
(declare-fun var151_infix_expression__t0 () Bool)
(declare-fun var145_a__t0 () (_ BitVec 64))
(assert
  (=  var151_infix_expression__t0 (= var145_a__t0 var150_implicit_coercion_of_literal_0__t0))
)
...
(assert
  (= var158_interpretation_of_theory_safe_over_a__t0 (theory1_safe var145_a__t0) )
)
...
(assert
  (= var160_interpretation_of_theory_safe_over_a__t0 (theory1_safe var145_a__t0) )
)

(push 1)

(assert
  (and true (or (not var160_interpretation_of_theory_safe_over_a__t0 ) ))
