...
(declare-fun var202_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var202_interpretation_of_theory_safe_over_id__t0 (theory1_safe var201_id__t0) )
)

(assert (! var202_interpretation_of_theory_safe_over_id__t0 :named A1))(check-sat)
...
(declare-fun var203_interpretation_of_theory_safe_over_self__t0 () Bool)
(assert
  (= var203_interpretation_of_theory_safe_over_self__t0 (theory1_safe var200_self__t0) )
)

(assert (! var203_interpretation_of_theory_safe_over_self__t0 :named A2))(check-sat)
...
(declare-fun var205_safe_self___t0 () Bool)
(assert
  (= var205_safe_self___t0 (theory1_safe var200_self__t0) )
)

(push 1)

(assert
  (and true (or (not var205_safe_self___t0 ) ))
...
(assert (! (= var210_implicit_coercion_of_literal_0__t0 var209_literal_0__t0) :named A3)); : /home/runner/work/carrier/carrier/core/src/vault.zz:166
(declare-fun var211_infix_expression__t0 () Bool)
(declare-fun var207_closure_fn___carrier__vault__get_identity_fn__t0 () (_ BitVec 64))
(assert
  (=  var211_infix_expression__t0 (= var207_closure_fn___carrier__vault__get_identity_fn__t0 var210_implicit_coercion_of_literal_0__t0))
)
...
(assert
  (= var212_interpretation_of_theory_safe_over_id__t0 (theory1_safe var201_id__t0) )
)
...
(assert
  (= var213_interpretation_of_theory_safe_over_self__t0 (theory1_safe var200_self__t0) )
)

(push 1)

(assert
  (and var211_infix_expression__t0 (or (not var212_interpretation_of_theory_safe_over_id__t0 ) (not var213_interpretation_of_theory_safe_over_self__t0 ) ))
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:170
(declare-fun var206_deref_var200_self__i_get_principal_identity__t0 () (_ BitVec 64))
(declare-fun var215_interpretation_of_theory_safe_over_deref_var200_self__i_get_principal_identity__t0 () Bool)
(assert
  (= var215_interpretation_of_theory_safe_over_deref_var200_self__i_get_principal_identity__t0 (theory1_safe var206_deref_var200_self__i_get_principal_identity__t0) )
)

(assert (! var215_interpretation_of_theory_safe_over_deref_var200_self__i_get_principal_identity__t0 :named A4))(check-sat)
...
; begin safe ptr check
; : /home/runner/work/carrier/carrier/core/src/vault.zz:171
(declare-fun var217_safe_deref_var200_self__i_get_principal_identity___t0 () Bool)
(assert
  (= var217_safe_deref_var200_self__i_get_principal_identity___t0 (theory1_safe var206_deref_var200_self__i_get_principal_identity__t0) )
)

(push 1)

(assert
  (and true (or (not var217_safe_deref_var200_self__i_get_principal_identity___t0 ) ))
