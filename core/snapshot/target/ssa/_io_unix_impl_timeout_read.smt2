...
(assert
  (= var257_safe___io__Result__Eof_____safe_return___t0 (theory1_safe var22___io__Result__Eof__t0) )
)
...
(assert
  (= var258_nullterm___io__Result__Eof_____nullterm_return___t0 (theory2_nullterm var22___io__Result__Eof__t0) )
)
...
(assert (! (= var259_implicit_coercion_of___io__Result__Eof__t0 var22___io__Result__Eof__t0) :named A8))(declare-fun var244_return__t0 () (_ BitVec 64))
(assert
...
(assert
  (= var277_safe___io__Result__Ready_____safe_return___t0 (theory1_safe var19___io__Result__Ready__t0) )
)
...
(assert
  (= var278_nullterm___io__Result__Ready_____nullterm_return___t0 (theory2_nullterm var19___io__Result__Ready__t0) )
)
...
(assert (! (= var279_implicit_coercion_of___io__Result__Ready__t0 var19___io__Result__Ready__t0) :named A9))(assert
...
(assert
  (= var301_safe___io__Result__Later_____safe_return___t0 (theory1_safe var20___io__Result__Later__t0) )
)
...
(assert
  (= var302_nullterm___io__Result__Later_____nullterm_return___t0 (theory2_nullterm var20___io__Result__Later__t0) )
)
...
(assert (! (= var303_implicit_coercion_of___io__Result__Later__t0 var20___io__Result__Later__t0) :named A15))(assert
