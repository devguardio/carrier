...
#if !defined(KRML_VERIFIED_UINT128) && defined(IS_MSVC64)
#include "3rdparty_hacl_star_dist_kremlin_kremlib_dist_minimal_fstar_uint128_msvc_h.h"
#elif !defined(KRML_VERIFIED_UINT128) && defined(HAS_INT128)
#include "3rdparty_hacl_star_dist_kremlin_kremlib_dist_minimal_fstar_uint128_gcc64_h.h"
#else
#include "3rdparty_hacl_star_dist_kremlin_kremlib_dist_minimal_FStar_UInt128_Verified_h.h"
#include "3rdparty_hacl_star_dist_kremlin_kremlib_dist_minimal_fstar_uint128_struct_endianness_h.h"
#endif
