...
(assert (! (= var704_len_deref_S699_self____t0 var700_qt__t0) :named A11)); : /home/runner/work/carrier/carrier/core/src/pq.zz:400
; : /home/runner/work/carrier/carrier/core/src/pq.zz:400
; call of safe
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var705_i__t0 () (_ BitVec 64))
(declare-fun var706_interpretation_of_theory_safe_over_i__t0 () Bool)
(assert
  (= var706_interpretation_of_theory_safe_over_i__t0 (theory1_safe var705_i__t0) )
)

(assert (! var706_interpretation_of_theory_safe_over_i__t0 :named A12))(check-sat)
...
(assert (! var707_interpretation_of_theory_safe_over_self__t0 :named A13))(check-sat)
...
(declare-fun var711_safe_i___t0 () Bool)
(assert
  (= var711_safe_i___t0 (theory1_safe var705_i__t0) )
)

(push 1)

(assert
  (and true (or (not var711_safe_i___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/pq.zz:402
(declare-fun var710_deref_var705_i___t0 () (_ BitVec 64))
(declare-fun var713_safe_deref_var705_i______safe_previous_value_of_deref_var705_i____t0 () Bool)
(assert
  (= var713_safe_deref_var705_i______safe_previous_value_of_deref_var705_i____t0 (theory1_safe var710_deref_var705_i___t0) )
)

(declare-fun var712_previous_value_of_deref_var705_i___t1 () (_ BitVec 64))
(assert
  (= var713_safe_deref_var705_i______safe_previous_value_of_deref_var705_i____t0 (theory1_safe var712_previous_value_of_deref_var705_i___t1) )
)

(declare-fun var714_nullterm_deref_var705_i______nullterm_previous_value_of_deref_var705_i____t0 () Bool)
(assert
  (= var714_nullterm_deref_var705_i______nullterm_previous_value_of_deref_var705_i____t0 (theory2_nullterm var710_deref_var705_i___t0) )
)

(assert
  (= var714_nullterm_deref_var705_i______nullterm_previous_value_of_deref_var705_i____t0 (theory2_nullterm var712_previous_value_of_deref_var705_i___t1) )
)

(declare-fun var712_previous_value_of_deref_var705_i___t0 () (_ BitVec 64))
(assert
  (= var712_previous_value_of_deref_var705_i___t1  (ite true var710_deref_var705_i___t0 var712_previous_value_of_deref_var705_i___t0)  )
)

(declare-fun var710_deref_var705_i___t1 () (_ BitVec 64))
(assert
  (= var710_deref_var705_i___t1 (bvadd var712_previous_value_of_deref_var705_i___t1 (_ bv1 64)) )
)

; : /home/runner/work/carrier/carrier/core/src/pq.zz:402
(declare-fun var715_safe_previous_value_of_deref_var705_i______safe_v___t0 () Bool)
(assert
  (= var715_safe_previous_value_of_deref_var705_i______safe_v___t0 (theory1_safe var712_previous_value_of_deref_var705_i___t1) )
)

(declare-fun var709_v__t1 () (_ BitVec 64))
(assert
  (= var715_safe_previous_value_of_deref_var705_i______safe_v___t0 (theory1_safe var709_v__t1) )
)

(declare-fun var716_nullterm_previous_value_of_deref_var705_i______nullterm_v___t0 () Bool)
(assert
  (= var716_nullterm_previous_value_of_deref_var705_i______nullterm_v___t0 (theory2_nullterm var712_previous_value_of_deref_var705_i___t1) )
)

(assert
  (= var716_nullterm_previous_value_of_deref_var705_i______nullterm_v___t0 (theory2_nullterm var709_v__t1) )
)

(declare-fun var709_v__t0 () (_ BitVec 64))
(assert
  (= var709_v__t1  (ite true var712_previous_value_of_deref_var705_i___t1 var709_v__t0)  )
)
...
(assert
  (=  var717_infix_expression__t0 (bvuge var710_deref_var705_i___t1 var700_qt__t0))
)
...
(assert (! (= var719_implicit_coercion_of_literal_0__t0 var718_literal_0__t0) :named A14)); : /home/runner/work/carrier/carrier/core/src/pq.zz:404
(declare-fun var720_safe_implicit_coercion_of_literal_0_____safe_deref_var705_i____t0 () Bool)
(assert
  (= var720_safe_implicit_coercion_of_literal_0_____safe_deref_var705_i____t0 (theory1_safe var719_implicit_coercion_of_literal_0__t0) )
)

(declare-fun var710_deref_var705_i___t2 () (_ BitVec 64))
(assert
  (= var720_safe_implicit_coercion_of_literal_0_____safe_deref_var705_i____t0 (theory1_safe var710_deref_var705_i___t2) )
)

(declare-fun var721_nullterm_implicit_coercion_of_literal_0_____nullterm_deref_var705_i____t0 () Bool)
(assert
  (= var721_nullterm_implicit_coercion_of_literal_0_____nullterm_deref_var705_i____t0 (theory2_nullterm var719_implicit_coercion_of_literal_0__t0) )
)

(assert
  (= var721_nullterm_implicit_coercion_of_literal_0_____nullterm_deref_var705_i____t0 (theory2_nullterm var710_deref_var705_i___t2) )
)

(assert
  (= var710_deref_var705_i___t2  (ite var717_infix_expression__t0 var719_implicit_coercion_of_literal_0__t0 var710_deref_var705_i___t1)  )
)

; end branch
; : /home/runner/work/carrier/carrier/core/src/pq.zz:406
(declare-fun var722_safe_v_____safe_return___t0 () Bool)
(assert
  (= var722_safe_v_____safe_return___t0 (theory1_safe var709_v__t1) )
)

(declare-fun var708_return__t1 () (_ BitVec 64))
(assert
  (= var722_safe_v_____safe_return___t0 (theory1_safe var708_return__t1) )
)

(declare-fun var723_nullterm_v_____nullterm_return___t0 () Bool)
(assert
  (= var723_nullterm_v_____nullterm_return___t0 (theory2_nullterm var709_v__t1) )
)

(assert
  (= var723_nullterm_v_____nullterm_return___t0 (theory2_nullterm var708_return__t1) )
)

(declare-fun var708_return__t0 () (_ BitVec 64))
(assert
  (= var708_return__t1  (ite true var709_v__t1 var708_return__t0)  )
)
