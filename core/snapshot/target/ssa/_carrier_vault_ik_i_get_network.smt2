...
;----------------------------------------------
;function ::carrier::vault_ik::i_get_network
;----------------------------------------------
...
(declare-fun var237_addr__t0 () (_ BitVec 64))
(declare-fun var238_interpretation_of_theory_safe_over_addr__t0 () Bool)
(assert
  (= var238_interpretation_of_theory_safe_over_addr__t0 (theory1_safe var237_addr__t0) )
)

(assert (! var238_interpretation_of_theory_safe_over_addr__t0 :named A1))(check-sat)
...
(assert
  (= var239_interpretation_of_theory_safe_over_self__t0 (theory1_safe var236_self__t0) )
)

(assert (! var239_interpretation_of_theory_safe_over_self__t0 :named A2))(check-sat)

; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
(declare-fun var244_addressof_deref_var236_self__ik_network___t0 () (_ BitVec 64))
(declare-fun var245_len_addressof_deref_var236_self__ik_network____t0 () (_ BitVec 64))
(assert
  (= var245_len_addressof_deref_var236_self__ik_network____t0 (theory0_len var244_addressof_deref_var236_self__ik_network___t0) )
)

(assert
  (= var245_len_addressof_deref_var236_self__ik_network____t0 (_ bv1 64))

)

(assert
  (= var244_addressof_deref_var236_self__ik_network___t0 (_ bv243 64))

)

(declare-fun var246_true__t0 () Bool)
(assert
  (= var246_true__t0 (theory1_safe var244_addressof_deref_var236_self__ik_network___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
(declare-fun var247_addressof_deref_var236_self__ik_network___t0 () (_ BitVec 64))
(declare-fun var248_len_addressof_deref_var236_self__ik_network____t0 () (_ BitVec 64))
(assert
  (= var248_len_addressof_deref_var236_self__ik_network____t0 (theory0_len var247_addressof_deref_var236_self__ik_network___t0) )
)

(assert
  (= var248_len_addressof_deref_var236_self__ik_network____t0 (_ bv1 64))

)

(assert
  (= var247_addressof_deref_var236_self__ik_network___t0 (_ bv243 64))

)

(declare-fun var249_true__t0 () Bool)
(assert
  (= var249_true__t0 (theory1_safe var247_addressof_deref_var236_self__ik_network___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var250_interpretation_of_theory_safe_over_addressof_deref_var236_self__ik_network___t0 () Bool)
(assert
  (= var250_interpretation_of_theory_safe_over_addressof_deref_var236_self__ik_network___t0 (theory1_safe var247_addressof_deref_var236_self__ik_network___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var251_interpretation_of_theory_safe_over_addr__t0 () Bool)
(assert
  (= var251_interpretation_of_theory_safe_over_addr__t0 (theory1_safe var237_addr__t0) )
)

(push 1)

(assert
  (and true (or (not var250_interpretation_of_theory_safe_over_addressof_deref_var236_self__ik_network___t0 ) (not var251_interpretation_of_theory_safe_over_addr__t0 ) ))
...
;end of function ::carrier::vault_ik::i_get_network
