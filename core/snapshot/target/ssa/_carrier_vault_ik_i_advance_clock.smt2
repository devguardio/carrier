...
(assert (! var239_interpretation_of_theory_safe_over_self__t0 :named A1))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:32
(declare-fun var242_return_value_of___time__real__t0 () (_ BitVec 64))
(declare-fun var243_safe_return_value_of___time__real_____safe_now___t0 () Bool)
(assert
  (= var243_safe_return_value_of___time__real_____safe_now___t0 (theory1_safe var242_return_value_of___time__real__t0) )
)

(declare-fun var241_now__t1 () (_ BitVec 64))
(assert
  (= var243_safe_return_value_of___time__real_____safe_now___t0 (theory1_safe var241_now__t1) )
)

(declare-fun var244_nullterm_return_value_of___time__real_____nullterm_now___t0 () Bool)
(assert
  (= var244_nullterm_return_value_of___time__real_____nullterm_now___t0 (theory2_nullterm var242_return_value_of___time__real__t0) )
)

(assert
  (= var244_nullterm_return_value_of___time__real_____nullterm_now___t0 (theory2_nullterm var241_now__t1) )
)

(declare-fun var241_now__t0 () (_ BitVec 64))
(assert
  (= var241_now__t1  (ite true var242_return_value_of___time__real__t0 var241_now__t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:33
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:33
(declare-fun var246_addressof_now___t0 () (_ BitVec 64))
(declare-fun var247_len_addressof_now____t0 () (_ BitVec 64))
(assert
  (= var247_len_addressof_now____t0 (theory0_len var246_addressof_now___t0) )
)

(assert
  (= var247_len_addressof_now____t0 (_ bv1 64))

)

(assert
  (= var246_addressof_now___t0 (_ bv241 64))

)

(declare-fun var248_true__t0 () Bool)
(assert
  (= var248_true__t0 (theory1_safe var246_addressof_now___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:33
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:33
(declare-fun var249_addressof_now___t0 () (_ BitVec 64))
(declare-fun var250_len_addressof_now____t0 () (_ BitVec 64))
(assert
  (= var250_len_addressof_now____t0 (theory0_len var249_addressof_now___t0) )
)

(assert
  (= var250_len_addressof_now____t0 (_ bv1 64))

)

(assert
  (= var249_addressof_now___t0 (_ bv241 64))

)

(declare-fun var251_true__t0 () Bool)
(assert
  (= var251_true__t0 (theory1_safe var249_addressof_now___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var252_interpretation_of_theory_safe_over_addressof_now___t0 () Bool)
(assert
  (= var252_interpretation_of_theory_safe_over_addressof_now___t0 (theory1_safe var249_addressof_now___t0) )
)

(push 1)

(assert
  (and true (or (not var252_interpretation_of_theory_safe_over_addressof_now___t0 ) ))
...
; callsite effects
; end of callsite effects
(declare-fun var253_return_value_of___time__to_millis__t0 () (_ BitVec 64))
(declare-fun var254_safe_return_value_of___time__to_millis_____safe_return___t0 () Bool)
(assert
  (= var254_safe_return_value_of___time__to_millis_____safe_return___t0 (theory1_safe var253_return_value_of___time__to_millis__t0) )
)

(declare-fun var240_return__t1 () (_ BitVec 64))
(assert
  (= var254_safe_return_value_of___time__to_millis_____safe_return___t0 (theory1_safe var240_return__t1) )
)

(declare-fun var255_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 () Bool)
(assert
  (= var255_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 (theory2_nullterm var253_return_value_of___time__to_millis__t0) )
)

(assert
  (= var255_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 (theory2_nullterm var240_return__t1) )
)

(declare-fun var240_return__t0 () (_ BitVec 64))
(assert
  (= var240_return__t1  (ite true var253_return_value_of___time__to_millis__t0 var240_return__t0)  )
)
