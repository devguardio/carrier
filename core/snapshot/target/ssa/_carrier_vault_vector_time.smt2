...
(assert
  (= var214_safe_self___t0 (theory1_safe var210_self__t0) )
)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:139
(declare-fun var215_deref_var210_self__i_advance_clock__t0 () (_ BitVec 64))
(declare-fun var216_interpretation_of_theory_safe_over_deref_var210_self__i_advance_clock__t0 () Bool)
(assert
  (= var216_interpretation_of_theory_safe_over_deref_var210_self__i_advance_clock__t0 (theory1_safe var215_deref_var210_self__i_advance_clock__t0) )
)

(assert (! var216_interpretation_of_theory_safe_over_deref_var210_self__i_advance_clock__t0 :named A2))(check-sat)
...
; begin safe ptr check
; : /home/runner/work/carrier/carrier/core/src/vault.zz:140
(declare-fun var220_safe_deref_var210_self__i_advance_clock___t0 () Bool)
(assert
  (= var220_safe_deref_var210_self__i_advance_clock___t0 (theory1_safe var215_deref_var210_self__i_advance_clock__t0) )
)

(push 1)

(assert
  (and true (or (not var220_safe_deref_var210_self__i_advance_clock___t0 ) ))
...
(declare-fun var221_return_value_of_closure_fn___carrier__vault__advance_clock_fn__t0 () (_ BitVec 64))
(declare-fun var222_safe_return_value_of_closure_fn___carrier__vault__advance_clock_fn_____safe_return___t0 () Bool)
(assert
  (= var222_safe_return_value_of_closure_fn___carrier__vault__advance_clock_fn_____safe_return___t0 (theory1_safe var221_return_value_of_closure_fn___carrier__vault__advance_clock_fn__t0) )
)

(declare-fun var212_return__t1 () (_ BitVec 64))
(assert
  (= var222_safe_return_value_of_closure_fn___carrier__vault__advance_clock_fn_____safe_return___t0 (theory1_safe var212_return__t1) )
)

(declare-fun var223_nullterm_return_value_of_closure_fn___carrier__vault__advance_clock_fn_____nullterm_return___t0 () Bool)
(assert
  (= var223_nullterm_return_value_of_closure_fn___carrier__vault__advance_clock_fn_____nullterm_return___t0 (theory2_nullterm var221_return_value_of_closure_fn___carrier__vault__advance_clock_fn__t0) )
)

(assert
  (= var223_nullterm_return_value_of_closure_fn___carrier__vault__advance_clock_fn_____nullterm_return___t0 (theory2_nullterm var212_return__t1) )
)

(declare-fun var212_return__t0 () (_ BitVec 64))
(assert
  (= var212_return__t1  (ite true var221_return_value_of_closure_fn___carrier__vault__advance_clock_fn__t0 var212_return__t0)  )
)
