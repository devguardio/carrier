...
(declare-fun var234_safe_literal_struct_232_____safe_ctx___t0 () Bool)
(assert
  (= var234_safe_literal_struct_232_____safe_ctx___t0 (theory1_safe var232_literal_struct_232__t0) )
)

(declare-fun var231_ctx__t1 () (_ BitVec 64))
(assert
  (= var234_safe_literal_struct_232_____safe_ctx___t0 (theory1_safe var231_ctx__t1) )
)

(declare-fun var235_nullterm_literal_struct_232_____nullterm_ctx___t0 () Bool)
(assert
  (= var235_nullterm_literal_struct_232_____nullterm_ctx___t0 (theory2_nullterm var232_literal_struct_232__t0) )
)

(assert
  (= var235_nullterm_literal_struct_232_____nullterm_ctx___t0 (theory2_nullterm var231_ctx__t1) )
)

(declare-fun var231_ctx__t0 () (_ BitVec 64))
(assert
  (= var231_ctx__t1  (ite true var232_literal_struct_232__t0 var231_ctx__t0)  )
)
...
(declare-fun var258_safe_literal_struct_236_____safe_return___t0 () Bool)
(assert
  (= var258_safe_literal_struct_236_____safe_return___t0 (theory1_safe var236_literal_struct_236__t0) )
)

(declare-fun var230_return__t1 () (_ BitVec 64))
(assert
  (= var258_safe_literal_struct_236_____safe_return___t0 (theory1_safe var230_return__t1) )
)

(declare-fun var259_nullterm_literal_struct_236_____nullterm_return___t0 () Bool)
(assert
  (= var259_nullterm_literal_struct_236_____nullterm_return___t0 (theory2_nullterm var236_literal_struct_236__t0) )
)

(assert
  (= var259_nullterm_literal_struct_236_____nullterm_return___t0 (theory2_nullterm var230_return__t1) )
)

(declare-fun var230_return__t0 () (_ BitVec 64))
(assert
  (= var230_return__t1  (ite true var236_literal_struct_236__t0 var230_return__t0)  )
)
...
(assert
  (= var260_interpretation_of_theory_safe_over___io__read_fn__t0 (theory1_safe var237_literal_struct_237__t0) )
)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/modules/io/src/unix.zz:114
(declare-fun var261_interpretation_of_theory_safe_over___io__read_fn__t0 () Bool)
(assert
  (= var261_interpretation_of_theory_safe_over___io__read_fn__t0 (theory1_safe var237_literal_struct_237__t0) )
)

(push 1)

(assert
  (and true (or (not var261_interpretation_of_theory_safe_over___io__read_fn__t0 ) ))
