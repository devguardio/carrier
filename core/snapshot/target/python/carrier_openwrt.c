...
#include <stdint.h>
#include <string.h>
#include "zz/carrier/carrier_openwrt.h"
...
extern PyTypeObject py_Type_carrier_openwrt_OTAState;
extern PyTypeObject py_Type_carrier_identity_Address;
extern PyTypeObject py_Type_carrier_noise_Responder;
extern PyTypeObject py_Type_io_Async;
extern PyTypeObject py_Type_io_unix_Async;
...
extern PyTypeObject py_Type_err_Err;
extern PyTypeObject py_Type_carrier_sft_State;
extern PyTypeObject py_Type_carrier_stream_Stream;
extern PyTypeObject py_Type_protonerf_Decoder;
extern PyTypeObject py_Type_carrier_identity_Alias;
...
static PyObject* py_carrier_openwrt_main(PyObject *pyself, PyObject *args) {
    //argc
    long long int arg0 = 0;
    //argv
    PyObject * arg1 = 0;
    if (!PyArg_ParseTuple(args, "lO", &arg0,&arg1)) { return NULL; };
    long long int rarg = (long long int)(carrier_openwrt_main(
        arg0,
        pyFATGetPtr(arg1, "char")));
    return PyLong_FromLong(rarg);
}

static PyObject* py_carrier_openwrt_register(PyObject *pyself, PyObject *args) {
    //ep
    PyObject * arg0 = 0;
    if (!PyArg_ParseTuple(args, "O", &arg0)) { return NULL; };
    carrier_openwrt_register(
...
{"main", py_carrier_openwrt_main, METH_VARARGS,""},
{"register", py_carrier_openwrt_register, METH_VARARGS,""},
{NULL, NULL, 0, NULL}
};

static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_openwrt", "carrier::openwrt", -1, methods};

PyObject*  py_mod_carrier_openwrt_Init()
{
