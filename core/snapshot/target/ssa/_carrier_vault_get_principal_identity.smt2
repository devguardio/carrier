...
(assert (! (= var218_implicit_coercion_of_literal_0__t0 var217_literal_0__t0) :named A3)); : /home/runner/work/carrier/carrier/core/src/vault.zz:166
(declare-fun var219_infix_expression__t0 () Bool)
(declare-fun var215_closure_fn___carrier__vault__get_identity_fn__t0 () (_ BitVec 64))
(assert
  (=  var219_infix_expression__t0 (= var215_closure_fn___carrier__vault__get_identity_fn__t0 var218_implicit_coercion_of_literal_0__t0))
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var220_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var220_interpretation_of_theory_safe_over_id__t0 (theory1_safe var209_id__t0) )
)
...
(assert
  (= var221_interpretation_of_theory_safe_over_self__t0 (theory1_safe var208_self__t0) )
)

(push 1)

(assert
  (and var219_infix_expression__t0 (or (not var220_interpretation_of_theory_safe_over_id__t0 ) (not var221_interpretation_of_theory_safe_over_self__t0 ) ))
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:170
(declare-fun var214_deref_var208_self__i_get_principal_identity__t0 () (_ BitVec 64))
(declare-fun var223_interpretation_of_theory_safe_over_deref_var208_self__i_get_principal_identity__t0 () Bool)
(assert
  (= var223_interpretation_of_theory_safe_over_deref_var208_self__i_get_principal_identity__t0 (theory1_safe var214_deref_var208_self__i_get_principal_identity__t0) )
)

(assert (! var223_interpretation_of_theory_safe_over_deref_var208_self__i_get_principal_identity__t0 :named A4))(check-sat)
...
; begin safe ptr check
; : /home/runner/work/carrier/carrier/core/src/vault.zz:171
(declare-fun var225_safe_deref_var208_self__i_get_principal_identity___t0 () Bool)
(assert
  (= var225_safe_deref_var208_self__i_get_principal_identity___t0 (theory1_safe var214_deref_var208_self__i_get_principal_identity__t0) )
)

(push 1)

(assert
  (and true (or (not var225_safe_deref_var208_self__i_get_principal_identity___t0 ) ))
