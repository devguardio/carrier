...
(declare-fun var736_conf__t0 () (_ BitVec 64))
(declare-fun var737_interpretation_of_theory_safe_over_conf__t0 () Bool)
(assert
  (= var737_interpretation_of_theory_safe_over_conf__t0 (theory1_safe var736_conf__t0) )
)

(assert (! var737_interpretation_of_theory_safe_over_conf__t0 :named A6))(check-sat)
...
(assert
  (= var738_interpretation_of_theory_safe_over_self__t0 (theory1_safe var735_self__t0) )
)
...
(assert (! (= var743_implicit_coercion_of_literal_0__t0 var740_literal_0__t0) :named A8))(declare-fun var739_i__t0 () (_ BitVec 64))
(assert
...
(assert
  (not (= var747_literal_32__t0 #x0000000000000020))
)
...
; : /home/runner/work/carrier/carrier/core/src/endpoint.zz:210
(declare-fun var748_deref_var735_self__p2p_stream_registry__t0 () (_ BitVec 64))
(declare-fun var749_len_deref_var735_self__p2p_stream_registry___t0 () (_ BitVec 64))
(assert
  (= var749_len_deref_var735_self__p2p_stream_registry___t0 (theory0_len var748_deref_var735_self__p2p_stream_registry__t0) )
)

(assert
  (= var749_len_deref_var735_self__p2p_stream_registry___t0 (_ bv32 64))

)

(declare-fun var750_true__t0 () Bool)
(assert
  (= var750_true__t0 (theory1_safe var748_deref_var735_self__p2p_stream_registry__t0) )
)
...
(assert (! (= var753_implicit_coercion_of_literal_32__t0 var752_literal_32__t0) :named A9)); : /home/runner/work/carrier/carrier/core/src/endpoint.zz:210
(declare-fun var754_infix_expression__t0 () Bool)
(assert
  (=  var754_infix_expression__t0 (bvult var739_i__t2 var753_implicit_coercion_of_literal_32__t0))
)

(assert (! var754_infix_expression__t0 :named A10))(check-sat)
...
(assert
  (not (= var739_i__t2 #x0000000000000001))
)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/endpoint.zz:211
(declare-fun var755_len_deref_var735_self__p2p_stream_registry___t0 () (_ BitVec 64))
(assert
  (= var755_len_deref_var735_self__p2p_stream_registry___t0 (theory0_len var748_deref_var735_self__p2p_stream_registry__t0) )
)

(declare-fun var756_i___len_deref_var735_self__p2p_stream_registry___t0 () Bool)
(assert
  (=  var756_i___len_deref_var735_self__p2p_stream_registry___t0 (bvult var739_i__t2 var755_len_deref_var735_self__p2p_stream_registry___t0))
)
...
(assert
  (and true (or (not var756_i___len_deref_var735_self__p2p_stream_registry___t0 ) ))
...
(assert (! (= var759_implicit_coercion_of_literal_0__t0 var758_literal_0__t0) :named A11)); : /home/runner/work/carrier/carrier/core/src/endpoint.zz:211
(declare-fun var760_infix_expression__t0 () Bool)
(declare-fun var757_array_member_deref_var735_self__p2p_stream_registry_i___t0 () (_ BitVec 64))
(assert
  (=  var760_infix_expression__t0 (= var757_array_member_deref_var735_self__p2p_stream_registry_i___t0 var759_implicit_coercion_of_literal_0__t0))
)
...
(assert
  (not (= var739_i__t2 #x0000000000000004))
)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/endpoint.zz:212
(declare-fun var761_len_deref_var735_self__p2p_stream_registry___t0 () (_ BitVec 64))
(assert
  (= var761_len_deref_var735_self__p2p_stream_registry___t0 (theory0_len var748_deref_var735_self__p2p_stream_registry__t0) )
)

(declare-fun var762_i___len_deref_var735_self__p2p_stream_registry___t0 () Bool)
(assert
  (=  var762_i___len_deref_var735_self__p2p_stream_registry___t0 (bvult var739_i__t2 var761_len_deref_var735_self__p2p_stream_registry___t0))
)
...
(assert
  (and var760_infix_expression__t0 (or (not var762_i___len_deref_var735_self__p2p_stream_registry___t0 ) ))
