...
static PyObject* py_carrier_pub_sysinfo_register(PyObject *pyself, PyObject *args) {
    //ep
    PyObject * arg0 = 0;
    if (!PyArg_ParseTuple(args, "O", &arg0)) { return NULL; };
    carrier_pub_sysinfo_register(
...
{"register", py_carrier_pub_sysinfo_register, METH_VARARGS,""},
{NULL, NULL, 0, NULL}
};

static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_pub_sysinfo", "carrier::pub_sysinfo", -1, methods};
