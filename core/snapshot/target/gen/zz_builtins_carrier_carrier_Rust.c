...
const __attribute__ ((unused)) size_t json_ParseError = 3;
...
const __attribute__ ((unused)) size_t carrier_sync_Failed = 8;
const __attribute__ ((unused)) size_t hpack_decoder_Invalid = 9;
const __attribute__ ((unused)) size_t err_OutOfTail = 10;
const __attribute__ ((unused)) size_t err_InvalidArgument = 11;
const __attribute__ ((unused)) size_t io_NotImplemented = 12;
