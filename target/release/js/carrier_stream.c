...
napi_value js_carrier_stream_incomming_close(napi_env env, napi_callback_info info) {
    ...
    bool  frrr = carrier_stream_incomming_close( local_0, local_1, local_1_tail, local_3);
...
napi_value jsGet_carrier_stream_Config_path(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  assert(status == napi_ok);
  mem += sizeof(size_t);
  carrier_stream_Config * obj = (carrier_stream_Config*)mem;
...
napi_value jsGet_carrier_stream_Config_open(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_stream_Config_close(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_stream_Config_stream(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_stream_Config_poll(napi_env env, napi_callback_info info) {
  napi_status status;
...
void js_delete_carrier_stream_Config(napi_env env, void *obj, void*hint) {
    free(obj);
}
napi_value js_new_carrier_stream_Config(napi_env env, napi_callback_info info) {
    napi_status status;
    ...
    void *obj = malloc(sizeof(size_t) + sizeof_carrier_stream_Config);
    memset(obj, 0, sizeof(size_t) + sizeof_carrier_stream_Config);
    ...
    *((size_t *)obj) = tail;
    ...
    status = napi_wrap(env,
            jsthis,
            obj,
            js_delete_carrier_stream_Config, // destructor
            0,  // finalize_hint
            0
    );
    assert(status == napi_ok);
...
void js_register_carrier_stream_Config (napi_env env, napi_value exports) {
    napi_property_descriptor properties[] = {
        { "path", 0, 0, jsGet_carrier_stream_Config_path, 0, 0, napi_default, 0},
        { "open", 0, 0, jsGet_carrier_stream_Config_open, 0, 0, napi_default, 0},
        { "close", 0, 0, jsGet_carrier_stream_Config_close, 0, 0, napi_default, 0},
        { "stream", 0, 0, jsGet_carrier_stream_Config_stream, 0, 0, napi_default, 0},
        { "poll", 0, 0, jsGet_carrier_stream_Config_poll, 0, 0, napi_default, 0},
    };
    napi_value cc;
    napi_status status = napi_define_class(env, "Config", NAPI_AUTO_LENGTH, js_new_carrier_stream_Config, 0, 5, properties, &cc);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "Config", cc);
    assert(status == napi_ok);
}


napi_value jsGet_carrier_stream_Stream_config(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  assert(status == napi_ok);
  mem += sizeof(size_t);
  carrier_stream_Stream * obj = (carrier_stream_Stream*)mem;
...
napi_value jsGet_carrier_stream_Stream_chan(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_stream_Stream_id(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_stream_Stream_order_incomming(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  napi_value value;
    status = napi_create_bigint_uint64(env, obj->order_incomming, &value);
...
napi_value jsGet_carrier_stream_Stream_order_outgoing(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  napi_value value;
    status = napi_create_bigint_uint64(env, obj->order_outgoing, &value);
...
napi_value jsGet_carrier_stream_Stream_errors_are_fatal(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_stream_Stream_closing(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  napi_value value;
    status = napi_create_uint32(env, obj->closing, &value);
...
napi_value jsGet_carrier_stream_Stream_broker_route(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  napi_value value;
    status = napi_create_bigint_uint64(env, obj->broker_route, &value);
...
napi_value jsGet_carrier_stream_Stream_state(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_stream_Stream_user1(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  napi_value value;
    status = napi_create_bigint_uint64(env, obj->user1, &value);
...
napi_value jsGet_carrier_stream_Stream_user2(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_stream_Stream_memory_pressure(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  napi_value value;
    status = napi_create_uint32(env, obj->memory_pressure, &value);
...
napi_value jsGet_carrier_stream_Stream_memory_pressure_timer_io(napi_env env, napi_callback_info info) {
  napi_status status;
...
void js_delete_carrier_stream_Stream(napi_env env, void *obj, void*hint) {
    free(obj);
}
napi_value js_new_carrier_stream_Stream(napi_env env, napi_callback_info info) {
    napi_status status;
    ...
    void *obj = malloc(sizeof(size_t) + sizeof_carrier_stream_Stream);
    memset(obj, 0, sizeof(size_t) + sizeof_carrier_stream_Stream);
    ...
    *((size_t *)obj) = tail;
    ...
    status = napi_wrap(env,
            jsthis,
            obj,
            js_delete_carrier_stream_Stream, // destructor
            0,  // finalize_hint
            0
    );
    assert(status == napi_ok);
...
void js_register_carrier_stream_Stream (napi_env env, napi_value exports) {
    napi_property_descriptor properties[] = {
        { "close", 0, js_carrier_stream_close, 0, 0, 0, napi_default, 0 },
        { "cancel", 0, js_carrier_stream_cancel, 0, 0, 0, napi_default, 0 },
        { "incomming_stream", 0, js_carrier_stream_incomming_stream, 0, 0, 0, napi_default, 0 },
        { "incomming_close", 0, js_carrier_stream_incomming_close, 0, 0, 0, napi_default, 0 },
        { "stream", 0, js_carrier_stream_stream, 0, 0, 0, napi_default, 0 },
        { "do_poll", 0, js_carrier_stream_do_poll, 0, 0, 0, napi_default, 0 },
        { "config", 0, 0, jsGet_carrier_stream_Stream_config, 0, 0, napi_default, 0},
        { "chan", 0, 0, jsGet_carrier_stream_Stream_chan, 0, 0, napi_default, 0},
        { "id", 0, 0, jsGet_carrier_stream_Stream_id, 0, 0, napi_default, 0},
        { "order_incomming", 0, 0, jsGet_carrier_stream_Stream_order_incomming, 0, 0, napi_default, 0},
        { "order_outgoing", 0, 0, jsGet_carrier_stream_Stream_order_outgoing, 0, 0, napi_default, 0},
        { "errors_are_fatal", 0, 0, jsGet_carrier_stream_Stream_errors_are_fatal, 0, 0, napi_default, 0},
        { "closing", 0, 0, jsGet_carrier_stream_Stream_closing, 0, 0, napi_default, 0},
        { "broker_route", 0, 0, jsGet_carrier_stream_Stream_broker_route, 0, 0, napi_default, 0},
        { "state", 0, 0, jsGet_carrier_stream_Stream_state, 0, 0, napi_default, 0},
        { "user1", 0, 0, jsGet_carrier_stream_Stream_user1, 0, 0, napi_default, 0},
        { "user2", 0, 0, jsGet_carrier_stream_Stream_user2, 0, 0, napi_default, 0},
        { "memory_pressure", 0, 0, jsGet_carrier_stream_Stream_memory_pressure, 0, 0, napi_default, 0},
        { "memory_pressure_timer_io", 0, 0, jsGet_carrier_stream_Stream_memory_pressure_timer_io, 0, 0, napi_default, 0},
    };
    napi_value cc;
    napi_status status = napi_define_class(env, "Stream", NAPI_AUTO_LENGTH, js_new_carrier_stream_Stream, 0, 19, properties, &cc);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "Stream", cc);
    assert(status == napi_ok);
}
...
napi_value js_carrier_stream_incomming_stream(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_4 == 0 || status != napi_ok) {
        ...
        local_4 = tttt_local_4 + sizeof(size_t*);
                    ...
                    if (status != napi_ok) {
                        napi_throw_type_error(env, 0, "3'th arg requires type ::slice::slice::Slice*");
                        return 0;
                    }
                    napi_value jsreturn = 0;
    bool  frrr = carrier_stream_incomming_stream( local_0, local_1, local_1_tail, local_3, local_4);
    status = napi_create_uint32(env, frrr, &jsreturn);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_carrier_stream_do_poll(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_3 == 0 || status != napi_ok) {
        ...
        local_3 = tttt_local_3 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    carrier_stream_do_poll( local_0, local_1, local_1_tail, local_3);
    return jsreturn;
}
...
napi_value js_carrier_stream_stream(napi_env env, napi_callback_info info) {
    ...
    status = napi_get_value_uint32(env, argv[1], (uint32_t*)&local_3);
                    ...
                    napi_value jsreturn = 0;
    slice_mut_slice_MutSlice * frrr = carrier_stream_stream( local_0, local_1, local_1_tail, local_3);
    assert(status == napi_ok);
    return jsreturn;
}


napi_value js_carrier_stream_Init(napi_env env, napi_value exports)
{
    js_register_carrier_stream_Config(env, exports);
    js_register_carrier_stream_Stream(env, exports);
    napi_value ff;
    napi_status status;
    status = napi_create_function(env, "incomming_close", NAPI_AUTO_LENGTH, js_carrier_stream_incomming_close, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "incomming_close", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "close", NAPI_AUTO_LENGTH, js_carrier_stream_close, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "close", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "incomming_stream", NAPI_AUTO_LENGTH, js_carrier_stream_incomming_stream, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "incomming_stream", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "do_poll", NAPI_AUTO_LENGTH, js_carrier_stream_do_poll, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "do_poll", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "cancel", NAPI_AUTO_LENGTH, js_carrier_stream_cancel, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "cancel", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "stream", NAPI_AUTO_LENGTH, js_carrier_stream_stream, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "stream", ff);
    assert(status == napi_ok);
    return exports;
}
