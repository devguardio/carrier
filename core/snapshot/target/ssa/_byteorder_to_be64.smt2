...
(declare-fun var792_return_value_of___byteorder__swap64__t0 () (_ BitVec 64))
(declare-fun var793_safe_return_value_of___byteorder__swap64_____safe_return___t0 () Bool)
(assert
  (= var793_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var792_return_value_of___byteorder__swap64__t0) )
)

(declare-fun var791_return__t1 () (_ BitVec 64))
(assert
  (= var793_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var791_return__t1) )
)

(declare-fun var794_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 () Bool)
(assert
  (= var794_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var792_return_value_of___byteorder__swap64__t0) )
)

(assert
  (= var794_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var791_return__t1) )
)

(declare-fun var791_return__t0 () (_ BitVec 64))
(assert
  (= var791_return__t1  (ite true var792_return_value_of___byteorder__swap64__t0 var791_return__t0)  )
)
...
(declare-fun var795_x__t0 () (_ BitVec 64))
(declare-fun var797_safe_x_____safe_return___t0 () Bool)
(assert
  (= var797_safe_x_____safe_return___t0 (theory1_safe var795_x__t0) )
)

(declare-fun var796_return__t1 () (_ BitVec 64))
(assert
  (= var797_safe_x_____safe_return___t0 (theory1_safe var796_return__t1) )
)

(declare-fun var798_nullterm_x_____nullterm_return___t0 () Bool)
(assert
  (= var798_nullterm_x_____nullterm_return___t0 (theory2_nullterm var795_x__t0) )
)

(assert
  (= var798_nullterm_x_____nullterm_return___t0 (theory2_nullterm var796_return__t1) )
)

(declare-fun var796_return__t0 () (_ BitVec 64))
(assert
  (= var796_return__t1  (ite true var795_x__t0 var796_return__t0)  )
)
