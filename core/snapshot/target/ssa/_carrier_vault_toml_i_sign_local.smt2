...
(assert (! (= var339_cast_of_deref_var328_self__user__t0 var338_deref_var328_self__user__t0) :named A5)); : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:430
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:433
(declare-fun var347_addressof_deref_var335_this__secret___t0 () (_ BitVec 64))
(declare-fun var348_len_addressof_deref_var335_this__secret____t0 () (_ BitVec 64))
(assert
  (= var348_len_addressof_deref_var335_this__secret____t0 (theory0_len var347_addressof_deref_var335_this__secret___t0) )
)

(assert
  (= var348_len_addressof_deref_var335_this__secret____t0 (_ bv1 64))

)

(assert
  (= var347_addressof_deref_var335_this__secret___t0 (_ bv346 64))

)

(declare-fun var349_true__t0 () Bool)
(assert
  (= var349_true__t0 (theory1_safe var347_addressof_deref_var335_this__secret___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:433
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:433
(declare-fun var350_addressof_deref_var335_this__secret___t0 () (_ BitVec 64))
(declare-fun var351_len_addressof_deref_var335_this__secret____t0 () (_ BitVec 64))
(assert
  (= var351_len_addressof_deref_var335_this__secret____t0 (theory0_len var350_addressof_deref_var335_this__secret___t0) )
)

(assert
  (= var351_len_addressof_deref_var335_this__secret____t0 (_ bv1 64))

)

(assert
  (= var350_addressof_deref_var335_this__secret___t0 (_ bv346 64))

)

(declare-fun var352_true__t0 () Bool)
(assert
  (= var352_true__t0 (theory1_safe var350_addressof_deref_var335_this__secret___t0) )
)
...
(assert
  (= var353_interpretation_of_theory_safe_over_subject__t0 (theory1_safe var330_subject__t0) )
)
...
(assert
  (= var354_interpretation_of_theory_safe_over_s__t0 (theory1_safe var329_s__t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var355_interpretation_of_theory_safe_over_addressof_deref_var335_this__secret___t0 () Bool)
(assert
  (= var355_interpretation_of_theory_safe_over_addressof_deref_var335_this__secret___t0 (theory1_safe var350_addressof_deref_var335_this__secret___t0) )
)

(push 1)

(assert
  (and true (or (not var353_interpretation_of_theory_safe_over_subject__t0 ) (not var354_interpretation_of_theory_safe_over_s__t0 ) (not var355_interpretation_of_theory_safe_over_addressof_deref_var335_this__secret___t0 ) ))
