...
(declare-fun var170_return_value_of___byteorder__swap64__t0 () (_ BitVec 64))
(declare-fun var171_safe_return_value_of___byteorder__swap64_____safe_return___t0 () Bool)
(assert
  (= var171_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var170_return_value_of___byteorder__swap64__t0) )
)

(declare-fun var169_return__t1 () (_ BitVec 64))
(assert
  (= var171_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var169_return__t1) )
)

(declare-fun var172_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 () Bool)
(assert
  (= var172_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var170_return_value_of___byteorder__swap64__t0) )
)

(assert
  (= var172_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var169_return__t1) )
)

(declare-fun var169_return__t0 () (_ BitVec 64))
(assert
  (= var169_return__t1  (ite true var170_return_value_of___byteorder__swap64__t0 var169_return__t0)  )
)
...
(declare-fun var173_x__t0 () (_ BitVec 64))
(declare-fun var175_safe_x_____safe_return___t0 () Bool)
(assert
  (= var175_safe_x_____safe_return___t0 (theory1_safe var173_x__t0) )
)

(declare-fun var174_return__t1 () (_ BitVec 64))
(assert
  (= var175_safe_x_____safe_return___t0 (theory1_safe var174_return__t1) )
)

(declare-fun var176_nullterm_x_____nullterm_return___t0 () Bool)
(assert
  (= var176_nullterm_x_____nullterm_return___t0 (theory2_nullterm var173_x__t0) )
)

(assert
  (= var176_nullterm_x_____nullterm_return___t0 (theory2_nullterm var174_return__t1) )
)

(declare-fun var174_return__t0 () (_ BitVec 64))
(assert
  (= var174_return__t1  (ite true var173_x__t0 var174_return__t0)  )
)
