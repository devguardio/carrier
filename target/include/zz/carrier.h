...
extern unsigned int hpack_decoder_decode_integer (hpack_decoder_Iterator*  const  self, err_Err*  const  e, uint8_t const  prefix_size);
...
static bool hpack_decoder_decode_literal (hpack_decoder_Iterator*  const  self, err_Err*  const  e, bool const  index);
...
#define hpack_decoder_DYNSIZE (    0x10)
...
bool hpack_decoder_next (hpack_decoder_Iterator*  const  self, err_Err*  const  e);
