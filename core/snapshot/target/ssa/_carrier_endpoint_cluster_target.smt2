...
(declare-fun var726_target__t0 () (_ BitVec 64))
(declare-fun var727_interpretation_of_theory_safe_over_target__t0 () Bool)
(assert
  (= var727_interpretation_of_theory_safe_over_target__t0 (theory1_safe var726_target__t0) )
)

(assert (! var727_interpretation_of_theory_safe_over_target__t0 :named A6))(check-sat)
...
(assert
  (= var730_safe_self___t0 (theory1_safe var725_self__t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/endpoint.zz:160
(declare-fun var732_addressof_deref_var725_self__cluster_target___t0 () (_ BitVec 64))
(declare-fun var733_len_addressof_deref_var725_self__cluster_target____t0 () (_ BitVec 64))
(assert
  (= var733_len_addressof_deref_var725_self__cluster_target____t0 (theory0_len var732_addressof_deref_var725_self__cluster_target___t0) )
)

(assert
  (= var733_len_addressof_deref_var725_self__cluster_target____t0 (_ bv1 64))

)

(assert
  (= var732_addressof_deref_var725_self__cluster_target___t0 (_ bv731 64))

)

(declare-fun var734_true__t0 () Bool)
(assert
  (= var734_true__t0 (theory1_safe var732_addressof_deref_var725_self__cluster_target___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/endpoint.zz:161
; : /home/runner/work/carrier/carrier/core/src/initiator.zz:32
(declare-fun var739_implicit_coercion_of___carrier__initiator__Move__Target__t0 () (_ BitVec 64))
(assert (! (= var739_implicit_coercion_of___carrier__initiator__Move__Target__t0 var233___carrier__initiator__Move__Target__t0) :named A8)); : /home/runner/work/carrier/carrier/core/src/endpoint.zz:161
(declare-fun var740_safe_implicit_coercion_of___carrier__initiator__Move__Target_____safe_deref_var725_self__cluster_move___t0 () Bool)
(assert
  (= var740_safe_implicit_coercion_of___carrier__initiator__Move__Target_____safe_deref_var725_self__cluster_move___t0 (theory1_safe var739_implicit_coercion_of___carrier__initiator__Move__Target__t0) )
)

(declare-fun var738_deref_var725_self__cluster_move__t1 () (_ BitVec 64))
(assert
  (= var740_safe_implicit_coercion_of___carrier__initiator__Move__Target_____safe_deref_var725_self__cluster_move___t0 (theory1_safe var738_deref_var725_self__cluster_move__t1) )
)

(declare-fun var741_nullterm_implicit_coercion_of___carrier__initiator__Move__Target_____nullterm_deref_var725_self__cluster_move___t0 () Bool)
(assert
  (= var741_nullterm_implicit_coercion_of___carrier__initiator__Move__Target_____nullterm_deref_var725_self__cluster_move___t0 (theory2_nullterm var739_implicit_coercion_of___carrier__initiator__Move__Target__t0) )
)

(assert
  (= var741_nullterm_implicit_coercion_of___carrier__initiator__Move__Target_____nullterm_deref_var725_self__cluster_move___t0 (theory2_nullterm var738_deref_var725_self__cluster_move__t1) )
)

(declare-fun var738_deref_var725_self__cluster_move__t0 () (_ BitVec 64))
(assert
  (= var738_deref_var725_self__cluster_move__t1  (ite true var739_implicit_coercion_of___carrier__initiator__Move__Target__t0 var738_deref_var725_self__cluster_move__t0)  )
)
