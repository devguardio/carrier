...
#include <stdint.h>
#include <string.h>
#include "zz/carrier/carrier_nodejs.h"
...
static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_nodejs", "carrier::nodejs", -1, methods};

PyObject*  py_mod_carrier_nodejs_Init()
{
