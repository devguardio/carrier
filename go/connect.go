...
func IConnectStart(ep *Endpoint, target *Target, network *Secret) (*IConnect, error) {
    self := &IConnect {
    ...
    if network == nil {
        ...
        C.carrier_connect_start_in_network(self.d, e.d, ep.d, (*C.carrier_identity_Target)(target), (*C.carrier_identity_Secret)(network));
    }
