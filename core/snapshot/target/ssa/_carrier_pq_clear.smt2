...
(assert (! (= var704_len_deref_S699_self____t0 var700_qt__t0) :named A11)); : /home/runner/work/carrier/carrier/core/src/pq.zz:76
; call of safe
...
; : /home/runner/work/carrier/carrier/core/src/pq.zz:77
(declare-fun var708_safe_literal_0_____safe_i___t0 () Bool)
(assert
  (= var708_safe_literal_0_____safe_i___t0 (theory1_safe var707_literal_0__t0) )
)

(declare-fun var706_i__t1 () (_ BitVec 64))
(assert
  (= var708_safe_literal_0_____safe_i___t0 (theory1_safe var706_i__t1) )
)

(declare-fun var709_nullterm_literal_0_____nullterm_i___t0 () Bool)
(assert
  (= var709_nullterm_literal_0_____nullterm_i___t0 (theory2_nullterm var707_literal_0__t0) )
)

(assert
  (= var709_nullterm_literal_0_____nullterm_i___t0 (theory2_nullterm var706_i__t1) )
)

; : /home/runner/work/carrier/carrier/core/src/pq.zz:77
(declare-fun var710_implicit_coercion_of_literal_0__t0 () (_ BitVec 64))
(assert (! (= var710_implicit_coercion_of_literal_0__t0 var707_literal_0__t0) :named A13))(declare-fun var706_i__t0 () (_ BitVec 64))
(assert
  (= var706_i__t1  (ite true var710_implicit_coercion_of_literal_0__t0 var706_i__t0)  )
)

; : /home/runner/work/carrier/carrier/core/src/pq.zz:77
; : /home/runner/work/carrier/carrier/core/src/pq.zz:77
; : /home/runner/work/carrier/carrier/core/src/pq.zz:77
(declare-fun var706_i__t2 () (_ BitVec 64))
(declare-fun var711_previous_value_of_i__t1 () (_ BitVec 64))
(assert
  (= var706_i__t2 (bvadd var711_previous_value_of_i__t1 (_ bv1 64)) )
)
...
(assert
  (=  var712_infix_expression__t0 (bvult var706_i__t2 var700_qt__t0))
)

(assert (! var712_infix_expression__t0 :named A14))(check-sat)
...
(assert
  (not (= var706_i__t2 #x0000000000000002))
)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/pq.zz:78
(declare-fun var713_len_deref_S699_self__q___t0 () (_ BitVec 64))
(assert
  (= var713_len_deref_S699_self__q___t0 (theory0_len var702_deref_S699_self__q__t0) )
)

(declare-fun var714_i___len_deref_S699_self__q___t0 () Bool)
(assert
  (=  var714_i___len_deref_S699_self__q___t0 (bvult var706_i__t2 var713_len_deref_S699_self__q___t0))
)
...
(assert
  (and true (or (not var714_i___len_deref_S699_self__q___t0 ) ))
...
(assert (! (= var719_implicit_coercion_of_literal_0__t0 var718_literal_0__t0) :named A15)); : /home/runner/work/carrier/carrier/core/src/pq.zz:78
(declare-fun var720_infix_expression__t0 () Bool)
(declare-fun var717_array_member_deref_S699_self__q_i__buf_mem__t0 () (_ BitVec 64))
(assert
  (=  var720_infix_expression__t0 (not (= var717_array_member_deref_S699_self__q_i__buf_mem__t0 var719_implicit_coercion_of_literal_0__t0)))
)
...
(assert (! (= var721_implicit_cast_of_i__t0 var706_i__t2) :named A16)); begin pointer arithmetic
(declare-fun var723_len_deref_S699_self__q___t0 () (_ BitVec 64))
(assert
  (= var723_len_deref_S699_self__q___t0 (theory0_len var702_deref_S699_self__q__t0) )
)

(declare-fun var724_implicit_cast_of_i___len_deref_S699_self__q___t0 () Bool)
(assert
  (=  var724_implicit_cast_of_i___len_deref_S699_self__q___t0 (bvult var721_implicit_cast_of_i__t0 var723_len_deref_S699_self__q___t0))
)
...
(assert
  (and true (or (not var724_implicit_cast_of_i___len_deref_S699_self__q___t0 ) ))
...
(assert
  (= var726_len_deref_S699_self__q___t0 (theory0_len var722_infix_expression__t0) )
)

(assert
  (=  var726_len_deref_S699_self__q___t0 (bvsub var723_len_deref_S699_self__q___t0 var721_implicit_cast_of_i__t0))
)
