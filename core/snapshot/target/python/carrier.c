...
static PyObject* py_carrier_hellozz(PyObject *pyself, PyObject *args) {
    long long int rarg = (long long int)(carrier_hellozz(
        ));
...
{"hellozz", py_carrier_hellozz, METH_NOARGS,""},
{NULL, NULL, 0, NULL}
};

static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier", "carrier", -1, methods};

PyObject*  py_mod_carrier_Init()
{
