...
(assert
  (= var707_interpretation_of_theory_safe_over_self__t0 (theory1_safe var705_self__t0) )
)

(assert (! var707_interpretation_of_theory_safe_over_self__t0 :named A5))(check-sat)
...
(assert
  (= var709_safe_self___t0 (theory1_safe var705_self__t0) )
)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/sync.zz:55
(declare-fun var710_deref_var705_self__ep__t0 () (_ BitVec 64))
(declare-fun var711_interpretation_of_theory_safe_over_deref_var705_self__ep__t0 () Bool)
(assert
  (= var711_interpretation_of_theory_safe_over_deref_var705_self__ep__t0 (theory1_safe var710_deref_var705_self__ep__t0) )
)

(assert (! var711_interpretation_of_theory_safe_over_deref_var705_self__ep__t0 :named A6))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/sync.zz:56
; begin safe ptr check
(declare-fun var714_safe_deref_var705_self__ep___t0 () Bool)
(assert
  (= var714_safe_deref_var705_self__ep___t0 (theory1_safe var710_deref_var705_self__ep__t0) )
)

(push 1)

(assert
  (and true (or (not var714_safe_deref_var705_self__ep___t0 ) ))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var716_interpretation_of_theory_safe_over_deref_var705_self__ep__t0 () Bool)
(assert
  (= var716_interpretation_of_theory_safe_over_deref_var705_self__ep__t0 (theory1_safe var710_deref_var705_self__ep__t0) )
)

(push 1)

(assert
  (and true (or (not var716_interpretation_of_theory_safe_over_deref_var705_self__ep__t0 ) ))
...
(declare-fun var713_deref_var710_deref_var705_self__ep___t1 () (_ BitVec 64))
(declare-fun var713_deref_var710_deref_var705_self__ep___t0 () (_ BitVec 64))
(assert
  (= var713_deref_var710_deref_var705_self__ep___t1  (ite true var713_deref_var710_deref_var705_self__ep___t1 var713_deref_var710_deref_var705_self__ep___t0)  )
)
