...
; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:56
(declare-fun var245_addressof_deref_var238_self__read_fds___t0 () (_ BitVec 64))
(declare-fun var246_len_addressof_deref_var238_self__read_fds____t0 () (_ BitVec 64))
(assert
  (= var246_len_addressof_deref_var238_self__read_fds____t0 (theory0_len var245_addressof_deref_var238_self__read_fds___t0) )
)

(assert
  (= var246_len_addressof_deref_var238_self__read_fds____t0 (_ bv1 64))

)

(assert
  (= var245_addressof_deref_var238_self__read_fds___t0 (_ bv244 64))

)

(declare-fun var247_true__t0 () Bool)
(assert
  (= var247_true__t0 (theory1_safe var245_addressof_deref_var238_self__read_fds___t0) )
)
