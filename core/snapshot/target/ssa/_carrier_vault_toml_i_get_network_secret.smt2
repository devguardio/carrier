...
(declare-fun var321_secret__t0 () (_ BitVec 64))
(declare-fun var322_interpretation_of_theory_safe_over_secret__t0 () Bool)
(assert
  (= var322_interpretation_of_theory_safe_over_secret__t0 (theory1_safe var321_secret__t0) )
)

(assert (! var322_interpretation_of_theory_safe_over_secret__t0 :named A2))(check-sat)
...
(assert (! (= var328_cast_of_deref_var320_self__user__t0 var327_deref_var320_self__user__t0) :named A4)); : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:470
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:473
(declare-fun var336_addressof_deref_var324_this__network_secret___t0 () (_ BitVec 64))
(declare-fun var337_len_addressof_deref_var324_this__network_secret____t0 () (_ BitVec 64))
(assert
  (= var337_len_addressof_deref_var324_this__network_secret____t0 (theory0_len var336_addressof_deref_var324_this__network_secret___t0) )
)

(assert
  (= var337_len_addressof_deref_var324_this__network_secret____t0 (_ bv1 64))

)

(assert
  (= var336_addressof_deref_var324_this__network_secret___t0 (_ bv335 64))

)

(declare-fun var338_true__t0 () Bool)
(assert
  (= var338_true__t0 (theory1_safe var336_addressof_deref_var324_this__network_secret___t0) )
)
