...
#include <stddef.h>
const __attribute__ ((unused)) size_t toml_ParseError = 1;
...
const __attribute__ ((unused)) size_t io_NotImplemented = 6;
const __attribute__ ((unused)) size_t err_SystemError = 7;
const __attribute__ ((unused)) size_t carrier_endpoint_InvalidBootstrap = 8;
const __attribute__ ((unused)) size_t carrier_router_OutOfOptions = 9;
const __attribute__ ((unused)) size_t json_ParseError = 10;
...
const __attribute__ ((unused)) size_t protonerf_Invalid = 14;
