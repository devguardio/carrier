...
(assert (! (= var340_cast_of_deref_var332_self__user__t0 var339_deref_var332_self__user__t0) :named A4)); : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:438
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:441
(declare-fun var348_unary_expression__t0 () Bool)
(declare-fun var347_deref_var336_this__has_principal__t0 () Bool)
(assert
  (= var348_unary_expression__t0 (not var347_deref_var336_this__has_principal__t0 ))
)
...
(assert
  (not (= var348_unary_expression__t0 true))
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var349_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var349_interpretation_of_theory_safe_over_id__t0 (theory1_safe var333_id__t0) )
)
...
(assert
  (and var348_unary_expression__t0 (or (not var349_interpretation_of_theory_safe_over_id__t0 ) (not var350_interpretation_of_theory_safe_over_self__t0 ) ))
...
; (not var348_unary_expression__t0)
(assert
  (not var348_unary_expression__t0)
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:445
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:445
(declare-fun var353_addressof_deref_var336_this__principal___t0 () (_ BitVec 64))
(declare-fun var354_len_addressof_deref_var336_this__principal____t0 () (_ BitVec 64))
(assert
  (= var354_len_addressof_deref_var336_this__principal____t0 (theory0_len var353_addressof_deref_var336_this__principal___t0) )
)

(assert
  (= var354_len_addressof_deref_var336_this__principal____t0 (_ bv1 64))

)

(assert
  (= var353_addressof_deref_var336_this__principal___t0 (_ bv352 64))

)

(declare-fun var355_true__t0 () Bool)
(assert
  (= var355_true__t0 (theory1_safe var353_addressof_deref_var336_this__principal___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:445
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:445
(declare-fun var356_addressof_deref_var336_this__principal___t0 () (_ BitVec 64))
(declare-fun var357_len_addressof_deref_var336_this__principal____t0 () (_ BitVec 64))
(assert
  (= var357_len_addressof_deref_var336_this__principal____t0 (theory0_len var356_addressof_deref_var336_this__principal___t0) )
)

(assert
  (= var357_len_addressof_deref_var336_this__principal____t0 (_ bv1 64))

)

(assert
  (= var356_addressof_deref_var336_this__principal___t0 (_ bv352 64))

)

(declare-fun var358_true__t0 () Bool)
(assert
  (= var358_true__t0 (theory1_safe var356_addressof_deref_var336_this__principal___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var359_interpretation_of_theory_safe_over_addressof_deref_var336_this__principal___t0 () Bool)
(assert
  (= var359_interpretation_of_theory_safe_over_addressof_deref_var336_this__principal___t0 (theory1_safe var356_addressof_deref_var336_this__principal___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var360_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var360_interpretation_of_theory_safe_over_id__t0 (theory1_safe var333_id__t0) )
)

(push 1)

(assert
  (and true (or (not var359_interpretation_of_theory_safe_over_addressof_deref_var336_this__principal___t0 ) (not var360_interpretation_of_theory_safe_over_id__t0 ) ))
