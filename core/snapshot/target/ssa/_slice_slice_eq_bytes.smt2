...
; literal expr
(declare-fun var42_literal_Unsigned_0___t0 () Bool)
(assert
  (not var42_literal_Unsigned_0___t0)
)

(declare-fun var40_return__t1 () Bool)
(declare-fun var40_return__t0 () Bool)
(assert
  (= var40_return__t1  (ite var41_infix_expression__t0 var42_literal_Unsigned_0___t0 var40_return__t0)  )
)
...
(declare-fun var46_implicit_coercion_of_literal_Unsigned_0___t0 () (_ BitVec 64))
(assert (! (= var46_implicit_coercion_of_literal_Unsigned_0___t0 var45_literal_Unsigned_0___t0) :named A4)); : /home/runner/work/carrier/carrier/modules/slice/src/slice.zz:40
(declare-fun var47_infix_expression__t0 () Bool)
(declare-fun var44_return_value_of___ext___string_h___memcmp__t0 () (_ BitVec 64))
(assert
  (=  var47_infix_expression__t0 (= var44_return_value_of___ext___string_h___memcmp__t0 var46_implicit_coercion_of_literal_Unsigned_0___t0))
)
