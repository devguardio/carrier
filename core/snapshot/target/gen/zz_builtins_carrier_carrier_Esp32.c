...
const __attribute__ ((unused)) size_t protonerf_Invalid = 5;
const __attribute__ ((unused)) size_t carrier_cmd_common_OpenResponse = 6;
const __attribute__ ((unused)) size_t carrier_endpoint_InvalidBootstrap = 7;
const __attribute__ ((unused)) size_t carrier_identity_Invalid = 8;
