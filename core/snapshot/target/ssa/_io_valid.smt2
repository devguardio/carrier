...
(assert
  (= var178_safe_self___t0 (theory1_safe var174_self__t0) )
)
...
(declare-fun var176_return__t1 () Bool)
(declare-fun var179_deref_var174_self__isvalid__t0 () Bool)
(declare-fun var176_return__t0 () Bool)
(assert
  (= var176_return__t1  (ite true var179_deref_var174_self__isvalid__t0 var176_return__t0)  )
)
