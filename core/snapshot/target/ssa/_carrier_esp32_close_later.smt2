...
(declare-fun var812_safe_ep___t0 () Bool)
(assert
  (= var812_safe_ep___t0 (theory1_safe var806_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var812_safe_ep___t0 ) ))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var814_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var814_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var806_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var814_interpretation_of_theory_safe_over_ep__t0 ) ))
...
(declare-fun var811_deref_var806_ep___t1 () (_ BitVec 64))
(declare-fun var811_deref_var806_ep___t0 () (_ BitVec 64))
(assert
  (= var811_deref_var806_ep___t1  (ite true var811_deref_var806_ep___t1 var811_deref_var806_ep___t0)  )
)
