...
extern {
    ...
    #[link_name = "carrier_config_return_ok"]
    pub fn r#return_ok( Zself: *mut u8,  Ze: *mut u8,  Zet: usize)  -> bool;

    #[link_name = "carrier_config_auth_get"]
    pub fn r#auth_get( Zself: *mut u8,  Ze: *mut u8,  Ze2: usize,  Zheaders: super::slice_slice::Slice);
    ...
    pub fn r#auth_add_stream( Zself: *mut u8,  Ze: *mut u8,  Zex: usize,  Zmsg: super::slice_slice::Slice)  -> bool;
