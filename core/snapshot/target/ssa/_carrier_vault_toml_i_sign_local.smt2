...
(assert (! (= var344_cast_of_deref_var333_self__user__t0 var343_deref_var333_self__user__t0) :named A5)); : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:436
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:437
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:439
(declare-fun var352_addressof_deref_var340_this__secret___t0 () (_ BitVec 64))
(declare-fun var353_len_addressof_deref_var340_this__secret____t0 () (_ BitVec 64))
(assert
  (= var353_len_addressof_deref_var340_this__secret____t0 (theory0_len var352_addressof_deref_var340_this__secret___t0) )
)

(assert
  (= var353_len_addressof_deref_var340_this__secret____t0 (_ bv1 64))

)

(assert
  (= var352_addressof_deref_var340_this__secret___t0 (_ bv351 64))

)

(declare-fun var354_true__t0 () Bool)
(assert
  (= var354_true__t0 (theory1_safe var352_addressof_deref_var340_this__secret___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:439
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:439
(declare-fun var355_addressof_deref_var340_this__secret___t0 () (_ BitVec 64))
(declare-fun var356_len_addressof_deref_var340_this__secret____t0 () (_ BitVec 64))
(assert
  (= var356_len_addressof_deref_var340_this__secret____t0 (theory0_len var355_addressof_deref_var340_this__secret___t0) )
)

(assert
  (= var356_len_addressof_deref_var340_this__secret____t0 (_ bv1 64))

)

(assert
  (= var355_addressof_deref_var340_this__secret___t0 (_ bv351 64))

)

(declare-fun var357_true__t0 () Bool)
(assert
  (= var357_true__t0 (theory1_safe var355_addressof_deref_var340_this__secret___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var358_interpretation_of_theory_safe_over_subject__t0 () Bool)
(assert
  (= var358_interpretation_of_theory_safe_over_subject__t0 (theory1_safe var335_subject__t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var359_interpretation_of_theory_safe_over_s__t0 () Bool)
(assert
  (= var359_interpretation_of_theory_safe_over_s__t0 (theory1_safe var334_s__t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var360_interpretation_of_theory_safe_over_addressof_deref_var340_this__secret___t0 () Bool)
(assert
  (= var360_interpretation_of_theory_safe_over_addressof_deref_var340_this__secret___t0 (theory1_safe var355_addressof_deref_var340_this__secret___t0) )
)

(push 1)

(assert
  (and true (or (not var358_interpretation_of_theory_safe_over_subject__t0 ) (not var359_interpretation_of_theory_safe_over_s__t0 ) (not var360_interpretation_of_theory_safe_over_addressof_deref_var340_this__secret___t0 ) ))
