...
; : /home/runner/work/carrier/carrier/core/src/esp32.zz:87
; literal expr
(declare-fun var925_literal_Unsigned_3___t0 () (_ BitVec 64))
(assert
  (= var925_literal_Unsigned_3___t0 (_ bv3 64))
...
(declare-fun var928_safe_ep___t0 () Bool)
(assert
  (= var928_safe_ep___t0 (theory1_safe var922_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var928_safe_ep___t0 ) ))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var930_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var930_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var922_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var930_interpretation_of_theory_safe_over_ep__t0 ) ))
...
(declare-fun var927_deref_var922_ep___t1 () (_ BitVec 64))
(declare-fun var927_deref_var922_ep___t0 () (_ BitVec 64))
(assert
  (= var927_deref_var922_ep___t1  (ite true var927_deref_var922_ep___t1 var927_deref_var922_ep___t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/src/esp32.zz:89
; literal expr
(declare-fun var933_literal_Unsigned_2___t0 () (_ BitVec 64))
(assert
  (= var933_literal_Unsigned_2___t0 (_ bv2 64))
