...
#line 28 "/Users/simon/Sites/carrier/src/responder.zz"
  uintptr_t const  size_before_any  =     frame ->at;

#line 30 "/Users/simon/Sites/carrier/src/responder.zz"
    slice_mut_slice_push(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    0x08    );

#line 31 "/Users/simon/Sites/carrier/src/responder.zz"
    slice_mut_slice_push(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    0x00    );

#line 32 "/Users/simon/Sites/carrier/src/responder.zz"
    slice_mut_slice_push(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    0x00    );

#line 33 "/Users/simon/Sites/carrier/src/responder.zz"
    slice_mut_slice_push(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    0x00    );
{

#line 36 "/Users/simon/Sites/carrier/src/responder.zz"
( *(    (uint8_t* )(( &    route)) +    7  )) |=     0b00000001;

}


#line 38 "/Users/simon/Sites/carrier/src/responder.zz"
    slice_mut_slice_push64(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    route    );

#line 39 "/Users/simon/Sites/carrier/src/responder.zz"
    slice_mut_slice_push64(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    byteorder_to_be64(    0    )    );

#line 42 "/Users/simon/Sites/carrier/src/responder.zz"
  carrier_identity_Address ephemeral_address  = {    0,};

#line 43 "/Users/simon/Sites/carrier/src/responder.zz"
    carrier_identity_address_from_secret(( &    ephemeral_address),( &    self ->ephemeral)    );

#line 44 "/Users/simon/Sites/carrier/src/responder.zz"
    carrier_symmetric_mix_hash(( &    self ->symm),    ephemeral_address .k,    32    );

#line 45 "/Users/simon/Sites/carrier/src/responder.zz"
    slice_mut_slice_append_bytes(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    ephemeral_address .k,    32    );

#line 48 "/Users/simon/Sites/carrier/src/responder.zz"
  carrier_identity_Address dh  = {    0,};

#line 49 "/Users/simon/Sites/carrier/src/responder.zz"
    carrier_identity_dh(( &    dh),( &    self ->ephemeral),( &    self ->remote_ephemeral)    );

#line 50 "/Users/simon/Sites/carrier/src/responder.zz"
    carrier_symmetric_mix_key(( &    self ->symm),    dh .k,    32    );

#line 53 "/Users/simon/Sites/carrier/src/responder.zz"
;

#line 54 "/Users/simon/Sites/carrier/src/responder.zz"
  uintptr_t const  before_encrypt_len  =     frame ->at;

#line 55 "/Users/simon/Sites/carrier/src/responder.zz"
  uint8_t*  const  before_encrypt_mem  = (    slice_mut_slice_mem(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    ))    ) +    frame ->at  );

#line 58 "/Users/simon/Sites/carrier/src/responder.zz"
  carrier_identity_Identity eid  = {    0,};

#line 59 "/Users/simon/Sites/carrier/src/responder.zz"
    carrier_vault_get_identity(    store,( &    eid)    );

#line 60 "/Users/simon/Sites/carrier/src/responder.zz"
    slice_mut_slice_append_bytes(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    eid .k,    32    );

#line 63 "/Users/simon/Sites/carrier/src/responder.zz"
    slice_mut_slice_push64(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    byteorder_to_be64(    timestamp    )    );

#line 66 "/Users/simon/Sites/carrier/src/responder.zz"
    slice_mut_slice_push32(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    byteorder_to_be32(    carrier_REVISION    )    );

#line 69 "/Users/simon/Sites/carrier/src/responder.zz"
    frame ->at +=     16;

#line 73 "/Users/simon/Sites/carrier/src/responder.zz"
    frame ->at +=     76;

#line 75 "/Users/simon/Sites/carrier/src/responder.zz"
;

#line 76 "/Users/simon/Sites/carrier/src/responder.zz"
;

#line 77 "/Users/simon/Sites/carrier/src/responder.zz"
;

#line 79 "/Users/simon/Sites/carrier/src/responder.zz"
    printf(    "<> pre encrypt %zu\n",    frame ->at    );

#line 80 "/Users/simon/Sites/carrier/src/responder.zz"
    hex_dump_slice(    (slice_slice_Slice const * )(    slice_slice_borrow(( &    frame ->slice)    ))    );

#line 82 "/Users/simon/Sites/carrier/src/responder.zz"
  uintptr_t const  rs  =     carrier_symmetric_encrypt_and_mix_hash(( &    self ->symm),    (err_Err* )(    e),
#line 19 "/Users/simon/Sites/carrier/src/responder.zz"
    et,
#line 83 "/Users/simon/Sites/carrier/src/responder.zz"
    before_encrypt_mem,((    frame ->at -    before_encrypt_len  ) -    16  ),
#line 84 "/Users/simon/Sites/carrier/src/responder.zz"
    0,
#line 85 "/Users/simon/Sites/carrier/src/responder.zz"
    before_encrypt_mem,(    frame ->at -    before_encrypt_len  )    );

#line 90 "/Users/simon/Sites/carrier/src/responder.zz"
  uint8_t signme  [     56 ]  = {    0,};

#line 91 "/Users/simon/Sites/carrier/src/responder.zz"
    mem_copy(    carrier_endpoint_SIGN_PURPOSE,    signme,    string_strlen(    carrier_endpoint_SIGN_PURPOSE    )    );

#line 92 "/Users/simon/Sites/carrier/src/responder.zz"
  uint8_t*  const  m  = (    signme +    string_strlen(    carrier_endpoint_SIGN_PURPOSE    )  );

#line 93 "/Users/simon/Sites/carrier/src/responder.zz"
    mem_copy(    self ->symm .h,    m,    32    );

#line 95 "/Users/simon/Sites/carrier/src/responder.zz"
  carrier_identity_Signature sig  = {    0,};

#line 96 "/Users/simon/Sites/carrier/src/responder.zz"
    carrier_vault_sign(    store,( &    sig),    signme,    56    );

#line 97 "/Users/simon/Sites/carrier/src/responder.zz"
    printf(    "<> %zu %zu\n",    frame ->at,    size_before_any    );

#line 98 "/Users/simon/Sites/carrier/src/responder.zz"
;

#line 100 "/Users/simon/Sites/carrier/src/responder.zz"
    hex_dump_slice(    (slice_slice_Slice const * )(    slice_slice_borrow(( &    frame ->slice)    ))    );

#line 101 "/Users/simon/Sites/carrier/src/responder.zz"
    assert(    slice_mut_slice_append_bytes(    (slice_mut_slice_MutSlice* )(    slice_mut_slice_borrow(    frame    )),    sig .k,    64    )    );

#line 102 "/Users/simon/Sites/carrier/src/responder.zz"
    hex_dump_slice(    (slice_slice_Slice const * )(    slice_slice_borrow(( &    frame ->slice)    ))    );

#line 104 "/Users/simon/Sites/carrier/src/responder.zz"
