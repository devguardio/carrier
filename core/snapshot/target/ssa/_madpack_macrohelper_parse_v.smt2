...
(assert (! (= var296_implicit_coercion_of___json__ValueType__Array__t0 var43___json__ValueType__Array__t0) :named A11)); : /home/runner/work/carrier/carrier/core/modules/madpack/src/macrohelper.zz:41
...
(assert
  (= var299_addressof___madpack__macrohelper__stringbuf___t0 (_ bv190 64))
...
(assert
  (= var302_addressof___madpack__macrohelper__stringbuf___t0 (_ bv190 64))
...
(assert
  (= var305_addressof___madpack__macrohelper__stringbuf___t0 (_ bv190 64))
...
(assert
  (= var190___madpack__macrohelper__stringbuf__t1  (ite ( and var294_return_value_of___buffer__cstr_eq__t0 var297_switch_branch__v_t__implicit_coercion_of___json__ValueType__Array___t0 ) var190___madpack__macrohelper__stringbuf__t1 var190___madpack__macrohelper__stringbuf__t0)  )
)
...
(assert
  (= var364_interpretation_of_theory___err__checked_over_deref_S260_e___t0 (theory17___err__checked var262_deref_S260_e___t0) )
)
...
(assert
  (= var380_interpretation_of_theory___err__checked_over_deref_S260_e___t0 (theory17___err__checked var262_deref_S260_e___t2) )
)
