...
(assert
  (=  var226_infix_expression__t0 (bvult var220_i__t2 var74___carrier__vault__MAX_BROKERS__t1))
)
...
(get-value (
  ...
  var74___carrier__vault__MAX_BROKERS__t1
...
(assert
  (not (= var74___carrier__vault__MAX_BROKERS__t1 #x0000000000000010))
)
