...
(assert
  (= var868_interpretation_of_theory___err__checked_over_e__t0 (theory31___err__checked var843_e__t2) )
)
...
(assert
  (= var921_interpretation_of_theory___err__checked_over_e__t0 (theory31___err__checked var843_e__t2) )
)
...
(assert
  (= var947_interpretation_of_theory___err__checked_over_e__t0 (theory31___err__checked var843_e__t4) )
)
...
(assert
  (= var991_interpretation_of_theory___err__checked_over_e__t0 (theory31___err__checked var843_e__t4) )
)
...
(assert
  (= var1017_interpretation_of_theory___err__checked_over_e__t0 (theory31___err__checked var843_e__t6) )
)
...
(assert
  (=  var1026_infix_expression__t0 (bvult var1020_i__t2 var266___carrier__vault__MAX_BROKERS__t1))
)
...
(assert
  (not (= var1020_i__t2 #x0000000000000002))
)
...
(assert
  (not (= var1020_i__t2 #x0000000000000008))
)
