...
(assert (! (= var704_len_deref_S699_self____t0 var700_qt__t0) :named A11)); : /home/runner/work/carrier/carrier/core/src/pq.zz:409
; : /home/runner/work/carrier/carrier/core/src/pq.zz:409
; call of safe
...
(declare-fun var712_safe_deref_var705_i______safe_v___t0 () Bool)
(assert
  (= var712_safe_deref_var705_i______safe_v___t0 (theory1_safe var710_deref_var705_i___t0) )
)

(declare-fun var709_v__t1 () (_ BitVec 64))
(assert
  (= var712_safe_deref_var705_i______safe_v___t0 (theory1_safe var709_v__t1) )
)

(declare-fun var713_nullterm_deref_var705_i______nullterm_v___t0 () Bool)
(assert
  (= var713_nullterm_deref_var705_i______nullterm_v___t0 (theory2_nullterm var710_deref_var705_i___t0) )
)

(assert
  (= var713_nullterm_deref_var705_i______nullterm_v___t0 (theory2_nullterm var709_v__t1) )
)

(declare-fun var709_v__t0 () (_ BitVec 64))
(assert
  (= var709_v__t1  (ite true var710_deref_var705_i___t0 var709_v__t0)  )
)
...
(assert (! (= var715_implicit_coercion_of_literal_0__t0 var714_literal_0__t0) :named A14)); : /home/runner/work/carrier/carrier/core/src/pq.zz:412
(declare-fun var716_infix_expression__t0 () Bool)
(assert
  (=  var716_infix_expression__t0 (= var710_deref_var705_i___t0 var715_implicit_coercion_of_literal_0__t0))
)
...
(assert
  (not (= var716_infix_expression__t0 false))
)
...
; : /home/runner/work/carrier/carrier/core/src/pq.zz:413
; : /home/runner/work/carrier/carrier/core/src/pq.zz:413
(declare-fun var717_safe_qt_____safe_deref_var705_i____t0 () Bool)
(assert
  (= var717_safe_qt_____safe_deref_var705_i____t0 (theory1_safe var700_qt__t0) )
)

(declare-fun var710_deref_var705_i___t1 () (_ BitVec 64))
(assert
  (= var717_safe_qt_____safe_deref_var705_i____t0 (theory1_safe var710_deref_var705_i___t1) )
)

(declare-fun var718_nullterm_qt_____nullterm_deref_var705_i____t0 () Bool)
(assert
  (= var718_nullterm_qt_____nullterm_deref_var705_i____t0 (theory2_nullterm var700_qt__t0) )
)

(assert
  (= var718_nullterm_qt_____nullterm_deref_var705_i____t0 (theory2_nullterm var710_deref_var705_i___t1) )
)

(assert
  (= var710_deref_var705_i___t1  (ite var716_infix_expression__t0 var700_qt__t0 var710_deref_var705_i___t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/src/pq.zz:415
; : /home/runner/work/carrier/carrier/core/src/pq.zz:415
(declare-fun var720_safe_deref_var705_i______safe_previous_value_of_deref_var705_i____t0 () Bool)
(assert
  (= var720_safe_deref_var705_i______safe_previous_value_of_deref_var705_i____t0 (theory1_safe var710_deref_var705_i___t1) )
)

(declare-fun var719_previous_value_of_deref_var705_i___t1 () (_ BitVec 64))
(assert
  (= var720_safe_deref_var705_i______safe_previous_value_of_deref_var705_i____t0 (theory1_safe var719_previous_value_of_deref_var705_i___t1) )
)

(declare-fun var721_nullterm_deref_var705_i______nullterm_previous_value_of_deref_var705_i____t0 () Bool)
(assert
  (= var721_nullterm_deref_var705_i______nullterm_previous_value_of_deref_var705_i____t0 (theory2_nullterm var710_deref_var705_i___t1) )
)

(assert
  (= var721_nullterm_deref_var705_i______nullterm_previous_value_of_deref_var705_i____t0 (theory2_nullterm var719_previous_value_of_deref_var705_i___t1) )
)

(declare-fun var719_previous_value_of_deref_var705_i___t0 () (_ BitVec 64))
(assert
  (= var719_previous_value_of_deref_var705_i___t1  (ite true var710_deref_var705_i___t1 var719_previous_value_of_deref_var705_i___t0)  )
)

(declare-fun var710_deref_var705_i___t2 () (_ BitVec 64))
(assert
  (= var710_deref_var705_i___t2 (bvsub var719_previous_value_of_deref_var705_i___t1 (_ bv1 64)) )
)
