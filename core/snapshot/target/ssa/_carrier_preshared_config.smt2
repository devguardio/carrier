...
(assert
  (= var278_safe___carrier__preshared__CONFIG_____safe_r___t0 (theory1_safe var35___carrier__preshared__CONFIG__t1) )
)
...
(assert
  (= var279_nullterm___carrier__preshared__CONFIG_____nullterm_r___t0 (theory2_nullterm var35___carrier__preshared__CONFIG__t1) )
)
...
(assert
  (= var277_r__t1  (ite true var35___carrier__preshared__CONFIG__t1 var277_r__t0)  )
)
...
(assert
  (= var286_interpretation_of_theory_safe_over_cast_of_literal_string____auth__identity__path__address__error__ok__code__trace___t0 (theory1_safe var40_cast_of_literal_string____auth__identity__path__address__error__ok__code__trace___t0) )
)
...
(assert
  (=  var288_infix_expression__t0 (bvuge var287_literal_Unsigned_56___t0 var41_literal_Unsigned_55___t0))
)
...
(assert
  (= var299_interpretation_of_theory_safe_over_cast_of_literal_string____auth__identity__path__address__error__ok__code__trace___t0 (theory1_safe var40_cast_of_literal_string____auth__identity__path__address__error__ok__code__trace___t0) )
)
...
(assert
  (=  var301_infix_expression__t0 (bvuge var300_literal_Unsigned_56___t0 var41_literal_Unsigned_55___t0))
)
...
(assert
  (= var309_interpretation_of_theory_safe_over_cast_of_literal_string____auth__identity__path__address__error__ok__code__trace___t0 (theory1_safe var40_cast_of_literal_string____auth__identity__path__address__error__ok__code__trace___t0) )
)
...
(assert
  (=  var311_infix_expression__t0 (bvuge var310_literal_Unsigned_56___t0 var41_literal_Unsigned_55___t0))
)
