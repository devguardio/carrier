...
(assert
  (= var230_interpretation_of_theory_safe_over_async__t0 (theory1_safe var229_async__t0) )
)

(assert (! var230_interpretation_of_theory_safe_over_async__t0 :named A0))(check-sat)
...
(assert
  (= var233_safe_async___t0 (theory1_safe var229_async__t0) )
)
...
; : /home/runner/work/carrier/carrier/core/modules/io/src/unix.zz:217
(declare-fun var235_cast_of_deref_var229_async__upper__t0 () (_ BitVec 64))
(declare-fun var234_deref_var229_async__upper__t0 () (_ BitVec 64))
(assert (! (= var235_cast_of_deref_var229_async__upper__t0 var234_deref_var229_async__upper__t0) :named A1)); : /home/runner/work/carrier/carrier/core/modules/io/src/unix.zz:217
(declare-fun var236_safe_cast_of_deref_var229_async__upper_____safe_self___t0 () Bool)
(assert
  (= var236_safe_cast_of_deref_var229_async__upper_____safe_self___t0 (theory1_safe var235_cast_of_deref_var229_async__upper__t0) )
)

(declare-fun var231_self__t1 () (_ BitVec 64))
(assert
  (= var236_safe_cast_of_deref_var229_async__upper_____safe_self___t0 (theory1_safe var231_self__t1) )
)

(declare-fun var237_nullterm_cast_of_deref_var229_async__upper_____nullterm_self___t0 () Bool)
(assert
  (= var237_nullterm_cast_of_deref_var229_async__upper_____nullterm_self___t0 (theory2_nullterm var235_cast_of_deref_var229_async__upper__t0) )
)

(assert
  (= var237_nullterm_cast_of_deref_var229_async__upper_____nullterm_self___t0 (theory2_nullterm var231_self__t1) )
)

(declare-fun var231_self__t0 () (_ BitVec 64))
(assert
  (= var231_self__t1  (ite true var235_cast_of_deref_var229_async__upper__t0 var231_self__t0)  )
)
...
(assert (! var238_interpretation_of_theory_safe_over_self__t0 :named A2))(check-sat)
...
(assert
  (= var241_safe_self___t0 (theory1_safe var231_self__t1) )
)
...
(assert (! (= var244_implicit_coercion_of_literal_0__t0 var243_literal_0__t0) :named A3))(declare-fun var242_deref_var231_self__timeout__t1 () (_ BitVec 64))
(declare-fun var242_deref_var231_self__timeout__t0 () (_ BitVec 64))
(assert
  (= var242_deref_var231_self__timeout__t1  (ite true var244_implicit_coercion_of_literal_0__t0 var242_deref_var231_self__timeout__t0)  )
)
