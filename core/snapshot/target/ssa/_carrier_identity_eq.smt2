...
(declare-fun var278_other__t0 () (_ BitVec 64))
(declare-fun var279_interpretation_of_theory_safe_over_other__t0 () Bool)
(assert
  (= var279_interpretation_of_theory_safe_over_other__t0 (theory1_safe var278_other__t0) )
)

(assert (! var279_interpretation_of_theory_safe_over_other__t0 :named A0))(check-sat)
...
(assert
  (= var280_interpretation_of_theory_safe_over_self__t0 (theory1_safe var277_self__t0) )
)

(assert (! var280_interpretation_of_theory_safe_over_self__t0 :named A1))(check-sat)
...
(declare-fun var284_implicit_coercion_of_literal_0__t0 () (_ BitVec 8))
(assert (! (= var284_implicit_coercion_of_literal_0__t0 ( (_ extract 7 0) var283_literal_0__t0 )) :named A2))(declare-fun var282_diff__t1 () (_ BitVec 8))
(declare-fun var282_diff__t0 () (_ BitVec 8))
(assert
  (= var282_diff__t1  (ite true var284_implicit_coercion_of_literal_0__t0 var282_diff__t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/src/identity.zz:502
(declare-fun var287_safe_literal_0_____safe_i___t0 () Bool)
(assert
  (= var287_safe_literal_0_____safe_i___t0 (theory1_safe var286_literal_0__t0) )
)

(declare-fun var285_i__t1 () (_ BitVec 64))
(assert
  (= var287_safe_literal_0_____safe_i___t0 (theory1_safe var285_i__t1) )
)

(declare-fun var288_nullterm_literal_0_____nullterm_i___t0 () Bool)
(assert
  (= var288_nullterm_literal_0_____nullterm_i___t0 (theory2_nullterm var286_literal_0__t0) )
)

(assert
  (= var288_nullterm_literal_0_____nullterm_i___t0 (theory2_nullterm var285_i__t1) )
)

; : /home/runner/work/carrier/carrier/core/src/identity.zz:502
(declare-fun var289_implicit_coercion_of_literal_0__t0 () (_ BitVec 64))
(assert (! (= var289_implicit_coercion_of_literal_0__t0 var286_literal_0__t0) :named A3))(declare-fun var285_i__t0 () (_ BitVec 64))
(assert
  (= var285_i__t1  (ite true var289_implicit_coercion_of_literal_0__t0 var285_i__t0)  )
)
...
(declare-fun var290_previous_value_of_i__t1 () (_ BitVec 64))
(assert
  (= var285_i__t2 (bvadd var290_previous_value_of_i__t1 (_ bv1 64)) )
)
...
(assert
  (= var292_safe_self___t0 (theory1_safe var277_self__t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/identity.zz:28
; literal expr
(declare-fun var293_literal_32__t0 () (_ BitVec 64))
(assert
  (= var293_literal_32__t0 (_ bv32 64))
...
(assert
  (not (= var293_literal_32__t0 #x0000000000000020))
)
...
; : /home/runner/work/carrier/carrier/core/src/identity.zz:502
(declare-fun var294_deref_var277_self__k__t0 () (_ BitVec 64))
(declare-fun var295_len_deref_var277_self__k___t0 () (_ BitVec 64))
(assert
  (= var295_len_deref_var277_self__k___t0 (theory0_len var294_deref_var277_self__k__t0) )
)

(assert
  (= var295_len_deref_var277_self__k___t0 (_ bv32 64))

)

(declare-fun var296_true__t0 () Bool)
(assert
  (= var296_true__t0 (theory1_safe var294_deref_var277_self__k__t0) )
)
...
(assert
  (not (= var297_literal_32__t0 #x0000000000000020))
)
...
(assert (! (= var299_implicit_coercion_of_literal_32__t0 var298_literal_32__t0) :named A4)); : /home/runner/work/carrier/carrier/core/src/identity.zz:502
(declare-fun var300_infix_expression__t0 () Bool)
(assert
  (=  var300_infix_expression__t0 (bvult var285_i__t2 var299_implicit_coercion_of_literal_32__t0))
)
...
(assert
  (not (= var285_i__t2 #x0000000000000001))
)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/identity.zz:503
(declare-fun var301_len_deref_var277_self__k___t0 () (_ BitVec 64))
(assert
  (= var301_len_deref_var277_self__k___t0 (theory0_len var294_deref_var277_self__k__t0) )
)

(declare-fun var302_i___len_deref_var277_self__k___t0 () Bool)
(assert
  (=  var302_i___len_deref_var277_self__k___t0 (bvult var285_i__t2 var301_len_deref_var277_self__k___t0))
)
...
(assert
  (and true (or (not var302_i___len_deref_var277_self__k___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/identity.zz:503
; begin safe ptr check
(declare-fun var305_safe_other___t0 () Bool)
(assert
  (= var305_safe_other___t0 (theory1_safe var278_other__t0) )
)

(push 1)

(assert
  (and true (or (not var305_safe_other___t0 ) ))
...
(assert
  (not (= var306_literal_32__t0 #x0000000000000020))
)
...
; : /home/runner/work/carrier/carrier/core/src/identity.zz:503
(declare-fun var307_deref_var278_other__k__t0 () (_ BitVec 64))
(declare-fun var308_len_deref_var278_other__k___t0 () (_ BitVec 64))
(assert
  (= var308_len_deref_var278_other__k___t0 (theory0_len var307_deref_var278_other__k__t0) )
)

(assert
  (= var308_len_deref_var278_other__k___t0 (_ bv32 64))

)

(declare-fun var309_true__t0 () Bool)
(assert
  (= var309_true__t0 (theory1_safe var307_deref_var278_other__k__t0) )
)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/identity.zz:503
(declare-fun var310_len_deref_var278_other__k___t0 () (_ BitVec 64))
(assert
  (= var310_len_deref_var278_other__k___t0 (theory0_len var307_deref_var278_other__k__t0) )
)

(declare-fun var311_i___len_deref_var278_other__k___t0 () Bool)
(assert
  (=  var311_i___len_deref_var278_other__k___t0 (bvult var285_i__t2 var310_len_deref_var278_other__k___t0))
)
...
(assert
  (and true (or (not var311_i___len_deref_var278_other__k___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/identity.zz:503
(declare-fun var313_infix_expression__t0 () (_ BitVec 8))
(declare-fun var303_array_member_deref_var277_self__k_i___t0 () (_ BitVec 8))
(declare-fun var312_array_member_deref_var278_other__k_i___t0 () (_ BitVec 8))
(assert
  (=  var313_infix_expression__t0 (bvxnor var303_array_member_deref_var277_self__k_i___t0 var312_array_member_deref_var278_other__k_i___t0))
)

; : /home/runner/work/carrier/carrier/core/src/identity.zz:503
(declare-fun var314_assign_inter__t0 () (_ BitVec 8))
(assert
  (=  var314_assign_inter__t0 (bvor var282_diff__t1 var313_infix_expression__t0))
)
...
(declare-fun var316_implicit_coercion_of_literal_0__t0 () (_ BitVec 8))
(assert (! (= var316_implicit_coercion_of_literal_0__t0 ( (_ extract 7 0) var315_literal_0__t0 )) :named A6)); : /home/runner/work/carrier/carrier/core/src/identity.zz:505
(declare-fun var317_infix_expression__t0 () Bool)
(declare-fun var282_diff__t2 () (_ BitVec 8))
(assert
  (=  var317_infix_expression__t0 (= var282_diff__t2 var316_implicit_coercion_of_literal_0__t0))
)

(declare-fun var281_return__t1 () Bool)
(declare-fun var281_return__t0 () Bool)
(assert
  (= var281_return__t1  (ite true var317_infix_expression__t0 var281_return__t0)  )
)
