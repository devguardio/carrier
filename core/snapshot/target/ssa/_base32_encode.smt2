...
(assert
  (= var194_interpretation_of_theory_symbol_over___err__OutOfTail__t0 (theory3_symbol var80___err__OutOfTail__t0) )
)
...
(assert
  (= var199_interpretation_of_theory___err__checked_over_deref_S138_e___t0 (theory26___err__checked var140_deref_S138_e___t1) )
)
...
(assert
  (= var294_interpretation_of_theory_symbol_over___err__OutOfTail__t0 (theory3_symbol var80___err__OutOfTail__t0) )
)
...
(assert
  (= var299_interpretation_of_theory___err__checked_over_deref_S138_e___t0 (theory26___err__checked var140_deref_S138_e___t2) )
)
...
(assert
  (not (= var353_infix_expression__t0 #x0000000000000004))
)
