...
napi_value js_io_select_make_read_async(napi_env env, napi_callback_info info);
napi_value js_io_select_impl_wake(napi_env env, napi_callback_info info);
napi_value js_string_slen(napi_env env, napi_callback_info info);
napi_value js_io_select_unix(napi_env env, napi_callback_info info);
napi_value js_io_select_stdin(napi_env env, napi_callback_info info);
...
napi_value js_io_select_impl_never(napi_env env, napi_callback_info info);
napi_value js_io_select_impl_timer_close(napi_env env, napi_callback_info info);
napi_value js_time_tick(napi_env env, napi_callback_info info);
napi_value js_io_select_impl_timeout_read(napi_env env, napi_callback_info info);
...
napi_value js_io_select_impl_unix_read(napi_env env, napi_callback_info info);
napi_value js_io_select_impl_unix_write(napi_env env, napi_callback_info info);
napi_value js_io_select_impl_unix_close(napi_env env, napi_callback_info info);
napi_value js_io_select_unix(napi_env env, napi_callback_info info);
napi_value js_err_fail_with_errno(napi_env env, napi_callback_info info);
napi_value js_io_select_impl_wait(napi_env env, napi_callback_info info);
...
napi_value js_io_select_impl_make_channel(napi_env env, napi_callback_info info);
napi_value js_io_select_impl_unix_close(napi_env env, napi_callback_info info);
...
napi_value js_io_select_impl_make_timeout(napi_env env, napi_callback_info info);
...
napi_value js_io_select_impl_unix_select(napi_env env, napi_callback_info info);
...
napi_value js_io_select_make_read_async(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_1 == 0 || status != napi_ok) {
        ...
        local_1 = tttt_local_1 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    bool  frrr = io_select_make_read_async( local_0, local_1);
...
napi_value js_io_select_impl_never(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_4 == 0 || status != napi_ok) {
        ...
        local_4 = tttt_local_4 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    io_Result  frrr = io_select_impl_never( local_0, local_1, local_1_tail, local_3, local_4);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_io_select_impl_timer_close(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_0 == 0 || status != napi_ok) {
        ...
        local_0 = tttt_local_0 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    io_select_impl_timer_close( local_0);
    return jsreturn;
}
...
napi_value js_io_select_impl_timeout_read(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_4 == 0 || status != napi_ok) {
        ...
        local_4 = tttt_local_4 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    io_Result  frrr = io_select_impl_timeout_read( local_0, local_1, local_1_tail, local_3, local_4);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_io_select_unix(napi_env env, napi_callback_info info) {
    ...
    status = napi_get_value_int32(env, argv[0], (int32_t*)&local_0);
                    ...
                    napi_value jsreturn = 0;
    io_Io  frrr = io_select_unix( local_0);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_io_select_impl_wait(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_1 == 0 || status != napi_ok) {
        ...
        local_1 = tttt_local_1 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    io_select_impl_wait( local_0, local_1, local_1_tail);
    return jsreturn;
}
...
napi_value js_io_select_impl_make_channel(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_4 == 0 || status != napi_ok) {
        ...
        local_4 = tttt_local_4 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    io_select_impl_make_channel( local_0, local_1, local_1_tail, local_3, local_4);
    return jsreturn;
}
...
napi_value js_io_select_impl_unix_close(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_0 == 0 || status != napi_ok) {
        ...
        local_0 = tttt_local_0 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    io_select_impl_unix_close( local_0);
    return jsreturn;
}
...
napi_value js_io_select_select_write_fd(napi_env env, napi_callback_info info) {
    ...
    status = napi_get_value_int32(env, argv[0], (int32_t*)&local_1);
                    ...
                    napi_value jsreturn = 0;
    bool  frrr = io_select_select_write_fd( local_0, local_1);
    status = napi_create_uint32(env, frrr, &jsreturn);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_io_select_impl_make_timeout(napi_env env, napi_callback_info info) {
    ...
    time_Time  local_3;
                    ...
                    napi_value jsreturn = 0;
    io_Io  frrr = io_select_impl_make_timeout( local_0, local_1, local_1_tail, local_3);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_io_select_select_read_fd(napi_env env, napi_callback_info info) {
    ...
    status = napi_get_value_int32(env, argv[0], (int32_t*)&local_1);
                    ...
                    napi_value jsreturn = 0;
    bool  frrr = io_select_select_read_fd( local_0, local_1);
    status = napi_create_uint32(env, frrr, &jsreturn);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_io_select_impl_unix_write(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_4 == 0 || status != napi_ok) {
        ...
        local_4 = tttt_local_4 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    io_Result  frrr = io_select_impl_unix_write( local_0, local_1, local_1_tail, local_3, local_4);
    assert(status == napi_ok);
    return jsreturn;
}

napi_value jsGet_io_select_Async_base(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  assert(status == napi_ok);
  mem += sizeof(size_t);
  io_select_Async * obj = (io_select_Async*)mem;
...
napi_value jsGet_io_select_Async_timeout(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_io_select_Async_count(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_io_select_Async_read_fds(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_io_select_Async_write_fds(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_io_select_Async_maxfd(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  napi_value value;
    status = napi_create_int32(env, obj->maxfd, &value);
...
void js_delete_io_select_Async(napi_env env, void *obj, void*hint) {
    free(obj);
}
napi_value js_new_io_select_Async(napi_env env, napi_callback_info info) {
    napi_status status;
    ...
    void *obj = malloc(sizeof(size_t) + sizeof_io_select_Async);
    memset(obj, 0, sizeof(size_t) + sizeof_io_select_Async);
    ...
    *((size_t *)obj) = tail;
    ...
    status = napi_wrap(env,
            jsthis,
            obj,
            js_delete_io_select_Async, // destructor
            0,  // finalize_hint
            0
    );
    assert(status == napi_ok);
...
void js_register_io_select_Async (napi_env env, napi_value exports) {
    napi_property_descriptor properties[] = {
        { "make", 0, js_io_select_make, 0, 0, 0, napi_default, 0 },
        { "reset", 0, js_io_select_reset, 0, 0, 0, napi_default, 0 },
        { "select_write_fd", 0, js_io_select_select_write_fd, 0, 0, 0, napi_default, 0 },
        { "select_read_fd", 0, js_io_select_select_read_fd, 0, 0, 0, napi_default, 0 },
        { "base", 0, 0, jsGet_io_select_Async_base, 0, 0, napi_default, 0},
        { "timeout", 0, 0, jsGet_io_select_Async_timeout, 0, 0, napi_default, 0},
        { "count", 0, 0, jsGet_io_select_Async_count, 0, 0, napi_default, 0},
        { "read_fds", 0, 0, jsGet_io_select_Async_read_fds, 0, 0, napi_default, 0},
        { "write_fds", 0, 0, jsGet_io_select_Async_write_fds, 0, 0, napi_default, 0},
        { "maxfd", 0, 0, jsGet_io_select_Async_maxfd, 0, 0, napi_default, 0},
    };
    napi_value cc;
    napi_status status = napi_define_class(env, "Async", NAPI_AUTO_LENGTH, js_new_io_select_Async, 0, 10, properties, &cc);
    assert(status == napi_ok);
...
napi_value js_io_select_impl_unix_read(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_4 == 0 || status != napi_ok) {
        ...
        local_4 = tttt_local_4 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    io_Result  frrr = io_select_impl_unix_read( local_0, local_1, local_1_tail, local_3, local_4);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_io_select_impl_unix_select(napi_env env, napi_callback_info info) {
    ...
    io_Ready  local_4;
                    ...
                    napi_value jsreturn = 0;
    io_select_impl_unix_select( local_0, local_1, local_1_tail, local_3, local_4);
    return jsreturn;
}


napi_value js_io_select_Init(napi_env env, napi_value exports)
{
    js_register_io_select_Async(env, exports);
    napi_value ff;
    napi_status status;
    status = napi_create_function(env, "reset", NAPI_AUTO_LENGTH, js_io_select_reset, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "reset", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "make_read_async", NAPI_AUTO_LENGTH, js_io_select_make_read_async, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "make_read_async", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "impl_wake", NAPI_AUTO_LENGTH, js_io_select_impl_wake, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "impl_wake", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "stdin", NAPI_AUTO_LENGTH, js_io_select_stdin, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "stdin", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "impl_never", NAPI_AUTO_LENGTH, js_io_select_impl_never, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "impl_never", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "impl_timer_close", NAPI_AUTO_LENGTH, js_io_select_impl_timer_close, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "impl_timer_close", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "impl_timeout_read", NAPI_AUTO_LENGTH, js_io_select_impl_timeout_read, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "impl_timeout_read", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "unix", NAPI_AUTO_LENGTH, js_io_select_unix, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "unix", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "impl_wait", NAPI_AUTO_LENGTH, js_io_select_impl_wait, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "impl_wait", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "impl_make_channel", NAPI_AUTO_LENGTH, js_io_select_impl_make_channel, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "impl_make_channel", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "impl_unix_close", NAPI_AUTO_LENGTH, js_io_select_impl_unix_close, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "impl_unix_close", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "select_write_fd", NAPI_AUTO_LENGTH, js_io_select_select_write_fd, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "select_write_fd", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "impl_make_timeout", NAPI_AUTO_LENGTH, js_io_select_impl_make_timeout, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "impl_make_timeout", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "select_read_fd", NAPI_AUTO_LENGTH, js_io_select_select_read_fd, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "select_read_fd", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "make", NAPI_AUTO_LENGTH, js_io_select_make, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "make", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "impl_unix_write", NAPI_AUTO_LENGTH, js_io_select_impl_unix_write, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "impl_unix_write", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "impl_unix_read", NAPI_AUTO_LENGTH, js_io_select_impl_unix_read, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "impl_unix_read", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "impl_unix_select", NAPI_AUTO_LENGTH, js_io_select_impl_unix_select, 0, &ff);
    assert(status == napi_ok);
