...
(declare-fun var210_other__t0 () (_ BitVec 64))
(declare-fun var211_interpretation_of_theory_safe_over_other__t0 () Bool)
(assert
  (= var211_interpretation_of_theory_safe_over_other__t0 (theory1_safe var210_other__t0) )
)

(assert (! var211_interpretation_of_theory_safe_over_other__t0 :named A0))(check-sat)
...
(assert (! (= var218_implicit_coercion_of_literal_Unsigned_0___t0 var217_literal_Unsigned_0___t0) :named A2)); : /home/runner/work/carrier/carrier/modules/net/src/address.zz:35
(declare-fun var219_infix_expression__t0 () Bool)
(declare-fun var216_return_value_of___ext___string_h___memcmp__t0 () (_ BitVec 64))
(assert
  (=  var219_infix_expression__t0 (= var216_return_value_of___ext___string_h___memcmp__t0 var218_implicit_coercion_of_literal_Unsigned_0___t0))
)

(declare-fun var213_return__t1 () Bool)
(declare-fun var213_return__t0 () Bool)
(assert
  (= var213_return__t1  (ite true var219_infix_expression__t0 var213_return__t0)  )
)
