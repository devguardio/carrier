...
static PyObject* py_carrier_main_main(PyObject *pyself, PyObject *args) {
    //argc
    long long int arg0 = 0;
    //argv
    PyObject * arg1 = 0;
    if (!PyArg_ParseTuple(args, "lO", &arg0,&arg1)) { return NULL; };
    long long int rarg = (long long int)(carrier_main_main(
        arg0,
...
{"main", py_carrier_main_main, METH_VARARGS,""},
{NULL, NULL, 0, NULL}
};

static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_main", "carrier::main", -1, methods};

PyObject*  py_mod_carrier_main_Init()
{
