...
(declare-fun var795_ep__t0 () (_ BitVec 64))
(declare-fun var796_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var796_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var795_ep__t0) )
)

(assert (! var796_interpretation_of_theory_safe_over_ep__t0 :named A5))(check-sat)
...
(declare-fun var798_safe_ep___t0 () Bool)
(assert
  (= var798_safe_ep___t0 (theory1_safe var795_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var798_safe_ep___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
(declare-fun var800_addressof___carrier__shell__ShellConfig___t0 () (_ BitVec 64))
(declare-fun var801_len_addressof___carrier__shell__ShellConfig____t0 () (_ BitVec 64))
(assert
  (= var801_len_addressof___carrier__shell__ShellConfig____t0 (theory0_len var800_addressof___carrier__shell__ShellConfig___t0) )
)

(assert
  (= var801_len_addressof___carrier__shell__ShellConfig____t0 (_ bv1 64))

)

(assert
  (= var800_addressof___carrier__shell__ShellConfig___t0 (_ bv503 64))

)

(declare-fun var802_true__t0 () Bool)
(assert
  (= var802_true__t0 (theory1_safe var800_addressof___carrier__shell__ShellConfig___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
(declare-fun var803_addressof___carrier__shell__ShellConfig___t0 () (_ BitVec 64))
(declare-fun var804_len_addressof___carrier__shell__ShellConfig____t0 () (_ BitVec 64))
(assert
  (= var804_len_addressof___carrier__shell__ShellConfig____t0 (theory0_len var803_addressof___carrier__shell__ShellConfig___t0) )
)

(assert
  (= var804_len_addressof___carrier__shell__ShellConfig____t0 (_ bv1 64))

)

(assert
  (= var803_addressof___carrier__shell__ShellConfig___t0 (_ bv503 64))

)

(declare-fun var805_true__t0 () Bool)
(assert
  (= var805_true__t0 (theory1_safe var803_addressof___carrier__shell__ShellConfig___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var806_interpretation_of_theory_safe_over_addressof___carrier__shell__ShellConfig___t0 () Bool)
(assert
  (= var806_interpretation_of_theory_safe_over_addressof___carrier__shell__ShellConfig___t0 (theory1_safe var803_addressof___carrier__shell__ShellConfig___t0) )
)
...
(assert
  (= var807_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var795_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var806_interpretation_of_theory_safe_over_addressof___carrier__shell__ShellConfig___t0 ) (not var807_interpretation_of_theory_safe_over_ep__t0 ) ))
...
(declare-fun var797_deref_var795_ep___t1 () (_ BitVec 64))
(declare-fun var797_deref_var795_ep___t0 () (_ BitVec 64))
(assert
  (= var797_deref_var795_ep___t1  (ite true var797_deref_var795_ep___t1 var797_deref_var795_ep___t0)  )
)
