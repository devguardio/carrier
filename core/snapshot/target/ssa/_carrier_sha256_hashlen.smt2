...
(declare-fun var124_safe___carrier__sha256__HASHLEN_____safe_return___t0 () Bool)
(assert
  (= var124_safe___carrier__sha256__HASHLEN_____safe_return___t0 (theory1_safe var6___carrier__sha256__HASHLEN__t1) )
)

(declare-fun var123_return__t1 () (_ BitVec 64))
(assert
  (= var124_safe___carrier__sha256__HASHLEN_____safe_return___t0 (theory1_safe var123_return__t1) )
)

(declare-fun var125_nullterm___carrier__sha256__HASHLEN_____nullterm_return___t0 () Bool)
(assert
  (= var125_nullterm___carrier__sha256__HASHLEN_____nullterm_return___t0 (theory2_nullterm var6___carrier__sha256__HASHLEN__t1) )
)

(assert
  (= var125_nullterm___carrier__sha256__HASHLEN_____nullterm_return___t0 (theory2_nullterm var123_return__t1) )
)

(declare-fun var123_return__t0 () (_ BitVec 64))
(assert
  (= var123_return__t1  (ite true var6___carrier__sha256__HASHLEN__t1 var123_return__t0)  )
)
