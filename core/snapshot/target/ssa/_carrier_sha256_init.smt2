...
(assert
  (= var112_interpretation_of_theory_safe_over_self__t0 (theory1_safe var111_self__t0) )
)

(assert (! var112_interpretation_of_theory_safe_over_self__t0 :named A2))(check-sat)
...
(declare-fun var115_safe_self___t0 () Bool)
(assert
  (= var115_safe_self___t0 (theory1_safe var111_self__t0) )
)

(push 1)

(assert
  (and true (or (not var115_safe_self___t0 ) ))
...
; literal expr
(declare-fun var116_literal_8__t0 () (_ BitVec 64))
(assert
  (= var116_literal_8__t0 (_ bv8 64))
...
(assert
  (not (= var116_literal_8__t0 #x0000000000000008))
)
...
; : /home/runner/work/carrier/carrier/core/src/sha256.zz:26
(declare-fun var117_deref_var111_self__state__t0 () (_ BitVec 64))
(declare-fun var118_len_deref_var111_self__state___t0 () (_ BitVec 64))
(assert
  (= var118_len_deref_var111_self__state___t0 (theory0_len var117_deref_var111_self__state__t0) )
)

(assert
  (= var118_len_deref_var111_self__state___t0 (_ bv8 64))

)

(declare-fun var119_true__t0 () Bool)
(assert
  (= var119_true__t0 (theory1_safe var117_deref_var111_self__state__t0) )
)
...
(declare-fun var123_implicit_coercion_of_literal_0__t0 () (_ BitVec 8))
(assert (! (= var123_implicit_coercion_of_literal_0__t0 ( (_ extract 7 0) var122_literal_0__t0 )) :named A3))(declare-fun var121_deref_var111_self__at__t1 () (_ BitVec 8))
(declare-fun var121_deref_var111_self__at__t0 () (_ BitVec 8))
(assert
  (= var121_deref_var111_self__at__t1  (ite true var123_implicit_coercion_of_literal_0__t0 var121_deref_var111_self__at__t0)  )
)
