...
(declare-fun var1008_ep__t0 () (_ BitVec 64))
(declare-fun var1009_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var1009_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var1008_ep__t0) )
)

(assert (! var1009_interpretation_of_theory_safe_over_ep__t0 :named A6))(check-sat)
...
(declare-fun var1011_safe_ep___t0 () Bool)
(assert
  (= var1011_safe_ep___t0 (theory1_safe var1008_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var1011_safe_ep___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/openwrt.zz:110
; : /home/runner/work/carrier/carrier/core/src/openwrt.zz:110
(declare-fun var1013_addressof___carrier__openwrt__OTAConfig___t0 () (_ BitVec 64))
(declare-fun var1014_len_addressof___carrier__openwrt__OTAConfig____t0 () (_ BitVec 64))
(assert
  (= var1014_len_addressof___carrier__openwrt__OTAConfig____t0 (theory0_len var1013_addressof___carrier__openwrt__OTAConfig___t0) )
)

(assert
  (= var1014_len_addressof___carrier__openwrt__OTAConfig____t0 (_ bv1 64))

)

(assert
  (= var1013_addressof___carrier__openwrt__OTAConfig___t0 (_ bv552 64))

)

(declare-fun var1015_true__t0 () Bool)
(assert
  (= var1015_true__t0 (theory1_safe var1013_addressof___carrier__openwrt__OTAConfig___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/openwrt.zz:110
; : /home/runner/work/carrier/carrier/core/src/openwrt.zz:110
(declare-fun var1016_addressof___carrier__openwrt__OTAConfig___t0 () (_ BitVec 64))
(declare-fun var1017_len_addressof___carrier__openwrt__OTAConfig____t0 () (_ BitVec 64))
(assert
  (= var1017_len_addressof___carrier__openwrt__OTAConfig____t0 (theory0_len var1016_addressof___carrier__openwrt__OTAConfig___t0) )
)

(assert
  (= var1017_len_addressof___carrier__openwrt__OTAConfig____t0 (_ bv1 64))

)

(assert
  (= var1016_addressof___carrier__openwrt__OTAConfig___t0 (_ bv552 64))

)

(declare-fun var1018_true__t0 () Bool)
(assert
  (= var1018_true__t0 (theory1_safe var1016_addressof___carrier__openwrt__OTAConfig___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var1019_interpretation_of_theory_safe_over_addressof___carrier__openwrt__OTAConfig___t0 () Bool)
(assert
  (= var1019_interpretation_of_theory_safe_over_addressof___carrier__openwrt__OTAConfig___t0 (theory1_safe var1016_addressof___carrier__openwrt__OTAConfig___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var1020_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var1020_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var1008_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var1019_interpretation_of_theory_safe_over_addressof___carrier__openwrt__OTAConfig___t0 ) (not var1020_interpretation_of_theory_safe_over_ep__t0 ) ))
...
(declare-fun var1010_deref_var1008_ep___t1 () (_ BitVec 64))
(declare-fun var1010_deref_var1008_ep___t0 () (_ BitVec 64))
(assert
  (= var1010_deref_var1008_ep___t1  (ite true var1010_deref_var1008_ep___t1 var1010_deref_var1008_ep___t0)  )
)
