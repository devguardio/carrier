...
(declare-fun var202_subject__t0 () (_ BitVec 64))
(declare-fun var204_interpretation_of_theory_safe_over_subject__t0 () Bool)
(assert
  (= var204_interpretation_of_theory_safe_over_subject__t0 (theory1_safe var202_subject__t0) )
)

(assert (! var204_interpretation_of_theory_safe_over_subject__t0 :named A1))(check-sat)

; : /home/runner/work/carrier/carrier/core/src/vault.zz:154
; call of safe
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var201_s__t0 () (_ BitVec 64))
(declare-fun var205_interpretation_of_theory_safe_over_s__t0 () Bool)
(assert
  (= var205_interpretation_of_theory_safe_over_s__t0 (theory1_safe var201_s__t0) )
)

(assert (! var205_interpretation_of_theory_safe_over_s__t0 :named A2))(check-sat)
...
(assert
  (= var206_interpretation_of_theory_safe_over_self__t0 (theory1_safe var200_self__t0) )
)

(assert (! var206_interpretation_of_theory_safe_over_self__t0 :named A3))(check-sat)
...
(declare-fun var208_safe_self___t0 () Bool)
(assert
  (= var208_safe_self___t0 (theory1_safe var200_self__t0) )
)

(push 1)

(assert
  (and true (or (not var208_safe_self___t0 ) ))
...
(assert (! (= var213_implicit_coercion_of_literal_0__t0 var212_literal_0__t0) :named A4)); : /home/runner/work/carrier/carrier/core/src/vault.zz:155
(declare-fun var214_infix_expression__t0 () Bool)
(declare-fun var210_closure_fn___carrier__vault__sign_fn__t0 () (_ BitVec 64))
(assert
  (=  var214_infix_expression__t0 (= var210_closure_fn___carrier__vault__sign_fn__t0 var213_implicit_coercion_of_literal_0__t0))
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var215_interpretation_of_theory_safe_over_subject__t0 () Bool)
(assert
  (= var215_interpretation_of_theory_safe_over_subject__t0 (theory1_safe var202_subject__t0) )
)
...
(assert
  (= var216_interpretation_of_theory_safe_over_s__t0 (theory1_safe var201_s__t0) )
)
...
(assert
  (= var217_interpretation_of_theory_safe_over_self__t0 (theory1_safe var200_self__t0) )
)

(push 1)

(assert
  (and var214_infix_expression__t0 (or (not var215_interpretation_of_theory_safe_over_subject__t0 ) (not var216_interpretation_of_theory_safe_over_s__t0 ) (not var217_interpretation_of_theory_safe_over_self__t0 ) ))
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:160
(declare-fun var209_deref_var200_self__i_sign_principal__t0 () (_ BitVec 64))
(declare-fun var219_interpretation_of_theory_safe_over_deref_var200_self__i_sign_principal__t0 () Bool)
(assert
  (= var219_interpretation_of_theory_safe_over_deref_var200_self__i_sign_principal__t0 (theory1_safe var209_deref_var200_self__i_sign_principal__t0) )
)

(assert (! var219_interpretation_of_theory_safe_over_deref_var200_self__i_sign_principal__t0 :named A5))(check-sat)
...
; begin safe ptr check
; : /home/runner/work/carrier/carrier/core/src/vault.zz:161
(declare-fun var221_safe_deref_var200_self__i_sign_principal___t0 () Bool)
(assert
  (= var221_safe_deref_var200_self__i_sign_principal___t0 (theory1_safe var209_deref_var200_self__i_sign_principal__t0) )
)

(push 1)

(assert
  (and true (or (not var221_safe_deref_var200_self__i_sign_principal___t0 ) ))
