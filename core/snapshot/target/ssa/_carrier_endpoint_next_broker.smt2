...
(assert
  (=  var862_infix_expression__t0 (bvult var856_i__t2 var29___carrier__vault__MAX_BROKERS__t1))
)
...
(assert
  (=  var868_infix_expression__t0 (bvuge var867_deref_var853_self__statem_connecting_trying_broker_index__t0 var29___carrier__vault__MAX_BROKERS__t1))
)
...
(get-value (
  ...
  var29___carrier__vault__MAX_BROKERS__t1
...
(assert
  (not (= var29___carrier__vault__MAX_BROKERS__t1 #x0000000000000010))
)
