...
(assert
  (= var341_interpretation_of_theory___err__checked_over_deref_S333_e___t0 (theory31___err__checked var335_deref_S333_e___t0) )
)
...
(assert
  (not (= var904_unary_expression__t0 false))
)
...
(assert
  (not (= var1021_unary_expression__t0 true))
)
...
(assert
  (= var1073_interpretation_of_theory_symbol_over___err__InvalidArgument__t0 (theory3_symbol var139___err__InvalidArgument__t0) )
)
...
(assert
  (= var1078_interpretation_of_theory___err__checked_over_deref_S333_e___t0 (theory31___err__checked var335_deref_S333_e___t1) )
)
