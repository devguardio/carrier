...
#line 6 "/home/aep/proj/zz/modules/pool/src/main.zz"
static void pool_main_it (pool_Pool*  const  pool, void*  const  item, void*  const  user);

#line 11 "/home/aep/proj/zz/modules/pool/src/main.zz"
int pool_main_main ();
...
#line 13 "/home/aep/proj/zz/modules/pool/src/main.zz"
  pool_Pool_1000 p  = {    0,};
    pool_make(    (pool_Pool* )(( &    p)),    1000,    16    );

#line 15 "/home/aep/proj/zz/modules/pool/src/main.zz"
    printf(    "alloc %x\n",    pool_alloc(    (pool_Pool* )(( &    p))    )    );

#line 16 "/home/aep/proj/zz/modules/pool/src/main.zz"
    printf(    "alloc %x\n",    pool_alloc(    (pool_Pool* )(( &    p))    )    );

#line 17 "/home/aep/proj/zz/modules/pool/src/main.zz"
    printf(    "alloc %x\n",    pool_alloc(    (pool_Pool* )(( &    p))    )    );

#line 18 "/home/aep/proj/zz/modules/pool/src/main.zz"
    pool_each(    (pool_Pool* )(( &    p)),    pool_main_it,    0    );

#line 20 "/home/aep/proj/zz/modules/pool/src/main.zz"
  return     0;
...
#line 8 "/home/aep/proj/zz/modules/pool/src/main.zz"
    printf(    "each  %x\n",    item    );
