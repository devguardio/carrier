...
(declare-fun var242_subject__t0 () (_ BitVec 64))
(declare-fun var244_interpretation_of_theory_safe_over_subject__t0 () Bool)
(assert
  (= var244_interpretation_of_theory_safe_over_subject__t0 (theory1_safe var242_subject__t0) )
)

(assert (! var244_interpretation_of_theory_safe_over_subject__t0 :named A1))(check-sat)

; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:41
; call of safe
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var241_s__t0 () (_ BitVec 64))
(declare-fun var245_interpretation_of_theory_safe_over_s__t0 () Bool)
(assert
  (= var245_interpretation_of_theory_safe_over_s__t0 (theory1_safe var241_s__t0) )
)

(assert (! var245_interpretation_of_theory_safe_over_s__t0 :named A2))(check-sat)
...
(assert
  (= var246_interpretation_of_theory_safe_over_self__t0 (theory1_safe var240_self__t0) )
)
...
(assert
  (= var251_addressof_deref_var240_self__ik_identity___t0 (_ bv250 64))
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:43
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:43
(declare-fun var254_addressof_deref_var240_self__ik_identity___t0 () (_ BitVec 64))
(declare-fun var255_len_addressof_deref_var240_self__ik_identity____t0 () (_ BitVec 64))
(assert
  (= var255_len_addressof_deref_var240_self__ik_identity____t0 (theory0_len var254_addressof_deref_var240_self__ik_identity___t0) )
)

(assert
  (= var255_len_addressof_deref_var240_self__ik_identity____t0 (_ bv1 64))

)

(assert
  (= var254_addressof_deref_var240_self__ik_identity___t0 (_ bv250 64))

)

(declare-fun var256_true__t0 () Bool)
(assert
  (= var256_true__t0 (theory1_safe var254_addressof_deref_var240_self__ik_identity___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var257_interpretation_of_theory_safe_over_subject__t0 () Bool)
(assert
  (= var257_interpretation_of_theory_safe_over_subject__t0 (theory1_safe var242_subject__t0) )
)
...
(assert
  (= var258_interpretation_of_theory_safe_over_s__t0 (theory1_safe var241_s__t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var259_interpretation_of_theory_safe_over_addressof_deref_var240_self__ik_identity___t0 () Bool)
(assert
  (= var259_interpretation_of_theory_safe_over_addressof_deref_var240_self__ik_identity___t0 (theory1_safe var254_addressof_deref_var240_self__ik_identity___t0) )
)

(push 1)

(assert
  (and true (or (not var257_interpretation_of_theory_safe_over_subject__t0 ) (not var258_interpretation_of_theory_safe_over_s__t0 ) (not var259_interpretation_of_theory_safe_over_addressof_deref_var240_self__ik_identity___t0 ) ))
