...
(assert (! (= var832_len_deref_S827_self____t0 var828_qt__t0) :named A12)); : /home/runner/work/carrier/carrier/core/src/pq.zz:76
; call of safe
...
; : /home/runner/work/carrier/carrier/core/src/pq.zz:77
(declare-fun var836_safe_literal_Unsigned_0______safe_i___t0 () Bool)
(assert
  (= var836_safe_literal_Unsigned_0______safe_i___t0 (theory1_safe var835_literal_Unsigned_0___t0) )
)

(declare-fun var834_i__t1 () (_ BitVec 64))
(assert
  (= var836_safe_literal_Unsigned_0______safe_i___t0 (theory1_safe var834_i__t1) )
)

(declare-fun var837_nullterm_literal_Unsigned_0______nullterm_i___t0 () Bool)
(assert
  (= var837_nullterm_literal_Unsigned_0______nullterm_i___t0 (theory2_nullterm var835_literal_Unsigned_0___t0) )
)

(assert
  (= var837_nullterm_literal_Unsigned_0______nullterm_i___t0 (theory2_nullterm var834_i__t1) )
)

; : /home/runner/work/carrier/carrier/core/src/pq.zz:77
(declare-fun var838_implicit_coercion_of_literal_Unsigned_0___t0 () (_ BitVec 64))
(assert (! (= var838_implicit_coercion_of_literal_Unsigned_0___t0 var835_literal_Unsigned_0___t0) :named A14))(declare-fun var834_i__t0 () (_ BitVec 64))
(assert
  (= var834_i__t1  (ite true var838_implicit_coercion_of_literal_Unsigned_0___t0 var834_i__t0)  )
)

; : /home/runner/work/carrier/carrier/core/src/pq.zz:77
; : /home/runner/work/carrier/carrier/core/src/pq.zz:77
; : /home/runner/work/carrier/carrier/core/src/pq.zz:77
(declare-fun var834_i__t2 () (_ BitVec 64))
(declare-fun var839_previous_value_of_i__t1 () (_ BitVec 64))
(assert
  (= var834_i__t2 (bvadd var839_previous_value_of_i__t1 (_ bv1 64)) )
)
...
(assert
  (=  var840_infix_expression__t0 (bvult var834_i__t2 var828_qt__t0))
)

(assert (! var840_infix_expression__t0 :named A15))(check-sat)
...
(assert
  (not (= var834_i__t2 #x0000000000000002))
)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/pq.zz:78
(declare-fun var841_len_deref_S827_self__q___t0 () (_ BitVec 64))
(assert
  (= var841_len_deref_S827_self__q___t0 (theory0_len var830_deref_S827_self__q__t0) )
)

(declare-fun var842_i___len_deref_S827_self__q___t0 () Bool)
(assert
  (=  var842_i___len_deref_S827_self__q___t0 (bvult var834_i__t2 var841_len_deref_S827_self__q___t0))
)
...
(assert
  (and true (or (not var842_i___len_deref_S827_self__q___t0 ) ))
...
(assert (! (= var847_implicit_coercion_of_literal_Unsigned_0___t0 var846_literal_Unsigned_0___t0) :named A16)); : /home/runner/work/carrier/carrier/core/src/pq.zz:78
(declare-fun var848_infix_expression__t0 () Bool)
(declare-fun var845_array_member_deref_S827_self__q_i__buf_mem__t0 () (_ BitVec 64))
(assert
  (=  var848_infix_expression__t0 (not (= var845_array_member_deref_S827_self__q_i__buf_mem__t0 var847_implicit_coercion_of_literal_Unsigned_0___t0)))
)
...
(assert
  (not (= var848_infix_expression__t0 false))
)
...
; : /home/runner/work/carrier/carrier/core/src/pq.zz:83
; : /home/runner/work/carrier/carrier/core/src/pq.zz:83
(declare-fun var849_implicit_cast_of_i__t0 () (_ BitVec 64))
(assert (! (= var849_implicit_cast_of_i__t0 var834_i__t2) :named A17)); begin pointer arithmetic
(declare-fun var851_len_deref_S827_self__q___t0 () (_ BitVec 64))
(assert
  (= var851_len_deref_S827_self__q___t0 (theory0_len var830_deref_S827_self__q__t0) )
)

(declare-fun var852_implicit_cast_of_i___len_deref_S827_self__q___t0 () Bool)
(assert
  (=  var852_implicit_cast_of_i___len_deref_S827_self__q___t0 (bvult var849_implicit_cast_of_i__t0 var851_len_deref_S827_self__q___t0))
)
...
(assert
  (and true (or (not var852_implicit_cast_of_i___len_deref_S827_self__q___t0 ) ))
...
(assert
  (= var854_len_deref_S827_self__q___t0 (theory0_len var850_infix_expression__t0) )
)

(assert
  (=  var854_len_deref_S827_self__q___t0 (bvsub var851_len_deref_S827_self__q___t0 var849_implicit_cast_of_i__t0))
)
