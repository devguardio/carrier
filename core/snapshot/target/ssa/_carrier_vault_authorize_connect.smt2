...
(declare-fun var212_interpretation_of_theory_safe_over_ii__t0 () Bool)
(assert
  (= var212_interpretation_of_theory_safe_over_ii__t0 (theory1_safe var211_ii__t0) )
)

(assert (! var212_interpretation_of_theory_safe_over_ii__t0 :named A1))(check-sat)
...
(assert
  (= var216_safe_self___t0 (theory1_safe var210_self__t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var220_interpretation_of_theory_safe_over_ii__t0 () Bool)
(assert
  (= var220_interpretation_of_theory_safe_over_ii__t0 (theory1_safe var211_ii__t0) )
)
...
(assert
  (=  var223_infix_expression__t0 (= var219_literal_0__t0 var222_literal_0__t0))
)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:223
(declare-fun var224_interpretation_of_theory_nullterm_over_literal_0__t0 () Bool)
(assert
  (= var224_interpretation_of_theory_nullterm_over_literal_0__t0 (theory2_nullterm var219_literal_0__t0) )
)

; : /home/runner/work/carrier/carrier/core/src/vault.zz:223
(declare-fun var225_infix_expression__t0 () Bool)
(assert
  (=  var225_infix_expression__t0 (or var223_infix_expression__t0 var224_interpretation_of_theory_nullterm_over_literal_0__t0))
)

(push 1)

(assert
  (and true (or (not var220_interpretation_of_theory_safe_over_ii__t0 ) (not var221_interpretation_of_theory_safe_over_self__t0 ) (not var225_infix_expression__t0 ) ))
...
(declare-fun var226_return_value_of___carrier__vault__authorize_open_stream__t0 () Bool)
(declare-fun var214_return__t0 () Bool)
(assert
  (= var214_return__t1  (ite true var226_return_value_of___carrier__vault__authorize_open_stream__t0 var214_return__t0)  )
)
