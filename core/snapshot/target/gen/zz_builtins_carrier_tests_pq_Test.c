...
#include <stddef.h>
const __attribute__ ((unused)) size_t io_Timeout = 1;
const __attribute__ ((unused)) size_t err_NotImplemented = 2;
const __attribute__ ((unused)) size_t hpack_decoder_Invalid = 3;
const __attribute__ ((unused)) size_t carrier_endpoint_InvalidBootstrap = 4;
...
const __attribute__ ((unused)) size_t carrier_router_OutOfOptions = 10;
