...
extern {
    ...
    pub fn r#on_stream_want_header_200( Zself: *mut u8,  Ze: *mut u8,  Zet: usize,  Zmsg: *const u8)  -> bool;
    ...
    pub fn r#on_printer_stream( Zself: *mut u8,  Ze: *mut u8,  Zet: usize,  Zmsg: *const u8)  -> bool;
