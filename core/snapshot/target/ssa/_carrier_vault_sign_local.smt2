...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:144
(declare-fun var219_deref_var210_self__i_sign_local__t0 () (_ BitVec 64))
(declare-fun var220_interpretation_of_theory_safe_over_deref_var210_self__i_sign_local__t0 () Bool)
(assert
  (= var220_interpretation_of_theory_safe_over_deref_var210_self__i_sign_local__t0 (theory1_safe var219_deref_var210_self__i_sign_local__t0) )
)

(assert (! var220_interpretation_of_theory_safe_over_deref_var210_self__i_sign_local__t0 :named A4))(check-sat)
...
; begin safe ptr check
; : /home/runner/work/carrier/carrier/core/src/vault.zz:145
(declare-fun var224_safe_deref_var210_self__i_sign_local___t0 () Bool)
(assert
  (= var224_safe_deref_var210_self__i_sign_local___t0 (theory1_safe var219_deref_var210_self__i_sign_local__t0) )
)

(push 1)

(assert
  (and true (or (not var224_safe_deref_var210_self__i_sign_local___t0 ) ))
