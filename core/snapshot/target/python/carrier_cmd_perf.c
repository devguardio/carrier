...
#include <stdint.h>
#include <string.h>
#include "zz/carrier/carrier_cmd_perf.h"
...
static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_cmd_perf", "carrier::cmd_perf", -1, methods};

PyObject*  py_mod_carrier_cmd_perf_Init()
{
