...
(assert
  (not (= var305_literal_32__t0 #x0000000000000020))
)
...
(assert (! (= var307_implicit_coercion_of_literal_32__t0 var306_literal_32__t0) :named A4)); : /home/runner/work/carrier/carrier/core/src/identity.zz:502
...
(assert
  (not (= var314_literal_32__t0 #x0000000000000020))
)
...
(assert
  (not (= var293_i__t2 #x0000000000000011))
)
...
(assert (! (= var324_implicit_coercion_of_literal_0__t0 ( (_ extract 7 0) var323_literal_0__t0 )) :named A6)); : /home/runner/work/carrier/carrier/core/src/identity.zz:505
