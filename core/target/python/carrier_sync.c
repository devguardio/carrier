...
static PyObject* py_carrier_sync_open_with_headers(PyObject *pyself, PyObject *args) {
    //self
    PyObject * arg0 = 0;
    //e
    PyObject * arg1 = 0;
    ...
    void * rarg = (void*)(carrier_sync_open_with_headers(
        pyFATGetPtr(arg0, "carrier_sync_Sync"),
        pyFATGetPtr(arg1, "err_Err"),
        ((pyFATObject *)arg1)->tail,
...
{"open_with_headers", py_carrier_sync_open_with_headers, METH_VARARGS,""},
