...
(declare-fun var904_ep__t0 () (_ BitVec 64))
(declare-fun var905_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var905_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var904_ep__t0) )
)

(assert (! var905_interpretation_of_theory_safe_over_ep__t0 :named A5))(check-sat)
...
(declare-fun var907_safe_ep___t0 () Bool)
(assert
  (= var907_safe_ep___t0 (theory1_safe var904_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var907_safe_ep___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/openwrt.zz:110
; : /home/runner/work/carrier/carrier/core/src/openwrt.zz:110
(declare-fun var909_addressof___carrier__openwrt__OTAConfig___t0 () (_ BitVec 64))
(declare-fun var910_len_addressof___carrier__openwrt__OTAConfig____t0 () (_ BitVec 64))
(assert
  (= var910_len_addressof___carrier__openwrt__OTAConfig____t0 (theory0_len var909_addressof___carrier__openwrt__OTAConfig___t0) )
)

(assert
  (= var910_len_addressof___carrier__openwrt__OTAConfig____t0 (_ bv1 64))

)

(assert
  (= var909_addressof___carrier__openwrt__OTAConfig___t0 (_ bv286 64))

)

(declare-fun var911_true__t0 () Bool)
(assert
  (= var911_true__t0 (theory1_safe var909_addressof___carrier__openwrt__OTAConfig___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/openwrt.zz:110
; : /home/runner/work/carrier/carrier/core/src/openwrt.zz:110
(declare-fun var912_addressof___carrier__openwrt__OTAConfig___t0 () (_ BitVec 64))
(declare-fun var913_len_addressof___carrier__openwrt__OTAConfig____t0 () (_ BitVec 64))
(assert
  (= var913_len_addressof___carrier__openwrt__OTAConfig____t0 (theory0_len var912_addressof___carrier__openwrt__OTAConfig___t0) )
)

(assert
  (= var913_len_addressof___carrier__openwrt__OTAConfig____t0 (_ bv1 64))

)

(assert
  (= var912_addressof___carrier__openwrt__OTAConfig___t0 (_ bv286 64))

)

(declare-fun var914_true__t0 () Bool)
(assert
  (= var914_true__t0 (theory1_safe var912_addressof___carrier__openwrt__OTAConfig___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var915_interpretation_of_theory_safe_over_addressof___carrier__openwrt__OTAConfig___t0 () Bool)
(assert
  (= var915_interpretation_of_theory_safe_over_addressof___carrier__openwrt__OTAConfig___t0 (theory1_safe var912_addressof___carrier__openwrt__OTAConfig___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var916_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var916_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var904_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var915_interpretation_of_theory_safe_over_addressof___carrier__openwrt__OTAConfig___t0 ) (not var916_interpretation_of_theory_safe_over_ep__t0 ) ))
...
(declare-fun var906_deref_var904_ep___t1 () (_ BitVec 64))
(declare-fun var906_deref_var904_ep___t0 () (_ BitVec 64))
(assert
  (= var906_deref_var904_ep___t1  (ite true var906_deref_var904_ep___t1 var906_deref_var904_ep___t0)  )
)
