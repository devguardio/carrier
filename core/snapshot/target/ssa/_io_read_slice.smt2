...
(assert
  (= var196_interpretation_of_theory___err__checked_over_deref_S187_e___t0 (theory23___err__checked var189_deref_S187_e___t0) )
)
...
(assert
  (= var244_interpretation_of_theory___err__checked_over_deref_S187_e___t0 (theory23___err__checked var189_deref_S187_e___t1) )
)
...
(assert
  (= var247_safe___io__Result__Error_____safe_return___t0 (theory1_safe var29___io__Result__Error__t0) )
)
...
(assert
  (= var248_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var29___io__Result__Error__t0) )
)
...
(assert (! (= var249_implicit_coercion_of___io__Result__Error__t0 var29___io__Result__Error__t0) :named A9))(declare-fun var213_return__t0 () (_ BitVec 64))
(assert
...
(assert
  (= var273_interpretation_of_theory_symbol_over___err__OutOfTail__t0 (theory3_symbol var148___err__OutOfTail__t0) )
)
...
(assert
  (= var278_interpretation_of_theory___err__checked_over_deref_S187_e___t0 (theory23___err__checked var189_deref_S187_e___t2) )
)
...
(assert
  (= var281_safe___io__Result__Error_____safe_return___t0 (theory1_safe var29___io__Result__Error__t0) )
)
...
(assert
  (= var282_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var29___io__Result__Error__t0) )
)
...
(assert (! (= var283_implicit_coercion_of___io__Result__Error__t0 var29___io__Result__Error__t0) :named A13))(assert
...
(assert
  (= var332_interpretation_of_theory___err__checked_over_deref_S187_e___t0 (theory23___err__checked var189_deref_S187_e___t4) )
)
...
(assert
  (= var334_safe___io__Result__Error_____safe_return___t0 (theory1_safe var29___io__Result__Error__t0) )
)
...
(assert
  (= var335_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var29___io__Result__Error__t0) )
)
...
(assert (! (= var336_implicit_coercion_of___io__Result__Error__t0 var29___io__Result__Error__t0) :named A19))(assert
...
(assert (! (= var337_implicit_coercion_of___io__Result__Ready__t0 var27___io__Result__Ready__t0) :named A20)); : /home/runner/work/carrier/carrier/core/modules/io/src/lib.zz:115
