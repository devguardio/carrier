...
(assert
  (= var414_interpretation_of_theory_symbol_over___carrier__identity__Invalid__t0 (theory3_symbol var69___carrier__identity__Invalid__t0) )
)
...
(assert
  (not (= var518_s2__t1 #x0000000000000042))
)
...
(assert
  (= var562_interpretation_of_theory_symbol_over___carrier__identity__Invalid__t0 (theory3_symbol var69___carrier__identity__Invalid__t0) )
)
