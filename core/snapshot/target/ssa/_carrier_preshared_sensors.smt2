...
(assert
  (= var278_safe___carrier__preshared__SENSORS_____safe_r___t0 (theory1_safe var193___carrier__preshared__SENSORS__t1) )
)
...
(assert
  (= var279_nullterm___carrier__preshared__SENSORS_____nullterm_r___t0 (theory2_nullterm var193___carrier__preshared__SENSORS__t1) )
)
...
(assert
  (= var277_r__t1  (ite true var193___carrier__preshared__SENSORS__t1 var277_r__t0)  )
)
...
(assert
  (= var286_interpretation_of_theory_safe_over_cast_of_literal_string_______t0 (theory1_safe var198_cast_of_literal_string_______t0) )
)
...
(assert
  (=  var288_infix_expression__t0 (bvuge var287_literal_Unsigned_3___t0 var199_literal_Unsigned_2___t0))
)
...
(assert
  (= var299_interpretation_of_theory_safe_over_cast_of_literal_string_______t0 (theory1_safe var198_cast_of_literal_string_______t0) )
)
...
(assert
  (=  var301_infix_expression__t0 (bvuge var300_literal_Unsigned_3___t0 var199_literal_Unsigned_2___t0))
)
...
(assert
  (= var309_interpretation_of_theory_safe_over_cast_of_literal_string_______t0 (theory1_safe var198_cast_of_literal_string_______t0) )
)
...
(assert
  (=  var311_infix_expression__t0 (bvuge var310_literal_Unsigned_3___t0 var199_literal_Unsigned_2___t0))
)
