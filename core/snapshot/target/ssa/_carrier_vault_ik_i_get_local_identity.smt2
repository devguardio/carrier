...
(declare-fun var229_id__t0 () (_ BitVec 64))
(declare-fun var230_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var230_interpretation_of_theory_safe_over_id__t0 (theory1_safe var229_id__t0) )
)

(assert (! var230_interpretation_of_theory_safe_over_id__t0 :named A1))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:38
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:38
(declare-fun var236_addressof_deref_var228_self__ik_identity___t0 () (_ BitVec 64))
(declare-fun var237_len_addressof_deref_var228_self__ik_identity____t0 () (_ BitVec 64))
(assert
  (= var237_len_addressof_deref_var228_self__ik_identity____t0 (theory0_len var236_addressof_deref_var228_self__ik_identity___t0) )
)

(assert
  (= var237_len_addressof_deref_var228_self__ik_identity____t0 (_ bv1 64))

)

(assert
  (= var236_addressof_deref_var228_self__ik_identity___t0 (_ bv235 64))

)

(declare-fun var238_true__t0 () Bool)
(assert
  (= var238_true__t0 (theory1_safe var236_addressof_deref_var228_self__ik_identity___t0) )
)
...
(assert
  (= var239_addressof_deref_var228_self__ik_identity___t0 (_ bv235 64))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var242_interpretation_of_theory_safe_over_addressof_deref_var228_self__ik_identity___t0 () Bool)
(assert
  (= var242_interpretation_of_theory_safe_over_addressof_deref_var228_self__ik_identity___t0 (theory1_safe var239_addressof_deref_var228_self__ik_identity___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var243_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var243_interpretation_of_theory_safe_over_id__t0 (theory1_safe var229_id__t0) )
)

(push 1)

(assert
  (and true (or (not var242_interpretation_of_theory_safe_over_addressof_deref_var228_self__ik_identity___t0 ) (not var243_interpretation_of_theory_safe_over_id__t0 ) ))
