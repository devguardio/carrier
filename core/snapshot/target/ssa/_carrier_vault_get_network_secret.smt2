...
(declare-fun var211_addr__t0 () (_ BitVec 64))
(declare-fun var212_interpretation_of_theory_safe_over_addr__t0 () Bool)
(assert
  (= var212_interpretation_of_theory_safe_over_addr__t0 (theory1_safe var211_addr__t0) )
)

(assert (! var212_interpretation_of_theory_safe_over_addr__t0 :named A1))(check-sat)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:127
(declare-fun var216_deref_var210_self__i_get_network_secret__t0 () (_ BitVec 64))
(declare-fun var217_interpretation_of_theory_safe_over_deref_var210_self__i_get_network_secret__t0 () Bool)
(assert
  (= var217_interpretation_of_theory_safe_over_deref_var210_self__i_get_network_secret__t0 (theory1_safe var216_deref_var210_self__i_get_network_secret__t0) )
)

(assert (! var217_interpretation_of_theory_safe_over_deref_var210_self__i_get_network_secret__t0 :named A3))(check-sat)
...
; begin safe ptr check
; : /home/runner/work/carrier/carrier/core/src/vault.zz:128
(declare-fun var221_safe_deref_var210_self__i_get_network_secret___t0 () Bool)
(assert
  (= var221_safe_deref_var210_self__i_get_network_secret___t0 (theory1_safe var216_deref_var210_self__i_get_network_secret__t0) )
)

(push 1)

(assert
  (and true (or (not var221_safe_deref_var210_self__i_get_network_secret___t0 ) ))
