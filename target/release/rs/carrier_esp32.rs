...
extern {
    ...
    pub fn r#ota_stream_open( Zself: *mut u8,  Ze: *mut u8,  Zet: usize,  Zheaders: *const u8);

    #[link_name = "carrier_esp32_ota_stream_stream"]
    pub fn r#ota_stream_stream( Zself: *mut u8,  Ze: *mut u8,  Zet: usize,  Zmsg: *const u8)  -> bool;

    #[link_name = "carrier_esp32_reboot_stream_open"]
    pub fn r#reboot_stream_open( Zself: *mut u8,  Ze: *mut u8,  Zet: usize,  Zheaders: *const u8);
