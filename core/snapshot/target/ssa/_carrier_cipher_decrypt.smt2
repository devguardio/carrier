...
(assert (! (= var159_len_deref_S155_e____t0 var156_et__t0) :named A1)); : /home/runner/work/carrier/carrier/core/src/cipher.zz:134
...
(assert (! (= var177_cast_of_e__t0 var155_e__t0) :named A9)); : /home/runner/work/carrier/carrier/core/src/cipher.zz:133
; : /home/runner/work/carrier/carrier/core/src/cipher.zz:144
; literal expr
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var180_interpretation_of_theory_safe_over_plain__t0 () Bool)
(assert
  (= var180_interpretation_of_theory_safe_over_plain__t0 (theory1_safe var163_plain__t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var181_interpretation_of_theory_safe_over_ciphertext__t0 () Bool)
(assert
  (= var181_interpretation_of_theory_safe_over_ciphertext__t0 (theory1_safe var160_ciphertext__t0) )
)
...
(assert
  (= var183_interpretation_of_theory_safe_over_self__t0 (theory1_safe var154_self__t0) )
)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/cipher.zz:78
(declare-fun var184_interpretation_of_theory___err__checked_over_deref_S155_e___t0 () Bool)
(assert
  (= var184_interpretation_of_theory___err__checked_over_deref_S155_e___t0 (theory13___err__checked var157_deref_S155_e___t0) )
)
...
(assert
  (= var185_interpretation_of_theory_len_over_ciphertext__t0 (theory0_len var160_ciphertext__t0) )
)
...
(assert
  (=  var186_infix_expression__t0 (bvuge var185_interpretation_of_theory_len_over_ciphertext__t0 var161_cipherlen__t0))
)
...
(assert
  (= var187_interpretation_of_theory_len_over_plain__t0 (theory0_len var163_plain__t0) )
)
...
(assert
  (=  var188_infix_expression__t0 (bvuge var187_interpretation_of_theory_len_over_plain__t0 var164_plainlen_max__t0))
)

(push 1)

(assert
  (and true (or (not var180_interpretation_of_theory_safe_over_plain__t0 ) (not var181_interpretation_of_theory_safe_over_ciphertext__t0 ) (not var182_interpretation_of_theory_safe_over_cast_of_e__t0 ) (not var183_interpretation_of_theory_safe_over_self__t0 ) (not var184_interpretation_of_theory___err__checked_over_deref_S155_e___t0 ) (not var186_infix_expression__t0 ) (not var188_infix_expression__t0 ) ))
...
(declare-fun var189_return_value_of___carrier__cipher__decrypt_ad__t0 () (_ BitVec 64))
(declare-fun var190_safe_return_value_of___carrier__cipher__decrypt_ad_____safe_return___t0 () Bool)
(assert
  (= var190_safe_return_value_of___carrier__cipher__decrypt_ad_____safe_return___t0 (theory1_safe var189_return_value_of___carrier__cipher__decrypt_ad__t0) )
)

(declare-fun var174_return__t1 () (_ BitVec 64))
(assert
  (= var190_safe_return_value_of___carrier__cipher__decrypt_ad_____safe_return___t0 (theory1_safe var174_return__t1) )
)

(declare-fun var191_nullterm_return_value_of___carrier__cipher__decrypt_ad_____nullterm_return___t0 () Bool)
(assert
  (= var191_nullterm_return_value_of___carrier__cipher__decrypt_ad_____nullterm_return___t0 (theory2_nullterm var189_return_value_of___carrier__cipher__decrypt_ad__t0) )
)

(assert
  (= var191_nullterm_return_value_of___carrier__cipher__decrypt_ad_____nullterm_return___t0 (theory2_nullterm var174_return__t1) )
)

(declare-fun var174_return__t0 () (_ BitVec 64))
(assert
  (= var174_return__t1  (ite true var189_return_value_of___carrier__cipher__decrypt_ad__t0 var174_return__t0)  )
)
