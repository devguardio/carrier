...
(declare-fun var797_ep__t0 () (_ BitVec 64))
(declare-fun var798_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var798_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var797_ep__t0) )
)

(assert (! var798_interpretation_of_theory_safe_over_ep__t0 :named A5))(check-sat)
...
(declare-fun var800_safe_ep___t0 () Bool)
(assert
  (= var800_safe_ep___t0 (theory1_safe var797_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var800_safe_ep___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
(declare-fun var802_addressof___carrier__shell__ShellConfig___t0 () (_ BitVec 64))
(declare-fun var803_len_addressof___carrier__shell__ShellConfig____t0 () (_ BitVec 64))
(assert
  (= var803_len_addressof___carrier__shell__ShellConfig____t0 (theory0_len var802_addressof___carrier__shell__ShellConfig___t0) )
)

(assert
  (= var803_len_addressof___carrier__shell__ShellConfig____t0 (_ bv1 64))

)

(assert
  (= var802_addressof___carrier__shell__ShellConfig___t0 (_ bv644 64))

)

(declare-fun var804_true__t0 () Bool)
(assert
  (= var804_true__t0 (theory1_safe var802_addressof___carrier__shell__ShellConfig___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
(declare-fun var805_addressof___carrier__shell__ShellConfig___t0 () (_ BitVec 64))
(declare-fun var806_len_addressof___carrier__shell__ShellConfig____t0 () (_ BitVec 64))
(assert
  (= var806_len_addressof___carrier__shell__ShellConfig____t0 (theory0_len var805_addressof___carrier__shell__ShellConfig___t0) )
)

(assert
  (= var806_len_addressof___carrier__shell__ShellConfig____t0 (_ bv1 64))

)

(assert
  (= var805_addressof___carrier__shell__ShellConfig___t0 (_ bv644 64))

)

(declare-fun var807_true__t0 () Bool)
(assert
  (= var807_true__t0 (theory1_safe var805_addressof___carrier__shell__ShellConfig___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var808_interpretation_of_theory_safe_over_addressof___carrier__shell__ShellConfig___t0 () Bool)
(assert
  (= var808_interpretation_of_theory_safe_over_addressof___carrier__shell__ShellConfig___t0 (theory1_safe var805_addressof___carrier__shell__ShellConfig___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var809_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var809_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var797_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var808_interpretation_of_theory_safe_over_addressof___carrier__shell__ShellConfig___t0 ) (not var809_interpretation_of_theory_safe_over_ep__t0 ) ))
...
(declare-fun var799_deref_var797_ep___t1 () (_ BitVec 64))
(declare-fun var799_deref_var797_ep___t0 () (_ BitVec 64))
(assert
  (= var799_deref_var797_ep___t1  (ite true var799_deref_var797_ep___t1 var799_deref_var797_ep___t0)  )
)
