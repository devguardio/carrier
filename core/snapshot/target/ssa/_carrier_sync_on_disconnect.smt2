...
(declare-fun var709_safe_con___t0 () Bool)
(assert
  (= var709_safe_con___t0 (theory1_safe var703_con__t0) )
)

(push 1)

(assert
  (and true (or (not var709_safe_con___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/sync.zz:98
(declare-fun var711_cast_of_deref_var703_con__user1__t0 () (_ BitVec 64))
(declare-fun var710_deref_var703_con__user1__t0 () (_ BitVec 64))
(assert (! (= var711_cast_of_deref_var703_con__user1__t0 var710_deref_var703_con__user1__t0) :named A7)); : /home/runner/work/carrier/carrier/core/src/sync.zz:98
(declare-fun var712_safe_cast_of_deref_var703_con__user1_____safe_self___t0 () Bool)
(assert
  (= var712_safe_cast_of_deref_var703_con__user1_____safe_self___t0 (theory1_safe var711_cast_of_deref_var703_con__user1__t0) )
)

(declare-fun var707_self__t1 () (_ BitVec 64))
(assert
  (= var712_safe_cast_of_deref_var703_con__user1_____safe_self___t0 (theory1_safe var707_self__t1) )
)

(declare-fun var713_nullterm_cast_of_deref_var703_con__user1_____nullterm_self___t0 () Bool)
(assert
  (= var713_nullterm_cast_of_deref_var703_con__user1_____nullterm_self___t0 (theory2_nullterm var711_cast_of_deref_var703_con__user1__t0) )
)

(assert
  (= var713_nullterm_cast_of_deref_var703_con__user1_____nullterm_self___t0 (theory2_nullterm var707_self__t1) )
)

(declare-fun var707_self__t0 () (_ BitVec 64))
(assert
  (= var707_self__t1  (ite true var711_cast_of_deref_var703_con__user1__t0 var707_self__t0)  )
)
...
(declare-fun var714_literal_string___home_runner_work_carrier_carrier_core_src_sync_zz___t0 () (_ BitVec 64))
(declare-fun var715_true__t0 () Bool)
(assert
  (= var715_true__t0 (theory1_safe var714_literal_string___home_runner_work_carrier_carrier_core_src_sync_zz___t0) )
)
...
(assert
  (= var716_true__t0 (theory2_nullterm var714_literal_string___home_runner_work_carrier_carrier_core_src_sync_zz___t0) )
)
...
(declare-fun var717_literal_string____carrier__sync__on_disconnect___t0 () (_ BitVec 64))
(declare-fun var718_true__t0 () Bool)
(assert
  (= var718_true__t0 (theory1_safe var717_literal_string____carrier__sync__on_disconnect___t0) )
)
...
(assert
  (= var719_true__t0 (theory2_nullterm var717_literal_string____carrier__sync__on_disconnect___t0) )
)
...
; literal expr
(declare-fun var720_literal_99__t0 () (_ BitVec 64))
(assert
  (= var720_literal_99__t0 (_ bv99 64))
...
; : /home/runner/work/carrier/carrier/core/src/sync.zz:99
; callsite effects
(declare-fun var721_return_value_of___err__assert_safe__t0 () (_ BitVec 64))
(declare-fun var723_safe_return_value_of___err__assert_safe_____safe_return___t0 () Bool)
(assert
  (= var723_safe_return_value_of___err__assert_safe_____safe_return___t0 (theory1_safe var721_return_value_of___err__assert_safe__t0) )
)

(declare-fun var722_return__t1 () (_ BitVec 64))
(assert
  (= var723_safe_return_value_of___err__assert_safe_____safe_return___t0 (theory1_safe var722_return__t1) )
)

(declare-fun var724_nullterm_return_value_of___err__assert_safe_____nullterm_return___t0 () Bool)
(assert
  (= var724_nullterm_return_value_of___err__assert_safe_____nullterm_return___t0 (theory2_nullterm var721_return_value_of___err__assert_safe__t0) )
)

(assert
  (= var724_nullterm_return_value_of___err__assert_safe_____nullterm_return___t0 (theory2_nullterm var722_return__t1) )
)

(declare-fun var722_return__t0 () (_ BitVec 64))
(assert
  (= var722_return__t1  (ite true var721_return_value_of___err__assert_safe__t0 var722_return__t0)  )
)
...
(assert
  (= var725_interpretation_of_theory_safe_over_self__t0 (theory1_safe var707_self__t1) )
)

(assert (! var725_interpretation_of_theory_safe_over_self__t0 :named A8))(check-sat)

; : /home/runner/work/carrier/carrier/core/src/sync.zz:99
(declare-fun var726_safe_return_____safe_return_value_of___err__assert_safe___t0 () Bool)
(assert
  (= var726_safe_return_____safe_return_value_of___err__assert_safe___t0 (theory1_safe var722_return__t1) )
)

(declare-fun var721_return_value_of___err__assert_safe__t1 () (_ BitVec 64))
(assert
  (= var726_safe_return_____safe_return_value_of___err__assert_safe___t0 (theory1_safe var721_return_value_of___err__assert_safe__t1) )
)

(declare-fun var727_nullterm_return_____nullterm_return_value_of___err__assert_safe___t0 () Bool)
(assert
  (= var727_nullterm_return_____nullterm_return_value_of___err__assert_safe___t0 (theory2_nullterm var722_return__t1) )
)

(assert
  (= var727_nullterm_return_____nullterm_return_value_of___err__assert_safe___t0 (theory2_nullterm var721_return_value_of___err__assert_safe__t1) )
)

(assert
  (= var721_return_value_of___err__assert_safe__t1  (ite true var722_return__t1 var721_return_value_of___err__assert_safe__t0)  )
)
...
(assert
  (= var729_safe_self___t0 (theory1_safe var707_self__t1) )
)
...
(declare-fun var730_deref_var707_self__error__t1 () Bool)
(declare-fun var730_deref_var707_self__error__t0 () Bool)
(assert
  (= var730_deref_var707_self__error__t1  (ite true var731_literal_4294967295__t0 var730_deref_var707_self__error__t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/src/sync.zz:101
; literal expr
(declare-fun var733_literal_0__t0 () Bool)
(assert
  (not var733_literal_0__t0)
)

(declare-fun var732_deref_var707_self__waiting__t1 () Bool)
(declare-fun var732_deref_var707_self__waiting__t0 () Bool)
(assert
  (= var732_deref_var707_self__waiting__t1  (ite true var733_literal_0__t0 var732_deref_var707_self__waiting__t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/src/sync.zz:102
; begin safe ptr check
(declare-fun var735_safe_ep___t0 () Bool)
(assert
  (= var735_safe_ep___t0 (theory1_safe var704_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var735_safe_ep___t0 ) ))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var737_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var737_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var704_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var737_interpretation_of_theory_safe_over_ep__t0 ) ))
...
(declare-fun var734_deref_var704_ep___t1 () (_ BitVec 64))
(declare-fun var734_deref_var704_ep___t0 () (_ BitVec 64))
(assert
  (= var734_deref_var704_ep___t1  (ite true var734_deref_var704_ep___t1 var734_deref_var704_ep___t0)  )
)
