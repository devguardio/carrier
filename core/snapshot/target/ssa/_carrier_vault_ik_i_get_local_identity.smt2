...
(declare-fun var239_id__t0 () (_ BitVec 64))
(declare-fun var240_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var240_interpretation_of_theory_safe_over_id__t0 (theory1_safe var239_id__t0) )
)

(assert (! var240_interpretation_of_theory_safe_over_id__t0 :named A1))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:38
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:38
(declare-fun var246_addressof_deref_var238_self__ik_identity___t0 () (_ BitVec 64))
(declare-fun var247_len_addressof_deref_var238_self__ik_identity____t0 () (_ BitVec 64))
(assert
  (= var247_len_addressof_deref_var238_self__ik_identity____t0 (theory0_len var246_addressof_deref_var238_self__ik_identity___t0) )
)

(assert
  (= var247_len_addressof_deref_var238_self__ik_identity____t0 (_ bv1 64))

)

(assert
  (= var246_addressof_deref_var238_self__ik_identity___t0 (_ bv245 64))

)

(declare-fun var248_true__t0 () Bool)
(assert
  (= var248_true__t0 (theory1_safe var246_addressof_deref_var238_self__ik_identity___t0) )
)
...
(assert
  (= var249_addressof_deref_var238_self__ik_identity___t0 (_ bv245 64))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var252_interpretation_of_theory_safe_over_addressof_deref_var238_self__ik_identity___t0 () Bool)
(assert
  (= var252_interpretation_of_theory_safe_over_addressof_deref_var238_self__ik_identity___t0 (theory1_safe var249_addressof_deref_var238_self__ik_identity___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var253_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var253_interpretation_of_theory_safe_over_id__t0 (theory1_safe var239_id__t0) )
)

(push 1)

(assert
  (and true (or (not var252_interpretation_of_theory_safe_over_addressof_deref_var238_self__ik_identity___t0 ) (not var253_interpretation_of_theory_safe_over_id__t0 ) ))
