...
(assert
  (= var229_interpretation_of_theory_safe_over_async__t0 (theory1_safe var228_async__t0) )
)

(assert (! var229_interpretation_of_theory_safe_over_async__t0 :named A0))(check-sat)
...
(declare-fun var232_safe_async___t0 () Bool)
(assert
  (= var232_safe_async___t0 (theory1_safe var228_async__t0) )
)

(push 1)

(assert
  (and true (or (not var232_safe_async___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:240
(declare-fun var234_cast_of_deref_var228_async__upper__t0 () (_ BitVec 64))
(declare-fun var233_deref_var228_async__upper__t0 () (_ BitVec 64))
(assert (! (= var234_cast_of_deref_var228_async__upper__t0 var233_deref_var228_async__upper__t0) :named A1)); : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:240
(declare-fun var235_safe_cast_of_deref_var228_async__upper_____safe_self___t0 () Bool)
(assert
  (= var235_safe_cast_of_deref_var228_async__upper_____safe_self___t0 (theory1_safe var234_cast_of_deref_var228_async__upper__t0) )
)

(declare-fun var230_self__t1 () (_ BitVec 64))
(assert
  (= var235_safe_cast_of_deref_var228_async__upper_____safe_self___t0 (theory1_safe var230_self__t1) )
)

(declare-fun var236_nullterm_cast_of_deref_var228_async__upper_____nullterm_self___t0 () Bool)
(assert
  (= var236_nullterm_cast_of_deref_var228_async__upper_____nullterm_self___t0 (theory2_nullterm var234_cast_of_deref_var228_async__upper__t0) )
)

(assert
  (= var236_nullterm_cast_of_deref_var228_async__upper_____nullterm_self___t0 (theory2_nullterm var230_self__t1) )
)

(declare-fun var230_self__t0 () (_ BitVec 64))
(assert
  (= var230_self__t1  (ite true var234_cast_of_deref_var228_async__upper__t0 var230_self__t0)  )
)
...
(assert
  (= var237_interpretation_of_theory_safe_over_self__t0 (theory1_safe var230_self__t1) )
)

(assert (! var237_interpretation_of_theory_safe_over_self__t0 :named A2))(check-sat)
...
(assert
  (= var240_safe_self___t0 (theory1_safe var230_self__t1) )
)
...
(assert (! (= var243_implicit_coercion_of_literal_0__t0 var242_literal_0__t0) :named A3))(declare-fun var241_deref_var230_self__timeout__t1 () (_ BitVec 64))
(declare-fun var241_deref_var230_self__timeout__t0 () (_ BitVec 64))
(assert
  (= var241_deref_var230_self__timeout__t1  (ite true var243_implicit_coercion_of_literal_0__t0 var241_deref_var230_self__timeout__t0)  )
)
