...
#include <stdint.h>
#include <string.h>
#include "zz/carrier/sysinfo_main.h"
...
static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "sysinfo_main", "sysinfo::main", -1, methods};

PyObject*  py_mod_sysinfo_main_Init()
{
