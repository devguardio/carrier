...
(assert
  (= var237_interpretation_of_theory_safe_over_ctx__t0 (theory1_safe var236_ctx__t0) )
)

(assert (! var237_interpretation_of_theory_safe_over_ctx__t0 :named A0))(check-sat)

; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:303
; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:303
; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:303
; begin safe ptr check
(declare-fun var239_safe_ctx___t0 () Bool)
(assert
  (= var239_safe_ctx___t0 (theory1_safe var236_ctx__t0) )
)

(push 1)

(assert
  (and true (or (not var239_safe_ctx___t0 ) ))
...
(assert (! (= var242_implicit_coercion_of_literal_0__t0 var241_literal_0__t0) :named A1)); : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:303
(declare-fun var243_safe_implicit_coercion_of_literal_0_____safe_deref_var236_ctx__time___t0 () Bool)
(assert
  (= var243_safe_implicit_coercion_of_literal_0_____safe_deref_var236_ctx__time___t0 (theory1_safe var242_implicit_coercion_of_literal_0__t0) )
)

(declare-fun var240_deref_var236_ctx__time__t1 () (_ BitVec 64))
(assert
  (= var243_safe_implicit_coercion_of_literal_0_____safe_deref_var236_ctx__time___t0 (theory1_safe var240_deref_var236_ctx__time__t1) )
)

(declare-fun var244_nullterm_implicit_coercion_of_literal_0_____nullterm_deref_var236_ctx__time___t0 () Bool)
(assert
  (= var244_nullterm_implicit_coercion_of_literal_0_____nullterm_deref_var236_ctx__time___t0 (theory2_nullterm var242_implicit_coercion_of_literal_0__t0) )
)

(assert
  (= var244_nullterm_implicit_coercion_of_literal_0_____nullterm_deref_var236_ctx__time___t0 (theory2_nullterm var240_deref_var236_ctx__time__t1) )
)

(declare-fun var240_deref_var236_ctx__time__t0 () (_ BitVec 64))
(assert
  (= var240_deref_var236_ctx__time__t1  (ite true var242_implicit_coercion_of_literal_0__t0 var240_deref_var236_ctx__time__t0)  )
)
...
(declare-fun var245_deref_var236_ctx__isvalid__t1 () Bool)
(declare-fun var245_deref_var236_ctx__isvalid__t0 () Bool)
(assert
  (= var245_deref_var236_ctx__isvalid__t1  (ite true var246_literal_0__t0 var245_deref_var236_ctx__isvalid__t0)  )
)
