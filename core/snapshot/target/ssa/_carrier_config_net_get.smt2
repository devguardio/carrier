...
(assert
  (= var1089_interpretation_of_theory___err__checked_over_deref_S892_e___t0 (theory12___err__checked var894_deref_S892_e___t2) )
)
...
(assert
  (= var1115_interpretation_of_theory___err__checked_over_deref_S892_e___t0 (theory12___err__checked var894_deref_S892_e___t4) )
)
...
(assert
  (not (= var1111_return_value_of___err__check__t1 false))
)
