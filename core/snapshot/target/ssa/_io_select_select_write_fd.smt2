...
; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:64
(declare-fun var235_addressof_deref_var228_self__write_fds___t0 () (_ BitVec 64))
(declare-fun var236_len_addressof_deref_var228_self__write_fds____t0 () (_ BitVec 64))
(assert
  (= var236_len_addressof_deref_var228_self__write_fds____t0 (theory0_len var235_addressof_deref_var228_self__write_fds___t0) )
)

(assert
  (= var236_len_addressof_deref_var228_self__write_fds____t0 (_ bv1 64))

)

(assert
  (= var235_addressof_deref_var228_self__write_fds___t0 (_ bv234 64))

)

(declare-fun var237_true__t0 () Bool)
(assert
  (= var237_true__t0 (theory1_safe var235_addressof_deref_var228_self__write_fds___t0) )
)
