...
(assert
  (= var236_interpretation_of_theory___err__checked_over_deref_S228_e___t0 (theory56___err__checked var230_deref_S228_e___t0) )
)
...
(assert
  (= var265_interpretation_of_theory___err__checked_over_deref_S228_e___t0 (theory56___err__checked var230_deref_S228_e___t1) )
)
...
(assert
  (= var268_safe___io__Result__Error_____safe_return___t0 (theory1_safe var26___io__Result__Error__t0) )
)
...
(assert
  (= var269_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var26___io__Result__Error__t0) )
)
...
(assert (! (= var270_implicit_coercion_of___io__Result__Error__t0 var26___io__Result__Error__t0) :named A7))(declare-fun var237_return__t0 () (_ BitVec 64))
(assert
...
(assert
  (= var271_safe___io__Result__Ready_____safe_return___t0 (theory1_safe var24___io__Result__Ready__t0) )
)
...
(assert
  (= var272_nullterm___io__Result__Ready_____nullterm_return___t0 (theory2_nullterm var24___io__Result__Ready__t0) )
)
...
(assert (! (= var273_implicit_coercion_of___io__Result__Ready__t0 var24___io__Result__Ready__t0) :named A8))(assert
...
(assert
  (= var283_interpretation_of_theory___err__checked_over_deref_S275_e___t0 (theory56___err__checked var277_deref_S275_e___t0) )
)
...
(assert
  (= var312_interpretation_of_theory___err__checked_over_deref_S275_e___t0 (theory56___err__checked var277_deref_S275_e___t1) )
)
...
(assert
  (= var315_safe___io__Result__Error_____safe_return___t0 (theory1_safe var26___io__Result__Error__t0) )
)
...
(assert
  (= var316_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var26___io__Result__Error__t0) )
)
...
(assert (! (= var317_implicit_coercion_of___io__Result__Error__t0 var26___io__Result__Error__t0) :named A16))(declare-fun var284_return__t0 () (_ BitVec 64))
(assert
...
(assert
  (= var318_safe___io__Result__Ready_____safe_return___t0 (theory1_safe var24___io__Result__Ready__t0) )
)
...
(assert
  (= var319_nullterm___io__Result__Ready_____nullterm_return___t0 (theory2_nullterm var24___io__Result__Ready__t0) )
)
...
(assert (! (= var320_implicit_coercion_of___io__Result__Ready__t0 var24___io__Result__Ready__t0) :named A17))(assert
