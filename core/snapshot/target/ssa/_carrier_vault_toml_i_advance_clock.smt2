...
(declare-fun var321_interpretation_of_theory_safe_over_self__t0 () Bool)
(assert
  (= var321_interpretation_of_theory_safe_over_self__t0 (theory1_safe var320_self__t0) )
)

(assert (! var321_interpretation_of_theory_safe_over_self__t0 :named A2))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:478
(declare-fun var324_return_value_of___time__real__t0 () (_ BitVec 64))
(declare-fun var325_safe_return_value_of___time__real_____safe_now___t0 () Bool)
(assert
  (= var325_safe_return_value_of___time__real_____safe_now___t0 (theory1_safe var324_return_value_of___time__real__t0) )
)

(declare-fun var323_now__t1 () (_ BitVec 64))
(assert
  (= var325_safe_return_value_of___time__real_____safe_now___t0 (theory1_safe var323_now__t1) )
)

(declare-fun var326_nullterm_return_value_of___time__real_____nullterm_now___t0 () Bool)
(assert
  (= var326_nullterm_return_value_of___time__real_____nullterm_now___t0 (theory2_nullterm var324_return_value_of___time__real__t0) )
)

(assert
  (= var326_nullterm_return_value_of___time__real_____nullterm_now___t0 (theory2_nullterm var323_now__t1) )
)

(declare-fun var323_now__t0 () (_ BitVec 64))
(assert
  (= var323_now__t1  (ite true var324_return_value_of___time__real__t0 var323_now__t0)  )
)
...
(assert
  (= var328_addressof_now___t0 (_ bv323 64))
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:479
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:479
(declare-fun var331_addressof_now___t0 () (_ BitVec 64))
(declare-fun var332_len_addressof_now____t0 () (_ BitVec 64))
(assert
  (= var332_len_addressof_now____t0 (theory0_len var331_addressof_now___t0) )
)

(assert
  (= var332_len_addressof_now____t0 (_ bv1 64))

)

(assert
  (= var331_addressof_now___t0 (_ bv323 64))

)

(declare-fun var333_true__t0 () Bool)
(assert
  (= var333_true__t0 (theory1_safe var331_addressof_now___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var334_interpretation_of_theory_safe_over_addressof_now___t0 () Bool)
(assert
  (= var334_interpretation_of_theory_safe_over_addressof_now___t0 (theory1_safe var331_addressof_now___t0) )
)

(push 1)

(assert
  (and true (or (not var334_interpretation_of_theory_safe_over_addressof_now___t0 ) ))
...
; callsite effects
; end of callsite effects
(declare-fun var335_return_value_of___time__to_millis__t0 () (_ BitVec 64))
(declare-fun var336_safe_return_value_of___time__to_millis_____safe_return___t0 () Bool)
(assert
  (= var336_safe_return_value_of___time__to_millis_____safe_return___t0 (theory1_safe var335_return_value_of___time__to_millis__t0) )
)

(declare-fun var322_return__t1 () (_ BitVec 64))
(assert
  (= var336_safe_return_value_of___time__to_millis_____safe_return___t0 (theory1_safe var322_return__t1) )
)

(declare-fun var337_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 () Bool)
(assert
  (= var337_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 (theory2_nullterm var335_return_value_of___time__to_millis__t0) )
)

(assert
  (= var337_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 (theory2_nullterm var322_return__t1) )
)

(declare-fun var322_return__t0 () (_ BitVec 64))
(assert
  (= var322_return__t1  (ite true var335_return_value_of___time__to_millis__t0 var322_return__t0)  )
)
