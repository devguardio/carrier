...
(declare-fun var112_safe___carrier__sha256__HASHLEN_____safe_return___t0 () Bool)
(assert
  (= var112_safe___carrier__sha256__HASHLEN_____safe_return___t0 (theory1_safe var36___carrier__sha256__HASHLEN__t1) )
)

(declare-fun var111_return__t1 () (_ BitVec 64))
(assert
  (= var112_safe___carrier__sha256__HASHLEN_____safe_return___t0 (theory1_safe var111_return__t1) )
)

(declare-fun var113_nullterm___carrier__sha256__HASHLEN_____nullterm_return___t0 () Bool)
(assert
  (= var113_nullterm___carrier__sha256__HASHLEN_____nullterm_return___t0 (theory2_nullterm var36___carrier__sha256__HASHLEN__t1) )
)

(assert
  (= var113_nullterm___carrier__sha256__HASHLEN_____nullterm_return___t0 (theory2_nullterm var111_return__t1) )
)

(declare-fun var111_return__t0 () (_ BitVec 64))
(assert
  (= var111_return__t1  (ite true var36___carrier__sha256__HASHLEN__t1 var111_return__t0)  )
)
