...
(declare-fun var902_ep__t0 () (_ BitVec 64))
(declare-fun var903_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var903_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var902_ep__t0) )
)

(assert (! var903_interpretation_of_theory_safe_over_ep__t0 :named A5))(check-sat)
...
(declare-fun var905_safe_ep___t0 () Bool)
(assert
  (= var905_safe_ep___t0 (theory1_safe var902_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var905_safe_ep___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/openwrt.zz:110
; : /home/runner/work/carrier/carrier/core/src/openwrt.zz:110
(declare-fun var907_addressof___carrier__openwrt__OTAConfig___t0 () (_ BitVec 64))
(declare-fun var908_len_addressof___carrier__openwrt__OTAConfig____t0 () (_ BitVec 64))
(assert
  (= var908_len_addressof___carrier__openwrt__OTAConfig____t0 (theory0_len var907_addressof___carrier__openwrt__OTAConfig___t0) )
)

(assert
  (= var908_len_addressof___carrier__openwrt__OTAConfig____t0 (_ bv1 64))

)

(assert
  (= var907_addressof___carrier__openwrt__OTAConfig___t0 (_ bv431 64))

)

(declare-fun var909_true__t0 () Bool)
(assert
  (= var909_true__t0 (theory1_safe var907_addressof___carrier__openwrt__OTAConfig___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/openwrt.zz:110
; : /home/runner/work/carrier/carrier/core/src/openwrt.zz:110
(declare-fun var910_addressof___carrier__openwrt__OTAConfig___t0 () (_ BitVec 64))
(declare-fun var911_len_addressof___carrier__openwrt__OTAConfig____t0 () (_ BitVec 64))
(assert
  (= var911_len_addressof___carrier__openwrt__OTAConfig____t0 (theory0_len var910_addressof___carrier__openwrt__OTAConfig___t0) )
)

(assert
  (= var911_len_addressof___carrier__openwrt__OTAConfig____t0 (_ bv1 64))

)

(assert
  (= var910_addressof___carrier__openwrt__OTAConfig___t0 (_ bv431 64))

)

(declare-fun var912_true__t0 () Bool)
(assert
  (= var912_true__t0 (theory1_safe var910_addressof___carrier__openwrt__OTAConfig___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var913_interpretation_of_theory_safe_over_addressof___carrier__openwrt__OTAConfig___t0 () Bool)
(assert
  (= var913_interpretation_of_theory_safe_over_addressof___carrier__openwrt__OTAConfig___t0 (theory1_safe var910_addressof___carrier__openwrt__OTAConfig___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var914_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var914_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var902_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var913_interpretation_of_theory_safe_over_addressof___carrier__openwrt__OTAConfig___t0 ) (not var914_interpretation_of_theory_safe_over_ep__t0 ) ))
...
(declare-fun var904_deref_var902_ep___t1 () (_ BitVec 64))
(declare-fun var904_deref_var902_ep___t0 () (_ BitVec 64))
(assert
  (= var904_deref_var902_ep___t1  (ite true var904_deref_var902_ep___t1 var904_deref_var902_ep___t0)  )
)
