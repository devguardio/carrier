...
; : /home/runner/work/carrier/carrier/core/modules/sysinfo/src/proto.zz:1689
(declare-fun var662_implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity__t0 () (_ BitVec 64))
(assert (! (= var662_implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity__t0 var306___sysinfo__proto__AuthorizationDel__Identity__t0) :named A0)); : /home/runner/work/carrier/carrier/core/modules/sysinfo/src/proto.zz:1695
(declare-fun var663_switch_branch__index__implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity___t0 () Bool)
(declare-fun var660_index__t0 () (_ BitVec 64))
(assert
  (=  var663_switch_branch__index__implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity___t0 (= var660_index__t0 var662_implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity__t0))
)
...
(assert
  (= var661_return__t1  (ite var663_switch_branch__index__implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity___t0 var666_implicit_coercion_of___protonerf__FieldType__Message__t0 var661_return__t0)  )
)

; branch returned. the rest of the function only happens if the condition leading to return never happened
; (not var663_switch_branch__index__implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity___t0)
(assert
  (not var663_switch_branch__index__implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity___t0)
)

; : /home/runner/work/carrier/carrier/core/modules/sysinfo/src/proto.zz:1699
(declare-fun var667_safe___protonerf__FieldType__Skip_____safe_return___t0 () Bool)
(assert
  (= var667_safe___protonerf__FieldType__Skip_____safe_return___t0 (theory1_safe var69___protonerf__FieldType__Skip__t0) )
)

(declare-fun var661_return__t2 () (_ BitVec 64))
(assert
  (= var667_safe___protonerf__FieldType__Skip_____safe_return___t0 (theory1_safe var661_return__t2) )
)

(declare-fun var668_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 () Bool)
(assert
  (= var668_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 (theory2_nullterm var69___protonerf__FieldType__Skip__t0) )
)

(assert
  (= var668_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 (theory2_nullterm var661_return__t2) )
)

; : /home/runner/work/carrier/carrier/core/modules/sysinfo/modules/protonerf/src/lib.zz:8
(declare-fun var669_implicit_coercion_of___protonerf__FieldType__Skip__t0 () (_ BitVec 64))
(assert (! (= var669_implicit_coercion_of___protonerf__FieldType__Skip__t0 var69___protonerf__FieldType__Skip__t0) :named A2))(assert
  (= var661_return__t2  (ite true var669_implicit_coercion_of___protonerf__FieldType__Skip__t0 var661_return__t1)  )
)
