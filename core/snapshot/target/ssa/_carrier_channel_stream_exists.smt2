...
(assert (! (= var735_implicit_coercion_of_literal_0__t0 var732_literal_0__t0) :named A6))(declare-fun var731_i__t0 () (_ BitVec 64))
(assert
...
(assert
  (= var738_safe_self___t0 (theory1_safe var727_self__t0) )
)
...
(assert
  (not (= var739_literal_16__t0 #x0000000000000010))
)
...
; : /home/runner/work/carrier/carrier/core/src/channel.zz:250
(declare-fun var740_deref_var727_self__streams__t0 () (_ BitVec 64))
(declare-fun var741_len_deref_var727_self__streams___t0 () (_ BitVec 64))
(assert
  (= var741_len_deref_var727_self__streams___t0 (theory0_len var740_deref_var727_self__streams__t0) )
)

(assert
  (= var741_len_deref_var727_self__streams___t0 (_ bv16 64))

)

(declare-fun var742_true__t0 () Bool)
(assert
  (= var742_true__t0 (theory1_safe var740_deref_var727_self__streams__t0) )
)
...
(assert
  (not (= var743_literal_16__t0 #x0000000000000010))
)
...
(declare-fun var745_implicit_coercion_of_literal_16__t0 () (_ BitVec 64))
(assert (! (= var745_implicit_coercion_of_literal_16__t0 var744_literal_16__t0) :named A7)); : /home/runner/work/carrier/carrier/core/src/channel.zz:250
(declare-fun var746_infix_expression__t0 () Bool)
(assert
  (=  var746_infix_expression__t0 (bvult var731_i__t2 var745_implicit_coercion_of_literal_16__t0))
)

(assert (! var746_infix_expression__t0 :named A8))(check-sat)
...
(assert
  (not (= var731_i__t2 #x0000000000000001))
)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/channel.zz:251
(declare-fun var747_len_deref_var727_self__streams___t0 () (_ BitVec 64))
(assert
  (= var747_len_deref_var727_self__streams___t0 (theory0_len var740_deref_var727_self__streams__t0) )
)

(declare-fun var748_i___len_deref_var727_self__streams___t0 () Bool)
(assert
  (=  var748_i___len_deref_var727_self__streams___t0 (bvult var731_i__t2 var747_len_deref_var727_self__streams___t0))
)
...
(assert
  (and true (or (not var748_i___len_deref_var727_self__streams___t0 ) ))
...
(assert (! (= var751_implicit_coercion_of_literal_0__t0 var750_literal_0__t0) :named A9)); : /home/runner/work/carrier/carrier/core/src/channel.zz:251
(declare-fun var752_infix_expression__t0 () Bool)
(declare-fun var749_array_member_deref_var727_self__streams_i___t0 () (_ BitVec 64))
(assert
  (=  var752_infix_expression__t0 (not (= var749_array_member_deref_var727_self__streams_i___t0 var751_implicit_coercion_of_literal_0__t0)))
)
...
(assert
  (not (= var731_i__t2 #x0000000000000002))
)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/channel.zz:252
(declare-fun var754_len_deref_var727_self__streams___t0 () (_ BitVec 64))
(assert
  (= var754_len_deref_var727_self__streams___t0 (theory0_len var740_deref_var727_self__streams__t0) )
)

(declare-fun var755_i___len_deref_var727_self__streams___t0 () Bool)
(assert
  (=  var755_i___len_deref_var727_self__streams___t0 (bvult var731_i__t2 var754_len_deref_var727_self__streams___t0))
)
...
(assert
  (and var752_infix_expression__t0 (or (not var755_i___len_deref_var727_self__streams___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/channel.zz:252
(declare-fun var756_array_member_deref_var727_self__streams_i___t0 () (_ BitVec 64))
(declare-fun var757_safe_array_member_deref_var727_self__streams_i______safe_strx___t0 () Bool)
(assert
  (= var757_safe_array_member_deref_var727_self__streams_i______safe_strx___t0 (theory1_safe var756_array_member_deref_var727_self__streams_i___t0) )
)

(declare-fun var753_strx__t1 () (_ BitVec 64))
(assert
  (= var757_safe_array_member_deref_var727_self__streams_i______safe_strx___t0 (theory1_safe var753_strx__t1) )
)

(declare-fun var758_nullterm_array_member_deref_var727_self__streams_i______nullterm_strx___t0 () Bool)
(assert
  (= var758_nullterm_array_member_deref_var727_self__streams_i______nullterm_strx___t0 (theory2_nullterm var756_array_member_deref_var727_self__streams_i___t0) )
)

(assert
  (= var758_nullterm_array_member_deref_var727_self__streams_i______nullterm_strx___t0 (theory2_nullterm var753_strx__t1) )
)

(declare-fun var753_strx__t0 () (_ BitVec 64))
(assert
  (= var753_strx__t1  (ite var752_infix_expression__t0 var756_array_member_deref_var727_self__streams_i___t0 var753_strx__t0)  )
)
...
(assert
  (= var759_interpretation_of_theory_safe_over_strx__t0 (theory1_safe var753_strx__t1) )
)

(assert (! var759_interpretation_of_theory_safe_over_strx__t0 :named A10))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/channel.zz:254
; begin safe ptr check
(declare-fun var762_safe_strx___t0 () Bool)
(assert
  (= var762_safe_strx___t0 (theory1_safe var753_strx__t1) )
)

(push 1)

(assert
  (and var752_infix_expression__t0 (or (not var762_safe_strx___t0 ) ))
...
(declare-fun var763_deref_var753_strx__id__t0 () (_ BitVec 32))
(declare-fun var728_streamid__t0 () (_ BitVec 32))
(assert
  (=  var764_infix_expression__t0 (= var763_deref_var753_strx__id__t0 var728_streamid__t0))
)
...
; literal expr
(declare-fun var765_literal_4294967295__t0 () Bool)
(assert
  var765_literal_4294967295__t0
)

(declare-fun var730_return__t1 () Bool)
(declare-fun var730_return__t0 () Bool)
(assert
  (= var730_return__t1  (ite ( and var752_infix_expression__t0 var764_infix_expression__t0 ) var765_literal_4294967295__t0 var730_return__t0)  )
)

; end branch
; branch returned. the rest of the function only happens if the condition leading to return never happened
; (not ( and var752_infix_expression__t0 var764_infix_expression__t0 ))
(assert
  (not ( and var752_infix_expression__t0 var764_infix_expression__t0 ))
)
...
(declare-fun var730_return__t2 () Bool)
(assert
  (= var730_return__t2  (ite true var766_literal_0__t0 var730_return__t1)  )
)
