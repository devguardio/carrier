...
(declare-fun var850_return_value_of___byteorder__swap64__t0 () (_ BitVec 64))
(declare-fun var851_safe_return_value_of___byteorder__swap64_____safe_return___t0 () Bool)
(assert
  (= var851_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var850_return_value_of___byteorder__swap64__t0) )
)

(declare-fun var849_return__t1 () (_ BitVec 64))
(assert
  (= var851_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var849_return__t1) )
)

(declare-fun var852_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 () Bool)
(assert
  (= var852_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var850_return_value_of___byteorder__swap64__t0) )
)

(assert
  (= var852_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var849_return__t1) )
)

(declare-fun var849_return__t0 () (_ BitVec 64))
(assert
  (= var849_return__t1  (ite true var850_return_value_of___byteorder__swap64__t0 var849_return__t0)  )
)
...
(declare-fun var853_x__t0 () (_ BitVec 64))
(declare-fun var855_safe_x_____safe_return___t0 () Bool)
(assert
  (= var855_safe_x_____safe_return___t0 (theory1_safe var853_x__t0) )
)

(declare-fun var854_return__t1 () (_ BitVec 64))
(assert
  (= var855_safe_x_____safe_return___t0 (theory1_safe var854_return__t1) )
)

(declare-fun var856_nullterm_x_____nullterm_return___t0 () Bool)
(assert
  (= var856_nullterm_x_____nullterm_return___t0 (theory2_nullterm var853_x__t0) )
)

(assert
  (= var856_nullterm_x_____nullterm_return___t0 (theory2_nullterm var854_return__t1) )
)

(declare-fun var854_return__t0 () (_ BitVec 64))
(assert
  (= var854_return__t1  (ite true var853_x__t0 var854_return__t0)  )
)
