...
(assert (! var229_interpretation_of_theory_safe_over_self__t0 :named A1))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:32
(declare-fun var232_return_value_of___time__real__t0 () (_ BitVec 64))
(declare-fun var233_safe_return_value_of___time__real_____safe_now___t0 () Bool)
(assert
  (= var233_safe_return_value_of___time__real_____safe_now___t0 (theory1_safe var232_return_value_of___time__real__t0) )
)

(declare-fun var231_now__t1 () (_ BitVec 64))
(assert
  (= var233_safe_return_value_of___time__real_____safe_now___t0 (theory1_safe var231_now__t1) )
)

(declare-fun var234_nullterm_return_value_of___time__real_____nullterm_now___t0 () Bool)
(assert
  (= var234_nullterm_return_value_of___time__real_____nullterm_now___t0 (theory2_nullterm var232_return_value_of___time__real__t0) )
)

(assert
  (= var234_nullterm_return_value_of___time__real_____nullterm_now___t0 (theory2_nullterm var231_now__t1) )
)

(declare-fun var231_now__t0 () (_ BitVec 64))
(assert
  (= var231_now__t1  (ite true var232_return_value_of___time__real__t0 var231_now__t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:33
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:33
(declare-fun var236_addressof_now___t0 () (_ BitVec 64))
(declare-fun var237_len_addressof_now____t0 () (_ BitVec 64))
(assert
  (= var237_len_addressof_now____t0 (theory0_len var236_addressof_now___t0) )
)

(assert
  (= var237_len_addressof_now____t0 (_ bv1 64))

)

(assert
  (= var236_addressof_now___t0 (_ bv231 64))

)

(declare-fun var238_true__t0 () Bool)
(assert
  (= var238_true__t0 (theory1_safe var236_addressof_now___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:33
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:33
(declare-fun var239_addressof_now___t0 () (_ BitVec 64))
(declare-fun var240_len_addressof_now____t0 () (_ BitVec 64))
(assert
  (= var240_len_addressof_now____t0 (theory0_len var239_addressof_now___t0) )
)

(assert
  (= var240_len_addressof_now____t0 (_ bv1 64))

)

(assert
  (= var239_addressof_now___t0 (_ bv231 64))

)

(declare-fun var241_true__t0 () Bool)
(assert
  (= var241_true__t0 (theory1_safe var239_addressof_now___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var242_interpretation_of_theory_safe_over_addressof_now___t0 () Bool)
(assert
  (= var242_interpretation_of_theory_safe_over_addressof_now___t0 (theory1_safe var239_addressof_now___t0) )
)

(push 1)

(assert
  (and true (or (not var242_interpretation_of_theory_safe_over_addressof_now___t0 ) ))
...
; callsite effects
; end of callsite effects
(declare-fun var243_return_value_of___time__to_millis__t0 () (_ BitVec 64))
(declare-fun var244_safe_return_value_of___time__to_millis_____safe_return___t0 () Bool)
(assert
  (= var244_safe_return_value_of___time__to_millis_____safe_return___t0 (theory1_safe var243_return_value_of___time__to_millis__t0) )
)

(declare-fun var230_return__t1 () (_ BitVec 64))
(assert
  (= var244_safe_return_value_of___time__to_millis_____safe_return___t0 (theory1_safe var230_return__t1) )
)

(declare-fun var245_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 () Bool)
(assert
  (= var245_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 (theory2_nullterm var243_return_value_of___time__to_millis__t0) )
)

(assert
  (= var245_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 (theory2_nullterm var230_return__t1) )
)

(declare-fun var230_return__t0 () (_ BitVec 64))
(assert
  (= var230_return__t1  (ite true var243_return_value_of___time__to_millis__t0 var230_return__t0)  )
)
