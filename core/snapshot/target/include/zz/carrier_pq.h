...
#define carrier_pq_KEEPALIVE (    5000)
...
#define carrier_pq_REORDER_THRESHOLD (    3)
...
#define carrier_pq_DEAD_PINGS (    5)
...
#define carrier_pq_DEAD_TLPS (    20)
