...
(declare-fun var265_return_value_of___byteorder__to_le64__t0 () (_ BitVec 64))
(declare-fun var266_safe_return_value_of___byteorder__to_le64_____safe_return___t0 () Bool)
(assert
  (= var266_safe_return_value_of___byteorder__to_le64_____safe_return___t0 (theory1_safe var265_return_value_of___byteorder__to_le64__t0) )
)

(declare-fun var264_return__t1 () (_ BitVec 64))
(assert
  (= var266_safe_return_value_of___byteorder__to_le64_____safe_return___t0 (theory1_safe var264_return__t1) )
)

(declare-fun var267_nullterm_return_value_of___byteorder__to_le64_____nullterm_return___t0 () Bool)
(assert
  (= var267_nullterm_return_value_of___byteorder__to_le64_____nullterm_return___t0 (theory2_nullterm var265_return_value_of___byteorder__to_le64__t0) )
)

(assert
  (= var267_nullterm_return_value_of___byteorder__to_le64_____nullterm_return___t0 (theory2_nullterm var264_return__t1) )
)

(declare-fun var264_return__t0 () (_ BitVec 64))
(assert
  (= var264_return__t1  (ite true var265_return_value_of___byteorder__to_le64__t0 var264_return__t0)  )
)
