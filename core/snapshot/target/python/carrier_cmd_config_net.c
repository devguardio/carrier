...
static PyObject* py_carrier_cmd_config_net_run_remote_net_get(PyObject *pyself, PyObject *args) {
    //e
    PyObject * arg0 = 0;
    //endpoint
    PyObject * arg2 = 0;
    ...
    carrier_cmd_config_net_run_remote_net_get(
...
static PyObject* py_carrier_cmd_config_net_run_self_net_join(PyObject *pyself, PyObject *args) {
    //e
    PyObject * arg0 = 0;
    //endpoint
    PyObject * arg2 = 0;
    ...
    if (!PyArg_ParseTuple(args, "OOs#", &arg0,&arg2,&arg3,&arg3_len)) { return NULL; };
    carrier_cmd_config_net_run_self_net_join(
        pyFATGetPtr(arg0, "err_Err"),
        ((pyFATObject *)arg0)->tail,
        pyFATGetPtr(arg2, "carrier_endpoint_Endpoint"),
        arg3);
...
static PyObject* py_carrier_cmd_config_net_run_remote_net_join(PyObject *pyself, PyObject *args) {
    //e
    PyObject * arg0 = 0;
    //endpoint
    PyObject * arg2 = 0;
    ...
    if (!PyArg_ParseTuple(args, "OOOs#", &arg0,&arg2,&arg3,&arg4,&arg4_len)) { return NULL; };
    carrier_cmd_config_net_run_remote_net_join(
        pyFATGetPtr(arg0, "err_Err"),
        ((pyFATObject *)arg0)->tail,
        pyFATGetPtr(arg2, "carrier_endpoint_Endpoint"),
        pyFATGetPtr(arg3, "carrier_identity_Identity"),
...
static PyObject* py_carrier_cmd_config_net_run_self_net_get(PyObject *pyself, PyObject *args) {
    //e
    PyObject * arg0 = 0;
    //endpoint
    PyObject * arg2 = 0;
    if (!PyArg_ParseTuple(args, "OO", &arg0,&arg2)) { return NULL; };
    carrier_cmd_config_net_run_self_net_get(
        pyFATGetPtr(arg0, "err_Err"),
        ((pyFATObject *)arg0)->tail,
        pyFATGetPtr(arg2, "carrier_endpoint_Endpoint"));
    Py_RETURN_NONE;
...
{"run_remote_net_get", py_carrier_cmd_config_net_run_remote_net_get, METH_VARARGS,""},
{"run_self_net_join", py_carrier_cmd_config_net_run_self_net_join, METH_VARARGS,""},
{"run_remote_net_join", py_carrier_cmd_config_net_run_remote_net_join, METH_VARARGS,""},
{"run_self_net_get", py_carrier_cmd_config_net_run_self_net_get, METH_VARARGS,""},
{NULL, NULL, 0, NULL}
};

static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_cmd_config_net", "carrier::cmd_config_net", -1, methods};

PyObject*  py_mod_carrier_cmd_config_net_Init()
{
