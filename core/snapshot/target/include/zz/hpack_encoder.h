...
extern void hpack_encoder_encode_integer (slice_mut_slice_MutSlice const  slice, err_Err*  const  e, uintptr_t const  et, uintptr_t value, uint8_t const  prefix_size);
