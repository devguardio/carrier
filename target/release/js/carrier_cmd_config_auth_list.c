...
napi_value js_carrier_cmd_config_auth_list_run_remote(napi_env env, napi_callback_info info);
...
napi_value js_carrier_cmd_config_auth_list_run_self_auth_list_print(napi_env env, napi_callback_info info);
napi_value js_carrier_cmd_config_auth_list_run_self(napi_env env, napi_callback_info info);
...
napi_value js_carrier_cmd_config_auth_list_run_remote(napi_env env, napi_callback_info info) {
    ...
    carrier_cmd_config_auth_list_run_remote( local_0, local_0_tail, local_2, local_3);
    return jsreturn;
}
...
napi_value js_carrier_cmd_config_auth_list_on_stream(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_3 == 0 || status != napi_ok) {
        ...
        local_3 = tttt_local_3 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    bool  frrr = carrier_cmd_config_auth_list_on_stream( local_0, local_1, local_1_tail, local_3);
...
napi_value js_carrier_cmd_config_auth_list_on_close(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_1 == 0 || status != napi_ok) {
        ...
        local_1 = tttt_local_1 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    carrier_cmd_config_auth_list_on_close( local_0, local_1, local_1_tail);
    return jsreturn;
}
...
napi_value js_carrier_cmd_config_auth_list_run_self(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_2 == 0 || status != napi_ok) {
        ...
        local_2 = tttt_local_2 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    carrier_cmd_config_auth_list_run_self( local_0, local_0_tail, local_2);
    return jsreturn;
}
...
napi_value js_carrier_cmd_config_auth_list_run_self_auth_list_print(napi_env env, napi_callback_info info) {
    ...
    char * local_2;
                    ...
                    napi_value jsreturn = 0;
    carrier_cmd_config_auth_list_run_self_auth_list_print( local_0, local_1, local_2);
    return jsreturn;
}


napi_value js_carrier_cmd_config_auth_list_Init(napi_env env, napi_value exports)
{
    napi_value ff;
    napi_status status;
    status = napi_create_function(env, "run_remote", NAPI_AUTO_LENGTH, js_carrier_cmd_config_auth_list_run_remote, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "run_remote", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "on_stream", NAPI_AUTO_LENGTH, js_carrier_cmd_config_auth_list_on_stream, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "on_stream", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "on_close", NAPI_AUTO_LENGTH, js_carrier_cmd_config_auth_list_on_close, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "on_close", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "run_self", NAPI_AUTO_LENGTH, js_carrier_cmd_config_auth_list_run_self, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "run_self", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "run_self_auth_list_print", NAPI_AUTO_LENGTH, js_carrier_cmd_config_auth_list_run_self_auth_list_print, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "run_self_auth_list_print", ff);
    assert(status == napi_ok);
    return exports;
}
