...
; : /home/runner/work/carrier/carrier/modules/err/src/lib.zz:283
; literal expr
(declare-fun var161_literal_Unsigned_0___t0 () (_ BitVec 64))
(assert
  (= var161_literal_Unsigned_0___t0 (_ bv0 64))

)

(declare-fun var162_implicit_coercion_of_literal_Unsigned_0___t0 () (_ BitVec 64))
(assert (! (= var162_implicit_coercion_of_literal_Unsigned_0___t0 var161_literal_Unsigned_0___t0) :named A0)); : /home/runner/work/carrier/carrier/modules/err/src/lib.zz:283
(declare-fun var163_infix_expression__t0 () Bool)
(declare-fun var157_a__t0 () (_ BitVec 64))
(assert
  (=  var163_infix_expression__t0 (= var157_a__t0 var162_implicit_coercion_of_literal_Unsigned_0___t0))
)
...
(assert
  (= var170_interpretation_of_theory_safe_over_a__t0 (theory1_safe var157_a__t0) )
)

(assert (! var170_interpretation_of_theory_safe_over_a__t0 :named A1))(check-sat)
...
(assert
  (= var172_interpretation_of_theory_safe_over_a__t0 (theory1_safe var157_a__t0) )
)

(push 1)

(assert
  (and true (or (not var172_interpretation_of_theory_safe_over_a__t0 ) ))
