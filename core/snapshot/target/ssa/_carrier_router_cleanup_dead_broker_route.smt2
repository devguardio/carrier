...
(declare-fun var697_chan__t0 () (_ BitVec 64))
(declare-fun var699_interpretation_of_theory_safe_over_chan__t0 () Bool)
(assert
  (= var699_interpretation_of_theory_safe_over_chan__t0 (theory1_safe var697_chan__t0) )
)

(assert (! var699_interpretation_of_theory_safe_over_chan__t0 :named A5))(check-sat)
...
(declare-fun var707_safe_chan___t0 () Bool)
(assert
  (= var707_safe_chan___t0 (theory1_safe var697_chan__t0) )
)

(push 1)

(assert
  (and true (or (not var707_safe_chan___t0 ) ))
...
(assert
  (not (= var708_literal_16__t0 #x0000000000000010))
)
...
; : /home/runner/work/carrier/carrier/core/src/router.zz:376
(declare-fun var709_deref_var697_chan__streams__t0 () (_ BitVec 64))
(declare-fun var710_len_deref_var697_chan__streams___t0 () (_ BitVec 64))
(assert
  (= var710_len_deref_var697_chan__streams___t0 (theory0_len var709_deref_var697_chan__streams__t0) )
)

(assert
  (= var710_len_deref_var697_chan__streams___t0 (_ bv16 64))

)

(declare-fun var711_true__t0 () Bool)
(assert
  (= var711_true__t0 (theory1_safe var709_deref_var697_chan__streams__t0) )
)
...
(assert
  (not (= var712_literal_16__t0 #x0000000000000010))
)
...
(assert (! (= var714_implicit_coercion_of_literal_16__t0 var713_literal_16__t0) :named A7)); : /home/runner/work/carrier/carrier/core/src/router.zz:376
(declare-fun var715_infix_expression__t0 () Bool)
(assert
  (=  var715_infix_expression__t0 (bvult var700_i__t2 var714_implicit_coercion_of_literal_16__t0))
)

(assert (! var715_infix_expression__t0 :named A8))(check-sat)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/router.zz:377
(declare-fun var716_len_deref_var697_chan__streams___t0 () (_ BitVec 64))
(assert
  (= var716_len_deref_var697_chan__streams___t0 (theory0_len var709_deref_var697_chan__streams__t0) )
)

(declare-fun var717_i___len_deref_var697_chan__streams___t0 () Bool)
(assert
  (=  var717_i___len_deref_var697_chan__streams___t0 (bvult var700_i__t2 var716_len_deref_var697_chan__streams___t0))
)
...
(assert
  (and true (or (not var717_i___len_deref_var697_chan__streams___t0 ) ))
...
(assert (! (= var720_implicit_coercion_of_literal_0__t0 var719_literal_0__t0) :named A9)); : /home/runner/work/carrier/carrier/core/src/router.zz:377
(declare-fun var721_infix_expression__t0 () Bool)
(declare-fun var718_array_member_deref_var697_chan__streams_i___t0 () (_ BitVec 64))
(assert
  (=  var721_infix_expression__t0 (= var718_array_member_deref_var697_chan__streams_i___t0 var720_implicit_coercion_of_literal_0__t0))
)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/router.zz:380
(declare-fun var723_len_deref_var697_chan__streams___t0 () (_ BitVec 64))
(assert
  (= var723_len_deref_var697_chan__streams___t0 (theory0_len var709_deref_var697_chan__streams__t0) )
)

(declare-fun var724_i___len_deref_var697_chan__streams___t0 () Bool)
(assert
  (=  var724_i___len_deref_var697_chan__streams___t0 (bvult var700_i__t2 var723_len_deref_var697_chan__streams___t0))
)
...
(assert
  (and true (or (not var724_i___len_deref_var697_chan__streams___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/router.zz:380
(declare-fun var725_array_member_deref_var697_chan__streams_i___t0 () (_ BitVec 64))
(declare-fun var726_safe_array_member_deref_var697_chan__streams_i______safe_strx___t0 () Bool)
(assert
  (= var726_safe_array_member_deref_var697_chan__streams_i______safe_strx___t0 (theory1_safe var725_array_member_deref_var697_chan__streams_i___t0) )
)

(declare-fun var722_strx__t1 () (_ BitVec 64))
(assert
  (= var726_safe_array_member_deref_var697_chan__streams_i______safe_strx___t0 (theory1_safe var722_strx__t1) )
)

(declare-fun var727_nullterm_array_member_deref_var697_chan__streams_i______nullterm_strx___t0 () Bool)
(assert
  (= var727_nullterm_array_member_deref_var697_chan__streams_i______nullterm_strx___t0 (theory2_nullterm var725_array_member_deref_var697_chan__streams_i___t0) )
)

(assert
  (= var727_nullterm_array_member_deref_var697_chan__streams_i______nullterm_strx___t0 (theory2_nullterm var722_strx__t1) )
)

(declare-fun var722_strx__t0 () (_ BitVec 64))
(assert
  (= var722_strx__t1  (ite true var725_array_member_deref_var697_chan__streams_i___t0 var722_strx__t0)  )
)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/router.zz:381
(declare-fun var728_interpretation_of_theory_safe_over_strx__t0 () Bool)
(assert
  (= var728_interpretation_of_theory_safe_over_strx__t0 (theory1_safe var722_strx__t1) )
)

(assert (! var728_interpretation_of_theory_safe_over_strx__t0 :named A10))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/router.zz:382
; begin safe ptr check
(declare-fun var731_safe_strx___t0 () Bool)
(assert
  (= var731_safe_strx___t0 (theory1_safe var722_strx__t1) )
)

(push 1)

(assert
  (and true (or (not var731_safe_strx___t0 ) ))
...
(declare-fun var732_deref_var722_strx__broker_route__t0 () (_ BitVec 64))
(declare-fun var698_dead_route__t0 () (_ BitVec 64))
(assert
  (=  var733_infix_expression__t0 (= var732_deref_var722_strx__broker_route__t0 var698_dead_route__t0))
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var735_interpretation_of_theory_safe_over_strx__t0 () Bool)
(assert
  (= var735_interpretation_of_theory_safe_over_strx__t0 (theory1_safe var722_strx__t1) )
)

(push 1)

(assert
  (and var733_infix_expression__t0 (or (not var735_interpretation_of_theory_safe_over_strx__t0 ) ))
...
(declare-fun var730_deref_var722_strx___t1 () (_ BitVec 64))
(declare-fun var730_deref_var722_strx___t0 () (_ BitVec 64))
(assert
  (= var730_deref_var722_strx___t1  (ite var733_infix_expression__t0 var730_deref_var722_strx___t1 var730_deref_var722_strx___t0)  )
)
