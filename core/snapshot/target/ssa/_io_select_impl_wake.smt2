...
(assert
  (= var239_interpretation_of_theory_safe_over_async__t0 (theory1_safe var238_async__t0) )
)

(assert (! var239_interpretation_of_theory_safe_over_async__t0 :named A0))(check-sat)
...
(assert
  (= var242_safe_async___t0 (theory1_safe var238_async__t0) )
)
...
; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:240
(declare-fun var244_cast_of_deref_var238_async__upper__t0 () (_ BitVec 64))
(declare-fun var243_deref_var238_async__upper__t0 () (_ BitVec 64))
(assert (! (= var244_cast_of_deref_var238_async__upper__t0 var243_deref_var238_async__upper__t0) :named A1)); : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:240
(declare-fun var245_safe_cast_of_deref_var238_async__upper_____safe_self___t0 () Bool)
(assert
  (= var245_safe_cast_of_deref_var238_async__upper_____safe_self___t0 (theory1_safe var244_cast_of_deref_var238_async__upper__t0) )
)

(declare-fun var240_self__t1 () (_ BitVec 64))
(assert
  (= var245_safe_cast_of_deref_var238_async__upper_____safe_self___t0 (theory1_safe var240_self__t1) )
)

(declare-fun var246_nullterm_cast_of_deref_var238_async__upper_____nullterm_self___t0 () Bool)
(assert
  (= var246_nullterm_cast_of_deref_var238_async__upper_____nullterm_self___t0 (theory2_nullterm var244_cast_of_deref_var238_async__upper__t0) )
)

(assert
  (= var246_nullterm_cast_of_deref_var238_async__upper_____nullterm_self___t0 (theory2_nullterm var240_self__t1) )
)

(declare-fun var240_self__t0 () (_ BitVec 64))
(assert
  (= var240_self__t1  (ite true var244_cast_of_deref_var238_async__upper__t0 var240_self__t0)  )
)
...
(assert (! var247_interpretation_of_theory_safe_over_self__t0 :named A2))(check-sat)
...
(assert
  (= var250_safe_self___t0 (theory1_safe var240_self__t1) )
)
...
(assert (! (= var253_implicit_coercion_of_literal_0__t0 var252_literal_0__t0) :named A3))(declare-fun var251_deref_var240_self__timeout__t1 () (_ BitVec 64))
(declare-fun var251_deref_var240_self__timeout__t0 () (_ BitVec 64))
(assert
  (= var251_deref_var240_self__timeout__t1  (ite true var253_implicit_coercion_of_literal_0__t0 var251_deref_var240_self__timeout__t0)  )
)
