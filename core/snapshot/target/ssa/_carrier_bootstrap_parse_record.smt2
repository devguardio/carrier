...
(assert
  (= var389_interpretation_of_theory___err__checked_over_e__t0 (theory56___err__checked var364_e__t2) )
)
...
(assert
  (= var808_interpretation_of_theory___err__checked_over_e__t0 (theory56___err__checked var364_e__t2) )
)
...
(assert
  (= var835_interpretation_of_theory___err__checked_over_e__t0 (theory56___err__checked var364_e__t4) )
)
...
(assert
  (not (= var837_unary_expression__t0 false))
)
...
(assert
  (= var866_interpretation_of_theory___err__checked_over_e__t0 (theory56___err__checked var364_e__t5) )
)
