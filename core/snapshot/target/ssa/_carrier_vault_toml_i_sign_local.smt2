...
(assert (! (= var343_cast_of_deref_var332_self__user__t0 var342_deref_var332_self__user__t0) :named A5)); : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:430
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:433
(declare-fun var351_addressof_deref_var339_this__secret___t0 () (_ BitVec 64))
(declare-fun var352_len_addressof_deref_var339_this__secret____t0 () (_ BitVec 64))
(assert
  (= var352_len_addressof_deref_var339_this__secret____t0 (theory0_len var351_addressof_deref_var339_this__secret___t0) )
)

(assert
  (= var352_len_addressof_deref_var339_this__secret____t0 (_ bv1 64))

)

(assert
  (= var351_addressof_deref_var339_this__secret___t0 (_ bv350 64))

)

(declare-fun var353_true__t0 () Bool)
(assert
  (= var353_true__t0 (theory1_safe var351_addressof_deref_var339_this__secret___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:433
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:433
(declare-fun var354_addressof_deref_var339_this__secret___t0 () (_ BitVec 64))
(declare-fun var355_len_addressof_deref_var339_this__secret____t0 () (_ BitVec 64))
(assert
  (= var355_len_addressof_deref_var339_this__secret____t0 (theory0_len var354_addressof_deref_var339_this__secret___t0) )
)

(assert
  (= var355_len_addressof_deref_var339_this__secret____t0 (_ bv1 64))

)

(assert
  (= var354_addressof_deref_var339_this__secret___t0 (_ bv350 64))

)

(declare-fun var356_true__t0 () Bool)
(assert
  (= var356_true__t0 (theory1_safe var354_addressof_deref_var339_this__secret___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var357_interpretation_of_theory_safe_over_subject__t0 () Bool)
(assert
  (= var357_interpretation_of_theory_safe_over_subject__t0 (theory1_safe var334_subject__t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var358_interpretation_of_theory_safe_over_s__t0 () Bool)
(assert
  (= var358_interpretation_of_theory_safe_over_s__t0 (theory1_safe var333_s__t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var359_interpretation_of_theory_safe_over_addressof_deref_var339_this__secret___t0 () Bool)
(assert
  (= var359_interpretation_of_theory_safe_over_addressof_deref_var339_this__secret___t0 (theory1_safe var354_addressof_deref_var339_this__secret___t0) )
)

(push 1)

(assert
  (and true (or (not var357_interpretation_of_theory_safe_over_subject__t0 ) (not var358_interpretation_of_theory_safe_over_s__t0 ) (not var359_interpretation_of_theory_safe_over_addressof_deref_var339_this__secret___t0 ) ))
