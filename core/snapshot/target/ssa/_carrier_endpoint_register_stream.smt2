...
(declare-fun var726_conf__t0 () (_ BitVec 64))
(declare-fun var727_interpretation_of_theory_safe_over_conf__t0 () Bool)
(assert
  (= var727_interpretation_of_theory_safe_over_conf__t0 (theory1_safe var726_conf__t0) )
)

(assert (! var727_interpretation_of_theory_safe_over_conf__t0 :named A6))(check-sat)
...
(assert (! var728_interpretation_of_theory_safe_over_self__t0 :named A7))(check-sat)
...
(assert (! (= var733_implicit_coercion_of_literal_0__t0 var730_literal_0__t0) :named A8))(declare-fun var729_i__t0 () (_ BitVec 64))
(assert
...
; : /home/runner/work/carrier/carrier/core/src/endpoint.zz:210
(declare-fun var738_deref_var725_self__p2p_stream_registry__t0 () (_ BitVec 64))
(declare-fun var739_len_deref_var725_self__p2p_stream_registry___t0 () (_ BitVec 64))
(assert
  (= var739_len_deref_var725_self__p2p_stream_registry___t0 (theory0_len var738_deref_var725_self__p2p_stream_registry__t0) )
)

(assert
  (= var739_len_deref_var725_self__p2p_stream_registry___t0 (_ bv32 64))

)

(declare-fun var740_true__t0 () Bool)
(assert
  (= var740_true__t0 (theory1_safe var738_deref_var725_self__p2p_stream_registry__t0) )
)
...
(assert (! (= var743_implicit_coercion_of_literal_32__t0 var742_literal_32__t0) :named A9)); : /home/runner/work/carrier/carrier/core/src/endpoint.zz:210
(declare-fun var744_infix_expression__t0 () Bool)
(assert
  (=  var744_infix_expression__t0 (bvult var729_i__t2 var743_implicit_coercion_of_literal_32__t0))
)

(assert (! var744_infix_expression__t0 :named A10))(check-sat)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/endpoint.zz:211
(declare-fun var745_len_deref_var725_self__p2p_stream_registry___t0 () (_ BitVec 64))
(assert
  (= var745_len_deref_var725_self__p2p_stream_registry___t0 (theory0_len var738_deref_var725_self__p2p_stream_registry__t0) )
)

(declare-fun var746_i___len_deref_var725_self__p2p_stream_registry___t0 () Bool)
(assert
  (=  var746_i___len_deref_var725_self__p2p_stream_registry___t0 (bvult var729_i__t2 var745_len_deref_var725_self__p2p_stream_registry___t0))
)
...
(assert
  (and true (or (not var746_i___len_deref_var725_self__p2p_stream_registry___t0 ) ))
...
(assert (! (= var749_implicit_coercion_of_literal_0__t0 var748_literal_0__t0) :named A11)); : /home/runner/work/carrier/carrier/core/src/endpoint.zz:211
(declare-fun var750_infix_expression__t0 () Bool)
(declare-fun var747_array_member_deref_var725_self__p2p_stream_registry_i___t0 () (_ BitVec 64))
(assert
  (=  var750_infix_expression__t0 (= var747_array_member_deref_var725_self__p2p_stream_registry_i___t0 var749_implicit_coercion_of_literal_0__t0))
)
...
(assert
  (not (= var729_i__t2 #x0000000000000011))
)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/endpoint.zz:212
(declare-fun var751_len_deref_var725_self__p2p_stream_registry___t0 () (_ BitVec 64))
(assert
  (= var751_len_deref_var725_self__p2p_stream_registry___t0 (theory0_len var738_deref_var725_self__p2p_stream_registry__t0) )
)

(declare-fun var752_i___len_deref_var725_self__p2p_stream_registry___t0 () Bool)
(assert
  (=  var752_i___len_deref_var725_self__p2p_stream_registry___t0 (bvult var729_i__t2 var751_len_deref_var725_self__p2p_stream_registry___t0))
)
...
(assert
  (and var750_infix_expression__t0 (or (not var752_i___len_deref_var725_self__p2p_stream_registry___t0 ) ))
...
; (not var750_infix_expression__t0)
(assert
  (not var750_infix_expression__t0)
)
