...
(assert
  (= var180_interpretation_of_theory___err__checked_over_deref_S173_e___t0 (theory8___err__checked var175_deref_S173_e___t0) )
)
...
(assert
  (= var216_interpretation_of_theory_symbol_over___protonerf__Invalid__t0 (theory3_symbol var48___protonerf__Invalid__t0) )
)
...
(assert
  (= var221_interpretation_of_theory___err__checked_over_deref_S173_e___t0 (theory8___err__checked var175_deref_S173_e___t1) )
)
...
(assert
  (not (= var195_deref_var172_self__at__t1 #x8000000000000000))
)
