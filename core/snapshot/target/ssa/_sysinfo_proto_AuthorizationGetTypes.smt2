...
(assert
  (= var664_safe___protonerf__FieldType__Skip_____safe_return___t0 (theory1_safe var21___protonerf__FieldType__Skip__t0) )
)

(declare-fun var663_return__t1 () (_ BitVec 64))
(assert
  (= var664_safe___protonerf__FieldType__Skip_____safe_return___t0 (theory1_safe var663_return__t1) )
)

(declare-fun var665_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 () Bool)
(assert
  (= var665_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 (theory2_nullterm var21___protonerf__FieldType__Skip__t0) )
)

(assert
  (= var665_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 (theory2_nullterm var663_return__t1) )
)

; : /home/runner/work/carrier/carrier/core/modules/protonerf/src/lib.zz:8
(declare-fun var666_implicit_coercion_of___protonerf__FieldType__Skip__t0 () (_ BitVec 64))
(assert (! (= var666_implicit_coercion_of___protonerf__FieldType__Skip__t0 var21___protonerf__FieldType__Skip__t0) :named A0))(declare-fun var663_return__t0 () (_ BitVec 64))
(assert
  (= var663_return__t1  (ite true var666_implicit_coercion_of___protonerf__FieldType__Skip__t0 var663_return__t0)  )
)
