...
(declare-fun var241_addr__t0 () (_ BitVec 64))
(declare-fun var242_interpretation_of_theory_safe_over_addr__t0 () Bool)
(assert
  (= var242_interpretation_of_theory_safe_over_addr__t0 (theory1_safe var241_addr__t0) )
)

(assert (! var242_interpretation_of_theory_safe_over_addr__t0 :named A1))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
(declare-fun var248_addressof_deref_var240_self__ik_network___t0 () (_ BitVec 64))
(declare-fun var249_len_addressof_deref_var240_self__ik_network____t0 () (_ BitVec 64))
(assert
  (= var249_len_addressof_deref_var240_self__ik_network____t0 (theory0_len var248_addressof_deref_var240_self__ik_network___t0) )
)

(assert
  (= var249_len_addressof_deref_var240_self__ik_network____t0 (_ bv1 64))

)

(assert
  (= var248_addressof_deref_var240_self__ik_network___t0 (_ bv247 64))

)

(declare-fun var250_true__t0 () Bool)
(assert
  (= var250_true__t0 (theory1_safe var248_addressof_deref_var240_self__ik_network___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
(declare-fun var251_addressof_deref_var240_self__ik_network___t0 () (_ BitVec 64))
(declare-fun var252_len_addressof_deref_var240_self__ik_network____t0 () (_ BitVec 64))
(assert
  (= var252_len_addressof_deref_var240_self__ik_network____t0 (theory0_len var251_addressof_deref_var240_self__ik_network___t0) )
)

(assert
  (= var252_len_addressof_deref_var240_self__ik_network____t0 (_ bv1 64))

)

(assert
  (= var251_addressof_deref_var240_self__ik_network___t0 (_ bv247 64))

)

(declare-fun var253_true__t0 () Bool)
(assert
  (= var253_true__t0 (theory1_safe var251_addressof_deref_var240_self__ik_network___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var254_interpretation_of_theory_safe_over_addressof_deref_var240_self__ik_network___t0 () Bool)
(assert
  (= var254_interpretation_of_theory_safe_over_addressof_deref_var240_self__ik_network___t0 (theory1_safe var251_addressof_deref_var240_self__ik_network___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var255_interpretation_of_theory_safe_over_addr__t0 () Bool)
(assert
  (= var255_interpretation_of_theory_safe_over_addr__t0 (theory1_safe var241_addr__t0) )
)

(push 1)

(assert
  (and true (or (not var254_interpretation_of_theory_safe_over_addressof_deref_var240_self__ik_network___t0 ) (not var255_interpretation_of_theory_safe_over_addr__t0 ) ))
