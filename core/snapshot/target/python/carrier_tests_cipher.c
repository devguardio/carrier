...
static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_tests_cipher", "carrier::tests::cipher", -1, methods};

PyObject*  py_mod_carrier_tests_cipher_Init()
{
