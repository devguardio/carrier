...
static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_tests_sha256", "carrier::tests::sha256", -1, methods};

PyObject*  py_mod_carrier_tests_sha256_Init()
{
