...
(assert
  (= var159_unary_expression__t0 (not var155_a__t0 ))
)
...
(assert
  (=  var167_infix_expression__t0 (= var155_a__t0 var166_literal_4294967295__t0))
)

(assert (! var167_infix_expression__t0 :named A0))(check-sat)
...
(assert
  (=  var170_infix_expression__t0 (= var155_a__t0 var169_literal_4294967295__t0))
)
