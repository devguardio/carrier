...
; : /home/aep/proj/devguard/carrier/core/src/revision.zz:8
...
; : :1
; literal expr
(declare-fun var15_literal_0__t0 () (_ BitVec 64))
(assert
  (= var15_literal_0__t0 (_ bv0 64))

)

(declare-fun var16_implicit_coercion_of_literal_0__t0 () (_ BitVec 64))
(assert (! (= var16_implicit_coercion_of_literal_0__t0 var15_literal_0__t0) :named A0))(declare-fun var10_return__t1 () (_ BitVec 64))
(declare-fun var10_return__t0 () (_ BitVec 64))
(assert
  (= var10_return__t1  (ite true var16_implicit_coercion_of_literal_0__t0 var10_return__t0)  )
)
