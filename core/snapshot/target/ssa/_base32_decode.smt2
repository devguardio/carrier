...
(assert
  (= var331_interpretation_of_theory_symbol_over___err__InvalidArgument__t0 (theory3_symbol var92___err__InvalidArgument__t0) )
)
...
(assert
  (= var336_interpretation_of_theory___err__checked_over_deref_S138_e___t0 (theory6___err__checked var140_deref_S138_e___t1) )
)
...
(assert
  (not (= var346_cast_of_lo__t0 #x0000000000000004))
)
...
(assert
  (= var374_interpretation_of_theory_symbol_over___err__OutOfTail__t0 (theory3_symbol var11___err__OutOfTail__t0) )
)
...
(assert
  (= var379_interpretation_of_theory___err__checked_over_deref_S138_e___t0 (theory6___err__checked var140_deref_S138_e___t2) )
)
