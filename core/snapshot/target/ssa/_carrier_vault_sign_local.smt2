...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:144
(declare-fun var217_deref_var208_self__i_sign_local__t0 () (_ BitVec 64))
(declare-fun var218_interpretation_of_theory_safe_over_deref_var208_self__i_sign_local__t0 () Bool)
(assert
  (= var218_interpretation_of_theory_safe_over_deref_var208_self__i_sign_local__t0 (theory1_safe var217_deref_var208_self__i_sign_local__t0) )
)

(assert (! var218_interpretation_of_theory_safe_over_deref_var208_self__i_sign_local__t0 :named A4))(check-sat)
...
; begin safe ptr check
; : /home/runner/work/carrier/carrier/core/src/vault.zz:145
(declare-fun var222_safe_deref_var208_self__i_sign_local___t0 () Bool)
(assert
  (= var222_safe_deref_var208_self__i_sign_local___t0 (theory1_safe var217_deref_var208_self__i_sign_local__t0) )
)

(push 1)

(assert
  (and true (or (not var222_safe_deref_var208_self__i_sign_local___t0 ) ))
