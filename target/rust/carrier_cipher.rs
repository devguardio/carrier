...
extern {
    ...
    pub fn r#decrypt( Zself: *mut u8,  Ze: *mut u8,  Zciphertext: *const u8,  Zcipherlen: usize,  Znonce: u64,  Zplain: *mut u8,  Zplainlen_max: usize)  -> usize;

    #[link_name = "carrier_cipher_encrypt"]
    pub fn r#encrypt( Zself: *mut u8,  Ze: *mut u8,  Zplain: *const u8,  Zplainlen: usize,  Znonce: u64,  Zciphertext: *mut u8,  Zcipherlen_max: usize)  -> usize;

    #[link_name = "carrier_cipher_encrypt_ad"]
    pub fn r#encrypt_ad( Zself: *mut u8,  Ze: *mut u8,  Zauthtext: *const u8,  Zauthtext_len: usize,  Zplain: *const u8,  Zplainlen: usize,  Znonce: u64,  Zciphertext: *mut u8,  Zcipherlen_max: usize)  -> usize;


    #[link_name = "carrier_cipher_decrypt_ad"]
    pub fn r#decrypt_ad( Zself: *mut u8,  Ze: *mut u8,  Zauthtext: *const u8,  Zauthtext_len: usize,  Zciphertext: *const u8,  Zcipherlen: usize,  Znonce: u64,  Zplain: *mut u8,  Zplainlen_max: usize)  -> usize;
