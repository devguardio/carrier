...
(assert (! (= var182_implicit_coercion_of_literal_0__t0 var181_literal_0__t0) :named A1)); : /home/runner/work/carrier/carrier/core/modules/io/src/lib.zz:268
(declare-fun var183_infix_expression__t0 () Bool)
(declare-fun var179_closure_fn___io__wake_fn__t0 () (_ BitVec 64))
(assert
  (=  var183_infix_expression__t0 (not (= var179_closure_fn___io__wake_fn__t0 var182_implicit_coercion_of_literal_0__t0)))
)
...
(assert
  (not (= var183_infix_expression__t0 true))
)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/modules/io/src/lib.zz:269
(declare-fun var178_deref_var174_self__impl_wake__t0 () (_ BitVec 64))
(declare-fun var184_interpretation_of_theory_safe_over_deref_var174_self__impl_wake__t0 () Bool)
(assert
  (= var184_interpretation_of_theory_safe_over_deref_var174_self__impl_wake__t0 (theory1_safe var178_deref_var174_self__impl_wake__t0) )
)

(assert (! var184_interpretation_of_theory_safe_over_deref_var174_self__impl_wake__t0 :named A2))(check-sat)
...
; begin safe ptr check
; : /home/runner/work/carrier/carrier/core/modules/io/src/lib.zz:270
(declare-fun var186_safe_deref_var174_self__impl_wake___t0 () Bool)
(assert
  (= var186_safe_deref_var174_self__impl_wake___t0 (theory1_safe var178_deref_var174_self__impl_wake__t0) )
)

(push 1)

(assert
  (and var183_infix_expression__t0 (or (not var186_safe_deref_var174_self__impl_wake___t0 ) ))
...
(declare-fun var176_deref_var174_self___t1 () (_ BitVec 64))
(declare-fun var176_deref_var174_self___t0 () (_ BitVec 64))
(assert
  (= var176_deref_var174_self___t1  (ite var183_infix_expression__t0 var176_deref_var174_self___t1 var176_deref_var174_self___t0)  )
)
