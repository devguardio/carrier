...
(assert (! (= var266_cast_of___ext___errno_h___errno__t0 var17___ext___errno_h___errno__t0) :named A11)); : /home/runner/work/carrier/carrier/core/modules/io/src/unix.zz:190
; : /home/runner/work/carrier/carrier/core/modules/io/src/unix.zz:190
; : /home/runner/work/carrier/carrier/core/modules/io/src/unix.zz:190
...
(assert (! (= var267_cast_of___ext___errno_h___EAGAIN__t0 var9___ext___errno_h___EAGAIN__t0) :named A12)); : /home/runner/work/carrier/carrier/core/modules/io/src/unix.zz:190
...
(assert
  (= var292_interpretation_of_theory___err__checked_over_deref_S232_e___t0 (theory36___err__checked var234_deref_S232_e___t1) )
)
...
(assert (! (= var297_implicit_coercion_of___io__Result__Error__t0 var31___io__Result__Error__t0) :named A15))(declare-fun var244_return__t0 () (_ BitVec 64))
(assert
...
(assert
  (= var299_safe___io__Result__Ready_____safe_return___t0 (theory1_safe var29___io__Result__Ready__t0) )
)
...
(assert
  (= var300_nullterm___io__Result__Ready_____nullterm_return___t0 (theory2_nullterm var29___io__Result__Ready__t0) )
)
...
(assert (! (= var301_implicit_coercion_of___io__Result__Ready__t0 var29___io__Result__Ready__t0) :named A17))(assert
...
(assert
  (= var302_interpretation_of_theory___err__checked_over_deref_S232_e___t0 (theory36___err__checked var234_deref_S232_e___t1) )
)
...
(assert
  (= var325_interpretation_of_theory___err__checked_over_deref_S232_e___t0 (theory36___err__checked var234_deref_S232_e___t2) )
)
...
(assert
  (= var328_safe___io__Result__Error_____safe_return___t0 (theory1_safe var31___io__Result__Error__t0) )
)
...
(assert
  (= var329_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var31___io__Result__Error__t0) )
)
...
(assert (! (= var330_implicit_coercion_of___io__Result__Error__t0 var31___io__Result__Error__t0) :named A21))(assert
