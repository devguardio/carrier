...
static PyObject* py_carrier_esp32_register_ota(PyObject *pyself, PyObject *args) {
    //ep
    PyObject * arg0 = 0;
    if (!PyArg_ParseTuple(args, "O", &arg0)) { return NULL; };
    carrier_esp32_register_ota(
        pyFATGetPtr(arg0, "carrier_endpoint_Endpoint"));
    Py_RETURN_NONE;
}

static PyObject* py_carrier_esp32_register_reboot(PyObject *pyself, PyObject *args) {
    //ep
    PyObject * arg0 = 0;
    if (!PyArg_ParseTuple(args, "O", &arg0)) { return NULL; };
    carrier_esp32_register_reboot(
        pyFATGetPtr(arg0, "carrier_endpoint_Endpoint"));
    Py_RETURN_NONE;
}
...
{"register_ota", py_carrier_esp32_register_ota, METH_VARARGS,""},
{"register_reboot", py_carrier_esp32_register_reboot, METH_VARARGS,""},
{NULL, NULL, 0, NULL}
};

static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_esp32", "carrier::esp32", -1, methods};

PyObject*  py_mod_carrier_esp32_Init()
{
