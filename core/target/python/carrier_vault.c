...
static PyObject * py_get_carrier_vault_Vault_i_get_secret(PyObject *pyself, void *closure) {

    carrier_vault_Vault * self = pyFATGetPtr(pyself, "carrier_vault_Vault");
    if (self == 0) { return 0; }
            return (PyObject*)self->i_get_secret.ctx;
}
static int py_set_carrier_vault_Vault_i_get_secret(PyObject *pyself, PyObject *value, void *closure) {

    carrier_vault_Vault * self = pyFATGetPtr(pyself, "carrier_vault_Vault");
    if (self == 0) { return 0; }
            self->i_get_secret = (carrier_vault_get_secret_fn){ fn: py_CLOSURE_carrier_vault_get_secret_fn, ctx: value };
    return 0;
}
...
{"i_get_secret", py_get_carrier_vault_Vault_i_get_secret, py_set_carrier_vault_Vault_i_get_secret,NULL,NULL},
...
static PyObject* py_carrier_vault_sign(PyObject *pyself, PyObject *args) {
    //self
    PyObject * arg0 = 0;
    //s
    PyObject * arg1 = 0;
...
static PyObject* py_carrier_vault_get_identity(PyObject *pyself, PyObject *args) {
    //self
    PyObject * arg0 = 0;
    //id
    PyObject * arg1 = 0;
    if (!PyArg_ParseTuple(args, "OO", &arg0,&arg1)) { return NULL; };
    carrier_vault_get_identity(
        pyFATGetPtr(arg0, "carrier_vault_Vault"),
        pyFATGetPtr(arg1, "carrier_identity_Identity"));
    Py_RETURN_NONE;
}
...
{"sign", py_carrier_vault_sign, METH_VARARGS,""},
{"close", py_carrier_vault_close, METH_VARARGS,""},
{"vector_time", py_carrier_vault_vector_time, METH_VARARGS,""},
{"get_identity", py_carrier_vault_get_identity, METH_VARARGS,""},
