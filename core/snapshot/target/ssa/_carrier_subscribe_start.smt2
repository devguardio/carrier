...
(assert
  (= var876_addressof___carrier__subscribe__SubscribeConfig___t0 (_ bv546 64))
...
(assert
  (= var888_addressof___carrier__subscribe__SubscribeConfig___t0 (_ bv546 64))
...
(assert
  (= var895_interpretation_of_theory_safe_over_literal_string___carrier_broker_v1_broker_subscribe___t0 (theory1_safe var548_literal_string___carrier_broker_v1_broker_subscribe___t0) )
)
...
(assert
  (= var896_interpretation_of_theory_nullterm_over_literal_string___carrier_broker_v1_broker_subscribe___t0 (theory2_nullterm var548_literal_string___carrier_broker_v1_broker_subscribe___t0) )
)
