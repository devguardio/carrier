...
(assert
  (= var122_interpretation_of_theory_safe_over_self__t0 (theory1_safe var121_self__t0) )
)

(assert (! var122_interpretation_of_theory_safe_over_self__t0 :named A2))(check-sat)
...
(declare-fun var125_safe_self___t0 () Bool)
(assert
  (= var125_safe_self___t0 (theory1_safe var121_self__t0) )
)

(push 1)

(assert
  (and true (or (not var125_safe_self___t0 ) ))
...
; literal expr
(declare-fun var126_literal_8__t0 () (_ BitVec 64))
(assert
  (= var126_literal_8__t0 (_ bv8 64))
...
(assert
  (not (= var126_literal_8__t0 #x0000000000000008))
)
...
; : /home/runner/work/carrier/carrier/core/src/sha256.zz:26
(declare-fun var127_deref_var121_self__state__t0 () (_ BitVec 64))
(declare-fun var128_len_deref_var121_self__state___t0 () (_ BitVec 64))
(assert
  (= var128_len_deref_var121_self__state___t0 (theory0_len var127_deref_var121_self__state__t0) )
)

(assert
  (= var128_len_deref_var121_self__state___t0 (_ bv8 64))

)

(declare-fun var129_true__t0 () Bool)
(assert
  (= var129_true__t0 (theory1_safe var127_deref_var121_self__state__t0) )
)
...
(declare-fun var133_implicit_coercion_of_literal_0__t0 () (_ BitVec 8))
(assert (! (= var133_implicit_coercion_of_literal_0__t0 ( (_ extract 7 0) var132_literal_0__t0 )) :named A3))(declare-fun var131_deref_var121_self__at__t1 () (_ BitVec 8))
(declare-fun var131_deref_var121_self__at__t0 () (_ BitVec 8))
(assert
  (= var131_deref_var121_self__at__t1  (ite true var133_implicit_coercion_of_literal_0__t0 var131_deref_var121_self__at__t0)  )
)
