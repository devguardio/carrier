...
#include <stdint.h>
#include <string.h>
#include "zz/carrier/carrier_python.h"
...
static PyObject* py_carrier_python_hellozz(PyObject *pyself, PyObject *args) {
    long long int rarg = (long long int)(carrier_python_hellozz(
        ));
...
{"hellozz", py_carrier_python_hellozz, METH_NOARGS,""},
{NULL, NULL, 0, NULL}
};

static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_python", "carrier::python", -1, methods};
