...
napi_value js_carrier_noise_accept(napi_env env, napi_callback_info info) {
    ...
    uintptr_t  frrr = carrier_noise_accept( local_0, local_1, local_1_tail, local_3, local_4, local_5, local_6);
...
napi_value js_carrier_noise_receive(napi_env env, napi_callback_info info) {
    ...
    uintptr_t  local_8;
    status = napi_get_value_uint32(env, argv[6], (uint32_t*)&local_8);

                    if (status != napi_ok) {
                        napi_throw_type_error(env, 0, "7'th arg requires type usize");
                        return 0;
                    }
                    napi_value jsreturn = 0;
    uintptr_t  frrr = carrier_noise_receive( local_0, local_1, local_1_tail, local_3, local_4, local_5, local_6, local_7, local_8);
    status = napi_create_uint32(env, frrr, &jsreturn);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_carrier_noise_initiate(napi_env env, napi_callback_info info) {
    ...
    status = napi_get_value_uint32(env, argv[6], (uint32_t*)&local_8);
                    ...
                    napi_value jsreturn = 0;
    uintptr_t  frrr = carrier_noise_initiate( local_0, local_1, local_1_tail, local_3, local_4, local_5, local_6, local_7, local_8);
    status = napi_create_uint32(env, frrr, &jsreturn);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_carrier_noise_initiate_insecure(napi_env env, napi_callback_info info) {
    ...
    status = napi_get_value_uint32(env, argv[6], (uint32_t*)&local_8);
                    ...
                    napi_value jsreturn = 0;
    uintptr_t  frrr = carrier_noise_initiate_insecure( local_0, local_1, local_1_tail, local_3, local_4, local_5, local_6, local_7, local_8);
    status = napi_create_uint32(env, frrr, &jsreturn);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_carrier_noise_complete(napi_env env, napi_callback_info info) {
    ...
    status = napi_get_value_uint32(env, argv[4], (uint32_t*)&local_6);
                    ...
                    napi_value jsreturn = 0;
    uintptr_t  frrr = carrier_noise_complete( local_0, local_1, local_1_tail, local_3, local_4, local_5, local_6);
    status = napi_create_uint32(env, frrr, &jsreturn);
    assert(status == napi_ok);
    return jsreturn;
}

napi_value jsGet_carrier_noise_Responder_symm(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  assert(status == napi_ok);
  mem += sizeof(size_t);
  carrier_noise_Responder * obj = (carrier_noise_Responder*)mem;
...
napi_value jsSet_carrier_noise_Responder_symm(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_noise_Responder_ephemeral(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_noise_Responder_statickey(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_noise_Responder_remote_ephemeral(napi_env env, napi_callback_info info) {
  napi_status status;
...
void js_delete_carrier_noise_Responder(napi_env env, void *obj, void*hint) {
    free(obj);
}
napi_value js_new_carrier_noise_Responder(napi_env env, napi_callback_info info) {
    napi_status status;
    ...
    void *obj = malloc(sizeof(size_t) + sizeof_carrier_noise_Responder);
    memset(obj, 0, sizeof(size_t) + sizeof_carrier_noise_Responder);
    ...
    *((size_t *)obj) = tail;
    ...
    status = napi_wrap(env,
            jsthis,
            obj,
            js_delete_carrier_noise_Responder, // destructor
            0,  // finalize_hint
            0
    );
    assert(status == napi_ok);
...
void js_register_carrier_noise_Responder (napi_env env, napi_value exports) {
    napi_property_descriptor properties[] = {
        { "receive", 0, js_carrier_noise_receive, 0, 0, 0, napi_default, 0 },
        { "receive_insecure", 0, js_carrier_noise_receive_insecure, 0, 0, 0, napi_default, 0 },
        { "accept", 0, js_carrier_noise_accept, 0, 0, 0, napi_default, 0 },
        { "symm", 0, 0, jsGet_carrier_noise_Responder_symm, jsSet_carrier_noise_Responder_symm, 0, napi_default, 0},
        { "ephemeral", 0, 0, jsGet_carrier_noise_Responder_ephemeral, 0, 0, napi_default, 0},
        { "statickey", 0, 0, jsGet_carrier_noise_Responder_statickey, 0, 0, napi_default, 0},
        { "remote_ephemeral", 0, 0, jsGet_carrier_noise_Responder_remote_ephemeral, 0, 0, napi_default, 0},
    };
    napi_value cc;
    napi_status status = napi_define_class(env, "Responder", NAPI_AUTO_LENGTH, js_new_carrier_noise_Responder, 0, 7, properties, &cc);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "Responder", cc);
    assert(status == napi_ok);
}


napi_value jsGet_carrier_noise_Initiator_symm(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  assert(status == napi_ok);
  mem += sizeof(size_t);
  carrier_noise_Initiator * obj = (carrier_noise_Initiator*)mem;
...
napi_value jsSet_carrier_noise_Initiator_symm(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_noise_Initiator_ephemeral(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsSet_carrier_noise_Initiator_ephemeral(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_noise_Initiator_remote_static(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsSet_carrier_noise_Initiator_remote_static(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_noise_Initiator_remote_ephemeral(napi_env env, napi_callback_info info) {
  napi_status status;
...
void js_delete_carrier_noise_Initiator(napi_env env, void *obj, void*hint) {
    free(obj);
}
napi_value js_new_carrier_noise_Initiator(napi_env env, napi_callback_info info) {
    napi_status status;
    ...
    void *obj = malloc(sizeof(size_t) + sizeof_carrier_noise_Initiator);
    memset(obj, 0, sizeof(size_t) + sizeof_carrier_noise_Initiator);
    ...
    *((size_t *)obj) = tail;
    ...
    status = napi_wrap(env,
            jsthis,
            obj,
            js_delete_carrier_noise_Initiator, // destructor
            0,  // finalize_hint
            0
    );
    assert(status == napi_ok);
...
void js_register_carrier_noise_Initiator (napi_env env, napi_value exports) {
    napi_property_descriptor properties[] = {
        { "complete", 0, js_carrier_noise_complete, 0, 0, 0, napi_default, 0 },
        { "initiate", 0, js_carrier_noise_initiate, 0, 0, 0, napi_default, 0 },
        { "initiate_insecure", 0, js_carrier_noise_initiate_insecure, 0, 0, 0, napi_default, 0 },
        { "symm", 0, 0, jsGet_carrier_noise_Initiator_symm, jsSet_carrier_noise_Initiator_symm, 0, napi_default, 0},
        { "ephemeral", 0, 0, jsGet_carrier_noise_Initiator_ephemeral, jsSet_carrier_noise_Initiator_ephemeral, 0, napi_default, 0},
        { "remote_static", 0, 0, jsGet_carrier_noise_Initiator_remote_static, jsSet_carrier_noise_Initiator_remote_static, 0, napi_default, 0},
        { "remote_ephemeral", 0, 0, jsGet_carrier_noise_Initiator_remote_ephemeral, 0, 0, napi_default, 0},
    };
    napi_value cc;
    napi_status status = napi_define_class(env, "Initiator", NAPI_AUTO_LENGTH, js_new_carrier_noise_Initiator, 0, 7, properties, &cc);
    assert(status == napi_ok);
...
napi_value js_carrier_noise_receive_insecure(napi_env env, napi_callback_info info) {
    ...
    status = napi_get_value_uint32(env, argv[3], (uint32_t*)&local_4);
                    ...
                    napi_value jsreturn = 0;
    carrier_noise_receive_insecure( local_0, local_1, local_2, local_3, local_4);
    return jsreturn;
}


napi_value js_carrier_noise_Init(napi_env env, napi_value exports)
{
    js_register_carrier_noise_Responder(env, exports);
    js_register_carrier_noise_Initiator(env, exports);
    napi_value ff;
    napi_status status;
    status = napi_create_function(env, "accept", NAPI_AUTO_LENGTH, js_carrier_noise_accept, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "accept", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "receive", NAPI_AUTO_LENGTH, js_carrier_noise_receive, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "receive", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "initiate", NAPI_AUTO_LENGTH, js_carrier_noise_initiate, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "initiate", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "initiate_insecure", NAPI_AUTO_LENGTH, js_carrier_noise_initiate_insecure, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "initiate_insecure", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "complete", NAPI_AUTO_LENGTH, js_carrier_noise_complete, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "complete", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "receive_insecure", NAPI_AUTO_LENGTH, js_carrier_noise_receive_insecure, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "receive_insecure", ff);
    assert(status == napi_ok);
    return exports;
}
