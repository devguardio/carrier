...
(assert
  (= var273_interpretation_of_theory___err__checked_over_deref_S260_e___t0 (theory49___err__checked var262_deref_S260_e___t0) )
)
...
(assert
  (= var307_addressof___madpack__macrohelper__stringbuf___t0 (_ bv78 64))
...
(assert
  (= var310_addressof___madpack__macrohelper__stringbuf___t0 (_ bv78 64))
...
(assert
  (= var338_addressof___madpack__macrohelper__stringbuf___t0 (_ bv78 64))
...
(assert
  (= var341_addressof___madpack__macrohelper__stringbuf___t0 (_ bv78 64))
...
(assert
  (= var344_addressof___madpack__macrohelper__stringbuf___t0 (_ bv78 64))
...
(assert
  (= var373_addressof___madpack__macrohelper__stringbuf___t0 (_ bv78 64))
