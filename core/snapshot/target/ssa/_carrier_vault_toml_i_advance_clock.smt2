...
(assert
  (= var329_interpretation_of_theory_safe_over_self__t0 (theory1_safe var328_self__t0) )
)

(assert (! var329_interpretation_of_theory_safe_over_self__t0 :named A2))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:478
(declare-fun var332_return_value_of___time__real__t0 () (_ BitVec 64))
(declare-fun var333_safe_return_value_of___time__real_____safe_now___t0 () Bool)
(assert
  (= var333_safe_return_value_of___time__real_____safe_now___t0 (theory1_safe var332_return_value_of___time__real__t0) )
)

(declare-fun var331_now__t1 () (_ BitVec 64))
(assert
  (= var333_safe_return_value_of___time__real_____safe_now___t0 (theory1_safe var331_now__t1) )
)

(declare-fun var334_nullterm_return_value_of___time__real_____nullterm_now___t0 () Bool)
(assert
  (= var334_nullterm_return_value_of___time__real_____nullterm_now___t0 (theory2_nullterm var332_return_value_of___time__real__t0) )
)

(assert
  (= var334_nullterm_return_value_of___time__real_____nullterm_now___t0 (theory2_nullterm var331_now__t1) )
)

(declare-fun var331_now__t0 () (_ BitVec 64))
(assert
  (= var331_now__t1  (ite true var332_return_value_of___time__real__t0 var331_now__t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:479
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:479
(declare-fun var336_addressof_now___t0 () (_ BitVec 64))
(declare-fun var337_len_addressof_now____t0 () (_ BitVec 64))
(assert
  (= var337_len_addressof_now____t0 (theory0_len var336_addressof_now___t0) )
)

(assert
  (= var337_len_addressof_now____t0 (_ bv1 64))

)

(assert
  (= var336_addressof_now___t0 (_ bv331 64))

)

(declare-fun var338_true__t0 () Bool)
(assert
  (= var338_true__t0 (theory1_safe var336_addressof_now___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:479
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:479
(declare-fun var339_addressof_now___t0 () (_ BitVec 64))
(declare-fun var340_len_addressof_now____t0 () (_ BitVec 64))
(assert
  (= var340_len_addressof_now____t0 (theory0_len var339_addressof_now___t0) )
)

(assert
  (= var340_len_addressof_now____t0 (_ bv1 64))

)

(assert
  (= var339_addressof_now___t0 (_ bv331 64))

)

(declare-fun var341_true__t0 () Bool)
(assert
  (= var341_true__t0 (theory1_safe var339_addressof_now___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var342_interpretation_of_theory_safe_over_addressof_now___t0 () Bool)
(assert
  (= var342_interpretation_of_theory_safe_over_addressof_now___t0 (theory1_safe var339_addressof_now___t0) )
)

(push 1)

(assert
  (and true (or (not var342_interpretation_of_theory_safe_over_addressof_now___t0 ) ))
...
; callsite effects
; end of callsite effects
(declare-fun var343_return_value_of___time__to_millis__t0 () (_ BitVec 64))
(declare-fun var344_safe_return_value_of___time__to_millis_____safe_return___t0 () Bool)
(assert
  (= var344_safe_return_value_of___time__to_millis_____safe_return___t0 (theory1_safe var343_return_value_of___time__to_millis__t0) )
)

(declare-fun var330_return__t1 () (_ BitVec 64))
(assert
  (= var344_safe_return_value_of___time__to_millis_____safe_return___t0 (theory1_safe var330_return__t1) )
)

(declare-fun var345_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 () Bool)
(assert
  (= var345_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 (theory2_nullterm var343_return_value_of___time__to_millis__t0) )
)

(assert
  (= var345_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 (theory2_nullterm var330_return__t1) )
)

(declare-fun var330_return__t0 () (_ BitVec 64))
(assert
  (= var330_return__t1  (ite true var343_return_value_of___time__to_millis__t0 var330_return__t0)  )
)
