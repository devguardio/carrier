...
#include <stdint.h>
#include <string.h>
#include "zz/carrier/carrier_config.h"
...
napi_value js_carrier_config_auth_get_cb(napi_env env, napi_callback_info info);
...
napi_value js_carrier_config_open_then_stream(napi_env env, napi_callback_info info) {
    ...
    carrier_config_open_then_stream( local_0, local_1, local_1_tail, local_3);
    return jsreturn;
}
...
napi_value js_carrier_config_auth_del_stream(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_3 == 0 || status != napi_ok) {
        ...
        local_3 = tttt_local_3 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    bool  frrr = carrier_config_auth_del_stream( local_0, local_1, local_1_tail, local_3);
...
napi_value js_carrier_config_auth_add_stream(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_3 == 0 || status != napi_ok) {
        ...
        local_3 = tttt_local_3 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    bool  frrr = carrier_config_auth_add_stream( local_0, local_1, local_1_tail, local_3);
    status = napi_create_uint32(env, frrr, &jsreturn);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_carrier_config_auth_get_cb(napi_env env, napi_callback_info info) {
    ...
    char * local_2;
                    ...
                    napi_value jsreturn = 0;
    carrier_config_auth_get_cb( local_0, local_1, local_2);
    return jsreturn;
}
...
napi_value js_carrier_config_register(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_0 == 0 || status != napi_ok) {
        ...
        local_0 = tttt_local_0 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    carrier_config_register( local_0);
    return jsreturn;
}
...
napi_value js_carrier_config_auth_add_del_stream(napi_env env, napi_callback_info info) {
    ...
    int  local_4;
    status = napi_get_value_int32(env, argv[2], (int32_t*)&local_4);

                    if (status != napi_ok) {
                        napi_throw_type_error(env, 0, "3'th arg requires type int");
                        return 0;
                    }
                    napi_value jsreturn = 0;
    bool  frrr = carrier_config_auth_add_del_stream( local_0, local_1, local_1_tail, local_3, local_4);
    status = napi_create_uint32(env, frrr, &jsreturn);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_carrier_config_return_err(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_1 == 0 || status != napi_ok) {
        ...
        local_1 = tttt_local_1 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    bool  frrr = carrier_config_return_err( local_0, local_1, local_1_tail);
    status = napi_create_uint32(env, frrr, &jsreturn);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_carrier_config_auth_get(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_3 == 0 || status != napi_ok) {
        ...
        local_3 = tttt_local_3 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    carrier_config_auth_get( local_0, local_1, local_1_tail, local_3);
    return jsreturn;
}
...
napi_value js_carrier_config_net_get(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_3 == 0 || status != napi_ok) {
        ...
        local_3 = tttt_local_3 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    carrier_config_net_get( local_0, local_1, local_1_tail, local_3);
    return jsreturn;
}
...
napi_value js_carrier_config_net_join_stream(napi_env env, napi_callback_info info) {
    ...
    if (tttt_local_3 == 0 || status != napi_ok) {
        ...
        local_3 = tttt_local_3 + sizeof(size_t*);
                    ...
                    napi_value jsreturn = 0;
    bool  frrr = carrier_config_net_join_stream( local_0, local_1, local_1_tail, local_3);
    status = napi_create_uint32(env, frrr, &jsreturn);
    assert(status == napi_ok);
    return jsreturn;
}
...
napi_value js_carrier_config_Init(napi_env env, napi_value exports)
{
    napi_value ff;
    napi_status status;
    status = napi_create_function(env, "open_then_stream", NAPI_AUTO_LENGTH, js_carrier_config_open_then_stream, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "open_then_stream", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "auth_del_stream", NAPI_AUTO_LENGTH, js_carrier_config_auth_del_stream, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "auth_del_stream", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "auth_add_stream", NAPI_AUTO_LENGTH, js_carrier_config_auth_add_stream, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "auth_add_stream", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "auth_get_cb", NAPI_AUTO_LENGTH, js_carrier_config_auth_get_cb, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "auth_get_cb", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "register", NAPI_AUTO_LENGTH, js_carrier_config_register, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "register", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "auth_add_del_stream", NAPI_AUTO_LENGTH, js_carrier_config_auth_add_del_stream, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "auth_add_del_stream", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "return_err", NAPI_AUTO_LENGTH, js_carrier_config_return_err, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "return_err", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "auth_get", NAPI_AUTO_LENGTH, js_carrier_config_auth_get, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "auth_get", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "net_get", NAPI_AUTO_LENGTH, js_carrier_config_net_get, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "net_get", ff);
    assert(status == napi_ok);
    status = napi_create_function(env, "net_join_stream", NAPI_AUTO_LENGTH, js_carrier_config_net_join_stream, 0, &ff);
    assert(status == napi_ok);
    status = napi_set_named_property(env, exports, "net_join_stream", ff);
    assert(status == napi_ok);
    return exports;
}
