...
static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_cmd_config_auth_add", "carrier::cmd_config_auth_add", -1, methods};

PyObject*  py_mod_carrier_cmd_config_auth_add_Init()
{
