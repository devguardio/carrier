...
(declare-fun var204_safe_self___t0 () Bool)
(assert
  (= var204_safe_self___t0 (theory1_safe var200_self__t0) )
)

(push 1)

(assert
  (and true (or (not var204_safe_self___t0 ) ))
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:139
(declare-fun var205_deref_var200_self__i_advance_clock__t0 () (_ BitVec 64))
(declare-fun var206_interpretation_of_theory_safe_over_deref_var200_self__i_advance_clock__t0 () Bool)
(assert
  (= var206_interpretation_of_theory_safe_over_deref_var200_self__i_advance_clock__t0 (theory1_safe var205_deref_var200_self__i_advance_clock__t0) )
)

(assert (! var206_interpretation_of_theory_safe_over_deref_var200_self__i_advance_clock__t0 :named A2))(check-sat)
...
; begin safe ptr check
; : /home/runner/work/carrier/carrier/core/src/vault.zz:140
(declare-fun var210_safe_deref_var200_self__i_advance_clock___t0 () Bool)
(assert
  (= var210_safe_deref_var200_self__i_advance_clock___t0 (theory1_safe var205_deref_var200_self__i_advance_clock__t0) )
)

(push 1)

(assert
  (and true (or (not var210_safe_deref_var200_self__i_advance_clock___t0 ) ))
...
(declare-fun var211_return_value_of_closure_fn___carrier__vault__advance_clock_fn__t0 () (_ BitVec 64))
(declare-fun var212_safe_return_value_of_closure_fn___carrier__vault__advance_clock_fn_____safe_return___t0 () Bool)
(assert
  (= var212_safe_return_value_of_closure_fn___carrier__vault__advance_clock_fn_____safe_return___t0 (theory1_safe var211_return_value_of_closure_fn___carrier__vault__advance_clock_fn__t0) )
)

(declare-fun var202_return__t1 () (_ BitVec 64))
(assert
  (= var212_safe_return_value_of_closure_fn___carrier__vault__advance_clock_fn_____safe_return___t0 (theory1_safe var202_return__t1) )
)

(declare-fun var213_nullterm_return_value_of_closure_fn___carrier__vault__advance_clock_fn_____nullterm_return___t0 () Bool)
(assert
  (= var213_nullterm_return_value_of_closure_fn___carrier__vault__advance_clock_fn_____nullterm_return___t0 (theory2_nullterm var211_return_value_of_closure_fn___carrier__vault__advance_clock_fn__t0) )
)

(assert
  (= var213_nullterm_return_value_of_closure_fn___carrier__vault__advance_clock_fn_____nullterm_return___t0 (theory2_nullterm var202_return__t1) )
)

(declare-fun var202_return__t0 () (_ BitVec 64))
(assert
  (= var202_return__t1  (ite true var211_return_value_of_closure_fn___carrier__vault__advance_clock_fn__t0 var202_return__t0)  )
)
