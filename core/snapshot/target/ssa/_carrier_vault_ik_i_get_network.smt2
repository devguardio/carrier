...
(declare-fun var230_interpretation_of_theory_safe_over_addr__t0 () Bool)
(assert
  (= var230_interpretation_of_theory_safe_over_addr__t0 (theory1_safe var229_addr__t0) )
)

(assert (! var230_interpretation_of_theory_safe_over_addr__t0 :named A1))(check-sat)
...
(assert
  (= var231_interpretation_of_theory_safe_over_self__t0 (theory1_safe var228_self__t0) )
)
...
(assert
  (= var233_safe_self___t0 (theory1_safe var228_self__t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
(declare-fun var236_addressof_deref_var228_self__ik_network___t0 () (_ BitVec 64))
(declare-fun var237_len_addressof_deref_var228_self__ik_network____t0 () (_ BitVec 64))
(assert
  (= var237_len_addressof_deref_var228_self__ik_network____t0 (theory0_len var236_addressof_deref_var228_self__ik_network___t0) )
)

(assert
  (= var237_len_addressof_deref_var228_self__ik_network____t0 (_ bv1 64))

)

(assert
  (= var236_addressof_deref_var228_self__ik_network___t0 (_ bv235 64))

)

(declare-fun var238_true__t0 () Bool)
(assert
  (= var238_true__t0 (theory1_safe var236_addressof_deref_var228_self__ik_network___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
(declare-fun var239_addressof_deref_var228_self__ik_network___t0 () (_ BitVec 64))
(declare-fun var240_len_addressof_deref_var228_self__ik_network____t0 () (_ BitVec 64))
(assert
  (= var240_len_addressof_deref_var228_self__ik_network____t0 (theory0_len var239_addressof_deref_var228_self__ik_network___t0) )
)

(assert
  (= var240_len_addressof_deref_var228_self__ik_network____t0 (_ bv1 64))

)

(assert
  (= var239_addressof_deref_var228_self__ik_network___t0 (_ bv235 64))

)

(declare-fun var241_true__t0 () Bool)
(assert
  (= var241_true__t0 (theory1_safe var239_addressof_deref_var228_self__ik_network___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var242_interpretation_of_theory_safe_over_addressof_deref_var228_self__ik_network___t0 () Bool)
(assert
  (= var242_interpretation_of_theory_safe_over_addressof_deref_var228_self__ik_network___t0 (theory1_safe var239_addressof_deref_var228_self__ik_network___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var243_interpretation_of_theory_safe_over_addr__t0 () Bool)
(assert
  (= var243_interpretation_of_theory_safe_over_addr__t0 (theory1_safe var229_addr__t0) )
)

(push 1)

(assert
  (and true (or (not var242_interpretation_of_theory_safe_over_addressof_deref_var228_self__ik_network___t0 ) (not var243_interpretation_of_theory_safe_over_addr__t0 ) ))
