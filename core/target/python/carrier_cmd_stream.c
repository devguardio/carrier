...
#include <stdint.h>
#include <string.h>
#include "zz/carrier/carrier_cmd_stream.h"
...
static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_cmd_stream", "carrier::cmd_stream", -1, methods};

PyObject*  py_mod_carrier_cmd_stream_Init()
{
