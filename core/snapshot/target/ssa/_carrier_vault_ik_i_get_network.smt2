...
(declare-fun var239_addr__t0 () (_ BitVec 64))
(declare-fun var240_interpretation_of_theory_safe_over_addr__t0 () Bool)
(assert
  (= var240_interpretation_of_theory_safe_over_addr__t0 (theory1_safe var239_addr__t0) )
)

(assert (! var240_interpretation_of_theory_safe_over_addr__t0 :named A1))(check-sat)
...
(assert
  (= var241_interpretation_of_theory_safe_over_self__t0 (theory1_safe var238_self__t0) )
)

(assert (! var241_interpretation_of_theory_safe_over_self__t0 :named A2))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
(declare-fun var246_addressof_deref_var238_self__ik_network___t0 () (_ BitVec 64))
(declare-fun var247_len_addressof_deref_var238_self__ik_network____t0 () (_ BitVec 64))
(assert
  (= var247_len_addressof_deref_var238_self__ik_network____t0 (theory0_len var246_addressof_deref_var238_self__ik_network___t0) )
)

(assert
  (= var247_len_addressof_deref_var238_self__ik_network____t0 (_ bv1 64))

)

(assert
  (= var246_addressof_deref_var238_self__ik_network___t0 (_ bv245 64))

)

(declare-fun var248_true__t0 () Bool)
(assert
  (= var248_true__t0 (theory1_safe var246_addressof_deref_var238_self__ik_network___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
; : /home/runner/work/carrier/carrier/core/src/vault_ik.zz:48
(declare-fun var249_addressof_deref_var238_self__ik_network___t0 () (_ BitVec 64))
(declare-fun var250_len_addressof_deref_var238_self__ik_network____t0 () (_ BitVec 64))
(assert
  (= var250_len_addressof_deref_var238_self__ik_network____t0 (theory0_len var249_addressof_deref_var238_self__ik_network___t0) )
)

(assert
  (= var250_len_addressof_deref_var238_self__ik_network____t0 (_ bv1 64))

)

(assert
  (= var249_addressof_deref_var238_self__ik_network___t0 (_ bv245 64))

)

(declare-fun var251_true__t0 () Bool)
(assert
  (= var251_true__t0 (theory1_safe var249_addressof_deref_var238_self__ik_network___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var252_interpretation_of_theory_safe_over_addressof_deref_var238_self__ik_network___t0 () Bool)
(assert
  (= var252_interpretation_of_theory_safe_over_addressof_deref_var238_self__ik_network___t0 (theory1_safe var249_addressof_deref_var238_self__ik_network___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var253_interpretation_of_theory_safe_over_addr__t0 () Bool)
(assert
  (= var253_interpretation_of_theory_safe_over_addr__t0 (theory1_safe var239_addr__t0) )
)

(push 1)

(assert
  (and true (or (not var252_interpretation_of_theory_safe_over_addressof_deref_var238_self__ik_network___t0 ) (not var253_interpretation_of_theory_safe_over_addr__t0 ) ))
