...
(declare-fun var265_return_value_of___byteorder__swap64__t0 () (_ BitVec 64))
(declare-fun var266_safe_return_value_of___byteorder__swap64_____safe_return___t0 () Bool)
(assert
  (= var266_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var265_return_value_of___byteorder__swap64__t0) )
)

(declare-fun var264_return__t1 () (_ BitVec 64))
(assert
  (= var266_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var264_return__t1) )
)

(declare-fun var267_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 () Bool)
(assert
  (= var267_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var265_return_value_of___byteorder__swap64__t0) )
)

(assert
  (= var267_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var264_return__t1) )
)

(declare-fun var264_return__t0 () (_ BitVec 64))
(assert
  (= var264_return__t1  (ite true var265_return_value_of___byteorder__swap64__t0 var264_return__t0)  )
)
...
(declare-fun var268_x__t0 () (_ BitVec 64))
(declare-fun var270_safe_x_____safe_return___t0 () Bool)
(assert
  (= var270_safe_x_____safe_return___t0 (theory1_safe var268_x__t0) )
)

(declare-fun var269_return__t1 () (_ BitVec 64))
(assert
  (= var270_safe_x_____safe_return___t0 (theory1_safe var269_return__t1) )
)

(declare-fun var271_nullterm_x_____nullterm_return___t0 () Bool)
(assert
  (= var271_nullterm_x_____nullterm_return___t0 (theory2_nullterm var268_x__t0) )
)

(assert
  (= var271_nullterm_x_____nullterm_return___t0 (theory2_nullterm var269_return__t1) )
)

(declare-fun var269_return__t0 () (_ BitVec 64))
(assert
  (= var269_return__t1  (ite true var268_x__t0 var269_return__t0)  )
)
