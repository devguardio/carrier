...
; : /home/runner/work/carrier/carrier/core/modules/sysinfo/src/proto.zz:1689
(declare-fun var654_implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity__t0 () (_ BitVec 64))
(assert (! (= var654_implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity__t0 var475___sysinfo__proto__AuthorizationDel__Identity__t0) :named A0)); : /home/runner/work/carrier/carrier/core/modules/sysinfo/src/proto.zz:1695
(declare-fun var655_switch_branch__index__implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity___t0 () Bool)
(declare-fun var652_index__t0 () (_ BitVec 64))
(assert
  (=  var655_switch_branch__index__implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity___t0 (= var652_index__t0 var654_implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity__t0))
)
...
(assert
  (= var653_return__t1  (ite var655_switch_branch__index__implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity___t0 var658_implicit_coercion_of___protonerf__FieldType__Message__t0 var653_return__t0)  )
)

; branch returned. the rest of the function only happens if the condition leading to return never happened
; (not var655_switch_branch__index__implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity___t0)
(assert
  (not var655_switch_branch__index__implicit_coercion_of___sysinfo__proto__AuthorizationDel__Identity___t0)
)

; : /home/runner/work/carrier/carrier/core/modules/sysinfo/src/proto.zz:1699
(declare-fun var659_safe___protonerf__FieldType__Skip_____safe_return___t0 () Bool)
(assert
  (= var659_safe___protonerf__FieldType__Skip_____safe_return___t0 (theory1_safe var28___protonerf__FieldType__Skip__t0) )
)

(declare-fun var653_return__t2 () (_ BitVec 64))
(assert
  (= var659_safe___protonerf__FieldType__Skip_____safe_return___t0 (theory1_safe var653_return__t2) )
)

(declare-fun var660_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 () Bool)
(assert
  (= var660_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 (theory2_nullterm var28___protonerf__FieldType__Skip__t0) )
)

(assert
  (= var660_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 (theory2_nullterm var653_return__t2) )
)

; : /home/runner/work/carrier/carrier/core/modules/protonerf/src/lib.zz:8
(declare-fun var661_implicit_coercion_of___protonerf__FieldType__Skip__t0 () (_ BitVec 64))
(assert (! (= var661_implicit_coercion_of___protonerf__FieldType__Skip__t0 var28___protonerf__FieldType__Skip__t0) :named A2))(assert
  (= var653_return__t2  (ite true var661_implicit_coercion_of___protonerf__FieldType__Skip__t0 var653_return__t1)  )
)
