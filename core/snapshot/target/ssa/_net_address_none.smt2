...
(assert
  (= var200_safe_self___t0 (theory1_safe var197_self__t0) )
)
...
; : /home/runner/work/carrier/carrier/modules/net/src/address.zz:30
; : /home/runner/work/carrier/carrier/modules/net/src/address.zz:10
(declare-fun var202_implicit_coercion_of___net__address__Type__Invalid__t0 () (_ BitVec 64))
(assert (! (= var202_implicit_coercion_of___net__address__Type__Invalid__t0 var15___net__address__Type__Invalid__t0) :named A1)); : /home/runner/work/carrier/carrier/modules/net/src/address.zz:30
(declare-fun var203_safe_implicit_coercion_of___net__address__Type__Invalid_____safe_deref_var197_self__typ___t0 () Bool)
(assert
  (= var203_safe_implicit_coercion_of___net__address__Type__Invalid_____safe_deref_var197_self__typ___t0 (theory1_safe var202_implicit_coercion_of___net__address__Type__Invalid__t0) )
)

(declare-fun var201_deref_var197_self__typ__t1 () (_ BitVec 64))
(assert
  (= var203_safe_implicit_coercion_of___net__address__Type__Invalid_____safe_deref_var197_self__typ___t0 (theory1_safe var201_deref_var197_self__typ__t1) )
)

(declare-fun var204_nullterm_implicit_coercion_of___net__address__Type__Invalid_____nullterm_deref_var197_self__typ___t0 () Bool)
(assert
  (= var204_nullterm_implicit_coercion_of___net__address__Type__Invalid_____nullterm_deref_var197_self__typ___t0 (theory2_nullterm var202_implicit_coercion_of___net__address__Type__Invalid__t0) )
)

(assert
  (= var204_nullterm_implicit_coercion_of___net__address__Type__Invalid_____nullterm_deref_var197_self__typ___t0 (theory2_nullterm var201_deref_var197_self__typ__t1) )
)

(declare-fun var201_deref_var197_self__typ__t0 () (_ BitVec 64))
(assert
  (= var201_deref_var197_self__typ__t1  (ite true var202_implicit_coercion_of___net__address__Type__Invalid__t0 var201_deref_var197_self__typ__t0)  )
)
