...
;----------------------------------------------
;function ::carrier::shell::register
;----------------------------------------------
...
(declare-fun var915_ep__t0 () (_ BitVec 64))
(declare-fun var916_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var916_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var915_ep__t0) )
)

(assert (! var916_interpretation_of_theory_safe_over_ep__t0 :named A6))(check-sat)

; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
; call
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
; begin safe ptr check
(declare-fun var918_safe_ep___t0 () Bool)
(assert
  (= var918_safe_ep___t0 (theory1_safe var915_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var918_safe_ep___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
(declare-fun var920_addressof___carrier__shell__ShellConfig___t0 () (_ BitVec 64))
(declare-fun var921_len_addressof___carrier__shell__ShellConfig____t0 () (_ BitVec 64))
(assert
  (= var921_len_addressof___carrier__shell__ShellConfig____t0 (theory0_len var920_addressof___carrier__shell__ShellConfig___t0) )
)

(assert
  (= var921_len_addressof___carrier__shell__ShellConfig____t0 (_ bv1 64))

)

(assert
  (= var920_addressof___carrier__shell__ShellConfig___t0 (_ bv207 64))

)

(declare-fun var922_true__t0 () Bool)
(assert
  (= var922_true__t0 (theory1_safe var920_addressof___carrier__shell__ShellConfig___t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
; : /home/runner/work/carrier/carrier/core/src/shell.zz:26
(declare-fun var923_addressof___carrier__shell__ShellConfig___t0 () (_ BitVec 64))
(declare-fun var924_len_addressof___carrier__shell__ShellConfig____t0 () (_ BitVec 64))
(assert
  (= var924_len_addressof___carrier__shell__ShellConfig____t0 (theory0_len var923_addressof___carrier__shell__ShellConfig___t0) )
)

(assert
  (= var924_len_addressof___carrier__shell__ShellConfig____t0 (_ bv1 64))

)

(assert
  (= var923_addressof___carrier__shell__ShellConfig___t0 (_ bv207 64))

)

(declare-fun var925_true__t0 () Bool)
(assert
  (= var925_true__t0 (theory1_safe var923_addressof___carrier__shell__ShellConfig___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var926_interpretation_of_theory_safe_over_addressof___carrier__shell__ShellConfig___t0 () Bool)
(assert
  (= var926_interpretation_of_theory_safe_over_addressof___carrier__shell__ShellConfig___t0 (theory1_safe var923_addressof___carrier__shell__ShellConfig___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var927_interpretation_of_theory_safe_over_ep__t0 () Bool)
(assert
  (= var927_interpretation_of_theory_safe_over_ep__t0 (theory1_safe var915_ep__t0) )
)

(push 1)

(assert
  (and true (or (not var926_interpretation_of_theory_safe_over_addressof___carrier__shell__ShellConfig___t0 ) (not var927_interpretation_of_theory_safe_over_ep__t0 ) ))
...
(declare-fun var917_deref_var915_ep___t1 () (_ BitVec 64))
(declare-fun var917_deref_var915_ep___t0 () (_ BitVec 64))
(assert
  (= var917_deref_var915_ep___t1  (ite true var917_deref_var915_ep___t1 var917_deref_var915_ep___t0)  )
)
...
;end of function ::carrier::shell::register
