...
; literal expr
(declare-fun var232_literal_4294967295__t0 () Bool)
(assert
  var232_literal_4294967295__t0
)

; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:142
(declare-fun var231_literal_struct_231__t0 () (_ BitVec 64))
(declare-fun var233_safe_literal_struct_231_____safe_ctx___t0 () Bool)
(assert
  (= var233_safe_literal_struct_231_____safe_ctx___t0 (theory1_safe var231_literal_struct_231__t0) )
)

(declare-fun var230_ctx__t1 () (_ BitVec 64))
(assert
  (= var233_safe_literal_struct_231_____safe_ctx___t0 (theory1_safe var230_ctx__t1) )
)

(declare-fun var234_nullterm_literal_struct_231_____nullterm_ctx___t0 () Bool)
(assert
  (= var234_nullterm_literal_struct_231_____nullterm_ctx___t0 (theory2_nullterm var231_literal_struct_231__t0) )
)

(assert
  (= var234_nullterm_literal_struct_231_____nullterm_ctx___t0 (theory2_nullterm var230_ctx__t1) )
)

(declare-fun var230_ctx__t0 () (_ BitVec 64))
(assert
  (= var230_ctx__t1  (ite true var231_literal_struct_231__t0 var230_ctx__t0)  )
)
...
(assert
  (= var242_true__t0 (theory1_safe var236_literal_struct_236__t0) )
)
...
(declare-fun var257_safe_literal_struct_235_____safe_return___t0 () Bool)
(assert
  (= var257_safe_literal_struct_235_____safe_return___t0 (theory1_safe var235_literal_struct_235__t0) )
)

(declare-fun var229_return__t1 () (_ BitVec 64))
(assert
  (= var257_safe_literal_struct_235_____safe_return___t0 (theory1_safe var229_return__t1) )
)

(declare-fun var258_nullterm_literal_struct_235_____nullterm_return___t0 () Bool)
(assert
  (= var258_nullterm_literal_struct_235_____nullterm_return___t0 (theory2_nullterm var235_literal_struct_235__t0) )
)

(assert
  (= var258_nullterm_literal_struct_235_____nullterm_return___t0 (theory2_nullterm var229_return__t1) )
)

(declare-fun var229_return__t0 () (_ BitVec 64))
(assert
  (= var229_return__t1  (ite true var235_literal_struct_235__t0 var229_return__t0)  )
)
...
(assert
  (= var259_interpretation_of_theory_safe_over___io__read_fn__t0 (theory1_safe var236_literal_struct_236__t0) )
)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:140
(declare-fun var260_interpretation_of_theory_safe_over___io__read_fn__t0 () Bool)
(assert
  (= var260_interpretation_of_theory_safe_over___io__read_fn__t0 (theory1_safe var236_literal_struct_236__t0) )
)

(push 1)

(assert
  (and true (or (not var260_interpretation_of_theory_safe_over___io__read_fn__t0 ) ))
