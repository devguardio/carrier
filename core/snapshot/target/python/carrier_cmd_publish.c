...
static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_cmd_publish", "carrier::cmd_publish", -1, methods};

PyObject*  py_mod_carrier_cmd_publish_Init()
{
