...
; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:56
(declare-fun var247_addressof_deref_var240_self__read_fds___t0 () (_ BitVec 64))
(declare-fun var248_len_addressof_deref_var240_self__read_fds____t0 () (_ BitVec 64))
(assert
  (= var248_len_addressof_deref_var240_self__read_fds____t0 (theory0_len var247_addressof_deref_var240_self__read_fds___t0) )
)

(assert
  (= var248_len_addressof_deref_var240_self__read_fds____t0 (_ bv1 64))

)

(assert
  (= var247_addressof_deref_var240_self__read_fds___t0 (_ bv246 64))

)

(declare-fun var249_true__t0 () Bool)
(assert
  (= var249_true__t0 (theory1_safe var247_addressof_deref_var240_self__read_fds___t0) )
)
