...
(assert (! var331_interpretation_of_theory_safe_over_self__t0 :named A2))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:478
(declare-fun var334_return_value_of___time__real__t0 () (_ BitVec 64))
(declare-fun var335_safe_return_value_of___time__real_____safe_now___t0 () Bool)
(assert
  (= var335_safe_return_value_of___time__real_____safe_now___t0 (theory1_safe var334_return_value_of___time__real__t0) )
)

(declare-fun var333_now__t1 () (_ BitVec 64))
(assert
  (= var335_safe_return_value_of___time__real_____safe_now___t0 (theory1_safe var333_now__t1) )
)

(declare-fun var336_nullterm_return_value_of___time__real_____nullterm_now___t0 () Bool)
(assert
  (= var336_nullterm_return_value_of___time__real_____nullterm_now___t0 (theory2_nullterm var334_return_value_of___time__real__t0) )
)

(assert
  (= var336_nullterm_return_value_of___time__real_____nullterm_now___t0 (theory2_nullterm var333_now__t1) )
)

(declare-fun var333_now__t0 () (_ BitVec 64))
(assert
  (= var333_now__t1  (ite true var334_return_value_of___time__real__t0 var333_now__t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:479
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:479
(declare-fun var338_addressof_now___t0 () (_ BitVec 64))
(declare-fun var339_len_addressof_now____t0 () (_ BitVec 64))
(assert
  (= var339_len_addressof_now____t0 (theory0_len var338_addressof_now___t0) )
)

(assert
  (= var339_len_addressof_now____t0 (_ bv1 64))

)

(assert
  (= var338_addressof_now___t0 (_ bv333 64))

)

(declare-fun var340_true__t0 () Bool)
(assert
  (= var340_true__t0 (theory1_safe var338_addressof_now___t0) )
)
...
(assert
  (= var341_addressof_now___t0 (_ bv333 64))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var344_interpretation_of_theory_safe_over_addressof_now___t0 () Bool)
(assert
  (= var344_interpretation_of_theory_safe_over_addressof_now___t0 (theory1_safe var341_addressof_now___t0) )
)

(push 1)

(assert
  (and true (or (not var344_interpretation_of_theory_safe_over_addressof_now___t0 ) ))
...
; callsite effects
; end of callsite effects
(declare-fun var345_return_value_of___time__to_millis__t0 () (_ BitVec 64))
(declare-fun var346_safe_return_value_of___time__to_millis_____safe_return___t0 () Bool)
(assert
  (= var346_safe_return_value_of___time__to_millis_____safe_return___t0 (theory1_safe var345_return_value_of___time__to_millis__t0) )
)

(declare-fun var332_return__t1 () (_ BitVec 64))
(assert
  (= var346_safe_return_value_of___time__to_millis_____safe_return___t0 (theory1_safe var332_return__t1) )
)

(declare-fun var347_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 () Bool)
(assert
  (= var347_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 (theory2_nullterm var345_return_value_of___time__to_millis__t0) )
)

(assert
  (= var347_nullterm_return_value_of___time__to_millis_____nullterm_return___t0 (theory2_nullterm var332_return__t1) )
)

(declare-fun var332_return__t0 () (_ BitVec 64))
(assert
  (= var332_return__t1  (ite true var345_return_value_of___time__to_millis__t0 var332_return__t0)  )
)
