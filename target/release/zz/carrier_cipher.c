...
#line 5 "/home/aep/proj/devguard/carrier/src/cipher.zz"
...
#line 23 "/home/aep/proj/devguard/carrier/src/cipher.zz"
...
;
const size_t sizeof_carrier_cipher_CipherState = sizeof(carrier_cipher_CipherState);
...
#line 71 "/home/aep/proj/devguard/carrier/src/cipher.zz"
uintptr_t __attribute__ ((visibility ("default"))) carrier_cipher_decrypt_ad (carrier_cipher_CipherState*  const  self, err_Err*  const  e, uintptr_t const  et, uint8_t const *  const  authtext, uintptr_t const  authtext_len, uint8_t const *  const  ciphertext, uintptr_t const  cipherlen, uint64_t const  nonce, uint8_t*  const  plain, uintptr_t const  plainlen_max)
{

#line 86 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    assert(    self ->has_key    );

#line 87 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  uintptr_t const  plainlen  = (    cipherlen -    16  );

#line 89 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    err_assert((    plainlen_max >=    plainlen  ),
#line 181 "/home/aep/proj/zz/modules/err/src/lib.zz"
    "/home/aep/proj/devguard/carrier/src/cipher.zz",
...
#line 90 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    err_assert((    cipherlen >    16  ),
#line 181 "/home/aep/proj/zz/modules/err/src/lib.zz"
    "/home/aep/proj/devguard/carrier/src/cipher.zz",
#line 182 "/home/aep/proj/zz/modules/err/src/lib.zz"
    "::carrier::cipher::decrypt_ad",
...
#line 92 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  uint8_t const *  const  mac  = (    ciphertext +    plainlen  );

#line 94 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  uint8_t nonce12  [     12 ]  = {    0,};

#line 95 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  uint64_t const  nonce_le  =     byteorder_to_le64(    nonce    );

#line 96 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    memcpy((    nonce12 +    4  ),    (uint8_t const * )(( &    nonce_le)),    8    );

#line 98 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  int const  xr  =     (int)(
#line 99 "/home/aep/proj/devguard/carrier/src/cipher.zz"

#line 98 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    Hacl_Chacha20Poly1305_aead_decrypt(
#line 99 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    plain,    (uint8_t* )(
#line 100 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    ciphertext),
#line 101 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    plainlen,    (uint8_t* )(
#line 102 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    mac),    (uint8_t* )(
#line 103 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    authtext),
#line 104 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    authtext_len,
#line 105 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    self ->key,
#line 106 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    nonce12    ));
if ((
#line 108 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    xr !=    0  )){

#line 109 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    err_fail(    (err_Err* )(    e),
#line 73 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    et,
#line 109 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    carrier_cipher_EncryptionError,
...
#line 110 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  return     0;

}


#line 112 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  return     plainlen;
...
#line 116 "/home/aep/proj/devguard/carrier/src/cipher.zz"
uintptr_t __attribute__ ((visibility ("default"))) carrier_cipher_encrypt (carrier_cipher_CipherState*  const  self, err_Err*  const  e, uintptr_t const  et, uint8_t const *  const  plain, uintptr_t const  plainlen, uint64_t const  nonce, uint8_t*  const  ciphertext, uintptr_t const  cipherlen_max)
{

#line 131 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  return     carrier_cipher_encrypt_ad(    self,    (err_Err* )(    e),
#line 118 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    et,
#line 131 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    0,    0,    plain,    plainlen,    nonce,    ciphertext,    cipherlen_max    );

}


#line 25 "/home/aep/proj/devguard/carrier/src/cipher.zz"
uintptr_t __attribute__ ((visibility ("default"))) carrier_cipher_encrypt_ad (carrier_cipher_CipherState*  const  self, err_Err*  const  e, uintptr_t const  et, uint8_t const *  const  authtext, uintptr_t const  authtext_len, uint8_t const *  const  plain, uintptr_t const  plainlen, uint64_t const  nonce, uint8_t*  const  ciphertext, uintptr_t const  cipherlen_max)
{

#line 42 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    assert(    self ->has_key    );

#line 44 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  uintptr_t const  cipherlen  = (    plainlen +    16  );

#line 45 "/home/aep/proj/devguard/carrier/src/cipher.zz"
...
#line 47 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  uint8_t*  const  mac  = (    ciphertext +    plainlen  );

#line 50 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  uint8_t nonce12  [     12 ]  = {    0,};

#line 51 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  uint64_t const  nonce_le  =     byteorder_to_le64(    nonce    );

#line 52 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    memcpy((    nonce12 +    4  ),    (uint8_t const * )(( &    nonce_le)),    8    );

#line 54 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  int const  xr  =     (int)(
#line 55 "/home/aep/proj/devguard/carrier/src/cipher.zz"

#line 54 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    Hacl_Chacha20Poly1305_aead_encrypt(
#line 55 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    ciphertext,
#line 56 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    mac,    (uint8_t* )(
#line 57 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    plain),
#line 58 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    plainlen,    (uint8_t* )(
#line 59 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    authtext),
#line 60 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    authtext_len,
#line 61 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    self ->key,
#line 62 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    nonce12    ));
if ((
#line 64 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    xr !=    0  )){

#line 65 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    err_fail(    (err_Err* )(    e),
#line 27 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    et,
#line 65 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    carrier_cipher_EncryptionError,
#line 87 "/home/aep/proj/zz/modules/err/src/lib.zz"
...
#line 66 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  return     0;

}


#line 68 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  return     cipherlen;
...
#line 135 "/home/aep/proj/devguard/carrier/src/cipher.zz"
uintptr_t __attribute__ ((visibility ("default"))) carrier_cipher_decrypt (carrier_cipher_CipherState*  const  self, err_Err*  const  e, uintptr_t const  et, uint8_t const *  const  ciphertext, uintptr_t const  cipherlen, uint64_t const  nonce, uint8_t*  const  plain, uintptr_t const  plainlen_max)
{

#line 148 "/home/aep/proj/devguard/carrier/src/cipher.zz"
  return     carrier_cipher_decrypt_ad(    self,    (err_Err* )(    e),
#line 137 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    et,
#line 148 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    0,    0,    ciphertext,    cipherlen,    nonce,    plain,    plainlen_max    );
...
#line 18 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    memcpy(    self ->key,    k,    32    );

#line 19 "/home/aep/proj/devguard/carrier/src/cipher.zz"
    self ->has_key =     true;
