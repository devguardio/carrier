...
(assert
  (not (= var383_at__t3 #x192f016403c00000))
)
...
(assert
  (not (= var459_infix_expression__t0 true))
)
...
(get-value (
  ...
  var217___carrier__vault__MAX_BROKERS__t1
...
(assert
  (not (= var217___carrier__vault__MAX_BROKERS__t1 #x0000000000000010))
)
...
(assert
  (=  var723_infix_expression__t0 (bvugt var415_storepos__t2 var217___carrier__vault__MAX_BROKERS__t1))
)
...
(assert
  (not (= var415_storepos__t2 #x0000000000000001))
)
