...
(assert
  (= var239_interpretation_of_theory_safe_over_ctx__t0 (theory1_safe var238_ctx__t0) )
)

(assert (! var239_interpretation_of_theory_safe_over_ctx__t0 :named A0))(check-sat)
...
(assert
  (= var241_safe_ctx___t0 (theory1_safe var238_ctx__t0) )
)
...
(assert (! (= var244_implicit_coercion_of_literal_0__t0 var243_literal_0__t0) :named A1)); : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:303
(declare-fun var245_safe_implicit_coercion_of_literal_0_____safe_deref_var238_ctx__time___t0 () Bool)
(assert
  (= var245_safe_implicit_coercion_of_literal_0_____safe_deref_var238_ctx__time___t0 (theory1_safe var244_implicit_coercion_of_literal_0__t0) )
)

(declare-fun var242_deref_var238_ctx__time__t1 () (_ BitVec 64))
(assert
  (= var245_safe_implicit_coercion_of_literal_0_____safe_deref_var238_ctx__time___t0 (theory1_safe var242_deref_var238_ctx__time__t1) )
)

(declare-fun var246_nullterm_implicit_coercion_of_literal_0_____nullterm_deref_var238_ctx__time___t0 () Bool)
(assert
  (= var246_nullterm_implicit_coercion_of_literal_0_____nullterm_deref_var238_ctx__time___t0 (theory2_nullterm var244_implicit_coercion_of_literal_0__t0) )
)

(assert
  (= var246_nullterm_implicit_coercion_of_literal_0_____nullterm_deref_var238_ctx__time___t0 (theory2_nullterm var242_deref_var238_ctx__time__t1) )
)

(declare-fun var242_deref_var238_ctx__time__t0 () (_ BitVec 64))
(assert
  (= var242_deref_var238_ctx__time__t1  (ite true var244_implicit_coercion_of_literal_0__t0 var242_deref_var238_ctx__time__t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/modules/io/src/select.zz:304
; literal expr
(declare-fun var248_literal_0__t0 () Bool)
(assert
  (not var248_literal_0__t0)
)

(declare-fun var247_deref_var238_ctx__isvalid__t1 () Bool)
(declare-fun var247_deref_var238_ctx__isvalid__t0 () Bool)
(assert
  (= var247_deref_var238_ctx__isvalid__t1  (ite true var248_literal_0__t0 var247_deref_var238_ctx__isvalid__t0)  )
)
