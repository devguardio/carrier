...
pub struct callback {
    ...
    pub f: extern fn ( Ze: *mut u8,  Zuser: *mut std::ffi::c_void,  Zkey: *const u8,  Zval: *const u8, ctx: *mut std::ffi::c_void),
}
...
extern {
    ...
    pub fn r#decode_integer( Zself: *mut u8,  Ze: *mut u8,  Zprefix_size: u8)  -> std::os::raw::c_uint;


    #[link_name = "hpack_decoder_decode_literal"]
    pub fn r#decode_literal( Zself: *mut u8,  Ze: *mut u8,  Zindex: bool)  -> bool;


    #[link_name = "hpack_decoder_next"]
    pub fn r#next( Zself: *mut u8,  Ze: *mut u8)  -> bool;
