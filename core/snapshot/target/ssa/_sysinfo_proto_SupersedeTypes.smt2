...
(assert
  (= var620_safe___protonerf__FieldType__Skip_____safe_return___t0 (theory1_safe var56___protonerf__FieldType__Skip__t0) )
)
...
(assert
  (= var621_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 (theory2_nullterm var56___protonerf__FieldType__Skip__t0) )
)
...
(assert (! (= var622_implicit_coercion_of___protonerf__FieldType__Skip__t0 var56___protonerf__FieldType__Skip__t0) :named A0))(declare-fun var619_return__t0 () (_ BitVec 64))
(assert
