...
(declare-fun var122_safe___carrier__sha256__BLOCKLEN_____safe_return___t0 () Bool)
(assert
  (= var122_safe___carrier__sha256__BLOCKLEN_____safe_return___t0 (theory1_safe var29___carrier__sha256__BLOCKLEN__t1) )
)

(declare-fun var121_return__t1 () (_ BitVec 64))
(assert
  (= var122_safe___carrier__sha256__BLOCKLEN_____safe_return___t0 (theory1_safe var121_return__t1) )
)

(declare-fun var123_nullterm___carrier__sha256__BLOCKLEN_____nullterm_return___t0 () Bool)
(assert
  (= var123_nullterm___carrier__sha256__BLOCKLEN_____nullterm_return___t0 (theory2_nullterm var29___carrier__sha256__BLOCKLEN__t1) )
)

(assert
  (= var123_nullterm___carrier__sha256__BLOCKLEN_____nullterm_return___t0 (theory2_nullterm var121_return__t1) )
)

(declare-fun var121_return__t0 () (_ BitVec 64))
(assert
  (= var121_return__t1  (ite true var29___carrier__sha256__BLOCKLEN__t1 var121_return__t0)  )
)
