...
(declare-fun var212_subject__t0 () (_ BitVec 64))
(declare-fun var214_interpretation_of_theory_safe_over_subject__t0 () Bool)
(assert
  (= var214_interpretation_of_theory_safe_over_subject__t0 (theory1_safe var212_subject__t0) )
)

(assert (! var214_interpretation_of_theory_safe_over_subject__t0 :named A1))(check-sat)

; : /home/runner/work/carrier/carrier/core/src/vault.zz:154
; call of safe
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var211_s__t0 () (_ BitVec 64))
(declare-fun var215_interpretation_of_theory_safe_over_s__t0 () Bool)
(assert
  (= var215_interpretation_of_theory_safe_over_s__t0 (theory1_safe var211_s__t0) )
)

(assert (! var215_interpretation_of_theory_safe_over_s__t0 :named A2))(check-sat)
...
(assert
  (= var216_interpretation_of_theory_safe_over_self__t0 (theory1_safe var210_self__t0) )
)

(assert (! var216_interpretation_of_theory_safe_over_self__t0 :named A3))(check-sat)
...
(assert
  (= var218_safe_self___t0 (theory1_safe var210_self__t0) )
)
...
(assert (! (= var223_implicit_coercion_of_literal_0__t0 var222_literal_0__t0) :named A4)); : /home/runner/work/carrier/carrier/core/src/vault.zz:155
(declare-fun var224_infix_expression__t0 () Bool)
(declare-fun var220_closure_fn___carrier__vault__sign_fn__t0 () (_ BitVec 64))
(assert
  (=  var224_infix_expression__t0 (= var220_closure_fn___carrier__vault__sign_fn__t0 var223_implicit_coercion_of_literal_0__t0))
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var225_interpretation_of_theory_safe_over_subject__t0 () Bool)
(assert
  (= var225_interpretation_of_theory_safe_over_subject__t0 (theory1_safe var212_subject__t0) )
)
...
(assert
  (= var226_interpretation_of_theory_safe_over_s__t0 (theory1_safe var211_s__t0) )
)
...
(assert
  (= var227_interpretation_of_theory_safe_over_self__t0 (theory1_safe var210_self__t0) )
)

(push 1)

(assert
  (and var224_infix_expression__t0 (or (not var225_interpretation_of_theory_safe_over_subject__t0 ) (not var226_interpretation_of_theory_safe_over_s__t0 ) (not var227_interpretation_of_theory_safe_over_self__t0 ) ))
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:160
(declare-fun var219_deref_var210_self__i_sign_principal__t0 () (_ BitVec 64))
(declare-fun var229_interpretation_of_theory_safe_over_deref_var210_self__i_sign_principal__t0 () Bool)
(assert
  (= var229_interpretation_of_theory_safe_over_deref_var210_self__i_sign_principal__t0 (theory1_safe var219_deref_var210_self__i_sign_principal__t0) )
)

(assert (! var229_interpretation_of_theory_safe_over_deref_var210_self__i_sign_principal__t0 :named A5))(check-sat)
...
; begin safe ptr check
; : /home/runner/work/carrier/carrier/core/src/vault.zz:161
(declare-fun var231_safe_deref_var210_self__i_sign_principal___t0 () Bool)
(assert
  (= var231_safe_deref_var210_self__i_sign_principal___t0 (theory1_safe var219_deref_var210_self__i_sign_principal__t0) )
)

(push 1)

(assert
  (and true (or (not var231_safe_deref_var210_self__i_sign_principal___t0 ) ))
