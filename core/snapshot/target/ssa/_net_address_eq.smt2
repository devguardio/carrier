...
(declare-fun var206_other__t0 () (_ BitVec 64))
(declare-fun var207_interpretation_of_theory_safe_over_other__t0 () Bool)
(assert
  (= var207_interpretation_of_theory_safe_over_other__t0 (theory1_safe var206_other__t0) )
)

(assert (! var207_interpretation_of_theory_safe_over_other__t0 :named A0))(check-sat)
...
(assert (! (= var214_implicit_coercion_of_literal_0__t0 var213_literal_0__t0) :named A2)); : /home/runner/work/carrier/carrier/modules/net/src/address.zz:35
(declare-fun var215_infix_expression__t0 () Bool)
(declare-fun var212_return_value_of___ext___string_h___memcmp__t0 () (_ BitVec 64))
(assert
  (=  var215_infix_expression__t0 (= var212_return_value_of___ext___string_h___memcmp__t0 var214_implicit_coercion_of_literal_0__t0))
)

(declare-fun var209_return__t1 () Bool)
(declare-fun var209_return__t0 () Bool)
(assert
  (= var209_return__t1  (ite true var215_infix_expression__t0 var209_return__t0)  )
)
