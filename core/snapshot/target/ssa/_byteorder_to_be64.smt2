...
(declare-fun var825_return_value_of___byteorder__swap64__t0 () (_ BitVec 64))
(declare-fun var826_safe_return_value_of___byteorder__swap64_____safe_return___t0 () Bool)
(assert
  (= var826_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var825_return_value_of___byteorder__swap64__t0) )
)

(declare-fun var824_return__t1 () (_ BitVec 64))
(assert
  (= var826_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var824_return__t1) )
)

(declare-fun var827_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 () Bool)
(assert
  (= var827_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var825_return_value_of___byteorder__swap64__t0) )
)

(assert
  (= var827_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var824_return__t1) )
)

(declare-fun var824_return__t0 () (_ BitVec 64))
(assert
  (= var824_return__t1  (ite true var825_return_value_of___byteorder__swap64__t0 var824_return__t0)  )
)
...
(declare-fun var828_x__t0 () (_ BitVec 64))
(declare-fun var830_safe_x_____safe_return___t0 () Bool)
(assert
  (= var830_safe_x_____safe_return___t0 (theory1_safe var828_x__t0) )
)

(declare-fun var829_return__t1 () (_ BitVec 64))
(assert
  (= var830_safe_x_____safe_return___t0 (theory1_safe var829_return__t1) )
)

(declare-fun var831_nullterm_x_____nullterm_return___t0 () Bool)
(assert
  (= var831_nullterm_x_____nullterm_return___t0 (theory2_nullterm var828_x__t0) )
)

(assert
  (= var831_nullterm_x_____nullterm_return___t0 (theory2_nullterm var829_return__t1) )
)

(declare-fun var829_return__t0 () (_ BitVec 64))
(assert
  (= var829_return__t1  (ite true var828_x__t0 var829_return__t0)  )
)
