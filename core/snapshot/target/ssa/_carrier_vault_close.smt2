...
(assert
  (= var203_safe_self___t0 (theory1_safe var200_self__t0) )
)
...
(assert (! (= var208_implicit_coercion_of_literal_0__t0 var207_literal_0__t0) :named A2)); : /home/runner/work/carrier/carrier/core/src/vault.zz:63
(declare-fun var209_infix_expression__t0 () Bool)
(declare-fun var205_closure_fn___carrier__vault__close_fn__t0 () (_ BitVec 64))
(assert
  (=  var209_infix_expression__t0 (not (= var205_closure_fn___carrier__vault__close_fn__t0 var208_implicit_coercion_of_literal_0__t0)))
)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:64
(declare-fun var204_deref_var200_self__i_close__t0 () (_ BitVec 64))
(declare-fun var210_interpretation_of_theory_safe_over_deref_var200_self__i_close__t0 () Bool)
(assert
  (= var210_interpretation_of_theory_safe_over_deref_var200_self__i_close__t0 (theory1_safe var204_deref_var200_self__i_close__t0) )
)

(assert (! var210_interpretation_of_theory_safe_over_deref_var200_self__i_close__t0 :named A3))(check-sat)
...
; begin safe ptr check
; : /home/runner/work/carrier/carrier/core/src/vault.zz:65
(declare-fun var212_safe_deref_var200_self__i_close___t0 () Bool)
(assert
  (= var212_safe_deref_var200_self__i_close___t0 (theory1_safe var204_deref_var200_self__i_close__t0) )
)

(push 1)

(assert
  (and var209_infix_expression__t0 (or (not var212_safe_deref_var200_self__i_close___t0 ) ))
...
(declare-fun var202_deref_var200_self___t1 () (_ BitVec 64))
(declare-fun var202_deref_var200_self___t0 () (_ BitVec 64))
(assert
  (= var202_deref_var200_self___t1  (ite var209_infix_expression__t0 var202_deref_var200_self___t1 var202_deref_var200_self___t0)  )
)
