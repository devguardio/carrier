...
(declare-fun var662_safe___protonerf__FieldType__Skip_____safe_return___t0 () Bool)
(assert
  (= var662_safe___protonerf__FieldType__Skip_____safe_return___t0 (theory1_safe var69___protonerf__FieldType__Skip__t0) )
)

(declare-fun var661_return__t1 () (_ BitVec 64))
(assert
  (= var662_safe___protonerf__FieldType__Skip_____safe_return___t0 (theory1_safe var661_return__t1) )
)

(declare-fun var663_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 () Bool)
(assert
  (= var663_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 (theory2_nullterm var69___protonerf__FieldType__Skip__t0) )
)

(assert
  (= var663_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 (theory2_nullterm var661_return__t1) )
)

; : /home/runner/work/carrier/carrier/core/modules/sysinfo/modules/protonerf/src/lib.zz:8
(declare-fun var664_implicit_coercion_of___protonerf__FieldType__Skip__t0 () (_ BitVec 64))
(assert (! (= var664_implicit_coercion_of___protonerf__FieldType__Skip__t0 var69___protonerf__FieldType__Skip__t0) :named A0))(declare-fun var661_return__t0 () (_ BitVec 64))
(assert
  (= var661_return__t1  (ite true var664_implicit_coercion_of___protonerf__FieldType__Skip__t0 var661_return__t0)  )
)
