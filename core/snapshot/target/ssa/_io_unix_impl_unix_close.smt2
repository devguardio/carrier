...
(declare-fun var233_deref_var229_ctx__isvalid__t0 () Bool)
(assert
  (= var234_unary_expression__t0 (not var233_deref_var229_ctx__isvalid__t0 ))
)
...
(assert
  (not (= var234_unary_expression__t0 true))
)
...
(declare-fun var233_deref_var229_ctx__isvalid__t1 () Bool)
(assert
  (= var233_deref_var229_ctx__isvalid__t1  (ite true var238_literal_0__t0 var233_deref_var229_ctx__isvalid__t0)  )
)
