...
(assert
  (= var654_safe___protonerf__FieldType__Skip_____safe_return___t0 (theory1_safe var13___protonerf__FieldType__Skip__t0) )
)
...
(assert
  (= var655_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 (theory2_nullterm var13___protonerf__FieldType__Skip__t0) )
)
...
(assert (! (= var656_implicit_coercion_of___protonerf__FieldType__Skip__t0 var13___protonerf__FieldType__Skip__t0) :named A0))(declare-fun var653_return__t0 () (_ BitVec 64))
(assert
