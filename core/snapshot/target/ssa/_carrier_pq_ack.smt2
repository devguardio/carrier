...
(assert
  (not (= var842_f__t2 #x85287100c0040000))
)
...
(assert
  (not (= var842_f__t2 #x68026a8a01420000))
)
...
(assert
  (not (= var842_f__t2 #x801a416060028000))
)
...
(assert
  (not (= var842_f__t2 #x7908184008000200))
)
...
(assert
  (not (= var842_f__t2 #x688c9802a48a0800))
)
...
(assert
   (=  var962_infix_expression__t0 (bvadd var961_array_member_qq_f__packet__t0 var450___carrier__pq__REORDER_THRESHOLD__t1))
)
...
(assert
  (not (= var842_f__t2 #xb08e118401580000))
)
...
(assert
  (not (= var842_f__t2 #x11000120c3a01900))
)
