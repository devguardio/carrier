...
(assert
  (= var347_interpretation_of_theory_symbol_over___err__OutOfTail__t0 (theory3_symbol var85___err__OutOfTail__t0) )
)
...
(assert
  (not (= var468_i__t2 #x0000000000000015))
)
...
(assert
  (not (= var485_infix_expression__t0 true))
)
