...
napi_value jsGet_carrier_vault_esp32_Mem_secret(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  assert(status == napi_ok);
  mem += sizeof(size_t);
  carrier_vault_esp32_Mem * obj = (carrier_vault_esp32_Mem*)mem;
...
napi_value jsGet_carrier_vault_esp32_Mem_network(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_vault_esp32_Mem_network_secret(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_vault_esp32_Mem_auth(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsGet_carrier_vault_esp32_Mem_file_name(napi_env env, napi_callback_info info) {
  napi_status status;
...
napi_value jsSet_carrier_vault_esp32_Mem_file_name(napi_env env, napi_callback_info info) {
  napi_status status;
...
void js_delete_carrier_vault_esp32_Mem(napi_env env, void *obj, void*hint) {
    free(obj);
}
napi_value js_new_carrier_vault_esp32_Mem(napi_env env, napi_callback_info info) {
    napi_status status;
    ...
    void *obj = malloc(sizeof(size_t) + sizeof_carrier_vault_esp32_Mem);
    memset(obj, 0, sizeof(size_t) + sizeof_carrier_vault_esp32_Mem);
    ...
    *((size_t *)obj) = tail;
    ...
    status = napi_wrap(env,
            jsthis,
            obj,
            js_delete_carrier_vault_esp32_Mem, // destructor
            0,  // finalize_hint
            0
    );
    assert(status == napi_ok);
...
void js_register_carrier_vault_esp32_Mem (napi_env env, napi_value exports) {
    napi_property_descriptor properties[] = {
        { "secret", 0, 0, jsGet_carrier_vault_esp32_Mem_secret, 0, 0, napi_default, 0},
        { "network", 0, 0, jsGet_carrier_vault_esp32_Mem_network, 0, 0, napi_default, 0},
        { "network_secret", 0, 0, jsGet_carrier_vault_esp32_Mem_network_secret, 0, 0, napi_default, 0},
        { "auth", 0, 0, jsGet_carrier_vault_esp32_Mem_auth, 0, 0, napi_default, 0},
        { "file_name", 0, 0, jsGet_carrier_vault_esp32_Mem_file_name, jsSet_carrier_vault_esp32_Mem_file_name, 0, napi_default, 0},
    };
    napi_value cc;
    napi_status status = napi_define_class(env, "Mem", NAPI_AUTO_LENGTH, js_new_carrier_vault_esp32_Mem, 0, 5, properties, &cc);
    assert(status == napi_ok);
...
napi_value js_carrier_vault_esp32_Init(napi_env env, napi_value exports)
{
    ...
    js_register_carrier_vault_esp32_Mem(env, exports);
    napi_value ff;
    napi_status status;
