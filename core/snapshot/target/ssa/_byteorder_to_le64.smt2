...
(declare-fun var158_return_value_of___byteorder__swap64__t0 () (_ BitVec 64))
(declare-fun var159_safe_return_value_of___byteorder__swap64_____safe_return___t0 () Bool)
(assert
  (= var159_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var158_return_value_of___byteorder__swap64__t0) )
)

(declare-fun var157_return__t1 () (_ BitVec 64))
(assert
  (= var159_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var157_return__t1) )
)

(declare-fun var160_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 () Bool)
(assert
  (= var160_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var158_return_value_of___byteorder__swap64__t0) )
)

(assert
  (= var160_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var157_return__t1) )
)

(declare-fun var157_return__t0 () (_ BitVec 64))
(assert
  (= var157_return__t1  (ite true var158_return_value_of___byteorder__swap64__t0 var157_return__t0)  )
)
...
(declare-fun var161_x__t0 () (_ BitVec 64))
(declare-fun var163_safe_x_____safe_return___t0 () Bool)
(assert
  (= var163_safe_x_____safe_return___t0 (theory1_safe var161_x__t0) )
)

(declare-fun var162_return__t1 () (_ BitVec 64))
(assert
  (= var163_safe_x_____safe_return___t0 (theory1_safe var162_return__t1) )
)

(declare-fun var164_nullterm_x_____nullterm_return___t0 () Bool)
(assert
  (= var164_nullterm_x_____nullterm_return___t0 (theory2_nullterm var161_x__t0) )
)

(assert
  (= var164_nullterm_x_____nullterm_return___t0 (theory2_nullterm var162_return__t1) )
)

(declare-fun var162_return__t0 () (_ BitVec 64))
(assert
  (= var162_return__t1  (ite true var161_x__t0 var162_return__t0)  )
)
