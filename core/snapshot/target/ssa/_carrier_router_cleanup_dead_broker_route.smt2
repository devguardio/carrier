...
(declare-fun var707_chan__t0 () (_ BitVec 64))
(declare-fun var709_interpretation_of_theory_safe_over_chan__t0 () Bool)
(assert
  (= var709_interpretation_of_theory_safe_over_chan__t0 (theory1_safe var707_chan__t0) )
)

(assert (! var709_interpretation_of_theory_safe_over_chan__t0 :named A5))(check-sat)
...
(declare-fun var717_safe_chan___t0 () Bool)
(assert
  (= var717_safe_chan___t0 (theory1_safe var707_chan__t0) )
)

(push 1)

(assert
  (and true (or (not var717_safe_chan___t0 ) ))
...
(assert
  (not (= var718_literal_16__t0 #x0000000000000010))
)
...
; : /home/runner/work/carrier/carrier/core/src/router.zz:376
(declare-fun var719_deref_var707_chan__streams__t0 () (_ BitVec 64))
(declare-fun var720_len_deref_var707_chan__streams___t0 () (_ BitVec 64))
(assert
  (= var720_len_deref_var707_chan__streams___t0 (theory0_len var719_deref_var707_chan__streams__t0) )
)

(assert
  (= var720_len_deref_var707_chan__streams___t0 (_ bv16 64))

)

(declare-fun var721_true__t0 () Bool)
(assert
  (= var721_true__t0 (theory1_safe var719_deref_var707_chan__streams__t0) )
)
...
; : /home/runner/work/carrier/carrier/core/src/router.zz:376
(declare-fun var722_literal_16__t0 () (_ BitVec 64))
(assert
  (= var722_literal_16__t0 (_ bv16 64))
...
(assert
  (not (= var722_literal_16__t0 #x0000000000000010))
)
...
(assert (! (= var724_implicit_coercion_of_literal_16__t0 var723_literal_16__t0) :named A7)); : /home/runner/work/carrier/carrier/core/src/router.zz:376
(declare-fun var725_infix_expression__t0 () Bool)
(assert
  (=  var725_infix_expression__t0 (bvult var710_i__t2 var724_implicit_coercion_of_literal_16__t0))
)

(assert (! var725_infix_expression__t0 :named A8))(check-sat)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/router.zz:377
(declare-fun var726_len_deref_var707_chan__streams___t0 () (_ BitVec 64))
(assert
  (= var726_len_deref_var707_chan__streams___t0 (theory0_len var719_deref_var707_chan__streams__t0) )
)

(declare-fun var727_i___len_deref_var707_chan__streams___t0 () Bool)
(assert
  (=  var727_i___len_deref_var707_chan__streams___t0 (bvult var710_i__t2 var726_len_deref_var707_chan__streams___t0))
)
...
(assert
  (and true (or (not var727_i___len_deref_var707_chan__streams___t0 ) ))
...
(assert (! (= var730_implicit_coercion_of_literal_0__t0 var729_literal_0__t0) :named A9)); : /home/runner/work/carrier/carrier/core/src/router.zz:377
(declare-fun var731_infix_expression__t0 () Bool)
(declare-fun var728_array_member_deref_var707_chan__streams_i___t0 () (_ BitVec 64))
(assert
  (=  var731_infix_expression__t0 (= var728_array_member_deref_var707_chan__streams_i___t0 var730_implicit_coercion_of_literal_0__t0))
)
...
(assert
  (not (= var710_i__t2 #x0000000000000008))
)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/router.zz:380
(declare-fun var733_len_deref_var707_chan__streams___t0 () (_ BitVec 64))
(assert
  (= var733_len_deref_var707_chan__streams___t0 (theory0_len var719_deref_var707_chan__streams__t0) )
)

(declare-fun var734_i___len_deref_var707_chan__streams___t0 () Bool)
(assert
  (=  var734_i___len_deref_var707_chan__streams___t0 (bvult var710_i__t2 var733_len_deref_var707_chan__streams___t0))
)
...
(assert
  (and true (or (not var734_i___len_deref_var707_chan__streams___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/router.zz:380
(declare-fun var735_array_member_deref_var707_chan__streams_i___t0 () (_ BitVec 64))
(declare-fun var736_safe_array_member_deref_var707_chan__streams_i______safe_strx___t0 () Bool)
(assert
  (= var736_safe_array_member_deref_var707_chan__streams_i______safe_strx___t0 (theory1_safe var735_array_member_deref_var707_chan__streams_i___t0) )
)

(declare-fun var732_strx__t1 () (_ BitVec 64))
(assert
  (= var736_safe_array_member_deref_var707_chan__streams_i______safe_strx___t0 (theory1_safe var732_strx__t1) )
)

(declare-fun var737_nullterm_array_member_deref_var707_chan__streams_i______nullterm_strx___t0 () Bool)
(assert
  (= var737_nullterm_array_member_deref_var707_chan__streams_i______nullterm_strx___t0 (theory2_nullterm var735_array_member_deref_var707_chan__streams_i___t0) )
)

(assert
  (= var737_nullterm_array_member_deref_var707_chan__streams_i______nullterm_strx___t0 (theory2_nullterm var732_strx__t1) )
)

(declare-fun var732_strx__t0 () (_ BitVec 64))
(assert
  (= var732_strx__t1  (ite true var735_array_member_deref_var707_chan__streams_i___t0 var732_strx__t0)  )
)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/router.zz:381
(declare-fun var738_interpretation_of_theory_safe_over_strx__t0 () Bool)
(assert
  (= var738_interpretation_of_theory_safe_over_strx__t0 (theory1_safe var732_strx__t1) )
)

(assert (! var738_interpretation_of_theory_safe_over_strx__t0 :named A10))(check-sat)
...
; : /home/runner/work/carrier/carrier/core/src/router.zz:382
; begin safe ptr check
(declare-fun var741_safe_strx___t0 () Bool)
(assert
  (= var741_safe_strx___t0 (theory1_safe var732_strx__t1) )
)

(push 1)

(assert
  (and true (or (not var741_safe_strx___t0 ) ))
...
(declare-fun var742_deref_var732_strx__broker_route__t0 () (_ BitVec 64))
(declare-fun var708_dead_route__t0 () (_ BitVec 64))
(assert
  (=  var743_infix_expression__t0 (= var742_deref_var732_strx__broker_route__t0 var708_dead_route__t0))
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var745_interpretation_of_theory_safe_over_strx__t0 () Bool)
(assert
  (= var745_interpretation_of_theory_safe_over_strx__t0 (theory1_safe var732_strx__t1) )
)

(push 1)

(assert
  (and var743_infix_expression__t0 (or (not var745_interpretation_of_theory_safe_over_strx__t0 ) ))
...
(declare-fun var740_deref_var732_strx___t1 () (_ BitVec 64))
(declare-fun var740_deref_var732_strx___t0 () (_ BitVec 64))
(assert
  (= var740_deref_var732_strx___t1  (ite var743_infix_expression__t0 var740_deref_var732_strx___t1 var740_deref_var732_strx___t0)  )
)
