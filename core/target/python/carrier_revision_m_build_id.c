...
#include <stdint.h>
#include <string.h>
#include "zz/carrier/carrier_revision_m_build_id.h"
...
static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_revision_m_build_id", "carrier::revision_m_build_id", -1, methods};

PyObject*  py_mod_carrier_revision_m_build_id_Init()
{
