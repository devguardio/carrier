...
(declare-fun var208_other__t0 () (_ BitVec 64))
(declare-fun var209_interpretation_of_theory_safe_over_other__t0 () Bool)
(assert
  (= var209_interpretation_of_theory_safe_over_other__t0 (theory1_safe var208_other__t0) )
)

(assert (! var209_interpretation_of_theory_safe_over_other__t0 :named A0))(check-sat)
...
(assert (! (= var216_implicit_coercion_of_literal_0__t0 var215_literal_0__t0) :named A2)); : /home/runner/work/carrier/carrier/modules/net/src/address.zz:35
(declare-fun var217_infix_expression__t0 () Bool)
(declare-fun var214_return_value_of___ext___string_h___memcmp__t0 () (_ BitVec 64))
(assert
  (=  var217_infix_expression__t0 (= var214_return_value_of___ext___string_h___memcmp__t0 var216_implicit_coercion_of_literal_0__t0))
)

(declare-fun var211_return__t1 () Bool)
(declare-fun var211_return__t0 () Bool)
(assert
  (= var211_return__t1  (ite true var217_infix_expression__t0 var211_return__t0)  )
)
