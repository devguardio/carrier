...
(assert
  (= var163_interpretation_of_theory___pool__member_over_ptr____self__t0 (theory56___pool__member var161_ptr___t0 var160_self__t0) )
)
...
(assert
  (= var173_interpretation_of_theory___pool__continuous_over_deref_var160_self___t0 (theory47___pool__continuous var171_deref_var160_self___t0) )
)
...
(assert
  (= var175_interpretation_of_theory___pool__continuous_over_deref_var160_self___t0 (theory47___pool__continuous var171_deref_var160_self___t0) )
)
...
(assert
  (= var308_interpretation_of_theory___pool__continuous_over_deref_var160_self___t0 (theory47___pool__continuous var171_deref_var160_self___t0) )
)
...
(assert
  (= var310_interpretation_of_theory___pool__continuous_over_deref_var160_self___t0 (theory47___pool__continuous var171_deref_var160_self___t0) )
)
