...
(declare-fun var237_id__t0 () (_ BitVec 64))
(declare-fun var238_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var238_interpretation_of_theory_safe_over_id__t0 (theory1_safe var237_id__t0) )
)

(assert (! var238_interpretation_of_theory_safe_over_id__t0 :named A1))(check-sat)
...
; : /home/aep/proj/devguard/carrier/core/src/vault_ik.zz:38
...
; : /home/aep/proj/devguard/carrier/core/src/vault_ik.zz:38
; : /home/aep/proj/devguard/carrier/core/src/vault_ik.zz:38
(declare-fun var244_addressof_deref_var236_self__ik_identity___t0 () (_ BitVec 64))
(declare-fun var245_len_addressof_deref_var236_self__ik_identity____t0 () (_ BitVec 64))
(assert
  (= var245_len_addressof_deref_var236_self__ik_identity____t0 (theory0_len var244_addressof_deref_var236_self__ik_identity___t0) )
)

(assert
  (= var245_len_addressof_deref_var236_self__ik_identity____t0 (_ bv1 64))

)

(assert
  (= var244_addressof_deref_var236_self__ik_identity___t0 (_ bv243 64))

)

(declare-fun var246_true__t0 () Bool)
(assert
  (= var246_true__t0 (theory1_safe var244_addressof_deref_var236_self__ik_identity___t0) )
)
...
(assert
  (= var247_addressof_deref_var236_self__ik_identity___t0 (_ bv243 64))
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var250_interpretation_of_theory_safe_over_addressof_deref_var236_self__ik_identity___t0 () Bool)
(assert
  (= var250_interpretation_of_theory_safe_over_addressof_deref_var236_self__ik_identity___t0 (theory1_safe var247_addressof_deref_var236_self__ik_identity___t0) )
)
...
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var251_interpretation_of_theory_safe_over_id__t0 () Bool)
(assert
  (= var251_interpretation_of_theory_safe_over_id__t0 (theory1_safe var237_id__t0) )
)

(push 1)

(assert
  (and true (or (not var250_interpretation_of_theory_safe_over_addressof_deref_var236_self__ik_identity___t0 ) (not var251_interpretation_of_theory_safe_over_id__t0 ) ))
