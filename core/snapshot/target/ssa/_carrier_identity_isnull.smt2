...
(declare-fun var277_k__t0 () (_ BitVec 64))
(declare-fun var278_interpretation_of_theory_safe_over_k__t0 () Bool)
(assert
  (= var278_interpretation_of_theory_safe_over_k__t0 (theory1_safe var277_k__t0) )
)

(assert (! var278_interpretation_of_theory_safe_over_k__t0 :named A0))(check-sat)
...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/identity.zz:477
(declare-fun var279_interpretation_of_theory_len_over_k__t0 () (_ BitVec 64))
(assert
  (= var279_interpretation_of_theory_len_over_k__t0 (theory0_len var277_k__t0) )
)

; : /home/runner/work/carrier/carrier/core/src/identity.zz:477
; literal expr
(declare-fun var280_literal_32__t0 () (_ BitVec 64))
(assert
  (= var280_literal_32__t0 (_ bv32 64))

)

(declare-fun var281_implicit_coercion_of_literal_32__t0 () (_ BitVec 64))
(assert (! (= var281_implicit_coercion_of_literal_32__t0 var280_literal_32__t0) :named A1)); : /home/runner/work/carrier/carrier/core/src/identity.zz:477
(declare-fun var282_infix_expression__t0 () Bool)
(assert
  (=  var282_infix_expression__t0 (bvuge var279_interpretation_of_theory_len_over_k__t0 var281_implicit_coercion_of_literal_32__t0))
)

(assert (! var282_infix_expression__t0 :named A2))(check-sat)
...
(assert
  (not (= var285_literal_0__t0 #x0000000000000000))
)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/identity.zz:479
(declare-fun var286_len_k___t0 () (_ BitVec 64))
(assert
  (= var286_len_k___t0 (theory0_len var277_k__t0) )
)

(declare-fun var287_literal_0___len_k___t0 () Bool)
(assert
  (=  var287_literal_0___len_k___t0 (bvult var285_literal_0__t0 var286_len_k___t0))
)
...
(assert
  (and true (or (not var287_literal_0___len_k___t0 ) ))
...
(declare-fun var284_first__t1 () (_ BitVec 8))
(declare-fun var288_array_member_k_literal_0___t0 () (_ BitVec 8))
(declare-fun var284_first__t0 () (_ BitVec 8))
(assert
  (= var284_first__t1  (ite true var288_array_member_k_literal_0___t0 var284_first__t0)  )
)
...
; : /home/runner/work/carrier/carrier/core/src/identity.zz:480
(declare-fun var291_safe_literal_1_____safe_i___t0 () Bool)
(assert
  (= var291_safe_literal_1_____safe_i___t0 (theory1_safe var290_literal_1__t0) )
)

(declare-fun var289_i__t1 () (_ BitVec 64))
(assert
  (= var291_safe_literal_1_____safe_i___t0 (theory1_safe var289_i__t1) )
)

(declare-fun var292_nullterm_literal_1_____nullterm_i___t0 () Bool)
(assert
  (= var292_nullterm_literal_1_____nullterm_i___t0 (theory2_nullterm var290_literal_1__t0) )
)

(assert
  (= var292_nullterm_literal_1_____nullterm_i___t0 (theory2_nullterm var289_i__t1) )
)

; : /home/runner/work/carrier/carrier/core/src/identity.zz:480
(declare-fun var293_implicit_coercion_of_literal_1__t0 () (_ BitVec 64))
(assert (! (= var293_implicit_coercion_of_literal_1__t0 var290_literal_1__t0) :named A3))(declare-fun var289_i__t0 () (_ BitVec 64))
(assert
  (= var289_i__t1  (ite true var293_implicit_coercion_of_literal_1__t0 var289_i__t0)  )
)
...
(assert (! (= var296_implicit_coercion_of_literal_32__t0 var295_literal_32__t0) :named A4)); : /home/runner/work/carrier/carrier/core/src/identity.zz:480
(declare-fun var297_infix_expression__t0 () Bool)
(assert
  (=  var297_infix_expression__t0 (bvult var289_i__t2 var296_implicit_coercion_of_literal_32__t0))
)
...
(assert
  (= var298_len_k___t0 (theory0_len var277_k__t0) )
)

(declare-fun var299_i___len_k___t0 () Bool)
(assert
  (=  var299_i___len_k___t0 (bvult var289_i__t2 var298_len_k___t0))
)
...
(assert
  (and true (or (not var299_i___len_k___t0 ) ))
...
(declare-fun var300_array_member_k_i___t0 () (_ BitVec 8))
(assert
  (=  var301_infix_expression__t0 (not (= var284_first__t1 var300_array_member_k_i___t0)))
)
...
; literal expr
(declare-fun var302_literal_0__t0 () Bool)
(assert
  (not var302_literal_0__t0)
)

(declare-fun var283_return__t1 () Bool)
(declare-fun var283_return__t0 () Bool)
(assert
  (= var283_return__t1  (ite var301_infix_expression__t0 var302_literal_0__t0 var283_return__t0)  )
)
...
(declare-fun var283_return__t2 () Bool)
(assert
  (= var283_return__t2  (ite true var303_literal_4294967295__t0 var283_return__t1)  )
)
