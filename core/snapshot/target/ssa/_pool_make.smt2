...
(assert
  (=  var173_infix_expression__t0 (bvsmod var166_blocksize__t1 var25___pool__ALIGN__t1))
)
...
(assert
  (=  var177_infix_expression__t0 (bvsmod var166_blocksize__t1 var25___pool__ALIGN__t1))
)
...
(assert
  (=  var204_infix_expression__t0 (bvsmod var203_cast_of_blocksize__t0 var25___pool__ALIGN__t1))
)
...
(assert
  (=  var209_infix_expression__t0 (bvsmod var208_cast_of_blocksize__t0 var25___pool__ALIGN__t1))
)
...
(assert
  (=  var252_infix_expression__t0 (bvsmod var251_cast_of_deref_S160_self__used__t0 var25___pool__ALIGN__t1))
)
...
(assert
  (=  var257_infix_expression__t0 (bvsmod var256_cast_of_deref_S160_self__used__t0 var25___pool__ALIGN__t1))
)
...
(assert
  (=  var277_infix_expression__t0 (bvsmod var276_cast_of_deref_S160_self__pool__t0 var25___pool__ALIGN__t1))
)
...
(assert
  (=  var282_infix_expression__t0 (bvsmod var281_cast_of_deref_S160_self__pool__t0 var25___pool__ALIGN__t1))
)
...
(assert
  (= var308_interpretation_of_theory___pool__continuous_over_deref_S160_self___t0 (theory22___pool__continuous var162_deref_S160_self___t0) )
)
...
(assert
  (= var310_interpretation_of_theory___pool__continuous_over_deref_S160_self___t0 (theory22___pool__continuous var162_deref_S160_self___t0) )
)
