...
(declare-fun var329_network__t0 () (_ BitVec 64))
(declare-fun var330_interpretation_of_theory_safe_over_network__t0 () Bool)
(assert
  (= var330_interpretation_of_theory_safe_over_network__t0 (theory1_safe var329_network__t0) )
)

(assert (! var330_interpretation_of_theory_safe_over_network__t0 :named A2))(check-sat)
...
(assert (! (= var336_cast_of_deref_var328_self__user__t0 var335_deref_var328_self__user__t0) :named A4)); : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:462
...
; : /home/runner/work/carrier/carrier/core/src/vault_toml.zz:465
(declare-fun var344_addressof_deref_var332_this__network___t0 () (_ BitVec 64))
(declare-fun var345_len_addressof_deref_var332_this__network____t0 () (_ BitVec 64))
(assert
  (= var345_len_addressof_deref_var332_this__network____t0 (theory0_len var344_addressof_deref_var332_this__network___t0) )
)

(assert
  (= var345_len_addressof_deref_var332_this__network____t0 (_ bv1 64))

)

(assert
  (= var344_addressof_deref_var332_this__network___t0 (_ bv343 64))

)

(declare-fun var346_true__t0 () Bool)
(assert
  (= var346_true__t0 (theory1_safe var344_addressof_deref_var332_this__network___t0) )
)
