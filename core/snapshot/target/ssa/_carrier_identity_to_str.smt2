...
(assert
  (= var347_interpretation_of_theory_symbol_over___err__OutOfTail__t0 (theory3_symbol var169___err__OutOfTail__t0) )
)
...
(assert
  (= var352_interpretation_of_theory___err__checked_over_deref_S290_e___t0 (theory12___err__checked var292_deref_S290_e___t1) )
)
...
(assert
  (not (= var468_i__t2 #x0000000000000010))
)
...
(assert
  (= var532_interpretation_of_theory___err__checked_over_deref_S290_e___t0 (theory12___err__checked var292_deref_S290_e___t1) )
)
...
(assert
  (= var554_interpretation_of_theory___err__checked_over_deref_S290_e___t0 (theory12___err__checked var292_deref_S290_e___t3) )
)
...
(assert
  (not (= var550_return_value_of___err__check__t1 false))
)
