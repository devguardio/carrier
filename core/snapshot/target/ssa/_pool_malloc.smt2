...
(assert
  (= var166_interpretation_of_theory___pool__member_over_literal_Unsigned_0____self__t0 (theory79___pool__member var165_literal_Unsigned_0___t0 var160_self__t0) )
)
...
(assert
  (=  var173_infix_expression__t0 (bvsmod var161_size__t1 var25___pool__ALIGN__t1))
)
...
(assert
  (=  var177_infix_expression__t0 (bvsmod var161_size__t1 var25___pool__ALIGN__t1))
)

; : /home/runner/work/carrier/carrier/modules/pool/src/lib.zz:130
(declare-fun var178_infix_expression__t0 () (_ BitVec 64))
(assert
  (=  var178_infix_expression__t0 (bvsub var25___pool__ALIGN__t1 var177_infix_expression__t0))
)
...
(assert
  (= var207_interpretation_of_theory___pool__member_over_return___self__t0 (theory79___pool__member var163_return__t1 var160_self__t0) )
)
...
(assert
  (not (= var227_infix_expression__t0 #x0000000000033100))
)
...
(assert
  (=  var298_infix_expression__t0 (bvsmod var297_cast_of_mem__t0 var25___pool__ALIGN__t1))
)
...
(assert
  (=  var303_infix_expression__t0 (bvsmod var302_cast_of_mem__t0 var25___pool__ALIGN__t1))
)
...
(assert
  (= var325_interpretation_of_theory___pool__member_over_return___self__t0 (theory79___pool__member var163_return__t2 var160_self__t0) )
)
...
(assert
  (= var330_interpretation_of_theory___pool__member_over_return___self__t0 (theory79___pool__member var163_return__t3 var160_self__t0) )
)
...
(assert
  (= var331_interpretation_of_theory___pool__member_over_return___self__t0 (theory79___pool__member var163_return__t3 var160_self__t0) )
)
