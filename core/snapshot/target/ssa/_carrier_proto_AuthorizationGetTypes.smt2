...
(assert
  (= var664_safe___protonerf__FieldType__Skip_____safe_return___t0 (theory1_safe var99___protonerf__FieldType__Skip__t0) )
)
...
(assert
  (= var665_nullterm___protonerf__FieldType__Skip_____nullterm_return___t0 (theory2_nullterm var99___protonerf__FieldType__Skip__t0) )
)
...
(assert (! (= var666_implicit_coercion_of___protonerf__FieldType__Skip__t0 var99___protonerf__FieldType__Skip__t0) :named A0))(declare-fun var663_return__t0 () (_ BitVec 64))
(assert
