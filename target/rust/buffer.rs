...
extern {
    ...
    pub fn r#eq_cstr( Zself: *const u8,  Zb: *const u8)  -> bool;

    #[link_name = "buffer_make"]
    pub fn r#make( Zself: *mut u8,  Ztail: usize);

    #[link_name = "buffer_append_cstr"]
    pub fn r#append_cstr( Zself: *mut u8,  Zcstr: *const u8);

    #[link_name = "buffer_as_slice"]
    pub fn r#as_slice( Zself: *const u8)  -> super::slice_slice::Slice;

    #[link_name = "buffer_fgets"]
    pub fn r#fgets( Zself: *mut u8,  Zstream: *mut u8)  -> bool;

    #[link_name = "sizeof_buffer_Buffer"]
    pub fn sizeof_Buffer(tail: libc::size_t) -> libc::size_t;

    #[link_name = "buffer_from_cstr"]
    pub fn r#from_cstr( Zself: *mut u8,  Zs: *const u8,  Ztail: usize);


    #[link_name = "buffer_from_slice"]
    pub fn r#from_slice( Zself: *mut u8,  Zslice: super::slice_slice::Slice,  Ztail: usize);

    #[link_name = "buffer_cstr_eq"]
    pub fn r#cstr_eq( Za: *const u8,  Zb: *const u8)  -> bool;

    #[link_name = "buffer_pop"]
    pub fn r#pop( Zself: *mut u8)  -> bool;

    #[link_name = "buffer_starts_with_cstr"]
    pub fn r#starts_with_cstr( Zself: *const u8,  Za: *const u8)  -> bool;

    #[link_name = "buffer_substr"]
    pub fn r#substr( Zself: *const u8,  Zfrom: usize,  Zsize: usize,  Zother: *mut u8);

    #[link_name = "buffer_format"]
    pub fn r#format( Zself: *mut u8,  Zfmt: *const u8)  -> std::os::raw::c_int;

    #[link_name = "buffer_split"]
    pub fn r#split( Zself: *const u8,  Ztoken: u8,  Ziterator: *mut usize,  Zother: *mut u8,  Ztail2: usize)  -> bool;

    #[link_name = "buffer_append_slice"]
    pub fn r#append_slice( Zself: *mut u8,  Zslice: super::slice_slice::Slice);

    #[link_name = "buffer_from_bytes"]
    pub fn r#from_bytes( Zself: *mut u8,  Zbytes: *const u8,  Zinlen: usize,  Ztail: usize);
    ...
    pub fn r#available( Zself: *const u8)  -> usize;

    #[link_name = "buffer_as_mut_slice"]
    pub fn r#as_mut_slice( Zself: *mut u8)  -> super::slice_mut_slice::MutSlice;

    #[link_name = "buffer_append_bytes"]
    pub fn r#append_bytes( Zself: *mut u8,  Zbytes: *const u8,  Zinlen: usize);

    #[link_name = "buffer_vformat"]
    pub fn r#vformat( Zself: *mut u8,  Zfmt: *const u8)  -> std::os::raw::c_int;

    #[link_name = "buffer_fread"]
    pub fn r#fread( Zself: *mut u8,  Zstream: *mut u8)  -> bool;
    ...
    pub fn r#clear( Zself: *mut u8);

    #[link_name = "buffer_ends_with_cstr"]
    pub fn r#ends_with_cstr( Zself: *const u8,  Za: *const u8)  -> bool;
