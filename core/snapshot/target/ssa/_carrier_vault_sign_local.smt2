...
; end of collecting theory invocation arguments
; : /home/runner/work/carrier/carrier/core/src/vault.zz:144
(declare-fun var209_deref_var200_self__i_sign_local__t0 () (_ BitVec 64))
(declare-fun var210_interpretation_of_theory_safe_over_deref_var200_self__i_sign_local__t0 () Bool)
(assert
  (= var210_interpretation_of_theory_safe_over_deref_var200_self__i_sign_local__t0 (theory1_safe var209_deref_var200_self__i_sign_local__t0) )
)

(assert (! var210_interpretation_of_theory_safe_over_deref_var200_self__i_sign_local__t0 :named A4))(check-sat)
...
; begin safe ptr check
; : /home/runner/work/carrier/carrier/core/src/vault.zz:145
(declare-fun var214_safe_deref_var200_self__i_sign_local___t0 () Bool)
(assert
  (= var214_safe_deref_var200_self__i_sign_local___t0 (theory1_safe var209_deref_var200_self__i_sign_local__t0) )
)

(push 1)

(assert
  (and true (or (not var214_safe_deref_var200_self__i_sign_local___t0 ) ))
