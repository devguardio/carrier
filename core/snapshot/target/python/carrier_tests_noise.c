...
extern PyTypeObject py_Type_buffer_Buffer;
extern PyTypeObject py_Type_carrier_tests_noise_Message;
extern PyTypeObject py_Type_carrier_tests_noise_Testcase;
extern PyTypeObject py_Type_carrier_identity_Secret;
...
static struct PyModuleDef mod_definition = {PyModuleDef_HEAD_INIT, "carrier_tests_noise", "carrier::tests::noise", -1, methods};

PyObject*  py_mod_carrier_tests_noise_Init()
{
