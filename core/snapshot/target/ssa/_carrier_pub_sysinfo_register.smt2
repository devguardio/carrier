...
(assert
  (= var850_addressof___carrier__pub_sysinfo__ConfigSysinfo___t0 (_ bv439 64))
...
(assert
  (= var853_addressof___carrier__pub_sysinfo__ConfigSysinfo___t0 (_ bv439 64))
...
(assert
  (= var860_addressof___carrier__pub_sysinfo__ConfigSensors___t0 (_ bv455 64))
...
(assert
  (= var863_addressof___carrier__pub_sysinfo__ConfigSensors___t0 (_ bv455 64))
