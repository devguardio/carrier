...
(declare-fun var850_return_value_of___byteorder__to_be64__t0 () (_ BitVec 64))
(declare-fun var851_safe_return_value_of___byteorder__to_be64_____safe_return___t0 () Bool)
(assert
  (= var851_safe_return_value_of___byteorder__to_be64_____safe_return___t0 (theory1_safe var850_return_value_of___byteorder__to_be64__t0) )
)

(declare-fun var849_return__t1 () (_ BitVec 64))
(assert
  (= var851_safe_return_value_of___byteorder__to_be64_____safe_return___t0 (theory1_safe var849_return__t1) )
)

(declare-fun var852_nullterm_return_value_of___byteorder__to_be64_____nullterm_return___t0 () Bool)
(assert
  (= var852_nullterm_return_value_of___byteorder__to_be64_____nullterm_return___t0 (theory2_nullterm var850_return_value_of___byteorder__to_be64__t0) )
)

(assert
  (= var852_nullterm_return_value_of___byteorder__to_be64_____nullterm_return___t0 (theory2_nullterm var849_return__t1) )
)

(declare-fun var849_return__t0 () (_ BitVec 64))
(assert
  (= var849_return__t1  (ite true var850_return_value_of___byteorder__to_be64__t0 var849_return__t0)  )
)
