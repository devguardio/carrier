...
(assert
  (not (= var842_f__t2 #x9d71e9bb5be08000))
)
...
(assert
  (not (= var842_f__t2 #xdf00160400002100))
)
...
(assert
  (not (= var842_f__t2 #x0815000341202000))
)
...
(assert
  (not (= var842_f__t2 #xc2008d6240000050))
)
...
(assert
  (not (= var842_f__t2 #x5982100b02058800))
)
...
(assert
  (not (= var842_f__t2 #x1101801690808200))
)
...
(assert
   (=  var962_infix_expression__t0 (bvadd var961_array_member_qq_f__packet__t0 var645___carrier__pq__REORDER_THRESHOLD__t1))
)
...
(assert
  (not (= var842_f__t2 #x169c888000000020))
)
...
(assert
  (not (= var842_f__t2 #x402847ad83984000))
)
