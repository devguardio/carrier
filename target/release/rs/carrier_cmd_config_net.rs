...
extern {
    ...
    pub fn r#run_remote_net_join( Ze: *mut u8,  Zet: usize,  Zendpoint: *mut u8,  Ztarget: *const u8,  Znet_secret: *const u8);
    ...
    pub fn r#run_self_net_join( Ze: *mut u8,  Zet: usize,  Zendpoint: *mut u8,  Znet_secret: *const u8);
