...
(assert (! (= var714_len_deref_S709_self____t0 var710_qt__t0) :named A11)); : /home/runner/work/carrier/carrier/core/src/pq.zz:400
; : /home/runner/work/carrier/carrier/core/src/pq.zz:400
; call of safe
; collecting theory invocation arguments
; end of collecting theory invocation arguments
(declare-fun var715_i__t0 () (_ BitVec 64))
(declare-fun var716_interpretation_of_theory_safe_over_i__t0 () Bool)
(assert
  (= var716_interpretation_of_theory_safe_over_i__t0 (theory1_safe var715_i__t0) )
)

(assert (! var716_interpretation_of_theory_safe_over_i__t0 :named A12))(check-sat)
...
(assert (! var717_interpretation_of_theory_safe_over_self__t0 :named A13))(check-sat)
...
(declare-fun var721_safe_i___t0 () Bool)
(assert
  (= var721_safe_i___t0 (theory1_safe var715_i__t0) )
)

(push 1)

(assert
  (and true (or (not var721_safe_i___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/pq.zz:402
(declare-fun var720_deref_var715_i___t0 () (_ BitVec 64))
(declare-fun var723_safe_deref_var715_i______safe_previous_value_of_deref_var715_i____t0 () Bool)
(assert
  (= var723_safe_deref_var715_i______safe_previous_value_of_deref_var715_i____t0 (theory1_safe var720_deref_var715_i___t0) )
)

(declare-fun var722_previous_value_of_deref_var715_i___t1 () (_ BitVec 64))
(assert
  (= var723_safe_deref_var715_i______safe_previous_value_of_deref_var715_i____t0 (theory1_safe var722_previous_value_of_deref_var715_i___t1) )
)

(declare-fun var724_nullterm_deref_var715_i______nullterm_previous_value_of_deref_var715_i____t0 () Bool)
(assert
  (= var724_nullterm_deref_var715_i______nullterm_previous_value_of_deref_var715_i____t0 (theory2_nullterm var720_deref_var715_i___t0) )
)

(assert
  (= var724_nullterm_deref_var715_i______nullterm_previous_value_of_deref_var715_i____t0 (theory2_nullterm var722_previous_value_of_deref_var715_i___t1) )
)

(declare-fun var722_previous_value_of_deref_var715_i___t0 () (_ BitVec 64))
(assert
  (= var722_previous_value_of_deref_var715_i___t1  (ite true var720_deref_var715_i___t0 var722_previous_value_of_deref_var715_i___t0)  )
)

(declare-fun var720_deref_var715_i___t1 () (_ BitVec 64))
(assert
  (= var720_deref_var715_i___t1 (bvadd var722_previous_value_of_deref_var715_i___t1 (_ bv1 64)) )
)

; : /home/runner/work/carrier/carrier/core/src/pq.zz:402
(declare-fun var725_safe_previous_value_of_deref_var715_i______safe_v___t0 () Bool)
(assert
  (= var725_safe_previous_value_of_deref_var715_i______safe_v___t0 (theory1_safe var722_previous_value_of_deref_var715_i___t1) )
)

(declare-fun var719_v__t1 () (_ BitVec 64))
(assert
  (= var725_safe_previous_value_of_deref_var715_i______safe_v___t0 (theory1_safe var719_v__t1) )
)

(declare-fun var726_nullterm_previous_value_of_deref_var715_i______nullterm_v___t0 () Bool)
(assert
  (= var726_nullterm_previous_value_of_deref_var715_i______nullterm_v___t0 (theory2_nullterm var722_previous_value_of_deref_var715_i___t1) )
)

(assert
  (= var726_nullterm_previous_value_of_deref_var715_i______nullterm_v___t0 (theory2_nullterm var719_v__t1) )
)

(declare-fun var719_v__t0 () (_ BitVec 64))
(assert
  (= var719_v__t1  (ite true var722_previous_value_of_deref_var715_i___t1 var719_v__t0)  )
)
...
(assert
  (=  var727_infix_expression__t0 (bvuge var720_deref_var715_i___t1 var710_qt__t0))
)
...
(assert (! (= var729_implicit_coercion_of_literal_0__t0 var728_literal_0__t0) :named A14)); : /home/runner/work/carrier/carrier/core/src/pq.zz:404
(declare-fun var730_safe_implicit_coercion_of_literal_0_____safe_deref_var715_i____t0 () Bool)
(assert
  (= var730_safe_implicit_coercion_of_literal_0_____safe_deref_var715_i____t0 (theory1_safe var729_implicit_coercion_of_literal_0__t0) )
)

(declare-fun var720_deref_var715_i___t2 () (_ BitVec 64))
(assert
  (= var730_safe_implicit_coercion_of_literal_0_____safe_deref_var715_i____t0 (theory1_safe var720_deref_var715_i___t2) )
)

(declare-fun var731_nullterm_implicit_coercion_of_literal_0_____nullterm_deref_var715_i____t0 () Bool)
(assert
  (= var731_nullterm_implicit_coercion_of_literal_0_____nullterm_deref_var715_i____t0 (theory2_nullterm var729_implicit_coercion_of_literal_0__t0) )
)

(assert
  (= var731_nullterm_implicit_coercion_of_literal_0_____nullterm_deref_var715_i____t0 (theory2_nullterm var720_deref_var715_i___t2) )
)

(assert
  (= var720_deref_var715_i___t2  (ite var727_infix_expression__t0 var729_implicit_coercion_of_literal_0__t0 var720_deref_var715_i___t1)  )
)

; end branch
; : /home/runner/work/carrier/carrier/core/src/pq.zz:406
(declare-fun var732_safe_v_____safe_return___t0 () Bool)
(assert
  (= var732_safe_v_____safe_return___t0 (theory1_safe var719_v__t1) )
)

(declare-fun var718_return__t1 () (_ BitVec 64))
(assert
  (= var732_safe_v_____safe_return___t0 (theory1_safe var718_return__t1) )
)

(declare-fun var733_nullterm_v_____nullterm_return___t0 () Bool)
(assert
  (= var733_nullterm_v_____nullterm_return___t0 (theory2_nullterm var719_v__t1) )
)

(assert
  (= var733_nullterm_v_____nullterm_return___t0 (theory2_nullterm var718_return__t1) )
)

(declare-fun var718_return__t0 () (_ BitVec 64))
(assert
  (= var718_return__t1  (ite true var719_v__t1 var718_return__t0)  )
)
