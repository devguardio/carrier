...
(declare-fun var718_return_value_of___byteorder__swap64__t0 () (_ BitVec 64))
(declare-fun var719_safe_return_value_of___byteorder__swap64_____safe_return___t0 () Bool)
(assert
  (= var719_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var718_return_value_of___byteorder__swap64__t0) )
)

(declare-fun var717_return__t1 () (_ BitVec 64))
(assert
  (= var719_safe_return_value_of___byteorder__swap64_____safe_return___t0 (theory1_safe var717_return__t1) )
)

(declare-fun var720_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 () Bool)
(assert
  (= var720_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var718_return_value_of___byteorder__swap64__t0) )
)

(assert
  (= var720_nullterm_return_value_of___byteorder__swap64_____nullterm_return___t0 (theory2_nullterm var717_return__t1) )
)

(declare-fun var717_return__t0 () (_ BitVec 64))
(assert
  (= var717_return__t1  (ite true var718_return_value_of___byteorder__swap64__t0 var717_return__t0)  )
)
...
(declare-fun var721_x__t0 () (_ BitVec 64))
(declare-fun var723_safe_x_____safe_return___t0 () Bool)
(assert
  (= var723_safe_x_____safe_return___t0 (theory1_safe var721_x__t0) )
)

(declare-fun var722_return__t1 () (_ BitVec 64))
(assert
  (= var723_safe_x_____safe_return___t0 (theory1_safe var722_return__t1) )
)

(declare-fun var724_nullterm_x_____nullterm_return___t0 () Bool)
(assert
  (= var724_nullterm_x_____nullterm_return___t0 (theory2_nullterm var721_x__t0) )
)

(assert
  (= var724_nullterm_x_____nullterm_return___t0 (theory2_nullterm var722_return__t1) )
)

(declare-fun var722_return__t0 () (_ BitVec 64))
(assert
  (= var722_return__t1  (ite true var721_x__t0 var722_return__t0)  )
)
