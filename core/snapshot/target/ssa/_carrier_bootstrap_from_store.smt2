...
(assert (! (= var351_implicit_coercion_of_literal_0__t0 ( (_ extract 7 0) var350_literal_0__t0 )) :named A5)); : /home/runner/work/carrier/carrier/core/src/bootstrap.zz:28
...
(assert
  (not (= var354_literal_4__t0 #x0000000000000004))
)
...
(assert
  (=  var360_infix_expression__t0 (= var61___net__address__Type__Ipv4__t0 var61___net__address__Type__Ipv4__t0))
)
...
(assert
  (=  var365_infix_expression__t0 (= var61___net__address__Type__Ipv4__t0 var62___net__address__Type__Ipv6__t0))
)
...
(assert
  (not (= var372_literal_16__t0 #x0000000000000010))
)
...
(assert
  (=  var378_infix_expression__t0 (= var62___net__address__Type__Ipv6__t0 var61___net__address__Type__Ipv4__t0))
)
...
(assert
  (=  var383_infix_expression__t0 (= var62___net__address__Type__Ipv6__t0 var62___net__address__Type__Ipv6__t0))
)
...
(assert
  (not (= var392_literal_32__t0 #x0000000000000020))
)
...
(assert
  (not (= var396_literal_32__t0 #x0000000000000020))
)
