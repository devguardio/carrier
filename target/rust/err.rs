...
extern {
    ...
    pub fn r#ignore( Zself: *mut u8);

    #[link_name = "err_check"]
    pub fn r#check( Zself: *mut u8,  Zfile: *const u8,  Zscope: *const u8,  Zline: usize)  -> bool;

    #[link_name = "err_abort"]
    pub fn r#abort( Zself: *mut u8,  Zfile: *const u8,  Zscope: *const u8,  Zline: usize);
    ...
    pub fn r#fail_with_win32( Zself: *mut u8,  Zfile: *const u8,  Zscope: *const u8,  Zline: usize,  Zfmt: *const u8);

    #[link_name = "err_backtrace"]
    pub fn r#backtrace( Zself: *mut u8,  Zfile: *const u8,  Zscope: *const u8,  Zline: usize);

    #[link_name = "err_fail_with_system_error"]
    pub fn r#fail_with_system_error( Zself: *mut u8,  Zmerrno: std::os::raw::c_int,  Zfile: *const u8,  Zscope: *const u8,  Zline: usize,  Zfmt: *const u8);

    #[link_name = "err_elog"]
    pub fn r#elog( Zself: *const u8);
    ...
    pub fn r#assert_safe( Za: *const std::ffi::c_void,  Zfile: *const u8,  Zscope: *const u8,  Zline: usize);

    #[link_name = "err_fail"]
    pub fn r#fail( Zself: *mut u8,  Ze: usize,  Zfile: *const u8,  Zscope: *const u8,  Zline: usize,  Zfmt: *const u8);
    ...
    pub fn r#fail_with_errno( Zself: *mut u8,  Zfile: *const u8,  Zscope: *const u8,  Zline: usize,  Zfmt: *const u8);

    #[link_name = "err_eprintf"]
    pub fn r#eprintf( Zself: *const u8,  Zout: *mut u8);
