...
(assert
  (= var240_interpretation_of_theory___err__checked_over_deref_S187_e___t0 (theory23___err__checked var189_deref_S187_e___t1) )
)
...
(assert
  (= var243_safe___io__Result__Error_____safe_return___t0 (theory1_safe var29___io__Result__Error__t0) )
)
...
(assert
  (= var244_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var29___io__Result__Error__t0) )
)
...
(assert (! (= var245_implicit_coercion_of___io__Result__Error__t0 var29___io__Result__Error__t0) :named A12))(declare-fun var205_return__t0 () (_ BitVec 64))
(assert
...
(assert
  (= var301_interpretation_of_theory___err__checked_over_deref_S187_e___t0 (theory23___err__checked var189_deref_S187_e___t3) )
)
...
(assert
  (= var303_safe___io__Result__Error_____safe_return___t0 (theory1_safe var29___io__Result__Error__t0) )
)
...
(assert
  (= var304_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var29___io__Result__Error__t0) )
)
...
(assert (! (= var305_implicit_coercion_of___io__Result__Error__t0 var29___io__Result__Error__t0) :named A22))(assert
...
(assert (! (= var306_implicit_coercion_of___io__Result__Ready__t0 var27___io__Result__Ready__t0) :named A23)); : /home/runner/work/carrier/carrier/core/modules/io/src/lib.zz:84
