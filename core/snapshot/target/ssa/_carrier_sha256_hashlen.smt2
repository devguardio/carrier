...
; : /home/aep/proj/devguard/carrier/core/src/sha256.zz:10
; : /home/aep/proj/devguard/carrier/core/src/sha256.zz:11
(declare-fun var120_safe___carrier__sha256__HASHLEN_____safe_return___t0 () Bool)
(assert
  (= var120_safe___carrier__sha256__HASHLEN_____safe_return___t0 (theory1_safe var41___carrier__sha256__HASHLEN__t1) )
)

(declare-fun var119_return__t1 () (_ BitVec 64))
(assert
  (= var120_safe___carrier__sha256__HASHLEN_____safe_return___t0 (theory1_safe var119_return__t1) )
)

(declare-fun var121_nullterm___carrier__sha256__HASHLEN_____nullterm_return___t0 () Bool)
(assert
  (= var121_nullterm___carrier__sha256__HASHLEN_____nullterm_return___t0 (theory2_nullterm var41___carrier__sha256__HASHLEN__t1) )
)

(assert
  (= var121_nullterm___carrier__sha256__HASHLEN_____nullterm_return___t0 (theory2_nullterm var119_return__t1) )
)

(declare-fun var119_return__t0 () (_ BitVec 64))
(assert
  (= var119_return__t1  (ite true var41___carrier__sha256__HASHLEN__t1 var119_return__t0)  )
)
