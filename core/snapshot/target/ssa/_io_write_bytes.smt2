...
(assert
  (= var198_interpretation_of_theory___err__checked_over_deref_S187_e___t0 (theory40___err__checked var189_deref_S187_e___t0) )
)
...
(assert
  (= var230_interpretation_of_theory___err__checked_over_deref_S187_e___t0 (theory40___err__checked var189_deref_S187_e___t1) )
)
...
(assert
  (= var233_safe___io__Result__Error_____safe_return___t0 (theory1_safe var12___io__Result__Error__t0) )
)
...
(assert
  (= var234_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var12___io__Result__Error__t0) )
)
...
(assert (! (= var235_implicit_coercion_of___io__Result__Error__t0 var12___io__Result__Error__t0) :named A9))(declare-fun var199_return__t0 () (_ BitVec 64))
(assert
...
(assert
  (= var264_interpretation_of_theory___err__checked_over_deref_S187_e___t0 (theory40___err__checked var189_deref_S187_e___t3) )
)
...
(assert (! (= var266_implicit_coercion_of___io__Result__Ready__t0 var10___io__Result__Ready__t0) :named A14)); : /home/runner/work/carrier/carrier/core/modules/io/src/lib.zz:199
