...
#include <stddef.h>
const __attribute__ ((unused)) size_t carrier_router_OutOfOptions = 1;
const __attribute__ ((unused)) size_t hpack_decoder_Invalid = 2;
const __attribute__ ((unused)) size_t carrier_endpoint_InvalidBootstrap = 3;
const __attribute__ ((unused)) size_t err_InvalidArgument = 4;
const __attribute__ ((unused)) size_t carrier_identity_Invalid = 5;
const __attribute__ ((unused)) size_t carrier_cipher_EncryptionError = 6;
...
const __attribute__ ((unused)) size_t err_NotImplemented = 10;
...
const __attribute__ ((unused)) size_t json_ParseError = 16;
const __attribute__ ((unused)) size_t protonerf_Invalid = 17;
