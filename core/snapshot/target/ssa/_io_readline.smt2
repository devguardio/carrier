...
(assert
  (= var251_interpretation_of_theory___err__checked_over_deref_S187_e___t0 (theory40___err__checked var189_deref_S187_e___t1) )
)
...
(assert
  (= var254_safe___io__Result__Error_____safe_return___t0 (theory1_safe var12___io__Result__Error__t0) )
)
...
(assert
  (= var255_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var12___io__Result__Error__t0) )
)
...
(assert (! (= var256_implicit_coercion_of___io__Result__Error__t0 var12___io__Result__Error__t0) :named A16))(declare-fun var220_return__t0 () (_ BitVec 64))
(assert
...
(assert
  (= var308_interpretation_of_theory___err__checked_over_deref_S187_e___t0 (theory40___err__checked var189_deref_S187_e___t3) )
)
...
(assert
  (= var310_safe___io__Result__Error_____safe_return___t0 (theory1_safe var12___io__Result__Error__t0) )
)
...
(assert
  (= var311_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var12___io__Result__Error__t0) )
)
...
(assert (! (= var312_implicit_coercion_of___io__Result__Error__t0 var12___io__Result__Error__t0) :named A22))(assert
...
(assert (! (= var313_implicit_coercion_of___io__Result__Ready__t0 var10___io__Result__Ready__t0) :named A23)); : /home/runner/work/carrier/carrier/core/modules/io/src/lib.zz:161
...
(assert
  (= var327_safe___io__Result__Ready_____safe_return___t0 (theory1_safe var10___io__Result__Ready__t0) )
)
...
(assert
  (= var328_nullterm___io__Result__Ready_____nullterm_return___t0 (theory2_nullterm var10___io__Result__Ready__t0) )
)
...
(assert (! (= var329_implicit_coercion_of___io__Result__Ready__t0 var10___io__Result__Ready__t0) :named A25))(assert
...
(assert
  (= var371_interpretation_of_theory_symbol_over___err__OutOfTail__t0 (theory3_symbol var67___err__OutOfTail__t0) )
)
...
(assert
  (= var376_interpretation_of_theory___err__checked_over_deref_S187_e___t0 (theory40___err__checked var189_deref_S187_e___t4) )
)
...
(assert
  (= var379_safe___io__Result__Error_____safe_return___t0 (theory1_safe var12___io__Result__Error__t0) )
)
...
(assert
  (= var380_nullterm___io__Result__Error_____nullterm_return___t0 (theory2_nullterm var12___io__Result__Error__t0) )
)
...
(assert (! (= var381_implicit_coercion_of___io__Result__Error__t0 var12___io__Result__Error__t0) :named A30))(assert
...
(assert
  (= var382_safe___io__Result__Later_____safe_return___t0 (theory1_safe var11___io__Result__Later__t0) )
)
...
(assert
  (= var383_nullterm___io__Result__Later_____nullterm_return___t0 (theory2_nullterm var11___io__Result__Later__t0) )
)
...
(assert (! (= var384_implicit_coercion_of___io__Result__Later__t0 var11___io__Result__Later__t0) :named A31))(assert
