...
; : /home/runner/work/carrier/carrier/core/src/endpoint.zz:155
(declare-fun var732_deref_var725_self__statem_connected_channels__t0 () (_ BitVec 64))
(declare-fun var733_len_deref_var725_self__statem_connected_channels___t0 () (_ BitVec 64))
(assert
  (= var733_len_deref_var725_self__statem_connected_channels___t0 (theory0_len var732_deref_var725_self__statem_connected_channels__t0) )
)

(assert
  (= var733_len_deref_var725_self__statem_connected_channels___t0 (_ bv6 64))

)

(declare-fun var734_true__t0 () Bool)
(assert
  (= var734_true__t0 (theory1_safe var732_deref_var725_self__statem_connected_channels__t0) )
)
...
(assert
  (not (= var735_literal_0__t0 #x0000000000000000))
)
...
; begin array bounds
; : /home/runner/work/carrier/carrier/core/src/endpoint.zz:155
(declare-fun var736_len_deref_var725_self__statem_connected_channels___t0 () (_ BitVec 64))
(assert
  (= var736_len_deref_var725_self__statem_connected_channels___t0 (theory0_len var732_deref_var725_self__statem_connected_channels__t0) )
)

(declare-fun var737_literal_0___len_deref_var725_self__statem_connected_channels___t0 () Bool)
(assert
  (=  var737_literal_0___len_deref_var725_self__statem_connected_channels___t0 (bvult var735_literal_0__t0 var736_len_deref_var725_self__statem_connected_channels___t0))
)
...
(assert
  (and true (or (not var737_literal_0___len_deref_var725_self__statem_connected_channels___t0 ) ))
...
; : /home/runner/work/carrier/carrier/core/src/endpoint.zz:155
(declare-fun var739_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0____t0 () (_ BitVec 64))
(declare-fun var740_len_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0_____t0 () (_ BitVec 64))
(assert
  (= var740_len_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0_____t0 (theory0_len var739_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0____t0) )
)

(assert
  (= var740_len_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0_____t0 (_ bv1 64))

)

(assert
  (= var739_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0____t0 (_ bv738 64))

)

(declare-fun var741_true__t0 () Bool)
(assert
  (= var741_true__t0 (theory1_safe var739_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0____t0) )
)
...
(declare-fun var742_safe_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0_______safe_return___t0 () Bool)
(assert
  (= var742_safe_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0_______safe_return___t0 (theory1_safe var739_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0____t0) )
)

(declare-fun var727_return__t1 () (_ BitVec 64))
(assert
  (= var742_safe_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0_______safe_return___t0 (theory1_safe var727_return__t1) )
)

(declare-fun var743_nullterm_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0_______nullterm_return___t0 () Bool)
(assert
  (= var743_nullterm_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0_______nullterm_return___t0 (theory2_nullterm var739_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0____t0) )
)

(assert
  (= var743_nullterm_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0_______nullterm_return___t0 (theory2_nullterm var727_return__t1) )
)

(declare-fun var727_return__t0 () (_ BitVec 64))
(assert
  (= var727_return__t1  (ite true var739_addressof_array_member_deref_var725_self__statem_connected_channels_literal_0____t0 var727_return__t0)  )
)
...
(assert
  (= var744_interpretation_of_theory_safe_over_return__t0 (theory1_safe var727_return__t1) )
)

(push 1)

(assert
  (and true (or (not var744_interpretation_of_theory_safe_over_return__t0 ) ))
...
(assert
  (= var745_interpretation_of_theory_safe_over_return__t0 (theory1_safe var727_return__t1) )
)

(push 1)

(assert
  (and true (or (not var745_interpretation_of_theory_safe_over_return__t0 ) ))
