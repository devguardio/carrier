...
Disconnect the channel. Immediately drop the encryption
context and stop sending any packets.
All unacked packets should be considered lost.

A disconnect is not ackd. If practical, a sender should
send Close to all channels and wait for the acks.
...
--------------------------------------------------------
| Stream (8 bytes unsigned big endian)                 |
--------------------------------------------------------
