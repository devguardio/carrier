...
(declare-fun var720_return_value_of___byteorder__to_be64__t0 () (_ BitVec 64))
(declare-fun var721_safe_return_value_of___byteorder__to_be64_____safe_return___t0 () Bool)
(assert
  (= var721_safe_return_value_of___byteorder__to_be64_____safe_return___t0 (theory1_safe var720_return_value_of___byteorder__to_be64__t0) )
)

(declare-fun var719_return__t1 () (_ BitVec 64))
(assert
  (= var721_safe_return_value_of___byteorder__to_be64_____safe_return___t0 (theory1_safe var719_return__t1) )
)

(declare-fun var722_nullterm_return_value_of___byteorder__to_be64_____nullterm_return___t0 () Bool)
(assert
  (= var722_nullterm_return_value_of___byteorder__to_be64_____nullterm_return___t0 (theory2_nullterm var720_return_value_of___byteorder__to_be64__t0) )
)

(assert
  (= var722_nullterm_return_value_of___byteorder__to_be64_____nullterm_return___t0 (theory2_nullterm var719_return__t1) )
)

(declare-fun var719_return__t0 () (_ BitVec 64))
(assert
  (= var719_return__t1  (ite true var720_return_value_of___byteorder__to_be64__t0 var719_return__t0)  )
)
